...
#lema(ur'San Jos_é_(?! (?:Oaks|Earthquakes))_e') + 
#lema(ur'[Cc]ol_ó_n_o') + #a.c colon
#lema(ur'Cimarr_o_n_ó', pre=ur'[Cc]ondados? de ') + 
#lema(ur'Megat_ón|Megatones]]__[óo]n\]\]es') + lema(ur'megat_ón|megatones]]__[óo]n\]\]es') + 
#lema(ur'Prot_ón|Protones]]__[óo]n\]\]es') + lema(ur'prot_ón|protones]]__[óo]n\]\]es') + 
#lema(ur'Aler_ón|Alerones]]__[óo]n\]\]es') + lema(ur'aler_ón|alerones]]__[óo]n\]\]es') + 
#lema(ur'Ax_ón|Axones]]__[óo]n\]\]es') + lema(ur'ax_ón|axones]]__[óo]n\]\]es') + 
#lema(ur'[Bb]al_ó_n(?!\]| Greyjoy)_o') + 
#lema(ur'Batall_ón|Batallones]]__[óo]n\]\]es') + lema(ur'batall_ón|batallones]]__[óo]n\]\]es') + 
#lema(ur'Concreci_ón|Concreciones]]__[óo]n\]\]es') + lema(ur'concreci_ón|concreciones]]__[óo]n\]\]es') + 
#lema(ur'confecci_ón|confeccion\g<x>]]__[óo]n\]\](?P<x>es|ar?)') + 
#lema(ur'Conjugaci_ón|Conjugaciones]]__[óo]n\]\]es') + lema(ur'conjugaci_ón|conjugaciones]]__[óo]n\]\]es') + 
#lema(ur'Convulsi_ón|Convulsiones]]__[óo]n\]\]es') + lema(ur'convulsi_ón|convulsiones]]__[óo]n\]\]es') + 
#lema(ur'Deportaci_ón|Deportaciones]]__[óo]n\]\]es') + lema(ur'deportaci_ón|deportaciones]]__[óo]n\]\]es') + 
#lema(ur'Depresi_ón|Depresiones]]__[óo]n\]\]es') + lema(ur'depresi_ón|depresiones]]__[óo]n\]\]es') + 
#lema(ur'Ecorregi_ón|Ecorregiones]]__[óo]n\]\]es') + lema(ur'ecorregi_ón|ecorregiones]]__[óo]n\]\]es') + 
#lema(ur'embri_ón|embrion\g<x>]]__[óo]n\]\](?P<x>es|ari[ao]s?)') + 
#lema(ur'Especificaci_ón|Especificaciones]]__[óo]n\]\]es') + lema(ur'especificaci_ón|especificaciones]]__[óo]n\]\]es') + 
#lema(ur'Exportaci_ón|Exportaciones]]__[óo]n\]\]es') + lema(ur'exportaci_ón|exportaciones]]__[óo]n\]\]es') + 
#lema(ur'Gasc_ó_n(?!\]| Modernes)_o') + 
#lema(ur'Hur_o_n_ó', pre=ur'[Cc]ondados? de ') + 
#lema(ur'Importaci_ón|Importaciones]]__[óo]n\]\]es') + lema(ur'importaci_ón|importaciones]]__[óo]n\]\]es') + 
#lema(ur'instruccion_es]]__\]\]es') + 
#lema(ur'Intoxicaci_ón|Intoxicaciones]]__[óo]n\]\]es') + lema(ur'intoxicaci_ón|intoxicaciones]]__[óo]n\]\]es') + 
#lema(ur'Inundaci_ón|Inundaciones]]__[óo]n\]\]es') + lema(ur'inundaci_ón|inundaciones]]__[óo]n\]\]es') + 
#lema(ur'[Mm]ascar_ó_n(?!\])_o') + #?????
#lema(ur'Melocot_ón|Melocotones]]__[óo]n\]\]es') + lema(ur'melocot_ón|melocotones]]__[óo]n\]\]es') + lema(ur'melocot_ón|melocoton\g<x>]]__[óo]n\]\](?P<x>es|eros?)') + 
#lema(ur'Microrregi_ón|Microrregiones]]__[óo]n\]\]es') + lema(ur'microrregi_ón|microrregiones]]__[óo]n\]\]es') + 
#lema(ur'migraci_ón|migraciones]]__[oó]n\]\]es') + lema(ur'Migraci_ón|Migraciones]]__[oó]n\]\]es') + 
#lema(ur'Monz_ón|Monzones]]__[óo]n\]\]es') + lema(ur'monz_ón|monzones]]__[óo]n\]\]es') + 
#lema(ur'Mutaci_ón|Mutaciones]]__[óo]n\]\]es') + lema(ur'mutaci_ón|mutaciones]]__[óo]n\]\]es') + 
#lema(ur'Preposici_ón|Preposiciones]]__[óo]n\]\]es') + lema(ur'preposici_ón|preposiciones]]__[óo]n\]\]es') + 
#lema(ur'Privatizaci_ón|Privatizaciones]]__[óo]n\]\]es') + lema(ur'privatizaci_ón|privatizaciones]]__[óo]n\]\]es') + 
#lema(ur'Procesi_ón|Procesiones]]__[óo]n\]\]es') + lema(ur'procesi_ón|procesiones]]__[óo]n\]\]es') + 
#lema(ur'Pulm_ón|Pulmones]]__[óo]n\]\]es') + lema(ur'pulm_ón|pulmones]]__[óo]n\]\]es') + 
#lema(ur'Riñ_ón|Riñones]]__[óo]n\]\]es') + lema(ur'riñ_ón|riñones]]__[óo]n\]\]es') + 
#lema(ur'Tradici_ón|Tradiciones]]__[óo]n\]\]es') + lema(ur'tradici_ón|tradicion\g<x>]]__[óo]n\]\](?P<x>es|al|ales)') + 
#lema(ur'Vacaci_ón|Vacaciones]]__[óo]n\]\]es') + lema(ur'vacaci_ón|vacaciones]]__[óo]n\]\]es') + 
#lema(ur'[Vv]al_ó_n(?!\])_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + 
#lema(ur'Violaci_ón|violaciones]]__[óo]n\]\]es') + lema(ur'violaci_ón|violaciones]]__[óo]n\]\]es') + 
#lema(ur'[Qq]uin_c_e(?! (?:de Novembro|poemes|generacions))_[sz]') + #fr,ca
#lema(ur'(?:[Ee]l|[Aa]l|[Dd]el) _R_ey \[\[_r') + lema(ur'[Ll]a _R_eina \[\[_r') + 
#lema(ur'(?:[Ee]l|[Aa]l|[Dd]el) _Prí_ncipe \[\[_(?:pr[ií]|Pri)') + lema(ur'[Ll]a _P_rincesa \[\[_p') + 
#lema(ur'(?:[Ee]l|[Aa]l|[Dd]el) _E_mperador \[\[_e') + lema(ur'[Ll]a _E_mperatriz \[\[_e') + 
#lema(ur'(?<!malorum )[Nn]_ó_mina(?! (?:al|el|la|un|dubia|Insecta|nuda|como|también|a))_o') + 
#retroX(ur'(?: All\'|(?:Aenetus|Aethopyga|Alstonia|Aquilegia|Bleda|Canna|Corymbia|Dicentra|Eucalyptus|Fritillaria|Hyla|Lepanthes|Melaleuca|Maranta|Megalaima|Pleurothallis|Protea|Raulia|Romulea|Scorzonera|Solenopsis|Synopcia|Syncarpha|Talisia|Viola|var\.|[AP]\.)) [Ee]xim_i_a_í') + 
#lema(ur'[Ss]ub_í_as?_i') + 
#lema(ur'(?<!Marcel )Pich_ó_n(?!\]| Stevann)_o') + 
...
#lema(ur'_D_ebian_d', pre=ur'(?:con|en|para|de) ', xpos=[ur'\.org']) + 
...
#lema(ur'[Hh]eredit_a_ri[ao]s?_á') + #1 pt
...
#lema(ur'[Aa]_demá_s_ dem[aá]') + 
#lema(ur'Carb_o_n_ó', pre=ur'[Cc]ondados? de ') + #0
#lema(ur'[Tt]estificar_á_[ns]?_a') + 
#lema(ur'[Dd]eclarar_á_[ns]*_a') + 
#lema(ur'[Cc]ertificar_á_[ns]*_a') + 
...
#lema(ur'[Pp]resupuestar_á_[ns]?_a') + 
#lema(ur'[Aa]yudar_á_[ns]?_a') + #1
#lema(ur'[Tt]ratar_á_[ns]?_a') + 
...
#lema(ur'_á_nimos?_a', xpos=[ur' et ']) + 
#lema(ur'_Á_nimos?_A') + 
...
#lema(ur'[Cc]ontin_ú_es_u', xpre=[ur'Rivalry ', ur'Chase ', ur'14 ', ur'Quest ', ur'Adventure ', ur'Season ', ur'Legend '], xpos=[ur' (?:from|se|to|preparation)']) + 
#lema(ur'[Ff]ront_ó_n(?!\])_o', xpos=[ur'Miami Jai Alai ']) + #5
#lema(ur'[Ee]st_a_dios?_á', xpos=[ur' (?:d[oa] |das |Mineirão|Vivaldo|Octávio|Durival|Cícero Pompeu|Magalhaes)', ]) + 
...
#lema(ur'[Mm]_á_s el_a') + 
#lema(ur'[Mm]_á_s a_a', xpos=[ur' (?:diferencia|fin|partir|pesar|poco|última|Alain|ella alaba|Caravana não)']) + 
#lema(ur'__l[ao]s_el ') + lema(ur'__L[ao]s_El ') + 
...
#lema(ur'[Hh]ind_ú__u', xpre=[ur'The '], xpos=[ur' (?:Art|Astrology|Charities|College|Electional|Imaginary|[Ll]ore|Nationalism|Troublemaker|University)']) + 
...
#lema(ur'[Ss]ab_í_as?_i', xpre=[ur' es ', ur'leyes ', ur'asamblea ', ur'opiniones ', ur'ideas ', ur' su ', ur' y ', ur'reflexiones ', ur'[Ll]a ', ur'[Ll]as ', ur'[Uu]na ', ur'[Uu]nas ', ur'Mujer ', ur'[Mm]uy ', ur'Ningú ', ur'Pintura '], xpos=[ur' +(?:leyes|hija|decisión|dosificación|disposiciones|imitación|instituciones|y |\(luchador)', ur'[\|\]]']) + 
...
#lema(ur'[Mm]ed_í_a[ns]? m[aá]s_i', xpre=[ur' y ', ur'puntuación ', ur'vida ']) + 
#lema(ur'[Dd]on_d_e_') + 
#lema(ur'[Ee]ntrever_á_[ns]?_a') + #11
#lema(ur'[Dd]os_ _mil_', xpre=[ur'Síntesis ']) + 
#lema(ur'[Tt]res_ _mil_') + 
#lema(ur'[Cc]uatro_ _mil_') + 
#lema(ur'[Cc]inco_ _mil_') + 
#lema(ur'[Ss]eis_ _mil_') + 
#lema(ur'[Ss]iete_ _mil_') + 
#lema(ur'[Oo]cho_ _mil_') + 
#lema(ur'[Nn]ueve_ _mil_') + 
#lema(ur'[Nn]a_ú_fraga_u', xpos=[ur' (?:frente|la|el|en|tras)']) + 
...
#lema(ur'[Cc]omisar_í_as?_i') + 
#lema(ur'[Uu]na_s_ [a-záéíóú]*s_') + 
#lema(ur'[Bb]alo_m_pié_n') + Hay una marca...
#lema(ur'[Pp]ilotar_í_a[ns]?_i') + #2
#lema(ur'[Pp]ulsi_ó_n(?!\])_o') + #5
#lema(ur'[Ss]er_á_s_a', xpos=[ur' (?:Victoria|i Isern)']) + 
...
#lema(ur'[Ee]r_ó_tic[ao]s?_o', xpre=[ur'[\'\|\[]', ur' of ' ur'Ars ', ur'Viva ', ur'Death ', ur'Classic ', ur'Hotel ', ur'= '], xpos=[ur':? (?:Awards|Lessons|\(canción|veterum)', ur'\'']) + 
...
#    lema(ur'_Á_sper[ao]s?_A', xpre=[ur' de ', ur'Per ', ur'Cilicia ']) + 
#    lema(ur'_á_sper[ao]s?_a', xpre=[ur'[CFHIPS]\. ', ur'per ', ur'tollis ', ur'Aeschynomene ', ur'Achyranthes ', ur'Rhinelepis ', ur'Stelis ', ur'Ficus ', ur'[Ss]milax ', ur'Chara ', ur'Mentzelia ', ur'Hydrangea ', ur'Hylomantis ', ur'Pipa ', ur'Crepis ', ur'Inula ', ur'Leucandra ', ur'Smilax ']) + 
#lema(ur'[Aa]_u_n (?:así)_ú') + 
#lema(ur'[Aa]l__rededor_ ') + #al rededor existe
#lema(ur'[Aa]ut_é_ntic[ao]s?_e', xpre=[ur'dell\'']) + autentica es válido
#lema(ur'[Ff]_ó_rmic[ao]s?_o', xpre=[ur'Apochinomma', ur'Rino ', ur'Mauro '], xpos=[ur' rufa']) + 
...
#lema(ur'[Hh]ac_í_a[ns]? (?:acabar|abrazar|arribar|asistir|atacar|causar|confiar|conocer|conseguir|consolidar|crear|dar|definir|derrotar|desarrollar|disminuir|dominar|escoger|escribir|establecer|experimentar|facilitar|fusionar|ganar|hacer|interpretar|llegar|lograr|mejorar|mirar|obtener|ofrecer|percibir|permitir|profundizar|proveer|realizar|realzar|requerir|saber|seguir|ser|situar|subrayar|sustituir|proteger|tener|tomar|usar|utilizar|vivir)_i') + 
#lema(ur'[Hh]edi_ó__o') + #6
#lema(ur'[Mm]_á_s (?:de|finalmente|habitualmente|cariñozamente)_a') + 
#lema(ur'[Pp]ari_ó__o', xpre=[ur'Mármol ', ], xpos=[ur'\]', ]) + #1
#lema(ur'[Ss]ent_é__e', xpre=[ur'Coração que '], xpos=[ur' x to']) + 
...
#lema(ur'Sab_í_an_i', xpre=[ur' a ', ur'B8 ', ur'marcas ', ur'marca ', ur'campeón ', ur'Platillos: ', ur'platillos '], xpos=[ur' (?:Cymbals|\(wrestler|\(luchador|fabrica|y (?:Orion|Promark)|lo incorporó)', ur'[\|\]]']) + 
...
#lema(ur'B_á_rbara_a', pre=ur'Santa ', xpos=[ur': ABC-Clio']) + 
#lema(ur'[Ee]nviar_á__a', xpre=[ur'que ', ur'se le ']) + 
...
#[(ur' ([a-záéíóúñ][a-záéíóúñ][a-záéíóúñ][a-záéíóúñ]+) \1 ', ur' \1 ')] + 
...
#lema(ur'[Jj]od_í__i', xpos=[ur' Picoult']) + 
...
#lema(ur'[Uu]n_í__i', xpos=[ur'[\'.]']) + 
#lema(ur'[Cc]orr_í__i', xpre=[ur'Adrienne '], xpos=[ur' English']) + 
#lema(ur'[Ee]leg_í__i') + 
#lema(ur'[Ee]scog_í__i') + 
#lema(ur'[Ee]scrib_í__i') + 
...
#lema(ur'[Rr]ub_í__i') + 
#lema(ur'[Cc]om_í__i', xpre=[ur'Francesco ']) + 
#lema(ur'[Bb]arr_í__i', xpre=[ur'"', ur'Pedro ', ], xpos=[ur' (?:en bangor|Griffiths)', ]) + #295
#lema(ur'[Bb]at_í__i', xpre=[ur'\'\'', ], xpos=[ur' = un', ]) + #5
#lema(ur'[Mm]an_í__i', xpre=[ur'\ba ', ur'\ble ', ur'Mounfield\|', ur'Carles ', ur'Península ', ur'Península de ', ur'de Mani\|', ur'profeta\)\|', ur'profeta \[\[', ur'fundada por '], xpos=[ur' (?:fue influenciado|se|Ratnam|Congo|Paudel|Kaul|padme|\]\], (?:líder|fundador)|\(profeta)\b']) + 
#lema(ur'[Pp]rend_í__i') + 
#lema(ur'[Pp]resent_í__i') + 
#lema(ur'[Pp]roced_í__i') + 
...
#lema(ur'[Ii]nclu_í__i') + 
#lema(ur'[Ii]nfer_í__i') + 
#lema(ur'[Ii]nvert_í__i') + 
#lema(ur'[Tt]it_í__i', xpre=[ur'Adel El '], xpos=[ur' (?:premier|Gantung)']) + 
#lema(ur'[Nn]o_minó__nimo') + 
#lema(ur'[Cc]onvert_í__i', xpre=[ur'Ángel ', ur'Hern[aá]n ']) + 
...
#lema(ur'[Ss]al_í__i', xpre=[ur'<\*'], xpos=[ur' Berisha']) + 
...
#lema(ur'Mart_í__i', xpos=[ur' (?:ten|Tileno|Noxon|Venturi)']) + 
...
#[(ur'\[\[Bah[ií]a\]\]', ur'[[Bahía (Brasil)|Bahía]]')] + 
...
#lema(ur'[Tt]em_í__i', xpre=[ur'Oscar ']) + 
...
#lema(ur'[Mm]_óv_il(?:es|)_[oó]b', xpre=[ur'Adria ', ur'Exxon ', ur'ExxonMobil\|', ur'Rally ']) + 
...
#lema(ur'[Vv]est_í__i', xpre=[ur'\bti '], xpos=[ur' la giubba']) + 
...
#lema(ur'[Tt]ransfer_í__i', xpre=[ur'Nakit ']) + 
# lema(ur'[Rr]eligi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpre=[ur'sur la ', ur'et '], xpos=[ur' (?:zoroastrienne|scandinave|des|romaine|égyptienne|de la science)']) + 
# lema(ur'Le_ó_n_o', pre=ur'(?:[Ee]n) ', xpre=[ur'Condado '], xpos=[ur' Jones']) + 
...
#[(ur'< *(?P<a>[Bb][Rr]) *>', ur'<br />')] + 
#lema(ur'(?:enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|dici?embre)_ de_ (?:\[\[|)[1-9][0-9][0-9]+_ del', xpos=[ur' sullo']) +#lema(ur'[Cc]ombusti_ó_n_o', xpre=[ur'Pyrokinesis, ', ur'Diesel ', ur'Second ', ur'Internal ', ur'Autodesk ', ur'Unsteady ', ur'Internacional ', ur'[Cc]oal ', ur'Human ', ur'Inner ', ur'Valve ', ur'Embryo: ', ur'fuel ', ur'plugin ', ur'Spontaneous '], xpos=[ur' (?:& de|as|des|et|of|in|for|and|Technologies|System|de végétaux|en général|improved|Spontaneous|stationary|Science|[Ee]ngines?|[Ee]ngineering|installations|cycle|Chamber|Emissions|products|Deposits|processes|systems|ramjet|2008|2009)\b', ur'" \(2004']) + 
#lema(ur'[Cc]ombat_í__i') + 
#lema(ur'[Cc]ompart_í__i') + 
#lema(ur'[Cc]onclu_í__i') + 
#lema(ur'[Cc]onoc_í__i') + 
#lema(ur'[Cc]onsegu_í__i') + 
#lema(ur'[Cc]ontribu_í__i') + 
...
#lema(ur'[Nn]ac_í__i'. xpos=[ur' Eldeniz']) + 
...
#lema(ur'_[[Parque nacional Waraira Repano|Parque nacional El Ávila]]__\[\[Parque [Nn]acional El Ávila\]\]') + 
#lema(ur'_[[Parque nacional de Yosemite]]__\[\[(?:Yosemite National Park)\]\]') + 
#lema(ur'_[[Parque nacional El Cajas]]__\[\[(?:Parque [Nn]acional Cajas)\]\]') + 
#lema(ur'_[[Parque nacional Sumaco Napo-Galeras]]__\[\[(?:Parque [Nn]acional Sumaco-Napo-Galeras)\]\]') + 
#lema(ur'_[[Parque nacional Yasuní]]__\[\[(?:Parque nacional Yasuni)\]\]') + 
#lema(ur'_[[Parque nacional del Gran Cañón]]__\[\[(?:Grand Canyon National Park)\]\]') + 
#lema(ur'_[[Parque nacional Cañón de los Reyes]]__\[\[(?:Parque [Nn]acional Kings Canyon|Kings Canyon National Park)\]\]') + 
#lema(ur'_[[Parque nacional de los Arcos]]__\[\[(?:Parque [Nn]acional Arches|Arches National Park)\]\]') + 
#lema(ur'_[[Parque nacional Archipiélago de Los Roques]]__\[\[(?:Parque [Nn]acional Los Roques)\]\]') + 
#lema(ur'_[[Parque nacional Enrique Olaya Herrera]]__\[\[(?:Parque [Nn]acional "Enrique Olaya Herrera")\]\]') + 
#[(ur'\[\[(?:Parque [Nn]acional de Kosciuszko|Parque [Nn]acional Kosciuszko)(?P<a>\]|\|)', ur'[[Parque nacional Kosciuszko\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional Keoladeo|Parque Nacional de Keoladeo)(?P<a>\]|\|)', ur'[[Parque nacional de Keoladeo\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional Pilcomayo|Parque [Nn]acional Río Pilcomayo)(?P<a>\]|\|)', ur'[[Parque nacional Río Pilcomayo\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional de Etosha|Parque Nacional Etosha)(?P<a>\]|\|)', ur'[[Parque nacional Etosha\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional de Mesa Verde|Parque [Nn]acional Mesa Verde)(?P<a>\]|\|)', ur'[[Parque nacional Mesa Verde\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional de Redwood|Parque Nacional Redwood)(?P<a>\]|\|)', ur'[[Parque nacional Redwood\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional de Serengueti|Parque nacional Serengeti|Parque [Nn]acional Serengueti)(?P<a>\]|\|)', ur'[[Parque nacional Serengueti\g<a>')] + 
#[(ur'\[\[(?:Parque [Nn]acional Henry Pittier)(?P<a>\]|\|)', ur'[[Parque nacional Henri Pittier\g<a>')] + 
...
#lema(ur'[Ss]erv_í__i', xpre=[ur'\b[Dd]e ', ur'\bdei ']) + 
#[(ur'\[\[(?:Tabla [Gg]eneral de la Copa Mundial de Fútbol|Tabla estadística de la Copa Mundial de Fútbol)(?P<a>\]|\|)', ur'[[Anexo:Tabla estadística de la Copa Mundial de Fútbol\g<a>')] + 
...
#lema(ur'_enero de_ (?:\[\[|)[1-9][0-9][0-9]+_gennaio') + 
#lema(ur'_febrero de_ (?:\[\[|[1-9][0-9][0-9]+)_febbraio') + 
#lema(ur'_abril de_ (?:\[\[|[1-9][0-9][0-9]+)_aprile', xpre=[ur'’']) + 
#lema(ur'_mayo de_ (?:\[\[|)[1-9][0-9][0-9]+_maggio', xpos=[ur' \(la historia']) + 
#lema(ur'_junio de_ (?:\[\[|)[1-9][0-9][0-9]+_giugno') + 
#lema(ur'_julio de_ (?:\[\[|[1-9][0-9][0-9]+)_luglio') + 
#lema(ur'_septiembre de_ (?:\[\[|[1-9][0-9][0-9]+)_settembre') + 
#lema(ur'_octubre de_ (?:\[\[|[1-9][0-9][0-9]+)_ottobre') + 
#lema(ur'_noviembre de_ (?:\[\[|)[1-9][0-9][0-9]+_novembre', xpre=[ur'(?:du|le) ']) + 
...
#lema(ur'[Ee]spec_í_fic[ao]_i', xpre=[ur'(?:[Ss]e|[Nn]o|[Ll]o) ', ur'[Qq]ue ', ur'[Nn]o lo ', ur'sistema ', ur'IEEE 1541 ', ur'también ', ur'donde ', ur'(?:como|cual) '], xpos=[ur' (?:el|la|los|las|también|muchas|como|quien|["“«]?(?:b|del?|[Ll]os|[Ee]l|[Ll]a|una?|a una|qu[ée]|sobre|si|en|un|dos|tres|cuatro|cinco|seis))\b', ur':']) + 
...
#lema(ur'Beltr_á_n_a', xpre=[ur'\bi ', ur'Sant ', ur'Vicenç ', ur'Adolf ', ur'Robert ', ur'Yurizan ', ur'obra de ', ur'Orlando ', ur'azul ', ur'Armando ', ur'Federico ', ur'Miguel ', ur'Termens ', ur'Tony ', ur'Benjamin '], xpos=[ur' Masses']) + 
#lema(ur'L_o_pez_ó', pre=ur'Santana ') + 
...
#Prereplacements
fechas = [
lema(ur'_e_nero_E', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_f_ebrero_F', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_m_arzo_M', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_a_bril_A', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_m_ayo_M', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_j_unio_J', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_j_ulio_J', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ', xpos=[ur' (?:César|A\.)']) + 
lema(ur'_a_gosto_A', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_s_eptiembre_S', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ', xpre=[ur'Liz ']) + 
lema(ur'_o_ctubre_O', pre=ur'(?:(?:(?<!12 )[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_n_oviembre_N', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_d_iciembre_D', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') +
[]][0]

grupoPre = fechas + [
#[(ur'\[\[(?P<a>.+?)\|\g<a>\]\]', ur'[[\g<a>]]')] + 
lema(ur'[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_ _[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.][a-záéíóúñü0-9]_  +_x') + 
lema(ur'[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_ _[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_  +_x') + 
lema(ur'[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_ _[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_  +_x') + 
lema(ur'[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]+ +[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_ _[a-záéíóúñü0-9.]*[a-záéíóúñü0-9]_  +_x') + 
lema(ur'[a-záéúíóúüñ]*_, _(?!title)[a-záéúíóúüñ]{2}[a-záéúíóúüñ]*_,_x') + 
lema(ur'[a-záéúíóúüñ]*_, _(?!title)[a-záéúíóúüñ]{2}[a-záéúíóúüñ]*_,_x') + 
lema(ur'_a  b  c  d  e  f  g  h__a b c d e f g  h') + 
lema(ur'_Sobre la base de__En base a') + 
[(ur'((?: [a-záéíóúñ][a-záéíóúñ]+|\]\])[.;])([A-ZÁÉÍÓÚÑ][a-záéíóúñ]+ )', ur'\1 \2')] +    
lema(ur'_ _(?:[A-Z][a-záéíóúñ]*[áéíóúñ][a-záéíóúñ]*|[ÁÉÍÓÚÑ][a-záéíóúñ]+)_', pre=ur'[a-záéúíóúüñA-ZÁÉÚÍÓÚÜÑ][a-záéúíóúüñA-ZÁÉÚÍÓÚÜÑ\]]+[\.;]', xpos=[ur'\.']) + 

####Apellidos
lema(ur'Fern_á_ndez_a', xpre=[ur'and ', ur'd’Anita ', ur'J[eé]r[oô]me ',ur'Jean ', ur'Valentim ', ur'Domenique ', ur'Dominique ', ur'Heine ', ur'Mervyn '], xpos=[ur' Islands']) +
lema(ur'G_á_lvez_a', xpos=[ur'\.gov']) + 
lema(ur'Le_ó_n Garc[ií]a_o') + 
...
lema(ur'G_ó_mez_o', xpre=[ur'[Oo]f ', ur'álbum de ', ur'Francisco ', ur'Dioguo ', ur'Selena ', ur'Thomas ', ur'Michelle ', ur'Scott ', ur'Selena '], xpos=[ur' (?:Gallery|ha obtenido|Addams|recibió 3|\(banda)', ur'(?:\]|\'s)']) + 
lema(ur'Gal_í_ndez_i') + 
lema(ur'Gonz_á_lez_a', xpre=[ur'Yann ', ur'Noe ',]) + 
lema(ur'L_ó_pez_o', xpre=[ur'4657\) ', ur'v\. ', ur'Santana ', ur'Manoel ', ur'Brook Lopez\|', ur'Brook ', ur'Rick ', ur'Olivia ', ur'Bernard ', ur'Colby ', ur'East ', ur'George ', ur'Elysia ', ur'Litoria ', ur'Gerard ', ur'Jennifer ', ur'Lynn '], xpos=[ur' (?:Tonight|Expeditions|Island|dos)', ur'(?:\. Genova|\'s|, Steven)']) + 
lema(ur'Mart_í_nez_i', xpre=[ur'Guillaume ', ur'Deuce" ', ur'California\)\|', ur'Georgia\)\|', ur'Deuce ', ur'Vicci ', ur'Dean ', ur'Sammy ', ur'Pamela ', ur'Yannick '], xpos=[ur' \((?:California|Georgia)']) + 
lema(ur'Ram_í_rez_i', xpre=[ur'Erika ', ur'Twiggy ']) + 
lema(ur'S_á_nchez_a', xpre=[ur'[Oo]f ', ur'Nia ', ur'Little ', ur'Temple ', ur'Cole ', ur'Enfants de ', ur'Mike ', ur'Dirty ', ], xpos=[ur' (?:Get High|tradition)', ]) + 
lema(ur'Su_á_rez_a', xpre=[ur'Jean de ', ur'und ', ur'Jeremy ', ur'R, ', ]) + 
lema(ur'V_é_lez_e', xpre=[ur'Maria '], xpos=[ur' (?:Mostar|& Dubail)']) + 
lema(ur'Ter_á_n_a', xpos=[ur' Ikkemen', ur'\'\'']) + 
lema(ur'_Á_lvarez_A', xpre=[ur'J '], xpos=[ur' Bernardez']) + 
####Nombres
lema(ur'F_é_lix_e', pre=ur'San ') +
lema(ur'Rub_é_n Ram[ií]rez_e') + 
lema(ur'Andr_é_s (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_e') +
lema(ur'Crist_ó_bal (?:Colón|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_o') +
lema(ur'Dar_í_o (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_i') +
lema(ur'Juli_á_n (?:Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_a') +
lema(ur'Mar_í_a (?:Fernanda|Isabel|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_i') +
lema(ur'Mar_í_a Antonia_i', xpos=[ur' Salvà']) +
lema(ur'Nicol_á_s (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_a') +
lema(ur'Ram_ó_n (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Tenias|Vásquez)_o') +
lema(ur'Tom_á_s (?:Alberto|Álvarez|Apóstol|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Tenias|Vásquez)_a') +
lema(ur'V_í_ctor (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_i') +
lema(ur'Mar_ía J_uana_(?:ia [Jj]|ía j)') + #11
lema(ur'Mart_í_n (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_i') +
lema(ur'_José_ (?:Alberto|Alejandro|Alfonso|Alfredo|Alonso|Antonio|Batlle|Carlos|Castillo|Clemente|Daniel|Domingo|Eduardo|Emilio|Enrique|Eugenio|Feliciano|Felipe|Fernando|Fernández|Ferrer|Francisco|Gabriel|García|González|Gregorio|Guadalupe|Hernández|Ignacio|Javier|Joaquín|Juan|Julián|Luis|Luís|Manuel|Mari|Maria|Mariano|Martí|Martínez|María|Miguel|Moreno|Mourinho|Ortega|Ortiz|Pablo|Pardo|Pedro|Rafael|Ramón|Reyes|Ricardo|Rivera|Rizal|Roberto|Rodríguez|Santiago|Santos|Silva|Sánchez|Torres|Trinidad|Vicente|Zorrilla|Ángel|de San Mart[ií]n)_(?:jos[eé]|Jose)') + 
lema(ur'_José_ (?:Abelardo|Acosta|Adolfo|Aguilar|Agustín|Alejo|Amador|Andrés|Benito|Bernardo|Blanco|Cabrera|Castro|Cela|Celestino|Demaría|Díaz|Elías|Eusebio|Faustino|Flores|Félix|Guerra|Gutiérrez|Gálvez|Gómez|Jiménez|Leonardo|León|López|Martín|Matías|Mujica|Muñoz|Mármol|Méndez|Nacho|Navarro|Nicolás|Nieto|Núñez|Ozámiz|Pascual|Pérez|Ramos|Ramírez|Rico|Ruiz|San|Serrano|Simón|Suárez|Tiburcio|Tomás|Toribio|Velásquez|Vázquez|Yves|Álvarez)_(?:jos[eé]|Jose)') + 
lema(ur'_María_ (?:Gabriela)_(?:mar[ií]a|Maria)') + 
lema(ur'_José_ del?_(?:jos[eé]|Jose)', pre=ur'San ') + 
lema(ur'_María_ (?:Morelos?|Gisbert)_(?:mar[ií]a|Maria)', pre=ur'[Jj]os[eé] ', xpos=[ur' (?:Pereira|Neves)']) + 
lema(ur'_María José__(?:[Mm]ar[ií]a jos[eé]|[Mm]ar[ií]a Jose|mar[ií]a José|Maria José)') + 
lema(ur'_Simón Bolívar__(?:sim[oó]n [Bb]ol[ií]var|Simon [Bb]ol[ií]var|Simón bol[ií]var|Simón Bolivar)', xpre=[ur'Avenue '], xpos=[ur' (?:Award|Wall|Buckner|and)']) + 
lema(ur'_Simón Díaz__(?:sim[oó]n [Dd][ií]a[sz]|Simon [Dd][ií]a[sz]|Simón d[ií]a[sz]|Simón Dia[sz]|Simón Días)') + 
...
lema(ur'_é_l (?:y|como|a|después|lo|la|con)_e', pre=ur'(?:[Aa]|[Dd]e) ') + 
#lema(ur'_consultado__acessado') + #25
lema(ur'_e_nero_E', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_f_ebrero_F', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_m_arzo_M', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
lema(ur'_a_bril_A', pre=ur'(?:(?:[AaEe]l|lunes|martes|mi[eé]rcoles|vueves|viernes|s[aá]bado|domingo) [0-9]+|[Mm]es) de |[Ee]n ') + 
...
lema(ur'Jos_é_ (?:Alberto|Álvarez|García|Gómez|González|Jiménez|Martínez|Pérez|Ramírez|Rodríguez|Sánchez|Suárez|Vásquez)_e') +
[
...
#lema(ur'[Hh]a_ll_a[ns]?_y', pre=ur'(?:se) ') + 
#lema(ur'[Hh]a_ya__(?:llan?|yan)', pre=ur'(?:que|no) ') + 
lema(ur'[Pp]_é_rdidas?_[eè]', pre=ur'(?:[Ss]in ) ') + 
lema(ur'[Pp]os_ibili_dad(?:es)?_(?:bili|osibil|osibli)') + 
lema(ur'[Cc]onsig_uió__io') + #5
lema(ur'[Cc]onstrucci_o_nes_ó') + #1
lema(ur'[Cc]onstrucci_ó_n_o', xpos=[ur'\]\]es', ]) + #77
lema(ur'_hu_sos? horarios?_(?:hu|[uú])') + 
lema(ur'[Ff]_á_cilmente_a') + #56
lema(ur'[Ff]_á_cil_a') + #56
lema(ur'[Vv]ol_ú_menes_u') + #113
lema(ur'[Dd]esag_ü_es?_u') + 
lema(ur'[Cc]onstitu_i_d[ao]s?_í') + #42
lema(ur'[Cc]onstitu_i_r(?:l[aeo]s?|se|)_í') + #5
lema(ur'[Cc]onstru_i_d[ao]s?_í') + #402
lema(ur'[Aa]_ú_n (?:más|menos|peor|mejor|están?|estaban?|no se|se|queda|hay|m[aá]s)_u') + 
...
lema(ur'[m]_á_s_a', pre=ur'[Aa]l ', xpos=[ur' se hace', ]) + #9
lema(ur'[m]_á_s_a', pre=ur'[Dd]el ', xpos=[ur' (?:d`en|Olmo|Cornell|de (?:l\'Artís|Marianet)|Esquerra)', ]) + #9
lema(ur'[Mm]_á_s nunca_a', xpos=[ur' (?:abandones|daja)', ]) + #7
lema(ur'[Mm]_á_s (?:ganador|prometedor|tentador)(?:as?|es|)_a') + #6
lema(ur'[Mm]_á_s ni_a', xpos=[ur' (?:sabes)', ]) + #6
lema(ur'[Mm]_á_s dur[ao]s?_a', xpos=[ur' que marmor', ]) + #5
lema(ur'[Mm]_á_s (?:adult|alt|ambicios|básic|característic|clásic|competitiv|deportiv|desead|destructiv|electrónic|exitos|fresc|hablad|longev|lujos|negr|nominad|nuev|poblad|productiv|prolífic|prosper|rar|rocker|sangrient|técnic|vendid|violent)[ao]s?_a') + #754
...
lema(ur'[Gg]ui_o__ó') + #407
lema(ur'[Tt]raslad_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #365
lema(ur'[Jj]ug_ó_ (?:[0-9]+|un|dos|tres|cuatro|cinco|seis|siete|ocho|nueve|diez)_o') + #320
lema(ur'[Dd]errot_ó__o') + #298
...
lema(ur'[Jj]ug_ó__o', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|e) ') + #232
lema(ur'[Pp]articip_ó__o', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|[Nn]o) ') + #226
lema(ur'[Dd]ebut_ó__o') + #222
...
lema(ur'[Dd]edic_ó__o', pre=ur'[Ss]e ') + #206
...
lema(ur'[Tt]om_ó__o', pre=ur'\b(?:[Ll]a|[Yy]) ', xpre=[ur'tomo ', ur'Shannon ', ur'Kagura ', ur'Mafuyu ', ur'Terry ', ], xpos=[ur' (?:[IVXLCDM]+|requerido|segundo|Takahashi|Yamanobe|Inoue|Vran|se ven|logró|tienen|[0-9]+)', ur'(?:, que|: [0-9]+|: [IVXLCDM]+)', ]) + #177
lema(ur'[Dd]estac_ó__o') + #166
lema(ur'[Cc]onstruy_ó__o') + #148
...
lema(ur'[Rr]ecibi_ó__o') + #131
lema(ur'[Pp]erdi_ó__o') + #116
lema(ur'[Cc]omenz_ó__o') + #115
lema(ur'[Aa]nunci_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Qq]ue) ') + #113
lema(ur'[Ff]inaliz_ó__o') + #113
lema(ur'[Ll]anz_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #107
lema(ur'[Rr]etir_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #107
lema(ur'[Ss]urgi_ó__o') + #107
lema(ur'[Ff]orm_ó__o', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|e) ') + #99
...
lema(ur'[Ff]alleci_ó__o') + #90
lema(ur'[Cc]elebr_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #88
lema(ur'[Pp]rometi_ó__o', xpos=[ur'(?:, (?:[Tt]antalio|[Pp]olonio)|\]\])']) + #88
lema(ur'[Cc]onvirti_ó__o') + #87
lema(ur'[Dd]esterr_ó__o', xpre=[ur'\bO ', ur'\bdo ', ur'Florianópolis\|'], xpos=[ur' (?:RC|\(Santa)', ur': Edições']) + #87
lema(ur'[Cc]ambi_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Nn]os) ') + #86
lema(ur'[Vv]olvi_ó__o') + #85
lema(ur'[Pp]rovoc_ó__o') + #80
...
lema(ur'[Oo](?:bcec|bjet|bnubil|br|bsequi|bserv|bsesion|bstin|bvi|casion|cult|cup|di|fert|fici|fusc|je|lisc|lvid|nde|per|pin|probi|pt|r|rbit|rden|re|rient|rigin|rquest|s|scil|sific|stent|torg|vacion)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #76
lema(ur'[Ll](?:abor|abr|ac|agrime|ament|astim|av|egisl|egitim|enific|entific|esion|ev|evant|evit|ib|iber|ibr|icenci|icit|ider|idi|ignific|ij|imit|impi|iquid|isi|ist|len|lor|o|ogr|ubric|ubrific|uch|uci)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #74
lema(ur'[Qq](?:uebr|uebrant|ued|uej|uem|uerell|uintuplic|uit)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #73
lema(ur'[Ii]naugur_ó__o') + #70
lema(ur'[Cc]onllev_ó__o') + #66
lema(ur'[Aa]pareci_ó__o') + #61
lema(ur'[Cc]oloc_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ', xpre=[ur'Yo ', ]) + #61
lema(ur'[Ii]nterpret_ó__o', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|e) ') + #61
lema(ur'[Pp]rotagoniz_ó__o') + #58
lema(ur'[Ss]ucedi_ó__o') + #58
...
lema(ur'[Dd]irigi_ó__o') + #53
lema(ur'[Ss]igui_ó__o') + #50
lema(ur'[Cc]aptur_ó__o') + #49
lema(ur'[Uu](?:ltim|nific|nt|s|surp)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #46
lema(ur'[Ss]ufri_ó__o') + #44
lema(ur'[Ii]ncorpor_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #43
lema(ur'[Rr]euni_ó__o') + #42
lema(ur'[Uu]ni_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ', xpos=[ur' (?:Steamship|Flag|Jack)', ]) + #41
lema(ur'[Uu]ni_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ', xpos=[ur' (?:Steamship|Flag|Jack)', ]) + #41
lema(ur'[Ee]specializ_ó__o') + #40
lema(ur'[Vv]enci_ó__o') + #40
lema(ur'[Aa]dapt_ó__o') + #38
lema(ur'[Cc]onstituy_ó__o', pre=ur'[Ss]e ') + #38
lema(ur'[Ss]err_ó__o') + #37
lema(ur'[Ll]ogr_ó__o', pre=ur'(?:[Ll][eo]|[Ss]e(?: me| te| l[aeo]s?|)) ') + #36
lema(ur'[Aa]mpli_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ', xpos=[ur' del? ', ]) + #35
lema(ur'[Bb](?:abe|ail|aj|alance|albuce|anc|araj|as|ast|atall|ate|añ|eatific|ec|enefici|es|ifurc|iloc|iografi|isec|lanque|lasfem|loc|loque|oicote|ombarde|onific|orde|orr|osquej|ot|re|rill|rinc|rome|ronce|rot|uce|url)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #33
lema(ur'[Ii]ncluy_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)|que) ') + #32
lema(ur'[Gg](?:alardon|angren|asific|ast|ener|ermin|est|estion|ir|lori|lorific|los|ole|olpe|radu|ranje|ratific|rit|uard|uerre|uill|uis|uiñ|ust)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #30
lema(ur'[Aa]sumi_ó__o') + #28
lema(ur'[Cc]ubri_ó__o') + #28
lema(ur'[Ee]stableci_ó__o') + #28
lema(ur'[Nn](?:ad|aj|arr|ecesit|egoci|evisc|idific|ombr|omin|oque|ot|otific|umer)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #28
lema(ur'[Pp]ermiti_ó__o') + #28
lema(ur'[C]uric_ó__o') + #26
lema(ur'[Dd]estruy_ó__o') + #26
lema(ur'[Ff]irm_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ', xpre=[ur'Te ', ]) + #26
lema(ur'[Mm]arc_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Ll]os?) ') + #26
lema(ur'[Ii]nvolucr_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Qq]ue) ') + #25
lema(ur'[Tt]itul_ó__o', pre=ur'(?:[Yy]a|[Ss]e)(?: me| te| l[aeo]s?|) ') + #25
lema(ur'[Ee]ncontr_ó__o', pre=ur'(?:[Ss]e(?: l[aeo]s?|)|[Ll][aeo]s?|[Dd]onde) ') + #24
lema(ur'[Gg]rab_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #24
lema(ur'[Oo]curri_ó__o') + #24
lema(ur'[p]ublic_ó__o', pre=ur'y ', xpre=[ur'maestros ', ur'alumnos ', ur'oral ', ur'privado ', ur'cr[íi]tica '], xpos=[ur' (?:en general|presente)', ur'\)']) + #24
lema(ur'[Ff]ij_ó__o', pre=ur'(?:[Ss]e(?: l[aeo]s?|)|[Ll][aeo]s?) ', xpre=[ur' a ', ur' e[ns] ', ]) + #23
lema(ur'[Aa]dquiri_ó__o') + #21
lema(ur'[Cc]ompiti_ó__o') + #21
lema(ur'[Ee]mpat_ó__o') + #21
lema(ur'[Rr]ompi_ó__o') + #21
lema(ur'[Uu]tiliz_ó__o', pre=ur'[Ss]e ') + #21
lema(ur'[Dd]escribi_ó__o') + #20
lema(ur'[Oo]ficializ_ó__o') + #20
lema(ur'[Pp]erteneci_ó__o') + #20
lema(ur'[Aa]cab_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ', xpre=[ur'[Mm]e ', ]) + #19
lema(ur'[Dd]esapareci_ó__o') + #19
lema(ur'[Ee]ntreg_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #19
lema(ur'[Rr]ecord_ó__o') + #19
lema(ur'[Ss]irvi_ó__o') + #19
lema(ur'[Aa]not_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|y) ') + #18
lema(ur'[Aa]bri_ó__o') + #17
lema(ur'[Aa]ctu_ó__o') + #17
lema(ur'[Aa]prob_ó__o') + #17
lema(ur'[Aa]ñadi_ó__o') + #17
lema(ur'[Dd]ebi_ó__o') + #17
lema(ur'[Rr]ecomend_ó__o') + #17
lema(ur'[Cc]omparti_ó__o') + #16
lema(ur'[Dd]ispar_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[LlMmTt]e|[Nn]os) ') + #16
lema(ur'[Cc]umpli_ó__o') + #15
lema(ur'[Dd]espert_ó__o') + #15
lema(ur'[Ii]mpidi_ó__o') + #15
lema(ur'[Oo]freci_ó__o') + #15
lema(ur'[Ss]inti_ó__o') + #15
lema(ur'[Cc]reci_ó__o') + #14
lema(ur'[Hh](?:abilit|abit|abl|all|amac|art|asti|el|ered|erman|erni|ibern|inc|ip|ipertrofi|ipotec|ocic|omenaje|onr|osped|osti|ueve|umidific|umill|usme)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #14
lema(ur'[Ee]xtendi_ó__o') + #13
lema(ur'[Tt]ransmiti_ó__o') + #13
lema(ur'[Cc]oncedi_ó__o') + #12
lema(ur'[Dd]efini_ó__o') + #12
lema(ur'[Dd]emostr_ó__o') + #12
lema(ur'[Dd]escendi_ó__o') + #12
lema(ur'[Jj](?:act|ade|ipi|iñ|ubil|unt|urament|ustific|ustipreci)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #12
lema(ur'[Pp]lane_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Qq]ue) ') + #12
lema(ur'[Rr]egres_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Qq]ue) ') + #12
lema(ur'[Ss]ubi_ó__o') + #12
lema(ur'[Aa]prendi_ó__o') + #11
lema(ur'[Cc]ompr_ó__o', pre=ur'(?:[Ll][eo]|[Ss]e(?: me| te| l[aeo]s?|)) ') + #11
lema(ur'[Dd]ecapit_ó__o') + #11
lema(ur'[Dd]esv_í_o_i', pre=ur'(?:[AaEe]l|[Uu]n|[Cc]ada|[Ll]igero|[Oo]tro|[Pp]rimer|[Dd]el?|[Mm]ismo) ') + #11
lema(ur'[Ee]strell_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|y) ') + #11
lema(ur'[Jj]odi_ó__o') + #11
lema(ur'[Rr]equiri_ó__o') + #11
lema(ur'[Ss]ecuestr_ó__o', pre=ur'\b(?:[Ll]a) ', xpre=[ur'Antiextorsión ', ur'Extorsión ', ], xpos=[ur' (?:de (?:Sol|nativas)|por)\b', ]) + #11
lema(ur'[Vv](?:ac|aci|acil|alid|alor|anaglori|ari|aticin|el|endimi|ener|entisc|erane|erific|ers|ersific|ersion|et|iaj|ici|idri|igil|ilipendi|incul|indic|iol|iolent|ir|ision|isit|islumbr|itrific|ivific|olte|omit|ot|ulner)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #11
lema(ur'[Aa]llan_ó__o', xpre=[ur'me ']) + #10
lema(ur'[Dd]espleg_ó__o') + #10
lema(ur'[Dd]espleg_ó__o') + #10
lema(ur'[Ii]nterfiri_ó__o') + #10
lema(ur'[Rr]eforz_ó__o') + #10
lema(ur'[Dd]ifundi_ó__o') + #9
lema(ur'[Dd]isolvi_ó__o') + #9
lema(ur'[Ee]xigi_ó__o') + #9
lema(ur'[Mm]inti_ó__o') + #9
lema(ur'[Pp]rotegi_ó__o') + #9
lema(ur'[Rr]esidi_ó__o') + #9
lema(ur'[Aa]dmiti_ó__o') + #8
lema(ur'[Aa]sent_ó__o') + #8
lema(ur'[Aa]sesin_ó__o', pre=ur'\b(?:[Ll]a) ', xpre=[ur'Bitch ', ur'amigo ', ur'corrupto ', ur'psicópata ', ur'violador ', ], xpos=[ur' (?:What|psicópata|serial)', ]) + #8
lema(ur'[Cc]ometi_ó__o') + #8
lema(ur'[Ee]scogi_ó__o') + #8
lema(ur'[Pp]areci_ó__o') + #8
lema(ur'[Pp]as_ó__o', pre=ur'(?:[Tt]odo|[Nn]ada) ', xpos=[ur' se', ]) + #8
lema(ur'[Rr]ecogi_ó__o') + #8
lema(ur'[Rr]ecorri_ó__o') + #8
lema(ur'[Rr]espondi_ó__o') + #8
lema(ur'[Ss]olicit_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #8
lema(ur'[Ss]ometi_ó__o') + #8
lema(ur'[Aa]plic_ó__o', pre=ur'\b(?:[Ll]a|[Yy]) ', xpos=[ur' en usos singulares']) + #7
lema(ur'[Bb]rind_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|que) ') + #7
lema(ur'[Cc]ogi_ó__o') + #7
lema(ur'[Cc]omprometi_ó__o') + #7
lema(ur'[Cc]onsisti_ó__o') + #7
lema(ur'[Pp]retendi_ó__o') + #7
lema(ur'[Pp]rohibi_ó__o') + #7
lema(ur'[Rr]econoci_ó__o') + #7
lema(ur'[Rr]econstruy_ó__o') + #7
lema(ur'[Rr]indi_ó__o') + #7
lema(ur'[Vv]isti_ó__o') + #7
lema(ur'[Aa]rrend_ó__o') + #6
lema(ur'[Cc]edi_ó__o') + #6
lema(ur'[Dd]espidi_ó__o') + #6
lema(ur'[Dd]esprendi_ó__o') + #6
lema(ur'[Mm]ordi_ó__o') + #6
lema(ur'[Rr]eprob_ó__o') + #6
lema(ur'[a]terr_ó__o') + #6
lema(ur'[Cc]olg_ó__o') + #5
lema(ur'[Dd]efendi_ó__o') + #5
lema(ur'[Dd]evolvi_ó__o') + #5
lema(ur'[Dd]imiti_ó__o') + #5
lema(ur'[Ee]ncomend_ó__o') + #5
lema(ur'[Ee]xpandi_ó__o') + #5
lema(ur'[Pp]obl_ó__o') + #5
lema(ur'[Pp]refiri_ó__o') + #5
lema(ur'[Rr]epiti_ó__o') + #5
lema(ur'[Rr]escindi_ó__o') + #5
lema(ur'[Tt]rasmiti_ó__o') + #5
lema(ur'[l]ami_ó__o') + #5
lema(ur'[Aa]cogi_ó__o') + #4
lema(ur'[Aa]dvirti_ó__o') + #4
lema(ur'[Aa]gradeci_ó__o') + #4
lema(ur'[Aa]zot_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Qq]ue) ') + #4
lema(ur'[Cc]onsumi_ó__o') + #4
lema(ur'[Dd]epar_ó__o') + #4
lema(ur'[Dd]esalent_ó__o') + #4
lema(ur'[Dd]esaloj_ó__o', pre=ur'(?:[Ss]e(?: me| te| l[aeo]s?|)|[Ll][aeo]s?) ') + #4
lema(ur'[Dd]esconcert_ó__o') + #4
lema(ur'[Dd]urmi_ó__o', xpos=[ur' Quadrato']) + #4
lema(ur'[Ee]fectu_ó__o') + #4
lema(ur'[Ee]ludi_ó__o') + #4
lema(ur'[Ee]mprendi_ó__o') + #4
lema(ur'[Ee]nloqueci_ó__o') + #4
lema(ur'[Ee]scondi_ó__o') + #4
lema(ur'[Ee]valu_ó__o') + #4
lema(ur'[Ff]avoreci_ó__o') + #4
lema(ur'[Ii]nscribi_ó__o') + #4
lema(ur'[Ii]nsisti_ó__o') + #4
lema(ur'[Pp]ermaneci_ó__o') + #4
lema(ur'[Pp]ersigui_ó__o') + #4
lema(ur'[Qq]uem_ó__o', pre=ur'\b(?:[Yy]|[Ss]e) ', xpos=[ur' por mis']) + #4
lema(ur'[Qq]uit_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ', xpre=[ur'[Yy]o ', ]) + #4
lema(ur'[Rr]econcomi_ó__o') + #4
lema(ur'[Rr]esolvi_ó__o') + #4
lema(ur'[Rr]evivi_ó__o') + #4
lema(ur'[Ss]obrevivi_ó__o') + #4
lema(ur'[Ss]uspendi_ó__o') + #4
lema(ur'[Aa]basteci_ó__o') + #3
lema(ur'[Aa]ccedi_ó__o') + #3
lema(ur'[Aa]traves_ó__o') + #3
lema(ur'[Cc]oincidi_ó__o') + #3
lema(ur'[Cc]ombati_ó__o') + #3
lema(ur'[Cc]omprendi_ó__o') + #3
lema(ur'[Cc]onfundi_ó__o') + #3
lema(ur'[Dd]evalu_ó__o') + #3
lema(ur'[Ee]ncerr_ó__o') + #3
lema(ur'[Ee]nfureci_ó__o') + #3
lema(ur'[Ee]xisti_ó__o') + #3
lema(ur'[Ee]xtingui_ó__o') + #3
lema(ur'[Ff]inaliz_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #3
lema(ur'[Ff]ingi_ó__o') + #3
lema(ur'[Ff]undi_ó__o') + #3
lema(ur'[Ii]nvirti_ó__o') + #3
lema(ur'[Ll]lam_ó__o', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|e) ', xpre=[ur'"', ur'\'\'', ur'esto ', ur'Desde ', ur'Yo ', ]) + #3
lema(ur'[Mm]idi_ó__o') + #3
lema(ur'[Pp]adeci_ó__o') + #3
lema(ur'[Pp]recedi_ó__o') + #3
lema(ur'[Pp]rendi_ó__o') + #3
lema(ur'[Pp]rocedi_ó__o') + #3
lema(ur'[Pp]romovi_ó__o') + #3
lema(ur'[Rr]eapareci_ó__o') + #3
lema(ur'[Rr]etransmiti_ó__o') + #3
lema(ur'[Rr]evirti_ó__o') + #3
lema(ur'[Ss]orprendi_ó__o') + #3
lema(ur'[Tt]ranscurri_ó__o') + #3
lema(ur'[Tt]ransport_ó__o', pre=ur'\b[Ll]o ') + #3
lema(ur'[Aa]bati_ó__o') + #2
lema(ur'[Aa]bsorbi_ó__o') + #2
lema(ur'[Aa]conteci_ó__o') + #2
lema(ur'[Aa]cost_ó__o') + #2
lema(ur'[Aa]maneci_ó__o') + #2
lema(ur'[Aa]peg_ó__o', pre=ur'[Ss]e ') + #2
lema(ur'[Aa]plaudi_ó__o') + #2
lema(ur'[Aa]rremeti_ó__o') + #2
lema(ur'[Aa]tendi_ó__o') + #2
lema(ur'[Dd]eneg_ó__o') + #2
lema(ur'[Dd]erriti_ó__o') + #2
lema(ur'[Dd]esenterr_ó__o') + #2
lema(ur'[Dd]esisti_ó__o') + #2
lema(ur'[Dd]esvaneci_ó__o') + #2
lema(ur'[Dd]evalu_ó__o', pre=ur'[Ss]e ') + #2
lema(ur'[Ee]njuici_ó__o') + #2
lema(ur'[Ee]ntendi_ó__o') + #2
lema(ur'[Ee]xpidi_ó__o') + #2
lema(ur'[Ii]mparti_ó__o') + #2
lema(ur'[Ii]mprimi_ó__o') + #2
lema(ur'[Ii]ntercedi_ó__o') + #2
lema(ur'[Ii]nterrumpi_ó__o') + #2
lema(ur'[Ii]nvadi_ó__o') + #2
lema(ur'[Mm]asacr_ó__o', pre=ur'\b(?:[Ll]a|[Yy]) ') + #2
lema(ur'[Mm]edi_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ', xpos=[ur' enterraban', ]) + #2
lema(ur'[Mm]ereci_ó__o') + #2
lema(ur'[Oo]miti_ó__o') + #2
lema(ur'[Pp]resumi_ó__o') + #2
lema(ur'[Pp]rosigui_ó__o') + #2
lema(ur'[Rr]eabri_ó__o') + #2
lema(ur'[Rr]efiri_ó__o') + #2
lema(ur'[Rr]emovi_ó__o') + #2
lema(ur'[Rr]enaci_ó__o') + #2
lema(ur'[Rr]esumi_ó__o') + #2
lema(ur'[Rr]event_ó__o') + #2
lema(ur'[Ss]ali_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #2
lema(ur'[Ss]ucumbi_ó__o') + #2
lema(ur'[Ss]ugiri_ó__o') + #2
lema(ur'[Ss]uprimi_ó__o') + #2
lema(ur'[Tt]embl_ó__o') + #2
lema(ur'[Tt]emi_ó__o') + #2
lema(ur'[Vv]erti_ó__o') + #2
lema(ur'[Aa]borreci_ó__o') + #1
lema(ur'[Aa]bsolvi_ó__o') + #1
lema(ur'[Aa]burri_ó__o') + #1
lema(ur'[Aa]crecent_ó__o') + #1
lema(ur'[Aa]gredi_ó__o') + #1
lema(ur'[Aa]ludi_ó__o') + #1
lema(ur'[Aa]marr_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #1
lema(ur'[Aa]nocheci_ó__o') + #1
lema(ur'[Aa]pret_ó__o') + #1
lema(ur'[Aa]rrepinti_ó__o') + #1
lema(ur'[Aa]trevi_ó__o') + #1
lema(ur'[Bb]lanqueci_ó__o') + #1
lema(ur'[Ca]ambi_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #1
lema(ur'[Cc]oescribi_ó__o') + #1
lema(ur'[Cc]omp_itió__(?:eti[oó]|itio)') + #1
lema(ur'[Cc]onmovi_ó__o') + #1
lema(ur'[Cc]orrespondi_ó__o') + #1
lema(ur'[Cc]orrigi_ó__o') + #1
lema(ur'[Dd]ebati_ó__o') + #1
lema(ur'[Dd]eprimi_ó__o') + #1
lema(ur'[Dd]erriv_ó__o') + #1
lema(ur'[Dd]esconoci_ó__o') + #1
...
lema(ur'[Ee]ncendi_ó__o') + #1
lema(ur'[Ee]ndureci_ó__o') + #1
lema(ur'[Ee]nmudeci_ó__o') + #1
lema(ur'[Ee]nnobleci_ó__o') + #1
lema(ur'[Ee]nriqueci_ó__o') + #1
lema(ur'[Ee]nvisti_ó__o') + #1
lema(ur'[Ee]sclareci_ó__o') + #1
lema(ur'[Ee]sculpi_ó__o') + #1
lema(ur'[Ee]xcedi_ó__o') + #1
lema(ur'[Ff]ortaleci_ó__o') + #1
lema(ur'[Ii]ncumpli_ó__o') + #1
lema(ur'[Ii]nsinu_ó__o') + #1
lema(ur'[Ll]ey_ó__o') + #1
lema(ur'[Nn]utri_ó__o') + #1
lema(ur'[Oo]bedeci_ó__o') + #1
lema(ur'[Pp]endi_ó__o') + #1
lema(ur'[Pp]osey_ó__o') + #1
lema(ur'[Pp]rescindi_ó__o') + #1
lema(ur'[Pp]revaleci_ó__o') + #1
lema(ur'[Pp]rovey_ó__o') + #1
lema(ur'[Rr]easumi_ó__o') + #1
lema(ur'[Rr]ecurri_ó__o') + #1
lema(ur'[Rr]eescribi_ó__o') + #1
lema(ur'[Rr]eincidi_ó__o') + #1
lema(ur'[Rr]eparti_ó__o') + #1
lema(ur'[Rr]epobl_ó__o') + #1
lema(ur'[Rr]eprendi_ó__o') + #1
lema(ur'[Rr]estableci_ó__o') + #1
lema(ur'[Rr]etrocedi_ó__o') + #1
lema(ur'[Rr]evendi_ó__o') + #1
...
lema(ur'[Tt]raicion_ó__o', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #1
lema(ur'[Tt]ransfiri_ó__o') + #1
lema(ur'[Tt]ravisti_ó__o') + #1
lema(ur'[Zz](?:af|anj|ap|arp|ozobr|urr)_ó__o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #1
...
grupoAndos = [
lema(ur'[Cc]onvirti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #34
lema(ur'[d]_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #28
lema(ur'[Hh]aci_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #20
lema(ur'[Ll]lev_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #15
lema(ur'[Rr]efiri_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #10
lema(ur'[Dd]ej_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #9
lema(ur'[Ll]lam_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #9
...
lema(ur'[Dd]ici_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #8
lema(ur'[Ee]nfrent_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #8
lema(ur'[Mm]anteni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #8
lema(ur'[Dd]estac_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #7
lema(ur'[Bb]as_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #6
lema(ur'[Dd]isput_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #6
lema(ur'[Pp]repar_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #6
lema(ur'[Qq]ued_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #6
lema(ur'[Uu]ni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #6
lema(ur'[Cc]lasific_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Cc]onsagr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Ee]miti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #5
lema(ur'[Ee]xplic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Gg]an_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Jj]ug_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Ll]anz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Mm]ir_á_ndo(?:[mst]e|las|l[eo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Mm]ostr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Oo]blig_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Pp]oni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #5
lema(ur'[Rr]eemplaz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Tt]ransform_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #5
lema(ur'[Tt]ray_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #5
lema(ur'[Vv]olvi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #5
lema(ur'[Bb]es_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Cc]oloc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Cc]ompar_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Cc]onserv_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Cc]re_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Dd]emostr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Dd]irigi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #4
lema(ur'[Dd]ispar_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Ff]orm_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Gg]radu_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Ii]ncorpor_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Mm]at_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Nn]eg_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Pp]as_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Pp]roclam_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Rr]euni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #4
lema(ur'[Ss]epar_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Tt]oc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #4
lema(ur'[Vv]i_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #4
lema(ur'[Aa]delant_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Aa]segur_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Bb]usc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Cc]aus_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Cc]onduci_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Cc]onfi_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Cc]onsolid_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
...
lema(ur'[Dd]efini_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Dd]esarroll_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Dd]ividi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Ee]strell_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Ee]xpandi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Gg]olpe_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Hh]abi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Hh]undi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Mm]arc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Pp]ermiti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Pp]idi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Pp]osicion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Pp]udi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Ss]igui_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #3
lema(ur'[Ss]itu_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Ss]um_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Tt]om_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
lema(ur'[Uu]bic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #3
...
lema(ur'[Aa]dvirti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
...
lema(ur'[Aa]lej_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Aa]liment_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Aa]part_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Aa]tac_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Aa]yud_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]alific_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]arg_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]entr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]lav_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]omplet_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]omponi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
...
lema(ur'[Cc]onfundi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Cc]ont_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Cc]uid_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[D]_á_ndo(?:[mst]e|las?|les?|los|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Dd]enomin_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Dd]espidi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Ee]jecut_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ee]ncontr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ee]nsambl_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ee]nseñ_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ee]ntreg_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ee]scondi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Ff]elicit_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Hh]all_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ii]mponi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Ii]nspir_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Ll]ogr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Mm]and_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Mm]ud_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Oo]bteni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Pp]eg_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Pp]rest_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
...
lema(ur'[Rr]elacion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Rr]enov_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Rr]eparti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Rr]eport_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Rr]etir_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
...
lema(ur'[Ss]inti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Tt]ir_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Tt]orn_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Tt]raslad_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Uu]tiliz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Yy]_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #2
lema(ur'[Aa]bandon_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]cus_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]dapt_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]dentr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]dicion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]horc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]lcanz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]m_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a', xpre=[ur'Pedro ']) + #1
...
lema(ur'[Aa]pod_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]poder_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]poy_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]proxim_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]puñal_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]rrebat_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]rregl_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
lema(ur'[Aa]torment_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]traves_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]tribuy_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Aa]vent_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]ñadi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Bb]orr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]ambi_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]as_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]edi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]hoc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]ocin_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]ogi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]omi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]omparti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]omprob_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]omprometi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]omunic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]oncentr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]onfes_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]onoci_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]onstruy_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Cc]opi_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]oron_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]ost_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Cc]ur_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Dd]edic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Dd]efendi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Dd]errot_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Dd]ese_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
lema(ur'[Dd]ibuj_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Dd]iscuti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Dd]istingui_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Dd]istribuy_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Dd]omin_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ee]lectrocut_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ee]mple_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ee]nfoc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ee]ngañ_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
lema(ur'[Ee]specializ_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ee]stableci_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Ee]strangul_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
lema(ur'[Ee]ximi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Ee]xtendi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Ff]alt_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ff]orz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ff]usion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Gg]ener_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Gg]obern_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Hh]abl_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Hh]iri_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
...
lema(ur'[Ii]mport_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]ncendi_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]nclin_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]ncluy_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Ii]nici_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]nscribi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Ii]nsert_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]nstal_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]nsult_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ii]ntegr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Jj]unt_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ll]i_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ll]iber_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ll]ider_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Mm]encion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Mm]ezcl_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
lema(ur'[Mm]ovi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Nn]ombr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Oo]bserv_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Oo]di_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Oo]rganiz_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Pp]ractic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Pp]regunt_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Pp]riv_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Pp]rohibi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Pp]roporcion_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Pp]rovey_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Pp]rovoc_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Qq]ueri_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Qq]uit_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]ecrimin_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]educi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Rr]egal_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]egistr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]egres_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]eincorpor_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]emont_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]enombr_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]epresent_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]espondi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Rr]evel_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]indi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Rr]ode_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Rr]ompi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Rr]ugi_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
...
lema(ur'[Ss]uplic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Ss]ustituy_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Tt]ap_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Tt]eni_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Tt]itul_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Tt]raduci_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Tt]ransmiti_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
lema(ur'[Tt]rat_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Vv]ali_é_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_e') + #1
...
lema(ur'[Vv]ol_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
...
# lema(ur'[Aa]plic_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #0
...
# lema(ur'[Mm]altrat_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #0
...
grupoMusica = [
lema(ur'[Mm]_ú_sica_u', pre=ur'\bde ', xpre=[ur'\'', ur'Dialogus ', ur'Tractatus ', ur'Escola ', ur'Scriptores ', ur'ecclesiastici '], xpos=[ur' (?:i|da|medii|libri|tratactus|theorica|Elettronica|aurea|Ficta|Tonante|negli)\b']) + 
lema(ur'[Mm]_ú_sica_u', pre=ur'[Ll]a ', xpre=[ur'Per ', ur'Plau De ', ur'sopra ', ur'Euridice, ', ur'Storia de ', ur' e ', ur'Contro ', ur'sei ', ur'per ', ur'Prima '], xpos=[ur' (?:[èe]|ci|Italiana nel|alla|del (?:cuore|violone|mare)|alla|per|degli|antica|nella|intorno|Fiorentina|russa|In)\b']) + 
lema(ur'[Mm]_ú_sicas?_u', pre=ur'(?:[Ll]as|[Uu]nas?|[Ss]us?|[Dd]ar|[Dd]ando|[Tt]ocando|[Cc]ada|tocaba|cantaba) ') + 
lema(ur'[Mm]_ú_sica (?:o|y|a|[Aa]c[uú]stica|culta|elaborada|folcl[óo]rica|instrumental|militar|original|orquestal|popular|pagana|profana|sinf[oó]nica|tradicional|regional|religiosa|vocal|[Ee]lectr[óo]nica|[Mm]ec[aá]nica|[Cc]ountry)\b_u') + 
lema(ur'[Mm]_ú_sica del_u', xpre=[ur'Ars '], xpos=[ur' (?:XV [Ss]ecolo|cuore|violone|mare|señor Giulio|Signor)']) + 
lema(ur'[Mm]_ú_sica de_u', xpre=[ur'della ']) + 
lema(ur'[Mm]_ú_sica al_u', xpos=[ur' (?:Castell|tempo)', ]) + 
lema(ur'[Mm]_ú_sicas_u', pre=ur'(?:[Ll]as|[Uu]nas|[Ss]us) ', xpos=[ur' [Cc]he']) + 
lema(ur'[Mm]_ú_sica cl[aá]sica_u') + 
lema(ur'[Mm]_ú_sica en_[uù]', xpre=[ur'Della ', ur'MSC ' ur'Storia de la ', ur'per ', ], xpos=[ur' (?:nella|Macerata|Mainz|negli)', ]) + 
lema(ur'[Mm]_ú_sicos?_u', xpre=[ur'\b(?:di|[Ii]l) ', ur'Adversus '], xpos=[ur' (?:prattico|del secolo|di|portuguezes|ha menester|perfetto)\b', ]) + #355
[]][0]

grupo1 = grupoMas + grupoEsta + grupoMusica + grupoAndos + grupoSe + [#Desde 1000
[(ur'< */ *(?P<a>[Bb][Rr]) *>', ur'<br />')] + 
lema(ur'_ E_st(?:e|á[ns]?|[ao]s?)_[Ee]', pre=ur'[-0-9a-záéúíóúüñA-ZÁÉÚÍÓÚÜÑ\]]+[\.;]') + 
...
lema(ur'_á_lbum_a', pre=ur'[Uu]n ', xpos=[ur' che']) + 
...
grupoAccion = [
lema(ur'[Ss]elecci_ó_n_o', xpos=[ur' Esportives', ur'\]\]es', ]) + #702
lema(ur'[Pp]oblaci_ó_n_o', xpre=[ur'New ', ur'North ', ur'Old ', ur'South ', ], xpos=[ur' (?:East|West)', ur'\]\](?:es|al|ales)', ]) + #521
lema(ur'[Cc]lasificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #516
lema(ur'[Ee]staci_ó_n_o', xpos=[ur'\]\]es', ]) + #472
lema(ur'[Nn]aci_ó_n_o', xpre=[ur'Mexicana ', ], xpos=[ur' Occitana', ur'(?:\]|\.com)', ]) + #384
lema(ur'[Cc]anci_ó_n_o', xpos=[ur'\]\]es', ]) + #312
lema(ur'[Dd]ivisi_ó_n_o', pre=ur'(?:[Uu]na|[Cc]ada|[Ss]u|[Pp]rimera|[Ss]egunda|[Cc]uarta) ', xpos=[ur' [12]\n', ur'\.htm', ]) + #300
lema(ur'[Ff]undaci_ó_n_o', xpre=[ur'Fundación en 1987 "', ], xpos=[ur' Paraguaya\'s', ur'(?:[\]@]|2008|\.uocra)', ]) + #298
lema(ur'[Rr]edirecci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Cc]ampe_ó_n_o', xpos=[ur'\]\]es', ]) + #282
lema(ur'[Cc]oncepci_ó_n_o', xpre=[ur' (?:of|ng) ', ur'Araneus ', ur'Immaculate ', ur'Sam ', ], xpos=[ur' (?:Gross|\(Texas)', ur'(?:\]|\.cl)', ]) + #207
lema(ur'[Ee]dici_ó_n(?!\]|\.cl)_o') + #201
lema(ur'[Vv]ersi_ó_n_o', pre=ur'(?:de|[Ll]a|[Uu]na|[Ee]sta|[Ee]sa|[Cc]ada|[Ss]u|[Ee]n|[Pp]rimera|[Ss]egunda|[Tt]ercera|[Cc]uarta|[ÚUúu]ltima|[Nn]ueva|cualquier) ', xpre=[ur'd\'après ', ur'pour ', ur'pour ', ], xpos=[ur' (?:Cue|thebaine|restaurée|en français|française)', ]) + #198
lema(ur'[Gg]rabaci_ó_n_o', xpos=[ur'\]\]es', ]) + #195
lema(ur'[Aa]sunci_ó_n_o', xpre=[ur' of ', ur'd\'', ur'near ', ], xpos=[ur' (?:Skyscraper|Golf|Business)', ]) + #188
lema(ur'[Pp]roduc_c_i(?:ón|ones)_s?') + #178
lema(ur'[Cc]oraz_ó_n_o', xpre=[ur'D\'', ur'Anya ', ], xpos=[ur' (?:Productions|Aquino)', ur'(?:\]\][a-z]+|\.cl|\.com)', ]) + #174
lema(ur'[Dd]irecci_ó_n_o', xpos=[ur'(?:\]|\.tytres)', ]) + #165
lema(ur'[Tt]elevisi_ó_n_o', pre=ur'[Dd]e ', xpos=[ur' (?:City|Without|Heaven)', ]) + #158
lema(ur'[Ii]nformaci_ó_n_o', xpos=[ur'(?: *[@\]]|\.(?:com|es))', ]) + #152
lema(ur'[Rr]inc_ó_n_o', xpre=[ur'\bs ', ur'cráter\)\|', ur'Georgia\)\|', ur'Vespo\]\] \(', ur'Rincon\]\] \(', ur'Vespo ', ur'Chrysometa ', ur'Beach ', ur'Real ', ur'Bonaire\)\|', ur'California\)\|', ur'Indiana\)\|'], xpos=[ur' (?:to|Valley|Beach|Mix|High|Center|Sapiencia|Point|Hill|Road|i Verdera|\((?:cráter|Georgia|Bonaire|California|Indiana))\b', ur'(?:, Bonaire|\]\]es)', ]) + #146
lema(ur'[Cc]omisi_ó_n_o', xpos=[ur'\]\]es', ]) + #141
lema(ur'[Cc]onstituci_ó_n_o', xpre=[ur'da ', ], xpos=[ur' di', ur'\]\]', ]) + #139
lema(ur'[Uu]ni_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]st?a) ', xpre=[ur' á ', ur'Auto ', ur'Journal de la ', ur'Ridge ', ur'San Fernando de ', ur'of ', ], xpos=[ur' (?:Académique|Women|Catholique|anarchiste|County|Nazionale|Bordeaux|Sportive|Testament|Metallic|Anarco-communiste|Athletique|Avenue|Bay|Brazilian|Buildings|Carbide|Castle|Chapel|Church|City|Company|Cycliste|Elementary|Elevated|Evangelischer|Ferry|Fire|Flag|Française|Guilde|High|Hill|Internationale|Jack|League|List|Maçonnique|Mining|Mundial pro|Nationale|Oil|Pacific|Square|Station|Steamship|Stock|Street|Terminal|Theological|Trust|Turnpike|University|Vélocipédique|anarcho|calédonienne|des|fédérale|istorica|nationale|pour|socialiste|storica|de (?:Compositeurs|banques)|(?:of|do) )', ]) + #138
lema(ur'[Aa]sociaci_ó_n_o', xpos=[ur'\]|\.Civil', ]) + #130
lema(ur'[Ee]ducaci_ó_n_o', xpos=[ur' Salsa', ur'(?:\]|\.go[bv]|\.yucatan|\.es)', ]) + #129
lema(ur'[Rr]elaci_ó_n_o', xpos=[ur'\]\]es', ]) + #129
lema(ur'[Aa]cci_ó_n_o', xpre=[ur'd\'', ], xpos=[ur'\]\]es', ]) + #127
lema(ur'[Cc]añ_ó_n_o', xpre=[ur'Ipyahe ', ur'[Mm]icropolitana ', ], xpos=[ur' City', ur'\]\]es', ]) + #117
lema(ur'[Pp]osici_ó_n_o', xpos=[ur'\]\]es', ]) + #113
lema(ur'_Venevisió_n_(venevisi[óo]|Venevisio)', xpre=[ur'\.', ], xpos=[ur'\.', ]) + #109
lema(ur'[Pp]roducci_ó_n_o', xpos=[ur'(?:\]|\.(?:com|gob)|\'s)', ]) + #106
lema(ur'[Dd]escripci_ó_n_o', xpre=[ur'cousa ', ], xpos=[ur' (?:Graphica|breue|Histórico Geografía|de todas las provincias, reynos)', ur'\]\]es', ]) + #104
lema(ur'[Rr]az_ó_n_o', xpre=[ur'Bernard ', ur'Cynthia V\. ', ur'Meital de ', ], xpos=[ur' (?:and|Copa|de aquellas muchas cabeçuelas)', ur'\]\]es', ]) + #98
lema(ur'[Aa]vi_ó_n_o', xpre=[ur'\b[LlDd]\'', ur'CS ', ur'Comme un ', ur'Paul ', ur'Cantón de ', ur'Europe en ', ur'cet ', ur'[Cc]antón de Avion\|', ur'[Cc]antón de ', ur'Novi ', ur'Orchestra ', ur'Par ', ur'Calais\)\|', ur'yvate ', ], xpos=[ur' (?:Corporation|Travel|de (?:Transport|minuit|Combat)|Baker|Express|\(Paso|)', ur'(?:, (?:Pas|Grenay)|\]\]es)', ]) + #97
lema(ur'[Rr]evoluci_ó_n_o', xpre=[ur'Zonda ', ], xpos=[ur'\]\]es', ]) + #97
lema(ur'[Ff]ederaci_ó_n_o', xpos=[ur' (?:de l|Galega|d)\b', ur'(?:\]|\.pe)', ]) + #92
lema(ur'[Rr]egi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na) ', xpos=[ur' (?:de|Mediterraneenne|Centrale|alpine|himalayenne|du |Sud et|Côtier|d\'Ambovombe)', ]) + #85
lema(ur'[Oo]rganizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #84
...
lema(ur'[Ii]nterpretaci_ó_n_o', xpos=[ur'\]\]es', ]) + #81
lema(ur'[Pp]resentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #81
lema(ur'[Tt]ibur_ó_n_o', xpre=[ur'(?:EA|[Ll]e|of|[Ii]n) ', ur'Arts ', ur'California\)\|', ur'Hyundai ', ], xpos=[ur' (?:Film|Chum|Boulevard|International|Challenger|y Belvedere|Center|Peninsula|\(California)', ur'(?:, \[|\]\]es)', ]) + #81
lema(ur'[Cc]olecci_ó_n_o', xpos=[ur'\]\]es', ]) + #80
lema(ur'[Cc]reaci_ó_n_o', xpos=[ur'\]\]es', ]) + #78
lema(ur'[Cc]omunicaci_ó_n_o', xpos=[ur'(?:\,umh|\]\]es|\.senado)', ]) + #77
lema(ur'[Pp]articipaci_ó_n_o', xpos=[ur' ciutadana', ur'\]\]es', ]) + #73
lema(ur'[Cc]onservaci_ó_n_o', xpos=[ur'\]\](?:es|ista)', ]) + #72
lema(ur'[Ee]lecci_ó_n_o', xpos=[ur'\]\]es', ]) + #72
lema(ur'[Oo]cupaci_ó_n_o', xpos=[ur'\]\]es', ]) + #72
lema(ur'[Ff]ormaci_ó_n_o', xpos=[ur'\]\]es', ]) + #71
lema(ur'[Pp]asi_ó_n_o', xpre=[ur'E\. ', ur'the ', ], xpos=[ur' (?:for|Wrestling|Dub|ni)\b', ur'\.demotilla', ]) + #71
lema(ur'[Ss]ecci_ó_n_o', xpos=[ur'[1-9\]]', ]) + #71
lema(ur'[Gg]eneraci_ó_n_o', xpre=[ur'@1', ], xpos=[ur'(?:\]|\.com)', ]) + #70
lema(ur'[Ii]lustraci_ó_n_o', xpos=[ur'\]\]es', ]) + #69
lema(ur'[Pp]ercusi_ó_n_o', xpre=[ur'and ', ], xpos=[ur' [Ss]et', ur'\]\]es', ]) + #69
lema(ur'[Tt]radici_ó_n_o', xpos=[ur'\]\](?:al|es)', ]) + #67
lema(ur'[Ff]usi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|de|y) ', xpre=[ur'énergie ', ], xpos=[ur' (?:Ford|Man|de deux|Systems|Rhône)', ur'\]\]es']) + #65
lema(ur'[Dd]ivisi_ó_n_o', pre=ur'[Tt]ercera ', xpos=[ur'\.cl', ]) + #30
lema(ur'[Dd]ivisi_ó_n_o', pre=ur'[Ll]a ', xpos=[ur' (?:[12]|Interrégionale|me perd|navale|en France|of |du |politique|méthodique|Rosemont|One|Two|Three|Théorique|de l’intérieur|des |Skanderbeg, Histoire|Charlemagne|SS Das reich sème|[Oo]ne)\b', ]) + #64
lema(ur'[Ii]nstituci_ó_n_o', xpos=[ur'\]\]es', ]) + #64
lema(ur'[Ii]nvestigaci_ó_n_o', xpos=[ur'\]\]es', ]) + #64
lema(ur'[Pp]reten_sio_nes_(?:sió|ci[oó])') + #64
lema(ur'[Ss]ituaci_ó_n_o', xpre=[ur'Q[’\']', ], xpos=[ur' \(Abril de 1864', ur'\]\]es', ]) + #64
lema(ur'[Ee]xposici_ó_n_o', xpos=[ur' de la dotrina', ur'\]\]es', ]) + #63
lema(ur'[Tt]orre_ó_n_o', xpos=[ur'\]\]es', ]) + #62
lema(ur'[Aa]parici_ó_n_o', xpos=[ur'\]\]es', ]) + #61
lema(ur'[Dd]efinici_ó_n_o', xpos=[ur'(?:\]|\.org|\.de)', ]) + #61
lema(ur'[Oo]peraci_ó_n_o', xpos=[ur'\]\]es', ]) + #60
lema(ur'[Ff]icci_ó_n_o', xpos=[ur'\]\]es', ]) + #59
lema(ur'[Aa]dministraci_ó_n_o', xpos=[ur'(?:@|\]\]es)', ]) + #58
lema(ur'[Ff]unci_ó_n_o', xpos=[ur'\]\]es', ]) + #57
lema(ur'[Pp]ublicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #55
lema(ur'[Uu]bicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #55
lema(ur'[Rr]egi_ó_n de_o', xpre=[ur'Muscinees de la ', ]) + #54
lema(ur'[Aa]nimaci_ó_n_o', xpos=[ur'\]\]es', ]) + #53
lema(ur'[Aa]viaci_ó_n_o', xpos=[ur'(?:\]\]es|\.mil)', ]) + #53
lema(ur'[Tt]ra_nsliteració_n_sliteraci[oó]') + #53
lema(ur'[Aa]dmin_istració_n_(?:itraci[oó]|straci[oó]|istrac[ioó])') + #52
lema(ur'[Dd]rag_ó_n_[oò]', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'Europa ', ur'Dent ', ur'Rêve ', ], xpos=[ur' (?:Cry|Con|Dance|Hunters|Inn|Lancer|Psychic|Caesar|Ranger|School|dans|Festival|Hill|Lore|Fly|Queen|Rouge|Warrior|Boy|TV|City|Tales|Booster|Rock|Comics|Knight|Tour|Hawk|marin|[Bb]oat|Lee|[Bb]all|[Ss]layer|[Qq]uest|[Rr]apide|[Ff]all|[Aa]ge|[Ww]orld|[Gg]ate|Shot|Tail|Khan|Ash|Sound|Force|Mk\.IV|/ Falcon)', ur'(?:\]\]es|\'s)', ]) + #52
lema(ur'[Pp]rogramaci_ó_n_o', xpos=[ur'\]\]es', ]) + #52
lema(ur'[Ee]ncarnaci_ó_n_o', xpos=[ur'\]\]es', ]) + #50
lema(ur'[Pp]abell_ó_n_o', xpos=[ur' As', ur'\]\]es', ]) + #49
lema(ur'[Ss]ubcampe_ó_n_o', xpos=[ur'\]\]es', ]) + #48
lema(ur'[Tt]elevisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]n|[Pp]or|Caracas) ', xpos=[ur' (?:Broadcasts?|Critics?|City|Parts|Preview)', ]) + #47
lema(ur'[Kk]ilot_ó_n_o', xpos=[ur'\]\]es', ]) + #46
lema(ur'[Pp]romoci_ó_n_o', xpre=[ur'Ròker ', ], xpos=[ur'\]\]es', ]) + #46
lema(ur'[Dd]istribuci_ó_n_o', xpos=[ur'\]\]es', ]) + #45
lema(ur'[Ee]lec_cio_nes_(?:i[oó]|cci[oó])') + #45
lema(ur'[Oo]btenci_ó_n_o', xpos=[ur'\]\]es', ]) + #45
lema(ur'[Rr]iñ_ó_n_o', xpos=[ur'\]\]es', ]) + #45
lema(ur'[Ii]_nauguració_n_(?:gnauraci[oó]|naguraci[oó]|nauguracio)', xpos=[ur'\]\]es', ]) + #44
lema(ur'[Nn]ataci_ó_n_o', xpos=[ur'\]\]es', ]) + #44
lema(ur'[Ll]esi_ó_n (?:de|en|que)\b_o') + #43
lema(ur'[Pp]rocesi_ó_n_o', xpos=[ur'\]\](?:es|al|ales)', ]) + #43
lema(ur'[Rr]enovaci_ó_n_o', xpos=[ur'\]\]es', ]) + #43
lema(ur'[Cc]oalici_ó_n(?![0-9\]])_o') + #42
lema(ur'[Ee]voluci_ó_n_o', xpos=[ur' e desnreolo', ur'\]\]es', ]) + #42
lema(ur'[Rr]esoluci_ó_n_o', xpos=[ur'\]\]es', ]) + #42
lema(ur'[Tt]romb_ó_n_o', xpos=[ur'\]\](?:es|istas?)', ]) + #42
lema(ur'[Cc]onvulsi_ó_n_o', xpos=[ur' (?:[Tt]herapy|Group)', ur'\]\]es', ]) + #41
lema(ur'[Bb]alc_ó_n_o', xpre=[ur'(?:[Ll]e|du|au) ', ur'\b(?:por|mon) ', ur'M\. ', ur'Claudie ', ur'Michael ', ur'Jill ', ur'grand ', ur'relais de ', ur'siendo ', ], xpos=[ur' (?:à|sur|Zone|en forêt|renombró)\b', ur'(?:\]\](?:es|ada)|, (?:Sylvie|corridor))']) + #40
lema(ur'[Cc]ati_ó_n_o', xpre=[ur'putative ', ], xpos=[ur' (?:denatonium|exchange|channel|in|of)', ur'\]\]es', ]) + #40
lema(ur'[Ee]cuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #40
lema(ur'[Ll]adr_ó_n_o', xpos=[ur' Peak', ur'\]\]es', ]) + #40
lema(ur'[Ss]axof_ó_n_o', xpos=[ur'\]\]es', ]) + #40
lema(ur'[Oo]pini_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]n|[Dd]e) ') + #39
lema(ur'[Pp]iñ_ó_n_o', xpre=[ur'Jannis ', ur'Kusnezov ', ur'Led ', ur'Pine ', ur'Ramon ', ], xpos=[ur' (?:Hills|Pine)', ur'\]\]es', ]) + #39
lema(ur'[Pp]risi_ó_n_o', xpre=[ur' In ', ur'Glass ', ], xpos=[ur' (?:ward|blues|Fellowship|Match)', ur'\]\]es', ]) + #39
lema(ur'[Cc]onfederaci_ó_n_o', xpos=[ur'\]\]es', ]) + #38
lema(ur'[Cc]orporaci_ó_n_o', xpos=[ur'\]\]es', ]) + #38
lema(ur'[Dd]iputaci_ó_n_o', xpos=[ur'\]\]es', ]) + #38
lema(ur'[Ee]misi_ó_n_o', xpos=[ur'\]\]es', ]) + #38
lema(ur'[Tt]ransmisi_ó_n_o', xpos=[ur' (?:Eléktrika|kon)', ur'\]\]es', ]) + #38
lema(ur'[Ll]ocalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #37
lema(ur'[Mm]anifestaci_ó_n_o', xpos=[ur'\]\]es', ]) + #37
lema(ur'[Tt]raducci_ó_n_o', xpos=[ur'\]\]es', ]) + #37
lema(ur'[Ii]n_s_cripciones_') + #36
lema(ur'[Ii]ntroducci_ó_n_o', xpos=[ur'\]\]es', ]) + #36
lema(ur'[Nn]ominaci_ó_n_o', xpos=[ur' indirècta', ur'\]\]es', ]) + #36
lema(ur'[Mm]isi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]|[Ee]st?a) ') + #35
lema(ur'[Pp]atr_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'repiè ', ur'vida ', ], xpos=[ur' (?:de presse|and|Saint|Advisory)', ]) + #35
lema(ur'[Cc]esi_ó_n_o', xpos=[ur'\]\]es', ]) + #34
lema(ur'[Cc]uesti_ó_n_o', xpos=[ur'\]\]es', ]) + #34
lema(ur'[Oo]ca_sio_nes_(?:ci[oó]|sió)') + #34
lema(ur'[Pp]untuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #34
lema(ur'[Cc]olaboraci_ó_n_o', xpos=[ur'\]\]es', ]) + #33
lema(ur'[Ss]esi_ó_n_o', xpre=[ur'room ', ur'[Ii]n ', ur'jam ', ], xpos=[ur'\]\]es', ]) + #33
lema(ur'[Vv]isi_ó_n_o', pre=ur'(?:[Uu]na|[Cc]ada|[Ss]u|[Ll]a|[Ee]sta) ', xpos=[ur' (?:City|mystique|érotique|romantique|qu|du|des|Gallery|après)\b', ]) + #33
lema(ur'[Dd]uraci_ó_n_o', xpos=[ur'\]\]es', ]) + #32
lema(ur'[Rr]evelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #32
lema(ur'[Tt]ax_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ') + #32
lema(ur'[Aa]tenci_ó_n_o', xpos=[ur'\]\]es', ]) + #31
lema(ur'[Ss]al_ó_n_o', pre=ur'(?:[Ee]l|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'Entr\'acte: ', ], xpos=[ur' (?:Bovy|Indien|International|de (?:Provence|Mai|thé|la (?:Jeune|Correspondance|Société)|l\')|dans |des |d[\'’´]|du |Premium|[Rr][eé]alités?)', ur'(?:\]\]es|\.com)', ]) + #31
lema(ur'[Aa]ctuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #30
lema(ur'[Ii]n_n_ovaciones_') + #30
lema(ur'[Ii]nten_ció_n_si[oó]') + #30
lema(ur'[Rr]econstrucci_ó_n_o', xpos=[ur'\]\]es', ]) + #30
lema(ur'[Rr]estauraci_ó_n_o', xpos=[ur'\]\]es', ]) + #30
lema(ur'[Cc]oncentraci_ó_n_o', xpos=[ur'\]\]es', ]) + #29
lema(ur'[Ii]nscripci_ó_n_o', xpos=[ur'\]\]es', ]) + #29
lema(ur'[Cc]a_n_ciones_') + #28
lema(ur'[Ii]ntegraci_ó_n_o', xpos=[ur'\]\]es', ]) + #28
lema(ur'[Oo]pci_ó_n_o', xpos=[ur'\]\]es', ]) + #28
lema(ur'[Rr]ecepci_ó_n_o', xpos=[ur'\]\]es', ]) + #28
lema(ur'[Cc]ertificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #27
lema(ur'[Cc]onvenci_ó_n_o', xpos=[ur'\]\]es', ]) + #27
lema(ur'[Ff]inalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #27
lema(ur'[Hh]abitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #27
lema(ur'[Ii]nfecci_ó_n_o', xpos=[ur'\]\]es', ]) + #27
lema(ur'[Ee]xten_sió_n_ci[oó]') + #26
lema(ur'[Ii]nstrucci_ó_n_o', xpos=[ur' pastoral que el', ur'\]\]es', ]) + #26
lema(ur'[Mm]utaci_ó_n_o', xpos=[ur'\]\]es', ]) + #26
lema(ur'[Pp]osesi_ó_n_o', xpos=[ur'\]\]es', ]) + #26
lema(ur'[Cc]allej_ó_n_o', xpos=[ur' \(banda', ur'\]\]es', ]) + #25
lema(ur'[Cc]omposici_ó_n_o', xpos=[ur'\]\]es', ]) + #25
lema(ur'[Ee]scuadr_ó_n_o', xpos=[ur'[\]0-9]', ]) + #25
lema(ur'[Pp]rofesi_ó_n_o', xpos=[ur'\]\](?:es|al|ales|istas?|almente)', ]) + #25
lema(ur'[Rr]eflexi_ó_n_o', xpre=[ur'Eine ', ur'Moment de ', ur'(?:für|und) ', ur'hermeneutische ', ur'banda\)\|', ur'kritischen ', ], xpos=[ur' (?:in|über|und|de[rs]|auf|Exhibition|Masterclass|\(banda)\b', ur', (?:Stargazery|Taste)', ur'\]\]es', ]) + #25
lema(ur'[Ss]ucesi_ó_n_o', xpos=[ur'\]\]es', ]) + #25
lema(ur'[Vv]ersi_ó_n en_o') + #25
lema(ur'[Dd]elegaci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Dd]epresi_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Gg]obernaci_ó_n_o', xpos=[ur' de la Generalidad de Cataluna', ur'(?:\]|\.gob)', ]) + #24
lema(ur'[Hh]idroavi_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Ii]nmigraci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Ii]nundaci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Ll]iberaci_ó_n_o', xpos=[ur'(?:\]|: Songs)', ]) + #24
lema(ur'[Pp]antal_ó_n_o', xpre=[ur'San ', ur'[Ll]e ', ur'monsieur ', ], xpos=[ur' (?:est|trop|et )', ur'(?:\]\][a-zñ]+|\'])', ]) + #24
lema(ur'[Pp]rotecci_ó_n_o') + #24
lema(ur'[Rr]ecaudaci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Rr]emodelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Ss]oluci_ó_n_o', xpos=[ur'\]\]es', ]) + #24
lema(ur'[Cc]icl_ó_n_o', xpos=[ur'\]\]es', ]) + #23
lema(ur'[Cc]ompetici_ó_n_o', xpos=[ur'\]\]es', ]) + #23
lema(ur'[Oo]posici_ó_n_o', xpos=[ur'\]\]es', ]) + #23
lema(ur'[Rr]ei__vindicaciones_n') + #23
lema(ur'[d]ecisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Pp]or) ') + #23
lema(ur'[l]e_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'Juusso ', ]) + #23
lema(ur'[Oo]ca_sió_n_(?:ci[oó]|sio)') + #22
lema(ur'[Rr]eedici_ó_n_o', xpos=[ur'\]\]es', ]) + #22
lema(ur'[Aa]dhesi_ó_n_o', xpre=[ur'& ', ur'Macrophage ', ur'[Ff]ocal ', ur'[Ii]n ', ur'[Cc]ell ', ], xpos=[ur' (?:and|of|Prevention|molecules)', ur'\]\][a-z]+', ]) + #21
lema(ur'[Cc]ol__ecciones_l') + #21
lema(ur'[Cc]onexi_ó_n(?!\]|\.com)_o', xpre=[ur'Madonna ', ur'Makarras ', ]) + #21
lema(ur'[Cc]onstruc_ció_n_i[oó]', xpos=[ur' dun', ]) + #21
lema(ur'[Pp]erd_ó_n_o', xpre=[ur'Gerald ', ur'Luana ', ur'Laurent ', ur'S[ae]nt ', ], xpos=[ur'\]\]es']) + #21
lema(ur'[Tt]ransici_ó_n_o', xpos=[ur'\]\]es', ]) + #21
lema(ur'[Uu]rbanizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #21
lema(ur'[Vv]ag_ó_n_o', xpos=[ur'\]\]es', ]) + #21
lema(ur'[Bb]ot_ó_n_o', xpre=[ur'Joaquín ', ], xpos=[ur'(?:\]|: Houghton)', ]) + #20
lema(ur'[Cc]elebraci_ó_n_o', xpos=[ur'\]\]es', ]) + #20
lema(ur'[Dd]ecisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #20
lema(ur'[Dd]enominaci_ó_n_o', xpos=[ur'\]\]es', ]) + #20
lema(ur'[Jj]am_ó_n_o', xpre=[ur'DJ ', ur'Joss ', ur'Kyle ', ur'Nacional ', ur'bruja ', ], xpos=[ur' (?:llega|Alfred|Lucas|Meredith|Gordon)', ur'\]\]es', ]) + #20
lema(ur'[Rr]eacci_ó_n_o', xpos=[ur'\]\]es', ]) + #20
lema(ur'[Rr]ecopilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #20
lema(ur'[Rr]euni_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]st?a) ', xpre=[ur'Denis de ', ], xpos=[ur' Island', ]) + #20
lema(ur'[b]al_ó_n_o', xpos=[ur'\]\]es', ]) + #20
lema(ur'[Aa]lgod_ó_n_o', xpos=[ur' Wine', ur'\]\](?:es|ero)', ]) + #19
lema(ur'[Cc]aj_ó_n_o', xpos=[ur' (?:Jinbiao|Run|Blvd|[Pp]ass|Summit|Transit|Boulevard|\(California|Valley|Park)', ur'(?:\]|\'\', sin tilde)', ur', (?:California|Fresno)', ]) + #19
lema(ur'[Cc]omparaci_ó_n_o', xpre=[ur'\bE ', ], xpos=[ur'\]\]es', ]) + #19
lema(ur'[Cc]orrec_c_iones_') + #19
lema(ur'[Cc]orrupci_ó_n_o', xpos=[ur'\]\]es', ]) + #19
lema(ur'[Dd]e_cisió_n_(?:si[sc]i[oó]|cici[oó])') + #19
lema(ur'[Dd]imensi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Oo]tra|[Ss]u|[Dd]e|[Ee]st?a|[Tt]ercera|[Cc]uarta) ', xpos=[ur' (?:psychique|Films|Records|Data)', ]) + #19
lema(ur'[Ll]im_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpre=[ur'Ed\. ', ur'scorzeta ', ]) + #19
lema(ur'[Pp]elot_ó_n_o', xpre=[ur'Oranje ', ur'Solidaires en ', ur'Tollo ', ur'[Tt]he ', ], xpos=[ur' (?:Association|d\')', ur'\]\][a-zñ]+', ]) + #19
lema(ur'[Pp]resi_ó_n_o', xpos=[ur'\]\]es', ]) + #19
lema(ur'[Rr]edacci_ó_n_o', xpos=[ur'\]\]es', ]) + #19
lema(ur'[Ss]eparaci_ó_n_o', xpos=[ur'\]\]es', ]) + #19
lema(ur'[Ss]ubregi_ó_n_o', xpre=[ur'Africa ', ur'Papuan ', ], xpos=[ur'\]\]es', ]) + #19
lema(ur'[Uu]ni_ó_n (?:Dem[oó]crata|Estepona|Sovi[eé]tica)_o') + #19
lema(ur'[Aa]daptaci_ó_n_o') + #18
lema(ur'[Aa]par_i_ciones_a') + #18
lema(ur'[Cc]olec_c_iones_') + #18
lema(ur'[Cc]oncesi_ó_n_o', xpos=[ur'\]\]es', ]) + #18
lema(ur'[Ee]recci_ó_n_o', xpos=[ur'\]\]es', ]) + #18
lema(ur'[Ee]scorpi_ó_n_o', xpre=[ur'Di ', ur'Milo de ', ], xpos=[ur'\]\]es', ]) + #18
lema(ur'[Ee]valuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #18
lema(ur'[Ee]xcepci_ó_n_o', xpos=[ur'\]\]es', ]) + #18
lema(ur'[Pp]ante_ó_n_o', xpos=[ur'\]\]es', ]) + #18
lema(ur'[Dd]ifusi_ó_n_o', xpre=[ur'Fonogram ', ], xpos=[ur'\]\]es', ]) + #17
lema(ur'[Ee]liminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #17
lema(ur'[Ee]xpedici_ó_n_o', xpos=[ur' Antarctic', ur'\]\]es', ]) + #17
lema(ur'[Ee]xportaci_ó_n_o', xpos=[ur'\]\]es', ]) + #17
lema(ur'[Ii]ntervenci_ó_n_o', xpre=[ur'Ajoute ', ], xpos=[ur'\]\]es', ]) + #17
lema(ur'[Oo]casi_ó_n_o', xpos=[ur'\]\]es', ]) + #17
lema(ur'[Pp]e_ó_n_o', xpre=[ur'Eddie ', ur'Dictyna ', ur'Carole ', ur'Domínguez ', ur'Lazy ', ur'Olatz ', ], xpos=[ur' – Batería', ur'\]\]es', ]) + #17
lema(ur'[Pp]end_ó_n_o', xpre=[ur'Dan y su ', ], xpos=[ur'\]\]es', ]) + #17
lema(ur'[Pp]etici_ó_n(?!\]|\.xsd)_o') + #17
lema(ur'[Rr]ecuperaci_ó_n_o', xpos=[ur'\]\]es', ]) + #17
lema(ur'[Ss]anci_ó_n_o', xpos=[ur'\]\]es', ]) + #17
lema(ur'[Aa]grupaci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Cc]ongregaci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Dd]estituci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Dd]etenci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Jj]onr_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Ll]egislaci_ó_n_o', xpre=[ur'Nueva Espana\. ', ], xpos=[ur'\]\]es', ]) + #16
lema(ur'[Mm]igraci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Mm]ill_ó_n_o', pre=ur'([Mm]edio|[Uu]n|[Ee]l) ') + #16
lema(ur'[Mm]oj_ó_n_o', xpre=[ur'Benedetto ', ur'Giuseppe '], xpos=[ur' Records', ur'\]\]es', ]) + #16
lema(ur'[Ss]uspen_sió_n_ci[oó]') + #16
lema(ur'[Vv]iolaci_ó_n_o', xpos=[ur'\]\]es', ]) + #16
lema(ur'[Bb]omb_ó_n_o', xpos=[ur' Evolution', ur'(?:\. Aqua|\]\]es)', ]) + #15
lema(ur'[Cc]amale_ó_n_o', xpos=[ur' Records', ur'\]\]es', ]) + #15
lema(ur'[Cc]hampiñ_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Cc]ivilizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Ii]nvasi_ó_n_o', pre=ur'\b(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|otra|de|[Pp]rimera|[Ss]egunda|[Tt]ercera|[Ss]éptima) ') + #15
lema(ur'[Jj]urisdicci_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Jj]uri_sdicció_n_dicci[oó]') + #1
lema(ur'[Jj]uri_sdiccio_nal(?:es|)_dicci[oó]') + #1
lema(ur'[Mm]edall_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Nn]utrici_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Rr]eproducci_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Uu]nificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #15
lema(ur'[Cc]ombinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Cc]onstelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Cc]ontinuaci_ó_n_o') + #14
lema(ur'[Ee]scal_ó_n_o', xpre=[ur'California\)\|', ur'Max ', ], xpos=[ur' (?:de Fonton|\(California)', ur'\]\]es', ]) + #14
lema(ur'[Ee]vasi_ó_n_o', xpre=[ur'Jailbreak ', ur'Bridging ', ur'Cartwheel ', ur'Citro[eë]n ', ur'Filter ', ur'Her ', ur'Matrix ', ur'Roman de ', ur'Somersault ', ur'[Ll]\'', ur'[Tt]ax ', ur'and ', ur'backflip ', ur'd\'', ur'legged ', ], xpos=[ur' (?:Films|of|par|Clause)', ur'(?:["\]]|, and)', ]) + #14
lema(ur'[Mm]aldici_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Oo]raci_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Pp]rot_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' *[1-9][0-9]*', ur' (?:Block|Prevé|Exora|Satria|en la clase|Synchrotron)', ur'\]\]es', ]) + #14
lema(ur'[Pp]royecci_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Tt]elevisi_ó_n (?:por|[Ss]atelital|[Pp][uú]blica)_o') + #14
lema(ur'[Tt]ransmi_sió_n_ci[oó]') + #14
lema(ur'[Vv]egetaci_ó_n_o', xpos=[ur'\]\]es', ]) + #14
lema(ur'[Aa]d_aptació_n_pataci[oó]') + #13
lema(ur'[Aa]limentaci_ó_n_o', xpos=[ur'(?:\]|\.es)', ]) + #13
lema(ur'[Aa]nfitri_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Aa]nglosaj_ó_n_o', xpos=[ur'\]\](?:as?|es)', ]) + #13
lema(ur'[Aa]plicaci_ó_n_o', pre=ur'(?:[Dd]e|[Ll]a|[Uu]na) ') + #13
lema(ur'[Cc]ant_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'estatjants ', ], xpos=[ur' (?:Tech|Hall|Ticino)', ]) + #13
lema(ur'[Cc]om__unicaciones_m') + #13
lema(ur'[Cc]onducci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Cc]onfesi_ó_n_o', xpre=[ur'A ', ur'Yô ', ], xpos=[ur'\]\]es', ]) + #13
lema(ur'[Dd]edicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Dd]esaparici_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Dd]imisi_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Dd]ocumentaci_ó_n_o', xpre=[ur'Centre International de ', ], xpos=[ur'  e poder', ur'\]\]es', ]) + #13
lema(ur'[Ee]dific__aciones_i') + #13
lema(ur'[Ee]lecci_o_nes_ó') + #13
lema(ur'[Ee]x_h_ibi(?:ó|ciones)_') + #13
lema(ur'[Ee]xplotaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Ee]xposi_ci_ones_(?:|sici|si)') + #13
lema(ur'[Ee]xpresi_ó_n_o', pre=ur'(?:[Dd]e|[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ', xpre=[ur'L\'', ], xpos=[ur' t', ur'\.tv', ]) + #13
lema(ur'[Gg]orri_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Ii]nnovaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Ii]nquisici_ó_n_o', xpos=[ur' á ', ur'(?:\]|\.scd|, chronista)', ]) + #13
lema(ur'[Ii]nstalaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Ss]alvaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Tt]elecomunicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #13
lema(ur'[Aa]fici_ó_n_o', xpos=[ur'\]\](?:es|ad[ao]s?)', ]) + #12
lema(ur'[Aa]lucinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Aa]mpliaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Cc]alificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Cc]anci_o_nes_ó') + #12
lema(ur'[Cc]intur_ó_n_o', xpre=[ur'Ride ', ], xpos=[ur'\]\]es', ]) + #12
lema(ur'[Cc]ontaminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Cc]oordinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Cc]oronaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Dd]emostraci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ee]jecuci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ee]stimaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ee]xploraci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ee]xtinci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ff]abricaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ii]luminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Ii]ncorporaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Pp]articipaci_o_nes_ó') + #12
lema(ur'[Pp]lanificaci_ó_n_o', xpos=[ur'(?:\]|\.gob)', ]) + #12
lema(ur'[Pp]reparaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Tt]ransformaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Vv]otaci_ó_n_o', xpos=[ur'\]\]es', ]) + #12
lema(ur'[Aa]ctualizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Aa]doraci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Aa]firmaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Cc]irculaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Cc]o_nmemoració_n_(?:nmemoracio|memoraci[oó])', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Cc]ompilaci_ó_n_o', xpos=[ur' curata', ur'\]\]es', ]) + #11
lema(ur'[Cc]onformaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Dd]estrucci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Ee]mbri_ó_n_o', xpos=[ur'\]\](?:es|ari[ao]s?)', ]) + #11
lema(ur'[Ff]acturaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Ff]ermi_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Ff]racci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Hh]omogen_eizació_n_(?:izaci[oó]|eizacio)') + #11
lema(ur'[Ii]ncisi_ó_n_o', xpre=[ur'Second ', ], xpos=[ur'\]\]es', ]) + #11
lema(ur'[Mm]ansi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur' House', ]) + #11
lema(ur'[Mm]edici_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Pp]recipitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Rr]educci_ó_n_o', xpos=[ur'\.gov', ur'\]\]es', ]) + #11
lema(ur'[Rr]eglamentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Rr]ehabilitaci_ó_n_o') + #11
lema(ur'[Rr]otaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Ss]imulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[Tt]entaci_ó_n_o', xpos=[ur'\]\]es', ]) + #11
lema(ur'[b]ill_ó_n_o', xpos=[ur' (?:of)', ur'\]\][a-zñ]+', ]) + #11
lema(ur'[Aa]probaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Bb]uz_ó_n_o', xpre=[ur'Beverlee ', ur'Freddy ', ur'Bernard ', ur'du ', ], xpos=[ur'\]\]es', ]) + #10
lema(ur'[Cc]ombusti_ó_n_o', pre=ur'(?:[Ll]a|[Dd]e) ', xpos=[ur' (?:et|en général)']) + 
lema(ur'[Cc]ombusti_ó_n_o', pre=ur'(?:[Ll]a|[Dd]e) ', xpos=[ur' et', ]) + #10
lema(ur'[Cc]ongesti_ó_n_o', xpre=[ur'Hors ', ur'ease ', ur'of ', ur'the ', ur'traffic ', ur'venous ', ], xpos=[ur' (?:[Aa]voidance|[Hh]andling|[Tt]hreshold|[Pp]ricing|Tax|of|Relief|Window|charges?|window|[Nn]otification|[Mm]itigation|[Ii]nterpretation|[Rr]eduction|[Cc]osts|[Cc]ontrol)', ]) + #10
lema(ur'[Cc]onspiraci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Cc]ooperaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Dd]esambiguaci_ó_n(?!\])_o') + #10
lema(ur'[Dd]escalificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Ee]corregi_ó_n(?!\])_o') + #10
lema(ur'[Ee]d_i_ciones_') + #10
lema(ur'[Ee]spol_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Ii]__dentificaciones_n') + #10
lema(ur'[Ii]dentificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Ii]mpresi_ó_n_o', xpos=[ur' de Felipe Mey', ur'\]\]es', ]) + #10
lema(ur'[Ii]nspiraci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Ll]icitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Mm]unici_ó_n_o', xpos=[ur'(?:\]|\.org)', ]) + #10
lema(ur'[Oo]bservaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Pp]ensi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpre=[ur'Filles de ', ], xpos=[ur' des']) + #10
lema(ur'[Rr]ecreaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Ss]umisi_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Tt]ap_ó_n_o', xpre=[ur'Michel ', ur'Serge ', ], xpos=[ur'\]\]es', ]) + #10
lema(ur'[Tt]ripulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #10
lema(ur'[Aa]ctuaci_o_nes_ó') + #9
lema(ur'[Aa]leaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
...
lema(ur'[Cc]lasificaci_o_nes_ó') + #9
lema(ur'[Cc]olisi_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Cc]ontrataci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ee]levaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ee]xaltaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ee]xplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ee]xtensi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #9
lema(ur'[Ee]xtrusi_ó_n_o', xpre=[ur'Screw ', ur'The ', ], xpos=[ur'(?:\]\][a-z]+|: Battlehymns)', ]) + #9
lema(ur'[Ff]ortificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Gg]alp_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ii]nflexi_ó_n_o', xpre=[ur'd\'', ur'and '], xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ii]ntera_c_ciones_') + #9
lema(ur'[Ii]nvestigaci_o_nes_ó') + #9
lema(ur'[Mm]elocot_ó_n_o', xpos=[ur'\]\](?:es|er[ao]s?)', ]) + #9
lema(ur'[Mm]enci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Pp]roporci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Pp]ublicaci_o_nes_ó') + #9
lema(ur'[Pp]urificaci_ó_n_o', xpos=[ur' \(Peñuelas', ur'\]\]es', ]) + #9
lema(ur'[Rr]ealizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Ss]educci_ó_n_o', xpos=[ur'\]\]es', ]) + #9
lema(ur'[Tt]amp_ó_n_o', xpre=[ur'\bdu ', ur'Zombie ', ur'[Ll]e ', ], xpos=[ur' Disease', ur'\]\]es', ]) + #9
lema(ur'[Vv]ersi_o_nes_ó') + #9
lema(ur'[Aa]dvocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Aa]gresi_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Aa]tracci_ó_n_o', xpos=[ur'[\]3]', ]) + #8
lema(ur'[Aa]udici_ó_n_o', xpos=[ur' Irritable', ur'\]\]es', ]) + #8
lema(ur'[Cc]anel_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Cc]ircunvalaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Cc]omputaci_ó_n_o', xpos=[ur'(?:\]|\.facyt)', ]) + #8
lema(ur'[Cc]ondici_ó_n_o', pre=ur'(?:[Ll]as?|[Uu]nas?|[Ss]us?) ') + #8
lema(ur'[Cc]onsolaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Cc]onversaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Cc]orrecci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Dd]ecoraci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Dd]evoci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Dd]istinci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Dd]ivisi_ó_n [Pp]ol[ií]tica_o') + #8
lema(ur'[Dd]onaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ff]og_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ii]ndemnizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ii]ntenci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ii]nversi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ll]ap_ó_n_o', xpre=[ur'Gúdar\+Hazte ', ur'Botaniques de ', ur'Parlons ', ur'\bDo ', ur'\bun ', ], xpos=[ur'\]\](?:as?|es)', ]) + #8
lema(ur'[Mm]ont_ó_n_o', xpre=[ur'Julie ', ur'Leonard ', ur'de ', ], xpos=[ur' \(Eccles', ur'(?:\]|, (?:Canad[áa]|Gran|Bradley))', ]) + #8
lema(ur'[Nn]avegaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Nn]otaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Oo]vaci_ó_n(?!\]|\.pe|\.com)_o') + #8
lema(ur'[Pp]ercepci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Pp]eregrinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Pp]laneaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Pp]lantaci_ó_n(?!\])_o') + #8
lema(ur'[Pp]ort_ó_n_o', xpre=[ur'Pamela '], xpos=[ur' (?:d[\'’]|Down|Plantation)', ur'\]\]es', ]) + #8
lema(ur'[Pp]ropagaci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Pp]rostituci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Rr]ecolecci_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Rr]elaci_o_nes_ó') + #8
lema(ur'[Rr]epetici_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Ss]aj_ó_n_o', xpos=[ur'\]\]es', ]) + #8
lema(ur'[Aa]dmisi_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Aa]lmid_ó_n_o', xpre=[ur'Rosales '], xpos=[ur'\]\]es', ]) + #7
lema(ur'[Aa]pag_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]ertifi_cació_n_(?:a[cs]i[oó]|casi[oó])') + #7
lema(ur'[Cc]hicharr_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]ircunscripci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]ircunvoluci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]olch_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]olonizaci_ó_n_o', xpos=[ur'\.com', ]) + #7
lema(ur'[Cc]onfirmaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]ontribuci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]onurbaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Cc]ulminaci_ó_n(?!\])_o') + #7
lema(ur'[Dd]isertaci_ó_n_o', xpos=[ur'\]\]es', ur' physico']) + #7
lema(ur'[Ee]quipaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Ee]rupci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Ee]xcavaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Ee]xpan_sió_n_ci[oó]') + #7
lema(ur'[Hh]ormig_ó_n_o', xpos=[ur'\]\](?:es|ad[ao]s?)', ]) + #7
lema(ur'[Ii]mportaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Ii]nvitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Jj]arr_ó_n_o', xpre=[ur'& ', ], xpos=[ur'\]', ur' (?:Collins|Vosburg)']) + #7
lema(ur'[Mm]asterizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Pp]acificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Pp]enetraci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Pp]ersecuci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Pp]rivatizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Rr]adiodifusi_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Rr]edenci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Rr]eputaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Rr]espiraci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Ss]ensaci_ó_n_o') + #7
lema(ur'[Ss]ensaci_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Tt]abl_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Tt]raici_ó_n_o', xpos=[ur'\]\]es', ]) + #7
lema(ur'[Aa]decuaci_ó_n(?!\])_o') + #6
lema(ur'[Aa]luvi_ó_n_o', xpos=[ur'\]\](?:es|al|ales)', ]) + #6
lema(ur'[Aa]mputaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Aa]nexi_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Aa]nunciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Aa]utorizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Cc]apacitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Cc]odificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Cc]ompetició_n__m?', xpos=[ur', reglamentacions']) + #6
lema(ur'[Cc]ompresi_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Cc]omuni_ó_n_o', xpre=[ur'cathechismo de la ', ], xpos=[ur'(?:\]|\.org)', ]) + #6
lema(ur'[Cc]onclusi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #6
lema(ur'[Cc]osmovisi_ó_n_o', xpos=[ur' des', ur'\]\]es', ]) + #6
lema(ur'[Dd]erivaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Dd]esignaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Dd]etecci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Dd]isposici_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ee]migraci_ó_n_o', xpos=[ur'(?:\.ca|\]\]es)', ]) + #6
lema(ur'[Ee]moci_ó_n(?![\]0-9])_o') + #6
lema(ur'[Ee]staci_o_nes_ó') + #6
lema(ur'[Ee]xplosi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #6
lema(ur'[Ee]xpropiaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ff]ermentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Gg]raduaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ii]mplementaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ii]nclusi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #6
lema(ur'[Ii]nserci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ii]ntersecci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ii]ntoxicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Jj]ubilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ll]ecci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ll]ocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Mm]odificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Nn]acionalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Nn]egociaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Nn]umeraci_ó_n_o') + #6
lema(ur'[Nn]umeraci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Oo]bsesi_ó_n_o', xpre=[ur'l[\'’]', ], xpos=[ur'(?:\])', ]) + #6
lema(ur'[Oo]rej_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Oo]rientaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Oo]xidaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Pp]artici_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Pp]ercusi_o_nes_ó') + #6
lema(ur'[Pp]ez_ó_n_o', xpre=[ur'Andre ', ur'Jean-Baptiste ', ], xpos=[ur'\]\]es', ]) + #6
lema(ur'[Pp]orci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Pp]romulgaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Rr]eelecci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Rr]eencarnaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Rr]egi_o_nes_ó') + #6
lema(ur'[Rr]eligi_ó_n [Cc]at[oó]lica_o') + #6
lema(ur'[Rr]eligi_ó_n_o', pre=ur'(?:[Uu]na|[Cc]ada|[Ss]u) ') + #6
lema(ur'[Rr]eorganizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Rr]epresi_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Rr]eversi_ó_n_o', xpre=[ur';', ur'Series ', ur'bit ', ], xpos=[ur' to', ur'\]\]es', ]) + #6
lema(ur'[Ss]elecci_o_nes_ó') + #6
lema(ur'[Ss]eñalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Ss]if_ó_n(?!\])_o') + #6
lema(ur'[Tt]if_ó_n_o', xpos=[ur'(?:[1-9\]])', ]) + #6
lema(ur'[Tt]ra_nsliteracio_nes_(?:sliteraci[oó]|nsliteració)') + #6
lema(ur'[Uu]tilizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Vv]inculaci_ó_n_o', xpos=[ur'\]\]es', ]) + #6
lema(ur'[Aa]creditaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]cumulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]dicci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]dici_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]djudicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]gregaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]ler_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]niquilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]notaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]proximaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]scensi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #5
lema(ur'[Aa]utodeterminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Aa]utomatizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Bb]ar_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]l?) ', xpre=[ur'\bpar ', ur'acuerdo ', ], xpos=[ur' (?:Michele|Reiter|Cohen|Corbin|Wolman|Samedi|Zemo|Gattoni)', ur', el', ]) + #5
lema(ur'[Bb]eatificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Bb]endici_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Bb]odeg_ó_n(?!\])_o') + #5
lema(ur'[Cc]aracterizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Cc]ivilizaci_o_nes_ó') + #5
lema(ur'[Cc]ondecoraci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Cc]onfiguraci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Dd]emarcaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Dd]etonaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Dd]iapas_ó_n_o', xpre=[ur'[Ll]e ', ur'[Tt]he ', ur'revue ', ], xpos=[ur' (?:Découverte|Records|[Dd]|\(revista)\b', ur'(?:, Scherzo|’s|\'|\]\])', ]) + #5
lema(ur'[Ee]scalaf_ó_n(?!\])_o') + #5
lema(ur'[Ee]x_cepció_n_epci[oó]') + #5
lema(ur'[Gg]laciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Hh]ipertensi_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]maginaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]mitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]n_strucció_n_trucci[oó]', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]nclinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]nspecci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ii]nten_cio_nes_si[oó]') + #5
lema(ur'[Ii]ntimidaci_ó_n(?!\])_o') + #5
lema(ur'[Ii]rrigaci_ó_n(?!\])_o') + #5
lema(ur'[Ll]egalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Mm]arat_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ') + #5
lema(ur'[Mm]el_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'Saye ', ur'abbati ', ur'listado ', ur'musicales ', ], xpos=[ur' (?:Music|Kinenbi)', ur', Naver', ]) + #5
lema(ur'[Mm]odernizaci_ó_n_o', xpos=[ur'(?:\]|\.(?:cl|gob))', ]) + #5
lema(ur'[Mm]otivaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Mm]ultiplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Nn]ominaci_o_nes_ó') + #5
lema(ur'[Oo]bligaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Oo]ca_sió_n_ci[oó]') + #5
lema(ur'[Oo]rdenaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Oo]rganizaci_o_nes_ó') + #5
lema(ur'[Pp]erdig_ó_n_o', xpre=[ur'Pierre ', ur'Troubadour ', ], xpos=[ur' d', ur'\]\][a-zñ]+', ]) + #5
lema(ur'[Pp]ostulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Pp]recisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Cc]on| y| de) ', xpos=[ur' (?:Bass|Weapons)', ]) + #5
lema(ur'[Pp]remiaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Rr]adiaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Rr]ebeli_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]sta|[Ee]sa|[Ee]n) ', xpos=[ur'(?:\]|\.org)', ]) + #5
lema(ur'[Rr]eestructuraci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Rr]efundaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Rr]egi_ó_n_o', pre=ur'(?:[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur' d\'Ambovombe', ]) + #5
lema(ur'[Rr]egionalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Rr]egulaci_ó_n_o', xpos=[ur'(?:[\]1])', ]) + #5
lema(ur'[Rr]estricci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Ss]alm_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'áerea ', ur'templo ', ], xpos=[ur' (?:Bay|Leap|Chase)', ur' P\.', ]) + #5
lema(ur'[Ss]ustituci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Tt]racci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Tt]ranscripci_ó_n_o', xpos=[ur'\]\]es', ]) + #5
lema(ur'[Tt]urr_ó_n_o', xpos=[ur' Kofi', ur'\]\]es', ]) + #5
lema(ur'[Vv]iolaci_o_nes_ó') + #5
lema(ur'[g]asc_ó_n_o', xpre=[ur'[Ll]e ', ur'ritme ', ur'Gentilòme ', ur'[Cc]atonet ', ur'[Cc]atonet ritme ', ur'dialecte ', ur'gentilòme ', ], xpos=[ur' du\b', ur'"', ]) + #5
lema(ur'Gab_ó_n_o', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' [Aa]irlines', ]) + #4
lema(ur'[Aa]bolici_ó_n_o', xpre=[ur'pola ', ], xpos=[ur'\]\]es', ]) + #4
lema(ur'[Aa]bsorci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Aa]claraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Aa]dmiraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Aa]dquisici_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Aa]glomeraci_ó_n_o', xpos=[ur' deu', ur'\]\]es', ]) + #4
lema(ur'[Aa]lineaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]alz_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]anonizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]apitulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]occi_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]omprensi_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]onsolidaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]ontenci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]ontradicci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]oproducci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Cc]uraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]ataci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]ecepci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]educci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]eforestaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]eformaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]efunci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]iscriminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Dd]istinci_o_nes_ó') + #4
lema(ur'[Dd]ivulgaci_ó_n_o', xpos=[ur'(?:\]\][a-zñ]+|\.famaf)', ]) + #4
lema(ur'[Ee]dici_o_nes_ó') + #4
lema(ur'[Ee]laboraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ee]lec_ció_n_i[oó]') + #4
lema(ur'[Ee]quitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ee]specificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ee]vangelizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ee]xhibici_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ee]xposici_o_nes_ó') + #4
lema(ur'[Ff]iltraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ff]rancmas_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ff]unci_o_nes_ó') + #4
lema(ur'[Hh]abilitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ii]lustrac__iones_c') + #4
lema(ur'[Ii]mprovisaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ii]mputaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ii]nducci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ii]niciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ii]nstituci_o_nes_ó') + #4
lema(ur'[Ii]nsurrecci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Mm]anipulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Mm]editaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Mm]icrorregi_ó_n(?!\])_o') + #4
lema(ur'[Mm]oci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Mm]otorizaci_ó_n(?!\])_o') + #4
lema(ur'[Nn]ormalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Oo]ca_s_ionando_c') + #4
lema(ur'[Oo]ptimizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Pp]o_sició_n_(?:ci[sc]i[oó]|sisi[oó]n)') + #4
lema(ur'[Pp]ose_sió_n_ci[oó]') + #4
lema(ur'[Pp]ositr_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #4
lema(ur'[Pp]recauci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Pp]revenci_ó_n_o') + #4
lema(ur'[Pp]roclamaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Pp]roducci_o_nes_ó') + #4
lema(ur'[Pp]rovisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #4
lema(ur'[Rr]atificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Rr]emoci_ó_n(?!\])_o') + #4
lema(ur'[Rr]eparaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Rr]eplicaci_ó_n(?!\])_o') + #4
lema(ur'[Rr]epresentaci_o_nes_ó') + #4
lema(ur'[Rr]evisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #4
lema(ur'[Rr]oset_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ss]atisfacci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Ss]edimentaci_ó_n(?!\])_o') + #4
lema(ur'[Ss]upervisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Bb]ajo) ', xpre=[ur'sous ', ], xpos=[ur', Tequivo', ur'\]\]es', ]) + #4
lema(ur'[Tt]ensi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|cierta) ', xpos=[ur' (?:narrative|érotique)', ]) + #4
lema(ur'[Tt]ibur_o_nes_ó') + #4
lema(ur'[Tt]ransfiguraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Tt]raslaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Vv]ibraci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[Vv]ocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #4
lema(ur'[p]ich_ó_n_o', xpos=[ur' quand', ur'\]\]es', ]) + #4
lema(ur'[Aa]bstenci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]bstracci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]ceptaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]ctivaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]gitaci_ó_n(?!\])_o') + #3
lema(ur'[Aa]nimaci_o_nes_ó') + #3
lema(ur'[Aa]parici_o_nes_ó') + #3
lema(ur'[Aa]pelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]portaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]spiraci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Aa]utomoci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]alefacci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]ampe_o_nes_ó') + #3
lema(ur'[Cc]ancelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]añ_o_nes_ó') + #3
lema(ur'[Cc]ertifi_cacio_nes_(?:a[cs]i[oó]|casi[oó]|cació)') + #3
lema(ur'[Cc]imarr_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpre=[ur'[Cc]ondado ', ur'[Mm]unicipio ', ], xpos=[ur' (?:Heritage|Cutoff)', ]) + #3
lema(ur'[Cc]o_mposició_n_(?:npo[cs]i[cs]i[oó]|mpoci[cs]i[oó]|mposisi[oó])') + #3
lema(ur'[Cc]oalici_o_nes_ó') + #3
lema(ur'[Cc]omercializaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]ompensaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]ompilaci_o_nes_ó') + #3
lema(ur'[Cc]onciliaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]ond_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el|[Uu]n|[Cc]ada|[Ss]u) ', xpos=[ur' Clú', ]) + #3
lema(ur'[Cc]ondensaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]onmoci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]onsideraci_ó_n_o') + #3
lema(ur'[Cc]onsideraci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]onversi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur' (?:d|de l\'art|du|des)', ]) + #3
lema(ur'[Cc]onvicci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Cc]oraz_o_nes_ó') + #3
lema(ur'[Cc]reaci_o_nes_ó') + #3
lema(ur'[Dd]esamortizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]eserci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]esolaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]eterminaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]icci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]iferenciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]ilataci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]irecci_o_nes_ó') + #3
lema(ur'[Dd]iscusi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]isoluci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]istracci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Dd]ivisi_o_nes_ó') + #3
lema(ur'[Dd]ominaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ee]mis_io_nes_(?:sió|ió)') + #3
lema(ur'[Ee]misi_o_nes_ó') + #3
...
lema(ur'[Ee]xplo_sió_n_cio') + #3
lema(ur'[Ee]xtorsi_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ff]alsificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ff]ijaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ff]ilmaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ff]inanciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
#lema(ur'[Ff]lor_ó_n(?!\])_o') + #3
lema(ur'[Ff]loraci_ó_n(?!\])_o') + #3
lema(ur'[Ff]undici_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Gg]eolocalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Gg]estaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Gg]lobalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Gg]rabaci_o_nes_ó') + #3
lema(ur'[Hh]ibridaci_ó_n(?!\])_o') + #3
lema(ur'[Ii]nstrumentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ii]nterconexi_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ii]nterrogaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ii]nva_sio_nes_(?:ci[oó]|sió)') + #3
lema(ur'[Ii]nva_sió_nes_ci[oó]') + #3
lema(ur'[Ii]rritaci_ó_n(?!\])_o') + #3
lema(ur'[Jj]urisdicci_o_nes_ó') + #3
lema(ur'[Ll]e_o_nes_ó') + #3
lema(ur'[Mm]ediaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Mm]edicaci_ó_n(?!\])_o') + #3
lema(ur'[Mm]ejill_ó_n(?!\])_o') + #3
lema(ur'[Mm]enci_o_nes_ó') + #3
lema(ur'[Mm]odulaci_ó_n(?!\])_o') + #3
lema(ur'[Mm]orm_ó_n_o', pre=ur'(?:[Ee]l|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'Yu\'', ]) + #3
lema(ur'[Nn]arraci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Nn]egaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Nn]otificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Oo]casi_o_nes_ó') + #3
lema(ur'[Oo]peraci_o_nes_ó') + #3
lema(ur'[Oo]scilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Pp]ercu_sió_n_ci[oó]') + #3
lema(ur'[Pp]erfecci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Pp]ersonificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
...
lema(ur'[Pp]retensi_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Pp]ropulsi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' (?:par |Photonique)', ]) + #3
lema(ur'[Rr]eactivaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Rr]ectificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Rr]epoblaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Rr]euni_o_nes_ó') + #3
lema(ur'[Ss]ecesi_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Ss]ubsecci_ó_n(?!\])_o') + #3
lema(ur'[Ss]uspensi_ó_n(?! d[\'’]armes)_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #3
lema(ur'[Tt]elevisi_o_nes_ó') + #3
lema(ur'[Tt]im_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u) ', xpos=[ur' (?:Screech|David|Menon|of)', ur'\]\]es', ]) + #3
lema(ur'[Tt]ra_smisió_n_nsmicio') + #3
lema(ur'[Tt]áx_ó_n(?!\])_o') + #3
lema(ur'[Vv]aloraci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Vv]isitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[Vv]ocalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #3
lema(ur'[r]ay_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpre=[ur'd\'', ], xpos=[ur' (?:croissant|de trois)', ]) + #3
lema(ur'[t]ac_ó_n_o') + #3
lema(ur'[Aa]bominaci_ó_n(?!\])_o') + #2
lema(ur'[Aa]bsoluci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]celeraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]daptaci_o_nes_ó') + #2
lema(ur'[Aa]daptaci_o_nes_ó') + #2
lema(ur'[Aa]dopci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]lteraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]mbici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]ntelaci_ó_n(?!\])_o') + #2
lema(ur'[Aa]nticipaci_ó_n(?!\])_o') + #2
lema(ur'[Aa]nulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]prehensi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]rgumentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]rticulaci_o_nes_ó') + #2
lema(ur'[Aa]signaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Aa]tol_ó_n(?!\])_o') + #2
lema(ur'[Aa]tracci_o_nes_ó') + #2
lema(ur'[Aa]veriguaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]allej_o_nes_ó') + #2
lema(ur'[Cc]ami_o_nes_ó') + #2
lema(ur'[Cc]ant_ó_n_o', pre=ur'[Aa] ', xpre=[ur'franquicia ', ur'interpretar ', ur'permitió ', ], xpos=[ur'\]\]es']) + #2
lema(ur'[Cc]aptaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]ard_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' Walker', ]) + #2
lema(ur'[Cc]ircuncisi_ó_n_o', xpos=[ur' on\b', ur'\]\]es', ]) + #2
lema(ur'[Cc]ircunnavegaci_ó_n_o', xpos=[ur'\]\](?:es|al|ales)', ]) + #2
lema(ur'[Cc]lonaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]o_mposicio_nes_(?:npo[cs]i[cs]i[oó]|mpoci[cs]i[oó]|mposisi[oó]|mposició)') + #2
lema(ur'[Cc]ol_o_nes_ó') + #2
lema(ur'[Cc]olecci_o_nes_ó') + #2
lema(ur'[Cc]olocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]omisi_o_nes_ó') + #2
lema(ur'[Cc]omplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]on_strucció_n_truccio') + #2
lema(ur'[Cc]ondici_o_nes_ó') + #2
...
lema(ur'[Cc]onmutaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]onsagraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]ontracci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]onvecci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Cc]orrelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]_o_nes_ó') + #2
lema(ur'[Dd]eclaraci_o_nes_ó') + #2
lema(ur'[Dd]egradaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
...
lema(ur'[Dd]esaparici_o_nes_ó') + #2
lema(ur'[Dd]escomposici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]eshidrataci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]esnutrici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]estilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]esviaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]evastaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]evoluci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]isyunci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Dd]iversi_o_nes_ó') + #2
lema(ur'[Dd]iversi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #2
lema(ur'[Ee]_o_nes_ó') + #2
lema(ur'[Ee]moci_o_nes_ó') + #2
lema(ur'[Ee]quivocaci_ó_n(?!\])_o') + #2
lema(ur'[Ee]scisi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ee]speci_alizació_n(?!\]\])_(?:alizacio|lizaci[oó])') + #2
lema(ur'[Ee]specificaci_o_nes_ó') + #2
lema(ur'[Ee]sturi_ó_n(?!\])_o') + #2
lema(ur'[Ee]vacuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ee]vacuaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ee]xcavaci_o_nes_ó') + #2
lema(ur'[Ee]xclusi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #2
lema(ur'[Ee]xcreci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ee]xcursi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #2
lema(ur'[Ee]xpansi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' (?:Opposing|pak)', ]) + #2
lema(ur'[Ee]xportaci_o_nes_ó') + #2
lema(ur'[Ee]xpulsi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ', xpos=[ur' de los Moriscos', ur'\]\]es', ]) + #2
lema(ur'[Ff]acci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ff]ascinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ff]il_ó_n_o', xpre=[ur' du ', ur' i ', ur'Augustin ', ur'L\. ', ur'Larese ', ur'Rick ', ur'Robert ', ur'solenaskitan ', ], xpos=[ur' (?:Kmita|réduit)', ur'\]\]es', ]) + #2
lema(ur'[Ff]iliaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ff]ortificaci_o_nes_ó') + #2
...
lema(ur'[Gg]eneraci_o_nes_ó') + #2
lema(ur'[Gg]uarnici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Hh]umillaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]_o_nes_ó') + #2
lema(ur'[Ii]mplantaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]ndicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nfiltraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nflamaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nformaci_o_nes_ó') + #2
lema(ur'[Ii]ntenci_o_nes_ó') + #2
lema(ur'[Ii]nteracci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nterdicci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nternacionalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nterrupci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]ntuici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nvocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ii]nyecci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ll]imitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ll]iquidaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ll]ocaci_o_nes_ó') + #2
lema(ur'[Ll]ocuci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Mm]aduraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Mm]alformaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Mm]aquetaci_ó_n(?!\])_o') + #2
lema(ur'[Mm]asturbaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Mm]enstruaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Mm]orri_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Nn]aci_o_nes_ó') + #2
lema(ur'[Nn]ivelaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Oo]clusi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Oo]presi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Oo]rnamentaci_ó_n(?!\])_o') + #2
lema(ur'[Pp]abell_o_nes_ó') + #2
lema(ur'[Pp]atr_o_nes_ó') + #2
lema(ur'[Pp]enalizaci_ó_n(?!\])_o') + #2
lema(ur'[Pp]erdici_ó_n_o') + #2
lema(ur'[Pp]erforaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]ersonalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]oci_o_nes_ó') + #2
lema(ur'[Pp]ortaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]osici_o_nes_ó') + #2
lema(ur'[Pp]reposici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]rescripci_ó_n(?!\])_o') + #2
lema(ur'[Pp]reservaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]revisi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]roces_io_nes_(?:si[oó]|ió)') + #2
lema(ur'[Pp]rohibici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]roliferaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]ronunciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Pp]roposici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]aci_ó_n_o', xpos=[ur' kaj', ur'(?:\])', ]) + #2
lema(ur'[Rr]ai_o_nes_ó') + #2
lema(ur'[Rr]eaparici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]ecesi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]eclamaci_ó_n(?!\])_o') + #2
lema(ur'[Rr]eclusi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]ecombinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]ecomendaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]ecordaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]egeneraci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]emisi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]endici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]engl_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]epetici_o_nes_ó') + #2
lema(ur'[Rr]eposici_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]estituci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Rr]evoluci_o_nes_ó') + #2
lema(ur'[Ss]anaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]egregaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]esi_o_nes_ó') + #2
lema(ur'[Ss]ill_ó_n_o', xpre=[ur'\'', ur'& ', ur'(?:du|[Ll]e|et) ', ur'Au ', ur'Claude ', ur'Grand ', ur'Jean ', ur'Mon ', ur'Princesse de ', ur'Victor ', ], xpos=[ur' (?:rhodanien|de Talbert|beach|industriel|de Bretagne|Sambre)', ur'\]\]es', ]) + #2
lema(ur'[Ss]indicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]ubcampe_o_nes_ó') + #2
lema(ur'[Ss]ubdivisi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #2
lema(ur'[Ss]ublevaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]ujeci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]uperaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]upresi_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]uscripci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Ss]ustentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Tt]ap_o_nes_ó') + #2
lema(ur'[Tt]ej_o_nes_ó') + #2
lema(ur'[Tt]ej_ó_n_o', pre=ur'[Ee]l ', xpos=[ur' Ranch', ]) + #2
lema(ur'[Tt]el_ó_n_o', xpre=[ur'Anagyrus ', ur'Ginintuan ', ]) + #2
lema(ur'[Tt]elevi_sió_n_cio') + #2
lema(ur'[Tt]if_o_nes_ó') + #2
lema(ur'[Tt]inci_ó_n(?!\])_o') + #2
lema(ur'[Tt]radici_o_nes_ó') + #2
lema(ur'[Tt]ransacci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Tt]ransformaci_o_nes_ó') + #2
lema(ur'[Tt]ransfusi_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u) ') + #2
lema(ur'[Tt]ranslocaci_ó_n(?!\])_o') + #2
lema(ur'[Tt]ransmisi_o_nes_ó') + #2
lema(ur'[Tt]ransportaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Tt]ransportaci_o_nes_ó') + #2
lema(ur'[Uu]nci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Vv]acaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Vv]ag_o_nes_ó') + #2
lema(ur'[Vv]ariaci_ó_n_o', xpos=[ur'\]\]es', ]) + #2
lema(ur'[Vv]entilaci_ó_n_o', xpre=[ur'Sagunto\'\', con libre', ], xpos=[ur'\]\]es', ]) + #2
lema(ur'[Vv]ibraci_o_nes_ó') + #2
lema(ur'[b]id_ó_n_o', xpre=[ur'Ville ', ur'beau un ', ], xpos=[ur'\]\]es', ]) + #2
lema(ur'[m]at_ó_n_o', xpos=[ur' BB1200', ur'\]\]es', ]) + #2
...
lema(ur'[Aa]lfabetizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]lienaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]locuci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]lucinaci_o_nes_ó') + #1
lema(ur'[Aa]lusi_o_nes_ó') + #1
lema(ur'[Aa]lusi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]mplificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]mputaci_o_nes_ó') + #1
lema(ur'[Aa]nfitri_o_nes_ó') + #1
lema(ur'[Aa]pelaci_o_nes_ó') + #1
lema(ur'[Aa]plicaci_o_nes_ó') + #1
lema(ur'[Aa]preciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Aa]rp_ó_n(?!\])_o') + #1
lema(ur'[Aa]sociaci_o_nes_ó') + #1
lema(ur'[Aa]tol_o_nes_ó') + #1
lema(ur'[Aa]udici_o_nes_ó') + #1
lema(ur'[Aa]utenticaci_ó_n(?!\])_o') + #1
lema(ur'[Aa]utodestrucci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Bb]al_o_nes_ó') + #1
lema(ur'[Bb]arrac_o_nes_ó') + #1
lema(ur'[Bb]arrac_ó_n(?!\])_o') + #1
lema(ur'[Bb]atall_o_nes_ó') + #1
lema(ur'[Bb]ifurcaci_o_nes_ó') + #1
lema(ur'[Bb]onificaci_o_nes_ó') + #1
lema(ur'[Bb]oquer_o_nes_ó') + #1
lema(ur'[Bb]ot_o_nes_ó') + #1
lema(ur'[Bb]uf_o_nes_ó') + #1
lema(ur'[Bb]uz_o_nes_ó') + #1
lema(ur'[Cc]alificaci_o_nes_ó') + #1
lema(ur'[Cc]analizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]aparaz_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]arburaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
...
lema(ur'[Cc]hampiñ_o_nes_ó') + #1
lema(ur'[Cc]intur_o_nes_ó') + #1
lema(ur'[Cc]ircunscripci_o_nes_ó') + #1
lema(ur'[Cc]itaci_ó_n(?!\])_o') + #1
lema(ur'[Cc]oagulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]olaboraci_o_nes_ó') + #1
lema(ur'[Cc]oloraci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]ombinaci_o_nes_ó') + #1
lema(ur'[Cc]ompeti_ció_n_tco') + #1
lema(ur'[Cc]ompetici_o_nes_ó') + #1
lema(ur'[Cc]omplicaci_o_nes_ó') + #1
lema(ur'[Cc]omprobaci_ó_n(?!\])_o') + #1
lema(ur'[Cc]oncatenaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]oncentraci_o_nes_ó') + #1
lema(ur'[Cc]oncesi_o_nes_ó') + #1
lema(ur'[Cc]ondenaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]onjugaci_o_nes_ó') + #1
lema(ur'[Cc]onjunci_o_nes_ó') + #1
lema(ur'[Cc]onjunci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]onnotaci_ó_n(?!\])_o') + #1
lema(ur'[Cc]onsternaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]onstituci_o_nes_ó') + #1
...
lema(ur'[Cc]ontraposici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]ontribuci_o_nes_ó') + #1
lema(ur'[Cc]onvenci_o_nes_ó') + #1
lema(ur'[Cc]onversaci_o_nes_ó') + #1
lema(ur'[Cc]ooperaci_o_nes_ó') + #1
lema(ur'[Cc]ord_ó_n_o', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Cc]orrelaci_o_nes_ó') + #1
lema(ur'[Cc]otizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Cc]ristianizaci_ó_n(?!\])_o') + #1
lema(ur'[Dd]ataci_o_nes_ó') + #1
...
lema(ur'[Dd]epilaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Dd]eposici_o_nes_ó') + #1
lema(ur'[Dd]epreciaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
...
lema(ur'[Dd]estinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Dd]esvinculaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
...
lema(ur'[Dd]isminuci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Dd]isposici_o_nes_ó') + #1
lema(ur'[Dd]isyunci_o_nes_ó') + #1
lema(ur'[Dd]iversificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Dd]otaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Dd]r_o_n(?!\])_ó') + #1
lema(ur'[Dd]rag_o_nes_ó') + #1
lema(ur'[Dd]uplicaci_o_nes_ó') + #1
lema(ur'[Dd]uplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]fusi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]lectr_o_nes_ó') + #1
lema(ur'[Ee]lectr_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Ee]lectrificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]longaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]mancipaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]mis_ió_n_sió') + #1
lema(ur'[Ee]ntonaci_ó_n(?!\])_o') + #1
lema(ur'[Ee]ntronizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]rupci_o_nes_ó') + #1
lema(ur'[Ee]specializaci_ó_n(?!\])_o') + #1
lema(ur'[Ee]speculaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]standarizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]sterilizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]stimulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]stratificaci_ó_n(?!\])_o') + #1
lema(ur'[Ee]vaporaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]vocaci_ó_n(?!\])_o') + #1
lema(ur'[Ee]xacci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xageraci_ó_n(?!\])_o') + #1
lema(ur'[Ee]xcitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xclamaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xcomuni_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xcursi_o_nes_ó') + #1
lema(ur'[Ee]xhibici_o_nes_ó') + #1
lema(ur'[Ee]xpectaci_ó_n(?!\])_o') + #1
lema(ur'[Ee]xpedici_o_nes_ó') + #1
lema(ur'[Ee]xperimentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xplicaci_o_nes_ó') + #1
lema(ur'[Ee]xpresi_o_nes_ó') + #1
lema(ur'[Ee]xtracci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ee]xtradici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]acci_o_nes_ó') + #1
lema(ur'[Ff]aj_ó_n(?!\])_o') + #1
lema(ur'[Ff]ald_ó_n(?!\])_o') + #1
lema(ur'[Ff]ermi_o_nes_ó') + #1
lema(ur'[Ff]ertilizaci_ó_n(?!\])_o') + #1
lema(ur'[Ff]iguraci_ó_n(?!\])_o') + #1
lema(ur'[Ff]iscalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]isi_ó_n_o', xpre=[ur'Celibe ', ], xpos=[ur' boy', ur'\]\]es', ]) + #1
lema(ur'[Ff]lotaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]luctuaci_ó_n(?!\])_o') + #1
lema(ur'[Ff]onaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]orestaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]ormaci_o_nes_ó') + #1
lema(ur'[Ff]ot_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpre=[ur'oficial '], xpos=[ur' Motor']) + #1
lema(ur'[Ff]racci_o_nes_ó') + #1
lema(ur'[Ff]rustraci_o_nes_ó') + #1
lema(ur'[Ff]undaci_o_nes_ó') + #1
lema(ur'[Ff]undamentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ff]usi_o_nes_ó') + #1
lema(ur'[Gg]ale_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Gg]esti_o_nes_ó') + #1
lema(ur'[Gg]ravitaci_ó_n(?!\])_o') + #1
lema(ur'[Gg]uarnici_o_nes_ó') + #1
lema(ur'[Hh]adr_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Hh]alc_o_nes_ó') + #1
lema(ur'[Hh]ur_o_nes_ó') + #1
lema(ur'[Hh]ur_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' (?:University|forman|Band|Potawatomi)', ]) + #1
lema(ur'[Ii]lustraci_o_nes_ó') + #1
lema(ur'[Ii]mplantaci_o_nes_ó') + #1
lema(ur'[Ii]mplicaci_o_nes_ó') + #1
lema(ur'[Ii]mplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]mposici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]mprecisi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]mpresi_o_nes_ó') + #1
lema(ur'[Ii]nacci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]ncrustaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]nervaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]nfecci_o_nes_ó') + #1
lema(ur'[Ii]nflaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]nfracci_o_nes_ó') + #1
lema(ur'[Ii]nhalaci_ó_n(?!\])_o') + #1
lema(ur'[Ii]nhibici_o_nes_ó') + #1
lema(ur'[Ii]nhibici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ii]niciaci_o_nes_ó') + #1
...
lema(ur'[Jj]ap_o_nes_ó') + #1
lema(ur'[Jj]arr_o_nes_ó') + #1
lema(ur'[Jj]onr_o_nes_ó') + #1
lema(ur'[Jj]ubilaci_o_nes_ó') + #1
lema(ur'[Ll]adr_o_nes_ó') + #1
lema(ur'[Ll]amentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ll]ecci_o_nes_ó') + #1
lema(ur'[Ll]ept_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Ll]evitaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ll]iberalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ll]imitaci_o_nes_ó') + #1
lema(ur'[Ll]ist_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el|[Uu]n|[Cc]ada|[Ss]u) ', xpre=[ur'far ', ]) + #1
lema(ur'[Ll]ocalizaci_o_nes_ó') + #1
lema(ur'[Mm]aceraci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]anifestaci_o_nes_ó') + #1
lema(ur'[Mm]anutenci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]arginaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]arr_o_nes_ó') + #1
lema(ur'[Mm]at_o_nes_ó') + #1
lema(ur'[Mm]ecanizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]editaci_o_nes_ó') + #1
lema(ur'[Mm]egat_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ', xpos=[ur' Hit', ]) + #1
lema(ur'[Mm]esorregi_ó_n(?!\])_o') + #1
lema(ur'[Mm]icronaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]ilitarizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]ill_o_nes_ó') + #1
lema(ur'[Mm]isti_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]ovilizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Mm]unici_o_nes_ó') + #1
lema(ur'[Mm]utaci_o_nes_ó') + #1
lema(ur'[Nn]aturalizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Oo]bstrucci_o_nes_ó') + #1
lema(ur'[Oo]bstrucci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Oo]misi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Oo]pini_o_nes_ó') + #1
lema(ur'[Oo]posici_o_nes_ó') + #1
lema(ur'[Oo]raci_o_nes_ó') + #1
lema(ur'[Oo]rientaci_o_nes_ó') + #1
lema(ur'[Oo]rquestaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Oo]stentaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]alpitaci_ó_n(?!\])_o') + #1
lema(ur'[Pp]antal_o_nes_ó') + #1
lema(ur'[Pp]asi_o_nes_ó') + #1
lema(ur'[Pp]eat_ó_n(?!\])_o') + #1
...
lema(ur'[Pp]inz_o_nes_ó') + #1
lema(ur'[Pp]iñ_o_nes_ó') + #1
lema(ur'[Pp]lantaci_o_nes_ó') + #1
lema(ur'[Pp]olarizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]olimerizaci_ó_n(?!\])_o') + #1
lema(ur'[Pp]ose_sio_nes_ci[oó]') + #1
lema(ur'[Pp]redicaci_ó_n_o', xpos=[ur' de la Ley', ur'\]\]es', ]) + #1
lema(ur'[Pp]redicci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]redicci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]reocupaci_o_nes_ó') + #1
lema(ur'[Pp]reparaci_o_nes_ó') + #1
lema(ur'[Pp]reselecci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]resentaci_o_nes_ó') + #1
lema(ur'[Pp]revisualizaci_ó_n(?!\])_o') + #1
lema(ur'[Pp]rofesi_o_nes_ó') + #1
lema(ur'[Pp]roliferaci_o_nes_ó') + #1
lema(ur'[Pp]rolongaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]rospecci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]rovocaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]udrici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Pp]ulg_o_nes_ó') + #1
lema(ur'[Pp]ulsaci_o_nes_ó') + #1
lema(ur'[Pp]unz_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]abi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]adiaci_o_nes_ó') + #1
lema(ur'[Rr]amificaci_o_nes_ó') + #1
...
lema(ur'[Rr]eacci_o_nes_ó') + #1
lema(ur'[Rr]ecapitulaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]ecepci_o_nes_ó') + #1
lema(ur'[Rr]eclamaci_o_nes_ó') + #1
lema(ur'[Rr]econciliaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]econstituci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]ecreaci_o_nes_ó') + #1
lema(ur'[Rr]efacci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]efracci_ó_n(?!\])_o') + #1
lema(ur'[Rr]efrigeraci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]efutaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]egresi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]egularizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]eimpresi_o_nes_ó') + #1
lema(ur'[Rr]eimpresi_ó_n_o', xpre=[ur'5th ', ], xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]eincorporaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]einvenci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]eligi_o_nes_ó') + #1
lema(ur'[Rr]emodelaci_o_nes_ó') + #1
lema(ur'[Rr]epercusi_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]eposici_o_nes_ó') + #1
lema(ur'[Rr]eproducci_o_nes_ó') + #1
lema(ur'[Rr]esoluci_o_nes_ó') + #1
lema(ur'[Rr]estricci_o_nes_ó') + #1
lema(ur'[Rr]etroalimentaci_ó_n(?!\])_o') + #1
lema(ur'[Rr]etrotranspos_ó_n_o', xpos=[ur' superfamily', ur'\]\]es', ]) + #1
lema(ur'[Rr]everberaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Rr]evisi_o_nes_ó') + #1
lema(ur'[Ss]alaz_ó_n(?!\])_o') + #1
lema(ur'[Ss]aturaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]ecci_o_nes_ó') + #1
lema(ur'[Ss]ecreci_ó_n_o', xpos=[ur'(?:\]|\.com)', ]) + #1
lema(ur'[Ss]edici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]emidesintegraci_ó_n(?!\])_o') + #1
lema(ur'[Ss]ensibilizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]eñalizaci_o_nes_ó') + #1
lema(ur'[Ss]if_o_nes_ó') + #1
lema(ur'[Ss]implificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]ocializaci_ó_n(?!\])_o') + #1
lema(ur'[Ss]oluci_o_nes_ó') + #1
lema(ur'[Ss]ubestaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]ubordinaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]ubsecci_o_nes_ó') + #1
lema(ur'[Ss]ubvenci_ó_n(?!\])_o') + #1
lema(ur'[Ss]uperposici_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Ss]uperstici_ó_n(?!\])_o') + #1
lema(ur'[Ss]uplicaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Tt]ax_o_nes_ó') + #1
...
lema(ur'[Tt]eut_ó_n(?!\])_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada) ', xpos=[ur' de Neville']) + #1
lema(ur'[Tt]raducci_o_nes_ó') + #1
lema(ur'[Tt]ransliteraci_ó_n(?!\])_o') + #1
lema(ur'[Tt]ransmigraci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Uu]bicaci_o_nes_ó') + #1
lema(ur'[Uu]rbanizaci_o_nes_ó') + #1
lema(ur'[Vv]acunaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]alidaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]alorizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]ar_ó_n_o', pre=ur'(?:[Ee]l|[Dd]el?|[Uu]n|[Cc]ada|[Ss]u|[Aa]) ') + #1
lema(ur'[Vv]eneraci_ó_n_o', xpre=[ur'Ian ', ur'Jun ', ur'Luis ', ur'Ofilada ', ur'Ynez ', ], xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]erificaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]isi_o_nes_ó') + #1
lema(ur'[Vv]isualizaci_o_nes_ó') + #1
lema(ur'[Vv]isualizaci_ó_n_o', xpos=[ur'\]\]es', ]) + #1
lema(ur'[Vv]otaci_o_nes_ó') + #1
...
lema(ur'[Cc]ie_mpié_s_(?:npi[eé]|mpie)') + #28
lema(ur'[Dd]ebutar_í_a[ns]?_i') + #22
lema(ur'[Pp]erder_í_a[ns]?_i') + #15
lema(ur'[Uu]n_í_r[mts]el[aeo]s?_i') + #13
lema(ur'[Cc]ongre_s_os?_') + #11
lema(ur'[Mm]_é_dicamente_e') + #11
lema(ur'[Pp]eluquer_í_as?_i') + #10
lema(ur'[Qq]uit_á_r[mts]el[aeo]s?_a') + #10
lema(ur'[Cc]omp_i_tiera[ns]?_e') + #9
lema(ur'[Pp]resentar_í_a[ns]?_i') + #9
lema(ur'[Aa]cced_í_a[ns]?_i') + #8
lema(ur'[Aa]s_c_enso(?:[rs]|res)_') + #8
lema(ur'[Pp]rincipalme_n_te_') + #8
lema(ur'[Tt]elev_i_sión_') + #7
lema(ur'[Tt]itular_í_a[ns]?_i') + #7
lema(ur'[Dd]_e_cidió_i') + #6
lema(ur'[Ee]xhib(?:ir|)_í_a[ns]?_i') + #6
lema(ur'[Tt]rabajar_í_a[ns]?_i') + #6
lema(ur'[Cc]u_m_plen_n') + #5
lema(ur'[Cc]ub_r_ir(?:se|)_') + #5
lema(ur'[Dd]ividi_d_[ao]_', pre=ur'(?:[Ee]st[aá]|[Ff]u[eé]|[Ee]s) ') + #5
lema(ur'[Ii]_m_portante_n') + #5
lema(ur'[Ii]mpart(?:ir|)_í_a[ns]?_i') + #5
lema(ur'[Ii]nterpretar_í_a[ns]?_i') + #5
lema(ur'[Rr]epet_í_a[ns]?_i') + #5
lema(ur'[Tt]e_m_porada_n') + #5
lema(ur'[Aa]daptar_í_a[ns]?_i') + #4
lema(ur'[Aa]eron_á_uticas_a') + #4
lema(ur'[Aa]ngiograf_í_as?_i') + #4
lema(ur'[Aa]umentar_í_a[ns]?_i') + #4
lema(ur'[Cc]o_nstrui_d[ao]s?_sntruí') + #4
lema(ur'[Cc]onsens_ú_(?:a[ns]?|e[ns]?)_u') + #4
lema(ur'[Cc]onsumir_á_[ns]?_a') + #4
lema(ur'[Dd]evolv_é_r[mts]el[aeo]s?_e') + #4
lema(ur'[Dd]isf_r_uta[nrs]?_') + #4
lema(ur'[Ee]xpon_í_a[ns]?_i') + #4
lema(ur'[Gg]rabar_í_a[ns]?_i') + #4
lema(ur'[Hh]ac_é_r[mts]el[aeo]s?_e') + #4
lema(ur'[Ii]mpon_í_a[ns]?_i') + #4
lema(ur'[Ii]ndicar_í_a[ns]_i') + #4
lema(ur'[Mm]ejorar_í_a[ns]?_i') + #4
lema(ur'[Mm]ostrar_í_a[ns]?_i') + #4
lema(ur'[Oo]cupar_í_a[ns]?_i') + #4
lema(ur'[Ss]inverg_ü_enzas?_u') + #4
lema(ur'[Tt]ardar_í_a[ns]?_i') + #4
lema(ur'[Tt]elev_i_sión_e') + #4
lema(ur'[Tt]ransitar_í_a[ns]?_i') + #4
lema(ur'_e_quipos?_é') + #4
lema(ur'[M]_ó_naco_o', pre=ur'[Ee]n ') + #3
lema(ur'[Aa]frontar_í_a[ns]?_i') + #3
lema(ur'[Aa]greg_á_r[mts]el[aeo]s?_a') + #3
lema(ur'[Aa]s_c_ensor(?:es|)_') + #3
lema(ur'[Aa]sis__tieron_i') + #3
lema(ur'[Aa]ñad(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Cc]o_m_parte_n') + #3
lema(ur'[Cc]oexist(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Cc]ol_a_boró_o') + #3
lema(ur'[Cc]ompeti_ci_ones_') + #3
lema(ur'[Cc]onectar_í_a[ns]?_i') + #3
lema(ur'[Cc]ons_titui_d[ao]s?_ituí') + #3
lema(ur'[Cc]onsolidar_í_a[ns]?_i') + #3
lema(ur'[Cc]ulminar_í_a[ns]?_i') + #3
lema(ur'[Dd]e__cidió_i') + #3
lema(ur'[Dd]escubi_e_rt[ao]s?_') + #3
lema(ur'[Dd]esempeñar_í_a[ns]?_i') + #3
lema(ur'[Dd]eterminar_í_a[ns]?_i') + #3
lema(ur'[Ee]_s_culturas?_') + #3
lema(ur'[Ee]migrar_í_a[ns]?_i') + #3
lema(ur'[Ee]namorar_í_a[ns]?_i') + #3
lema(ur'[Ee]ncend_í_(?:a[ns]?|)_i') + #3
lema(ur'[Ee]ntrenar_í_a[ns]?_i') + #3
lema(ur'[Ee]st_á dividid_a_a divid') + #3
lema(ur'[Hh]undir_á_[ns]?_a') + #3
lema(ur'[Ii]n_strui_d[ao]s?_truí') + #3
lema(ur'[Ii]ntentar_í_a[ns]?_i') + #3
lema(ur'[Ii]nventar_í_a[ns]?_i') + #3
lema(ur'[Ll]lam_á_r[mts]el[aeo]s?_a') + #3
lema(ur'[Mm]oment_á_ne[ao]_a') + #3
lema(ur'[Mm]ostr_á_r[mts]el[aeo]s?_a') + #3
lema(ur'[Oo]clu_i_d[ao]s?_í') + #3
lema(ur'[Oo]dontopediatr_í_as?_i') + #3
lema(ur'[Oo]ptometr_í_as?_i') + #3
lema(ur'[Pp]erci_b_id[ao]s?_v') + #3
lema(ur'[Pp]olin_ó_mic[ao]_o') + #3
lema(ur'[Pp]roporcionar_í_a[ns]?_i') + #3
lema(ur'[Pp]rotagonizar_í_a[ns]?_i') + #3
lema(ur'[Rr]etransmit(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Rr]ob_á_r[mts]el[aeo]s?_a') + #3
lema(ur'[Tt]ie_m_pos_n') + #3
lema(ur'[Tt]raumat_ó_log[ao]s?_o') + #3
lema(ur'[l]ic_ú_an_u') + #3
lema(ur'[K]atmand_ú__u', pre=ur'(?:[Dd]e|[Ee]n) ') + #2
lema(ur'[Aa]cerc_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Aa]credit_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Aa]cuñar_í_a[ns]?_i') + #2
lema(ur'[Aa]dmi_ni_stración_') + #2
lema(ur'[Aa]gregar_í_a[ns]?_i') + #2
lema(ur'[Aa]lejar_í_a[ns]?_i') + #2
lema(ur'[Aa]lica_í_d[ao]s?_i') + #2
lema(ur'[Aa]trev_í_a[ns]?_i') + #2
lema(ur'[Aa]vanzar_í_a[ns]?_i') + #2
lema(ur'[Cc]elebrar_í_a[ns]?_i') + #2
lema(ur'[Cc]errar_í_a[ns]?_i') + #2
lema(ur'[Cc]lav_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Cc]oloc_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Cc]olocar_í_a[ns]?_i') + #2
lema(ur'[Cc]ompetiti__v[ao]s?_t') + #2
lema(ur'[Cc]oncretar_í_a[ns]?_i') + #2
lema(ur'[Cc]onfund(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Cc]onfundir_á_[ns]?_a') + #2
lema(ur'[Cc]onsiderar_í_a[ns]?_i') + #2
lema(ur'[Cc]onst_itui_d[ao]s?_uí') + #2
...
lema(ur'[Dd]eclar_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Dd]esapare_c_er?_s') + #2
lema(ur'[Dd]escub_ri_dor(?:[ae]s?|)_ir') + #2
lema(ur'[Dd]esignar_í_a[ns]?_i') + #2
lema(ur'[Dd]ividir_í_a[ns]?_i') + #2
lema(ur'[Dd]on_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Ee]_m_parentado_n') + #2
lema(ur'[Ee]fica_z__s') + #2
lema(ur'[Ee]m_blemá_tic[ao]s?_plem[aá]') + #2
lema(ur'[Ee]ncantar_í_a[ns]?_i') + #2
lema(ur'[Ee]scup(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Ff]isiograf_í_a_i') + #2
lema(ur'[Ff]uncionar_í_an_i') + #2
lema(ur'[Gg]enerar_í_a[ns]?_i') + #2
lema(ur'[Hh]ablar_í_a[ns]?_i') + #2
lema(ur'[Ii]_m_prescindible_n') + #2
lema(ur'[Ii]mped_í_r[mts]el[aeo]s?_i') + #2
lema(ur'[Ii]ncrementar_í_a[ns]?_i') + #2
lema(ur'[Ii]ntegrar_í_a[ns]?_i') + #2
lema(ur'[Ii]nterrump(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Jj]er_á_rquic[ao]s?_a') + #2
lema(ur'[Ll]iberar_í_a[ns]?_i') + #2
lema(ur'[Ll]ogar_í_tmic[ao]s?_i') + #2
lema(ur'[Nn]eg_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Pp]artir_á_[ns]_a') + #2
lema(ur'[Pp]ermit_í_r[mts]el[aeo]s?_i') + #2
lema(ur'[Pp]od_ó_log[ao]s?_o') + #2
lema(ur'[Pp]rescribir_á_[ns]?_a') + #2
lema(ur'[Pp]ropon_é_r[mts]el[aeo]s?_e') + #2
lema(ur'[Pp]rostitu_i_d[ao]s?_í') + #2
lema(ur'[Qq]ued_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Rr]eci_b_iendo_v') + #2
lema(ur'[Rr]econstitu_i_d[ao]s?_í') + #2
lema(ur'[Rr]edise_ñ_ad[ao]s?_n') + #2
lema(ur'[Rr]egistrar_í_a[ns]?_i') + #2
lema(ur'[Rr]egrabar_í_a[ns]?_i') + #2
lema(ur'[Rr]egres_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Rr]emontar_í_a[ns]?_i') + #2
lema(ur'[Rr]enovar_í_a[ns]?_i') + #2
lema(ur'[Rr]esum(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Ss]ellar_í_a[ns]_i') + #1
lema(ur'[Ss]emiderru_i_d[ao]s?_í') + #2
lema(ur'[Ss]olventar_í_a[ns]?_i') + #2
lema(ur'[Ss]ubsist(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Ss]uperar_í_a[ns]?_i') + #2
lema(ur'[Tt]e_m_poradas_n') + #2
lema(ur'[Tt]ro_m_peta_n') + #2
lema(ur'[Uu]bicar_í_a[ns]?_i') + #2
lema(ur'[Vv]iajar_í_a[ns]?_i') + #2
lema(ur'_C_ercan[ao]s?_S') + #2
lema(ur'[a]lbergar_í_a[ns]?_i') + #2
lema(ur'[t]en_ido__dio', pre=ur'[Hh]a(?:n?|bían?|ber) ') + #2
lema(ur'[C]amer_ú_n_u', pre=ur'(?:[Ee]n) ') + #1
lema(ur'[Aa]_m_parar_n') + #1
lema(ur'[Aa]cab_a_rá_') + #1
lema(ur'[Aa]clar_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]consejar_í_a[ns]?_i') + #1
lema(ur'[Aa]copl_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]dministrar_í_a[ns]?_i') + #1
lema(ur'[Aa]gitar_í_a[ns]?_i') + #1
lema(ur'[Aa]gradec_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Aa]griar_í_a[ns]?_i') + #1
lema(ur'[Aa]grupar_í_a[ns]?_i') + #1
lema(ur'[Aa]lertar_í_a[ns]?_i') + #1
lema(ur'[Aa]liar_s_e_z') + #1
lema(ur'[Aa]mbientar_í_a[ns]?_i') + #1
lema(ur'[Aa]ntepen_ú_ltim[ao]s?_u') + #1
lema(ur'[Aa]pare_z_ca[ns]?_s') + #1
lema(ur'[Aa]parec_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Aa]plic_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]poderar_í_a[ns]?_i') + #1
lema(ur'[Aa]portar_í_a[ns]?_i') + #1
lema(ur'[Aa]prehend_í_a[ns]?_i') + #1
lema(ur'[Aa]rrebat_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]rregl_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]rremet_í_a[ns]?_i') + #1
lema(ur'[Aa]rruinar_í_a[ns]?_i') + #1
lema(ur'[Aa]segur_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Aa]segurar_í_a[ns]?_i') + #1
lema(ur'[Aa]t_ribui_d[ao]s?_tribuí') + #1
lema(ur'[Aa]tacar_í_a[ns]?_i') + #1
lema(ur'[Aa]tar_í_an_i') + #1
lema(ur'[Aa]udicionar_í_a[ns]?_i') + #1
lema(ur'[Aa]ñad_í_r[mts]el[aeo]s?_i') + #1
lema(ur'[Bb]al_ompié__ónpie') + #1
lema(ur'[Bb]ibliograf_í_as_i') + #1
lema(ur'[Bb]urlar_í_a[ns]?_i') + #1
lema(ur'[Cc]_áno_nes_anó') + #1
lema(ur'[Cc]a_m_panas?_n') + #1
lema(ur'[Cc]a_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Cc]almar_í_a[ns]_i') + #1
lema(ur'[Cc]atapultar_í_a[ns]?_i') + #1
lema(ur'[Cc]err_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Cc]hurrasquer_í_as?_i') + #1
lema(ur'[Cc]ircular_í_a[ns]?_i') + #1
lema(ur'[Cc]o_m_patriotas_n') + #1
lema(ur'[Cc]o_m_pañía_n') + #1
lema(ur'[Cc]o_m_pendio_n') + #1
lema(ur'[Cc]o_m_pensada_n') + #1
lema(ur'[Cc]o_m_plejo_n') + #1
lema(ur'[Cc]o_m_positor_n') + #1
lema(ur'[Cc]o_m_puertas_n') + #1
lema(ur'[Cc]o_m_puesta_n') + #1
lema(ur'[Cc]ol_a_borador_o') + #1
lema(ur'[Cc]olaborar_í_a[ns]?_i') + #1
lema(ur'[Cc]om__pañeros_n') + #1
lema(ur'[Cc]ombatir_á_[ns]?_a') + #1
lema(ur'[Cc]oment_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Cc]omp_itió__etio') + #1
lema(ur'[Cc]ompar_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Cc]ompeti_ci_ón_') + #1
lema(ur'[Cc]ompeticio_ne_s_en') + #1
lema(ur'[Cc]ompromet_í_a[ns]?_i') + #1
lema(ur'[Cc]onceb_í_a[ns]?_i') + #1
lema(ur'[Cc]onced_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Cc]onfes_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Cc]onfirmar_í_a[ns]?_i') + #1
lema(ur'[Cc]onoci_éndos_e_endoc') + #1
lema(ur'[Cc]onservar_í_a[ns]?_i') + #1
lema(ur'[Cc]onst_itui_d[ao]s?_rituí') + #1
lema(ur'[Cc]ontactar_í_a[ns]?_i') + #1
lema(ur'[Cc]onte_m_poráneo_n') + #1
lema(ur'[Cc]ontemplar_í_a[ns]?_i') + #1
lema(ur'[Cc]ontestar_í_a[ns]?_i') + #1
lema(ur'[Cc]onvi_r_tieron_') + #1
lema(ur'[Cc]onvi_rtió__tio') + #1
lema(ur'[Cc]onvivir_á_[ns]?_a') + #1
lema(ur'[Cc]ooperar_í_a[ns]?_i') + #1
lema(ur'[Cc]oquetear_í_a[ns]?_i') + #1
lema(ur'[Cc]ortar_í_a[ns]?_i') + #1
lema(ur'[Cc]ua_d_rad[ao]s?_') + #1
lema(ur'[Cc]ubi_e_rt[ao]s?_') + #1
lema(ur'[Cc]ultivar_í_a[ns]?_i') + #1
...
lema(ur'[Dd]edic_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Dd]egenerar_í_a[ns]_i') + #1
lema(ur'[Dd]ej_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Dd]emostr_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Dd]emostrar_í_a[ns]?_i') + #1
lema(ur'[Dd]enominar_í_a[ns]?_i') + #1
lema(ur'[Dd]errumbar_í_a[ns]?_i') + #1
lema(ur'[Dd]esaperci_b_id[ao]s?_v') + #1
lema(ur'[Dd]esarrollar_í_a[ns]?_i') + #1
lema(ur'[Dd]escansar_í_a[ns]?_i') + #1
lema(ur'[Dd]escub_ri_eron_ir') + #1
lema(ur'[Dd]escub_ri_r_ir') + #1
lema(ur'[Dd]esinter_é_s_e') + #1
lema(ur'[Dd]eslumbrar_í_a[ns]?_i') + #1
lema(ur'[Dd]estapar_í_a[ns]?_i') + #1
...
lema(ur'[Dd]ifund(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Dd]ilatar_í_a[ns]?_i') + #1
lema(ur'[Dd]ilu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Dd]isfrutar_í_a[ns]?_i') + #1
...
lema(ur'[Ee]conom_é_tric(?:as|os?)_e') + #1
lema(ur'[Ee]fectuar_í_a[ns]?_i') + #1
lema(ur'[Ee]fica_c_es_s') + #1
lema(ur'[Ee]jecutar_í_a[ns]?_i') + #1
lema(ur'[Ee]liminar_í_a[ns]?_i') + #1
lema(ur'[Ee]lud(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ee]mbest_í_a[ns]?_i') + #1
lema(ur'[Ee]mparejar_í_a[ns]?_i') + #1
lema(ur'[Ee]mpe_zarí_a[ns]?_sari') + #1
lema(ur'[Ee]ncaminar_í_a[ns]?_i') + #1
lema(ur'[Ee]ncender_á_[ns]?_a') + #1
lema(ur'[Ee]nfurecer_á_[ns]?_a') + #1
lema(ur'[Ee]nlistar_í_a[ns]?_i') + #1
lema(ur'[Ee]nojar_í_a[ns]?_i') + #1
lema(ur'[Ee]nseñ_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ee]nv_iá_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_ía') + #1
lema(ur'[Ee]nvi_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ee]scap_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ee]specular_í_a[ns]?_i') + #1
lema(ur'[Ee]sperar_í_a[ns]?_i') + #1
lema(ur'[Ee]studiar_í_a[ns]?_i') + #1
lema(ur'[Ee]timol_ó_gic(?:[ao]s|amente)_o') + #1
lema(ur'[Ee]vitar_í_a[ns]?_i') + #1
...
lema(ur'[Ee]xig_í_r[mts]el[aeo]s?_i') + #1
lema(ur'[Ee]xim_í_as?_i', pre=ur'(?:[Ll]o|[Qq]ue|[Dd]onde) ') + #1
lema(ur'[Ee]xplorar_í_a[ns]?_i') + #1
lema(ur'[Ee]xtra_ñ_(?:[ao]s|amente)_n') + #1
lema(ur'[Ff]ijar_í_a[ns]?_i') + #1
lema(ur'[Ff]lu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Ff]renar_í_a[ns]?_i') + #1
lema(ur'[Ff]und(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ff]usionar_í_a[ns]?_i') + #1
lema(ur'[Gg]an_á_r[mts]el[aeo]s?_a') + #1
...
lema(ur'[Ii]_m_pacto_n') + #1
lema(ur'[Ii]_m_plantación_n') + #1
lema(ur'[Ii]_m_plica_n') + #1
lema(ur'[Ii]_m_popularidad_n') + #1
lema(ur'[Ii]_m_previsto_n') + #1
lema(ur'[Ii]_m_prácticos_n') + #1
lema(ur'[Ii]_m_pulsa_n') + #1
lema(ur'[Ii]_m_pulsaba_n') + #1
lema(ur'[Ii]_m_pulsó_n') + #1
lema(ur'[Ii]_m_punemente_n') + #1
lema(ur'[Ii]_nclui_d[ao]s?_cluí') + #1
lema(ur'[Ii]_ns_pirado_sn') + #1
lema(ur'[Ii]gualar_í_a[ns]?_i') + #1
lema(ur'[Ii]mprimir_á_[ns]?_a') + #1
lema(ur'[Ii]n_c_identes?_s') + #1
lema(ur'[Ii]n_s_pector_') + #1
lema(ur'[Ii]ncendiar_í_an_i') + #1
lema(ur'[Ii]nclu_i_rl[aeo]s?_í') + #1
lema(ur'[Ii]nclu_irá_[ns]?_íra') + #1
lema(ur'[Ii]nclu_irí_a[ns]?_íri') + #1
lema(ur'[Ii]ncorporar_í_a[ns]?_i') + #1
lema(ur'[Ii]ncumpl(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ii]ncur_s_i(?:onar|ón|ones|on[oó]|ona[ns]?)_c') + #1
lema(ur'[Ii]nflu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Ii]ngeni_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ii]nhib(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ii]nsinu_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ii]nstalar_í_a[ns]?_i') + #1
lema(ur'[Ii]nstitu_i_r(?:l[aeo]s?|se|)_í') + #1
...
lema(ur'[Jj]ug_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Jj]untar_í_a[ns]?_i') + #1
lema(ur'[Jj]ustificar_í_a[ns]?_i') + #1
lema(ur'[Ll]am_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_bie') + #1
lema(ur'[Ll]anz_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Ll]avar_í_a[ns]?_i') + #1
lema(ur'[Ll]e_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Ll]evantar_í_a[ns]?_i') + #1
lema(ur'[Ll]evar_í_a[ns]?_i') + #1
lema(ur'[Ll]i_m_piamente_n') + #1
lema(ur'[Ll]lenar_í_a[ns]?_i') + #1
lema(ur'[Mm]a_m_posteados_n') + #1
lema(ur'[Mm]and_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Mm]anejar_í_a[ns]?_i') + #1
lema(ur'[Mm]anten_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Mm]arisquer_í_as?_i') + #1
lema(ur'[Mm]et_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Mm]ezclar_í_a[ns]?_i') + #1
...
lema(ur'[Oo]bstru_i_r(?:l[aeo]s?|se|)_í') + #1
...
lema(ur'[Pp]ens_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Pp]ercan_c_es?_s') + #1
lema(ur'[Pp]ermit_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_íe') + #1
lema(ur'[Pp]ersist(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Pp]erten_ecerí_a_ceri') + #1
lema(ur'[Pp]etrograf_í_as?_i') + #1
lema(ur'[Pp]itar_í_a[ns]?_i') + #1
lema(ur'[Pp]lanear_í_a[ns]?_i') + #1
lema(ur'[Pp]oni_en_do_ne') + #1
lema(ur'[Pp]orquer_í_as?_i') + #1
lema(ur'[Pp]osi__ción_si') + #1
lema(ur'[Pp]osi_c_ionado_s') + #1
lema(ur'[Pp]osi_c_iones_s') + #1
lema(ur'[Pp]osi_c_ionó_s') + #1
lema(ur'[Pp]osi_ci_ón_sic') + #1
lema(ur'[Pp]reced_í_a[ns]?_i') + #1
lema(ur'[Pp]refi__riendo_e') + #1
lema(ur'[Pp]rend_í_a[ns]?_i') + #1
lema(ur'[Pp]reparar_í_a[ns]?_i') + #1
lema(ur'[Pp]resupon_í_a[ns]?_i') + #1
lema(ur'[Pp]rivar_í_a[ns]?_i') + #1
lema(ur'[Pp]ro_v_ocando_b') + #1
lema(ur'[Pp]ro_v_ocar_b') + #1
lema(ur'[Pp]roclamar_í_a[ns]?_i') + #1
lema(ur'[Pp]rogramar_í_a[ns]?_i') + #1
lema(ur'[Pp]romet_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_íe') + #1
lema(ur'[Pp]romocionar_í_a[ns]?_i') + #1
lema(ur'[Pp]rosperar_í_a[ns]?_i') + #1
lema(ur'[Pp]royectar_í_a[ns]?_i') + #1
lema(ur'[Qq]uin_c_e(?:nal|nalmente)_[sz]') + #1
...
lema(ur'[Rr]escind(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Rr]espaldar_í_a[ns]?_i') + #1
lema(ur'[Rr]esucitar_í_a[ns]?_i') + #1
lema(ur'[Rr]etir_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Rr]etomar_í_a[ns]?_i') + #1
lema(ur'[Rr]etornar_í_a[ns]?_i') + #1
...
lema(ur'[Ss]ecu_e_ncial(?:es|)_a') + #1
lema(ur'[Ss]eleccionar_í_a[ns]?_i') + #1
...
lema(ur'[Ss]ubdivid(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ss]ubir_á_[ns]_a') + #1
lema(ur'[Ss]ubordinar_í_a[ns]?_i') + #1
lema(ur'[Ss]ubstitu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Ss]ubstra_í_(?:a[ns]?|d[ao]s?)_i') + #1
lema(ur'[Ss]ucumb(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ss]urt(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Tt]a_m_poco_n') + #1
lema(ur'[Tt]apar_í_a[ns]?_i') + #1
lema(ur'[Tt]e_m_plo_n') + #1
lema(ur'[Tt]e_m_poral_n') + #1
lema(ur'[Tt]ej_í_a[ns]?_i') + #1
...
lema(ur'[Tt]iem__po_n') + #1
lema(ur'[Tt]ocar_í_an_i') + #1
lema(ur'[Tt]olerar_í_a[ns]?_i') + #1
lema(ur'[Tt]om_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Tt]ra_ns_parente_sn') + #1
lema(ur'[Tt]ra_ns_portaba_sn') + #1
lema(ur'[Tt]ra_ns_portado_sn') + #1
lema(ur'[Tt]ra_ns_portes_sn') + #1
lema(ur'[Tt]ran_s_parencia_') + #1
lema(ur'[Tt]ran_s_portador_') + #1
lema(ur'[Tt]ran_s_portarse_') + #1
lema(ur'[Tt]ranscender_á_[ns]?_a') + #1
lema(ur'[Tt]ranscrib(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Tt]ranscurrir_á_[ns]?_a') + #1
lema(ur'[Tt]rasladar_í_a[ns]?_i') + #1
lema(ur'[Tt]ratar_í_a[ns]?_i') + #1
lema(ur'[Uu]n_ _papel_') + #1
lema(ur'[Uu]n_ _periodista_') + #1
lema(ur'[Vv]engar_í_a[ns]?_i') + #1
lema(ur'[Vv]ig_ésimo sé_ptima_esimose') + #1
lema(ur'[Vv]olar_í_a[ns]?_i') + #1
lema(ur'[Vv]olvi_éndos_e_endoc') + #1
lema(ur'[Vv]olvi_éndos_e_endoc') + #1
lema(ur'[ee]_m_pacad[ao]s?_n') + #1
lema(ur'_marzo__[Mm]arço', pre=ur'acessado em [0-9]+ de ') + #1
lema(ur'[a]rd_í_an_i') + #1
lema(ur'[b]ajar_í_a[ns]?_i') + #1
...
lema(ur'\b(?:[1-9]|[012][0-9]|3[01])_ de_ (?:[Ee]nero|[Ff]ebrero|[Mm]arzo|[Aa]bril|[Mm]ayo|[Jj]unio|[Jj]ulio|[Aa]gosto|[Ss]eptiembre|[Oo]ctubre|[Nn]oviembre|[Dd]iciembre)_') + #7048
lema(ur'_ de _[12][0-9]{3}_', pre=ur'(?:[Ee]nero|[Ff]ebrero|[Mm]arzo|[Aa]bril|[Mm]ayo|[Jj]unio|[Jj]ulio|[Aa]gosto|[Ss]eptiembre|[Oo]ctubre|[Nn]oviembre|[Dd]iciembre)') + 
lema(ur'(?:[Aa]erot|[Cc]rono|[Hh]eli|[Tt]elet|[Tt])ran_s_port(?:a(?:[ns]?|ba[ns]?|bles?|ción|d[ao]s?|dor(?:es|)|ndo|r(?:se|ía[ns]?|))|e[ns]?|istas?)_') + #12
lema(ur'(?:[Cc]on|[Ss](?:ub|))igu_i_entes?_') + #45
lema(ur'(?:[Pp]|[Cc]op)rop__iedad(?:es|)_r') + #24
lema(ur'(?:[Ss]emid|[Ss]ubd|[Hh]iperd|[Dd])esa_rroll_(?:ó|os?|a[nrs]?|ad[ao]s?|ando|ador|adora|adores|arse|aron|ar[ií]a[ns]?|aba[ns]?)_(?:roll|rr?oy|rrol)') + #164
lema(ur'Ad_í_s Abeba_i') + #22
lema(ur'Arbel_á_ez_a') + #94
lema(ur'Azerbaiy_á_n_a') + #42
lema(ur'Berm_ú_dez_u') + #448
lema(ur'C_ú_cuta_u') + #153
lema(ur'Car_ú_pano_u') + #15
lema(ur'D_í_as_i', pre=ur'(?:[uúUÚ]ltimos|Mil|Nueve|Nuestros|Trece|Buenos) ') + #31
lema(ur'E_n_ (?:el|la|los|las)_N') + #15
lema(ur'Emiratos _Á_rabes Unidos_A') + #51
lema(ur'Benalc_á_zar_a') + 
lema(ur'Kirguist_á_n_a') + #28
lema(ur'Logroñ_é_s_e') + #27
lema(ur'Mosc_ú__u') + #77
lema(ur'Pap_ú_a_u', pre=ur'(?:[Dd]e|[Ee]n) ') + #13
lema(ur'Paraguan_á__a') + #14
lema(ur'R_ó_terdam_o', pre=ur'(?:[Dd]e|[Ee]n) ') + #5
lema(ur'Rep_ú_blica Dominicana_u') + #203
lema(ur'Sajcabaj_á__a') + #0
lema(ur'Se_ú_l_u', pre=ur'(?:[Dd]e|[Ee]n) ') + #19
lema(ur'Sud_á_n\]\]_a', pre=ur'\[\[') + #0
lema(ur'T_á_riba_a') + #0
lema(ur'T_ú_nez_u') + #78
lema(ur'Taf_í_ del Valle_i') + #2
lema(ur'Teher_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ') + #6
lema(ur'Vig_í_a_i', pre=ur'El ') + #20
lema(ur'[12][0-9]{3} _en cine__au cinéma', pre=ur'\[') + #680
lema(ur'[Aa]_ _cabo_', pre=ur'[Ll]lev(?:[oó]|aron|a[ns]?) ') + #42
lema(ur'[Aa]_ _gusto_', pre=ur'(?:[Ee]st[aá]|estaba|sintió|muy|m[aá]s) ') + #0
lema(ur'[Aa]_ _menudo_') + #7
lema(ur'[Aa]_ _partir_') + #47
lema(ur'[Aa]_ _punto_', pre=ur'[Ee]st(?:a(?:[ns]|ba[ns]?|)|uvo)') + #0
lema(ur'[Aa]_m_paro_n') + #1
lema(ur'[Aa]_s_cendencias?_') + #0
lema(ur'[Aa]_ñ_os (?:antes|después)_n') + #9
lema(ur'[Aa]bandonar_í_a[ns]?_i') + #1
lema(ur'[Aa]barcar_í_a[ns]?_i') + #0
lema(ur'[Aa]br(?:ir|)_í_a[ns]?_i') + #4
lema(ur'[Aa]br_í_a[ns]?_i') + #4
lema(ur'[Aa]brir_á_[ns]?_a') + #5
lema(ur'[Aa]bsor_b_(e[rns]?|id[ao]s?)_v') + #35
lema(ur'[Aa]bsorb_í_a[ns]?_i') + #0
lema(ur'[Aa]bstra_í_(?:a[ns]?|d[ao]s?)_i') + #0
lema(ur'[Aa]c__ompañará_c') + #0
lema(ur'[Aa]cad_é_mic(?:as|amente)_e') + #7
lema(ur'[Aa]cceder_á_[ns]?_a') + #3
lema(ur'[Aa]celerar_í_a[ns]?_i') + #0
lema(ur'[Aa]cent_ú_(?:a[ns]?|e[ns]?)_u') + #2
lema(ur'[Aa]ceptar_í_a[ns]?_i') + #0
lema(ur'[Aa]cercar_s_e(?:lo|)_c') + #1
lema(ur'[Aa]cetaldeh_í_d[ao]s?_i') + #9
lema(ur'[Aa]co_g_(?:id[ao]s?|iera[ns]|erá?)_j') + #9
lema(ur'[Aa]coger_á_[ns]?_a') + #2
lema(ur'[Aa]compa_ñ_antes?_n') + #1
lema(ur'[Aa]compañar_í_a[ns]?_i') + #1
lema(ur'[Aa]cr_ó_nimos?_o') + #10
lema(ur'[Aa]credit_á_(?:ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)|rsel[aeo]s?)_a') + #2
lema(ur'[Aa]ct_ú_(?:a[ns]|e[ns]?)_u') + #30
lema(ur'[Aa]cud(?:ir|)_í_a[ns]?_i') + #9
lema(ur'[Aa]cudir_á_[ns]?_a') + #0
lema(ur'[Aa]cusar_í_a[ns]?_i') + #0
lema(ur'[Aa]dmit(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Aa]dmit_í__i') + #2
lema(ur'[Aa]dmitir_á_[ns]?_a') + #0
lema(ur'[Aa]dole_sc_entes?_[sc]') + #18
lema(ur'[Aa]doptar_í_a[ns]?_i') + #1
lema(ur'[Aa]dquir_ió__(?:io|[oó])') + #25
lema(ur'[Aa]dquir_í_a[ns]?_i') + #0
lema(ur'[Aa]dquirir_á_[ns]?_a') + #3
lema(ur'[Aa]dvers_a_rios?_á') + #11
lema(ur'[Aa]dvi__rti(?:endo|eron|éndole|éndoles|éndose|ó)_e') + #5
lema(ur'[Aa]er__opuertos?_e') + #3
lema(ur'[Aa]er_ó_bic[ao]s?_o') + #5
lema(ur'[Aa]erol_í_neas?_i') + #160
lema(ur'[Aa]fectar_í_a[ns]?_i') + #1
lema(ur'[Aa]g_o_sto_u', pre=ur'(?:[Dd]e|[0-9]+\.?) ') + #18
lema(ur'[Aa]gr_ó_nom[ao]s?_o') + #24
lema(ur'[Aa]gradar_í_a[ns]?_i') + #1
lema(ur'[Aa]gradecim_i_entos?_') + #1
lema(ur'[Aa]jonjol_í__i') + #5
lema(ur'[Aa]justad_í_sim[ao]s?_i') + #1
lema(ur'[Aa]l_ _menos_') + #3
lema(ur'[Aa]l_í_an?_i', pre=ur'[Ss]e ') + #14
lema(ur'[Aa]lcan_c_e[ns]?_z') + #8
lema(ur'[Aa]lcanzar_í_a[ns]?_i') + #1
lema(ur'[Aa]ldeh_í_d[ao]s?_i') + #26
lema(ur'[Aa]leg_ó_ric[ao]s?_o') + #5
lema(ur'[Aa]lfarer_í_as?_i') + #10
lema(ur'[Aa]lgor_í_tmicas?_i') + #3
lema(ur'[Aa]lgori_t_mos?_') + #4
lema(ur'[Aa]lien_í_genas?_i') + #87
lema(ur'[Aa]lm_í_bar(?:es|)_i') + #6
lema(ur'[Aa]lt_í_sim[ao]s?_i') + #2
lema(ur'[Aa]m_é_rica (?:del [Nn]orte|del [Ss]ur|[Cc]entral|[Hh]ispana|[Aa]nglosajona|de Cali)_e') + #121
lema(ur'[Aa]maz_ó_nic(?:as|os?)_o') + #19
lema(ur'[Aa]maz_ó_nica_o', pre=ur'(?:apariencia|especie|[Ss]elva|tribu|Lengua|medicinal|Cuenca|Guayaba|[Rr]egi[oó]n|cultural|dulce..|Colombia..| y) ') + #4
lema(ur'[Aa]mpl_í_sim[ao]s?_i') + #1
lema(ur'[Aa]n_áli_sis_alí') + #9
lema(ur'[Aa]n_ó_nim(?:[ao]s|amente)_o') + #14
lema(ur'[Aa]n_ó_nim[ao]_o', pre=ur'(?:[Ss]ociedad|[Mm]ensaje) ') + #17
lema(ur'[Aa]nal_ó_gic[ao]s?_o') + #19
lema(ur'[Aa]nexar_í_a[ns]?_i') + #0
lema(ur'[Aa]nexion_á_r[mts]el[aeo]s?_a') + #0
lema(ur'[Aa]notar_í_a[ns]?_i') + #6
lema(ur'[Aa]ntag_ó_nic[ao]s?_o') + #22
lema(ur'[Aa]ntagon_i_stas?_í') + #3
lema(ur'[Aa]nti_i_nflamatori[ao]s?_') + #21
lema(ur'[Aa]ntinarc_ó_ticos?_o') + #1
lema(ur'[Aa]ntiqu_í_sim[ao]s?_i') + #2
lema(ur'[Aa]ntropom_ó_rfic[ao]s?_o') + #9
lema(ur'[Aa]p_are_c(?:e(?:[ns]?|r(?:a[ns]?|[áé]|ía[ns]?|))|ieron)_(?:ara|re)') + #29
lema(ur'[Aa]p_é_ndices?_e') + #22
lema(ur'[Aa]p_í_col[ao]s?_i') + #7
lema(ur'[Aa]p_ó_stol (?:San|Andr[eé]s|Juan|Jaime|Pedro|Pablo|Santiago|Mateo|Mat[ií]as|Tom[aá]s|Bartolom[eé])_o') + #21
lema(ur'[Aa]p_ó_stol_o', pre=ur'(?:Andr[eé]s|Juan|Jaime|Pedro|Pablo|Santiago|Mateo|Mat[ií]as|Tom[aá]s|Bartolom[eé]) ') + #154
lema(ur'[Aa]pagar_í_a[ns]?_i') + #0
lema(ur'[Aa]parec_í_a[ns]?_i') + #24
lema(ur'[Aa]parecer_á_[ns]?_a') + #12
lema(ur'[Aa]parecer_í_a[ns]?_i') + #9
lema(ur'[Aa]pocal_i_psis_í') + #17
lema(ur'[Aa]poderar_s_e(?:lo|)_c') + #0
lema(ur'[Aa]poyar_í_a[ns]?_i') + #0
lema(ur'[Aa]prend_í_a[ns]?_i') + #2
lema(ur'[Aa]prender_á_[ns]?_a') + #1
lema(ur'[Aa]pro_b_ad[ao]s?_v') + #36
lema(ur'[Aa]provechar_í_a[ns]?_i') + #0
lema(ur'[Aa]rist_ó_cratas?_o') + #15
lema(ur'[Aa]rque_ó_log[ao]s?_o') + #31
lema(ur'[Aa]rqueol_ó_gic[ao]s?_o') + #126
lema(ur'[Aa]rquer_í_as?_i') + #11
lema(ur'[Aa]rras_ó_ (?:en|con)_o') + #14
lema(ur'[Aa]rt_í_sticamente_i') + #34
lema(ur'[Aa]rtific_i_al(?:es|)_') + #59
lema(ur'[Aa]rtiller_í_as?_i') + #65
lema(ur'[Aa]sar_í_as?_i') + #1
lema(ur'[Aa]sc_ó_rbic[ao]s?_o') + #2
lema(ur'[Aa]scend_í_(?:a[ns]?)_i') + #5
lema(ur'[Aa]scender_á_[ns]?_a') + #0
lema(ur'[Aa]sesinar_í_a[ns]?_i') + #1
lema(ur'[Aa]sis__tió_i') + #8
lema(ur'[Aa]sist(?:ir|)_í_a[ns]?_i') + #13
lema(ur'[Aa]sistir_á_[ns]?_a') + #0
lema(ur'[Aa]sociar_í_a[ns]?_i') + #1
lema(ur'[Aa]sum(?:ir|)_í_a[ns]?_i') + #5
lema(ur'[Aa]sumir_á_[ns]?_a') + #1
lema(ur'[Aa]ten_ú_(?:a[ns]?|e[ns]?)_u') + #4
lema(ur'[Aa]tend_í_(?:a[ns]?|)_i') + #3
lema(ur'[Aa]tender_á_[ns]?_a') + #1
lema(ur'[Aa]terrar_í_a[ns]?_i') + #1
lema(ur'[Aa]tl_é_tic(?:[ao]s|amente)_e') + #6
lema(ur'[Aa]tra_í_d[ao]s?_i') + #24
lema(ur'[Aa]trap_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #1
lema(ur'[Aa]tribu_i_d[ao]s?_í') + #65
lema(ur'[Aa]tribu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Aa]tribu_í_r[mts]el[aeo]s?_i') + #2
lema(ur'[Aa]u_té_ntic[ao]s?_nte') + #1
lema(ur'[Aa]ut_ó_dromos_o') + #0
lema(ur'[Aa]uto_o_xida(?:ción|ciones|ntes?)_') + #0
lema(ur'[Aa]utob_u_ses_ú') + #2
lema(ur'[Aa]utom_á_tic(?:[ao]s|amente)_a') + #33
lema(ur'[Aa]van_z_(?:ando|ad[ao]s?|[aoó])_s') + #3
lema(ur'[Aa]verg_ü_enza[ns]?_u') + #2
lema(ur'[Aa]yudar_í_a[ns]?_i') + #3
lema(ur'[Aa]ñad_í__i') + #0
lema(ur'[Aa]ñadir_á_[ns]?_a') + #1
lema(ur'[Bb]_ri_tánic[ao]s?_ir') + #0
lema(ur'[Bb]_á_ltic[ao]s_a') + #2
lema(ur'[Bb]_á_ltico(?! S\.)_a') + #4
lema(ur'[Bb]_á_sic(?:as|os?|amente)_a') + #75
lema(ur'[Bb]_ú_squedas?_u') + #147
lema(ur'[Bb]acteriolog_í_as?_i') + #1
lema(ur'[Bb]ailar_í_a[ns]?_i') + #2
lema(ur'[Bb]aj_í_sim[ao]s?_i') + #2
lema(ur'[Bb]astar_í_a[ns]?_i') + #1
lema(ur'[Bb]endec_í_a[ns]?_i') + #0
lema(ur'[Bb]eneficiar_í_an?_i', pre=ur'[Ss]e ') + #4
lema(ur'[Bb]iof_í_sic[ao]s?_i') + #6
lema(ur'[Bb]iomec_á_nic[ao]s?_a') + #7
lema(ur'[Bb]iopol_í_tix[ao]s?_i') + #0
lema(ur'[Bb]ioqu_í_mic[ao]s?_i') + #28
lema(ur'[Bb]iotecnol_ó_gic[ao]s?_o') + #3
lema(ur'[Bb]lanqu_í_sim[ao]s?_i') + #0
lema(ur'[Bb]ol_í_grafos?_i') + #6
lema(ur'[Bb]oleter_í_as?_i') + #6
lema(ur'[Bb]r_ú_julas?_u') + #8
lema(ur'[Bb]rindar_í_a[ns]?_i') + #0
lema(ur'[Bb]uen_í_sim[ao]s?_i') + #4
lema(ur'[Bb]urocr_á_tic[ao]s?_a') + #1
lema(ur'[Bb]uscar_í_a[ns]?_i') + #1
lema(ur'[Bb]ut_í_ric[ao]s?_i') + #3
lema(ur'[Bb]utanodi_ó_lic[ao]s?_o') + #0
lema(ur'[Cc]_iu_dadan[ao]s?_ui') + #4
lema(ur'[Cc]_á_lculo (?:del?|num[eé]rico|mental|según|estructural)_a') + #45
lema(ur'[Cc]_á_lculo_a', pre=ur'(?:[Ee]l|[Uu]n|[Dd]el?|[Aa]l|y)') + #0
lema(ur'[Cc]_á_lid(?:[ao]s|amente)_a') + #5
lema(ur'[Cc]_á_nceres_a') + #12
lema(ur'[Cc]_á_todos?_a') + #4
lema(ur'[Cc]_é_sped_e') + #138
lema(ur'[Cc]_ó_digos_o') + #26
lema(ur'[Cc]_ó_mo_o', pre=ur'¿ *') + #207
lema(ur'[Cc]_ó_mod(?:[ao]s|amente)_o') + #11
lema(ur'[Cc]_ó_moda_o') + #2
lema(ur'[Cc]_ó_nic(?:as|os?)_o') + #0
lema(ur'[Cc]_ó_nyuges?_o') + #20
lema(ur'[Cc]a_cerí_as?_(?:zer[ií]|ceri)') + #44
lema(ur'[Cc]a_m_pos_n') + #17
lema(ur'[Cc]a_y_endo_ll') + #1
lema(ur'[Cc]a_í_a[ns]_i') + #3
lema(ur'[Cc]acer_í_as?_i') + #27
lema(ur'[Cc]ad_á_veres_a') + #10
lema(ur'[Cc]alor_í_as?_i') + #6
lema(ur'[Cc]am_é_lid[ao]s?_e') + #3
lema(ur'[Cc]ambiar_í_a_i', pre=ur'(?:[Nn]o|[Ll][ao]) ') + #1
lema(ur'[Cc]ambiar_í_an_i') + #0
lema(ur'[Cc]ampeon_í_sim[ao]s?_i') + #6
lema(ur'[Cc]anadi_e_nse_é') + #0
lema(ur'[Cc]ancer_í_gen[ao]s?_i') + #3
lema(ur'[Cc]ant_one_s_óne') + #2
lema(ur'[Cc]antar_í_a[ns]?_i') + #8
lema(ur'[Cc]apit_á_n Am[eé]rica_a') + #31
lema(ur'[Cc]ar_í_sim[ao]s?_i') + #1
lema(ur'[Cc]ar_ó_tid[ao]s?_o') + #10
lema(ur'[Cc]aracter_í_stc[ao]s?_i') + #3
lema(ur'[Cc]aracter_í_stic[ao]s?_i') + #185
lema(ur'[Cc]aracteri_z_(?:a[nrs]?|d[ao]s?|[oó])_s') + #2
lema(ur'[Cc]aracterí_s_ticas?_') + #7
lema(ur'[Cc]ardiolog_í_as?_i') + #23
lema(ur'[Cc]ardiopat_í_as?_i') + #11
lema(ur'[Cc]arn_í_vor(os?|as)_i') + #21
lema(ur'[Cc]asar_s_e(?:lo|)_c') + #0
lema(ur'[Cc]at_alogó__ologo') + #3
lema(ur'[Cc]at_á_logo_a', pre=ur'(?:[Ee]l|[Uu]n|[Dd]e) ') + #85
lema(ur'[Cc]at_á_logos_a') + #7
lema(ur'[Cc]atastr_ó_fic(?:[ao]s?|amente)_o') + #3
lema(ur'[Cc]atedr_á_tic[ao]s?_a') + #14
lema(ur'[Cc]ausar_í_a[ns]?_i') + #0
lema(ur'[Cc]e_ntroamé_rica_troam[eé]') + #0
lema(ur'[Cc]ed_í_a[ns]?_i') + #1
lema(ur'[Cc]ent_í_metros?_i') + #9
lema(ur'[Cc]entrar_í_a[ns]?_i') + #0
lema(ur'[Cc]ercan_í_as?_i') + #73
lema(ur'[Cc]et_á_ceos?_a') + #9
lema(ur'[Cc]h_á_rter_a', pre=ur'(?:aerolíneas?|vuelos?|tipos?|modos?)(?: de|) ') + #52
lema(ur'[Cc]ie_m_piés_n') + #5
lema(ur'[Cc]ircu_n_stacias_') + #0
lema(ur'[Cc]ircu_n_stancia(?:l|les|)_') + #0
lema(ur'[Cc]ircun_s_pección_') + #1
lema(ur'[Cc]ircun_s_tancias?_') + #1
lema(ur'[Cc]irug_í_as?_i') + #47
lema(ur'[Cc]iudad__es_d') + #2
lema(ur'[Cc]l_á_sic(?:o|[ao]s|amente)_a') + #289
lema(ur'[Cc]l_í_nic(?:[ao]s|amente)_i') + #20
lema(ur'[Cc]lasificar_í_a[ns]?_i') + #2
lema(ur'[Cc]lorh_í_dric[ao]s?_i') + #4
lema(ur'[Cc]o_m_paras_n') + #2
lema(ur'[Cc]o_m_petencia_n') + #2
lema(ur'[Cc]o_m_port(arse|amiento)_n') + #2
lema(ur'[Cc]o_m_prar_n') + #2
lema(ur'[Cc]o_m_pre_n') + #1
lema(ur'[Cc]o_m_puesto_n') + #0
lema(ur'[Cc]o_m_puso_n') + #0
lema(ur'[Cc]o_nvirtió__virtio') + #0
lema(ur'[Cc]o_o_peraci(?:ón|ones)_') + #12
lema(ur'[Cc]o_o_rdenad[ao]s?_') + #5
lema(ur'[Cc]obrar_í_a[ns]?_i') + #2
lema(ur'[Cc]octeler_í_as?_i') + #0
lema(ur'[Cc]oincidir_á_[ns]?_a') + #0
lema(ur'[Cc]ol_a_boración_o') + #1
lema(ur'[Cc]ol_é_ric[ao]s?_e') + #0
lema(ur'[Cc]om_é_r[mts]el[aeo]s?_e') + #4
lema(ur'[Cc]om_ú_nmente_u') + #119
lema(ur'[Cc]ombat(?:ir|)_í_a[ns]?_i') + #5
lema(ur'[Cc]omenzar_í_a[ns]?_i') + #8
lema(ur'[Cc]ompa_rtió__r?tio', pre=ur'(?:[Qq]ui[ée]n|[Qq]u[ée]|[Dd][óo]nde|[Cc]u[áa]ndo|[Tt]ambién|[Aa]demás|[Ss]e|[Ll][ao]s?|e) ') + #8
lema(ur'[Cc]ompart(?:ir|)_í_a[ns]?_i') + #11
lema(ur'[Cc]ompart_í_a(?:[ns]?|mos)_i') + #10
lema(ur'[Cc]ompartir_á_[ns]?_a') + #1
lema(ur'[Cc]ompet_í_(?:a[ns]?|)_i') + #6
lema(ur'[Cc]ompet_í_a[ns]?_i') + #6
lema(ur'[Cc]ompetic_i_ón_í?') + #1
lema(ur'[Cc]ompetir_á_n?_a') + #5
lema(ur'[Cc]ompetir_í_a[ns]?_i') + #1
lema(ur'[Cc]ompetitiv_id_ad_') + #1
lema(ur'[Cc]ompletar_í_a[ns]?_i') + #2
lema(ur'[Cc]omplic_á_r[mts]el[aeo]s?_a') + #0
lema(ur'[Cc]ompo_s_itor(?:as?|es|)_c') + #1
lema(ur'[Cc]ompon_í_a[ns]?_i') + #9
lema(ur'[Cc]ompondr_á_[ns]?_a') + #1
lema(ur'[Cc]omposi_c_ión_s') + #0
lema(ur'[Cc]omprend_í_a[ns]?_i') + #4
lema(ur'[Cc]omprender_á_[ns]?_a') + #0
lema(ur'[Cc]omunic_á_r[mts]el[aeo]s?_a') + #0
lema(ur'[Cc]on __el_el con ') + #10
lema(ur'[Cc]on_cedié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_sedie') + #1
lema(ur'[Cc]on_s_ecuencias?_c') + #0
lema(ur'[Cc]on_s_iderad[ao]s?_c') + #3
lema(ur'[Cc]on_s_titu(?:ye|y[oó]|ción|ciones|id[ao]s?)_') + #3
lema(ur'[Cc]on_s_tru(?:ir(?:lo|se|á|án|ía|ían|)|cción|cciones)_') + #27
lema(ur'[Cc]on_s_truyeron_') + #2
lema(ur'[Cc]on_strui_d[ao]s?_(?:tru[ií]|struí)') + #80
lema(ur'[Cc]on_strui_d[ao]s?_(?:tru[ií]|struí)') + #80
lema(ur'[Cc]on_struyó__truyo') + #1
lema(ur'[Cc]onced_í_a[ns]?_i') + #1
lema(ur'[Cc]onceder_á_[ns]?_a') + #0
lema(ur'[Cc]onclu_i_(?:r(?:l[aeo]s?|se|)|d[ao]s?)_í') + #38
lema(ur'[Cc]onclu_i_d[ao]s?_í') + #36
lema(ur'[Cc]oncluir_á_[ns]?_a') + #0
lema(ur'[Cc]oncurr(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Cc]oncurrir_á_[ns]?_a') + #0
lema(ur'[Cc]ondu_jo__cio') + #1
lema(ur'[Cc]onduc_í_a[ns]?_i') + #5
lema(ur'[Cc]onducir_á_[ns]?_a') + #2
lema(ur'[Cc]onf_í_e[ns]_i') + #0
lema(ur'[Cc]onf_í_o_i', pre=ur'(?:[Tt]i|[Vv]os) ') + #0
lema(ur'[Cc]onfia_n_zas?_') + #9
lema(ur'[Cc]onfie_s_a[ns]?_z') + #3
lema(ur'[Cc]onformar_í_a[ns]?_i') + #2
lema(ur'[Cc]ono_c_id[ao]s?_s') + #10
lema(ur'[Cc]onoc_í_a[ns]?_i') + #26
lema(ur'[Cc]onocer_s_e(?:lo|)_c') + #0
lema(ur'[Cc]onocer_á_[ns]?_a') + #8
lema(ur'[Cc]onocer_í_a(?:[ns]?|mos)_i') + #9
lema(ur'[Cc]onocid_í_sim[ao]s?_i') + #1
lema(ur'[Cc]onocim_ie_ntos?_ei') + #1
lema(ur'[Cc]ons_i_guieron_e') + #9
lema(ur'[Cc]ons_iguió__eguio') + #1
lema(ur'[Cc]onsagrar_í_a[ns]?_i') + #3
lema(ur'[Cc]onsecu_e_ncias?_a') + #0
lema(ur'[Cc]onsegu_í_a[ns]?_i') + #20
lema(ur'[Cc]onseguir_á_[ns]?_a') + #4
lema(ur'[Cc]onseguir_í_a[ns]?_i') + #5
lema(ur'[Cc]onsider_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Cc]onsig_uió__i[oó]') + #12
lema(ur'[Cc]onsigu_ió__o') + #1
lema(ur'[Cc]onsist_í_a[ns]?_i') + #21
lema(ur'[Cc]onsistir_á_[ns]?_a') + #0
lema(ur'[Cc]onst_r_uye[ns]?_') + #0
lema(ur'[Cc]onstituir_á_[ns]?_a') + #0
lema(ur'[Cc]onstru_i_r(?! (?:a paz|unha))_í') + #9
lema(ur'[Cc]onstru_í_as?_i') + #15
lema(ur'[Cc]onstruir_á_[ns]?_a') + #4
lema(ur'[Cc]onsum(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Cc]ont_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Cc]ont_ó_ (?:que|como|con)_o') + #43
lema(ur'[Cc]ontadur_í_as?_i') + #7
lema(ur'[Cc]ontar_í_a[ns]?_i') + #6
lema(ur'[Cc]onte_m_poránea_n') + #4
lema(ur'[Cc]onten_í_a[ns]_i') + #3
lema(ur'[Cc]ontend_í_(?:a[ns]?|)_i') + #2
lema(ur'[Cc]ontendr_á_[ns]?_a') + #3
lema(ur'[Cc]onteni_en_do_ne') + #0
lema(ur'[Cc]onti_n_gentes?_') + #13
lema(ur'[Cc]ontin_ú_(?:an|en)_u') + #95
lema(ur'[Cc]ontinuar_í_a[ns]?_i') + #2
lema(ur'[Cc]ontra_í_(?:a[ns]?|d[ao]s?)_i') + #24
lema(ur'[Cc]ontrar_r_estar(?:l[aeo]s?|ía[ns]?|)_') + #7
lema(ur'[Cc]ontrar_r_evoluci(?:ón|onari[ao]s?)_') + #19
lema(ur'[Cc]ontrar_restará__estara') + #0
lema(ur'[Cc]ontribu_i_d[ao]s?_í') + #5
lema(ur'[Cc]ontribu_i_d[ao]s?_í') + #5
lema(ur'[Cc]ontribu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Cc]ontribuir_á_[ns]?_a') + #0
lema(ur'[Cc]onv_erti_rían_ierte') + #0
lema(ur'[Cc]onv_i_rti(?:ó|endo|eron)_e') + #49
...
lema(ur'[Cc]onvert(?:ir|)_í_a[ns]?_i') + #20
lema(ur'[Cc]onvertir_á_[ns]?_a') + #9
lema(ur'[Cc]onvertir_í_a[ns]?_i') + #15
lema(ur'[Cc]onvi__rtieron_e') + #9
lema(ur'[Cc]onvi_rtié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_ertie') + #4
lema(ur'[Cc]onvi_rtió__ertio') + #2
lema(ur'[Cc]onvi_rtió__erto', pre=ur'[Ss]e ') + #3
lema(ur'[Cc]onvir_tió__itio') + #0
lema(ur'[Cc]onvirt_ió__o') + #1
lema(ur'[Cc]onviv_í_a[ns]_i') + #1
lema(ur'[Cc]or_respondí_a_espondi') + #0
lema(ur'[Cc]ore_ó_graf[ao]s?_o') + #22
lema(ur'[Cc]oronar_s_e(?:lo|)_c') + #0
lema(ur'[Cc]orr_í_an_i') + #3
lema(ur'[Cc]orre_spondí_a_pondi') + #0
lema(ur'[Cc]orrer_í_a[ns]?_i') + #4
lema(ur'[Cc]orrespond(?:er|)_í_an?_i') + #13
lema(ur'[Cc]orrespond_í_a[ns]?_i') + #10
lema(ur'[Cc]orresponder_á_[ns]?_a') + #0
lema(ur'[Cc]orresponder_í_a[ns]?_i') + #3
lema(ur'[Cc]r_i_men_') + #0
lema(ur'[Cc]r_á_neos?_a') + #64
lema(ur'[Cc]r_í_menes_i') + #68
lema(ur'[Cc]re_í__i') + #3
lema(ur'[Cc]re_í_a(?:[ns]?|mos)_i') + #56
lema(ur'[Cc]re_í_bles?_i') + #8
lema(ur'[Cc]re_í_d[ao]s?_i') + #14
lema(ur'[Cc]rear_í_a[ns]?_i') + #3
lema(ur'[Cc]recer_á_[ns]?_a') + #0
lema(ur'[Cc]ri_a_turas?_') + #1
lema(ur'[Cc]ron_ó_metros?_o') + #33
lema(ur'[Cc]ronol_ó_gic(?:[ao]s|amente)_o') + #8
lema(ur'[Cc]u[aá]_nd_o_dn') + #5
lema(ur'[Cc]u_m_pla_n') + #2
lema(ur'[Cc]u_m_pliéndose_n') + #0
lema(ur'[Cc]u_á_ntic[ao]s?_a') + #11
lema(ur'[Cc]ua_n_do (?:se|ven?|el|es|eran?|fue|llegan?|hay|el|la|sale|sus?|este)_') + #1
lema(ur'[Cc]uadrag_é_sim[ao]s?_e') + #5
lema(ur'[Cc]ubrir_á_[ns]?_a') + #0
lema(ur'[Cc]ulpar_í_a[ns]?_i') + #1
lema(ur'[Cc]umpl(?:ir|)_í_a[ns]?_i') + #16
lema(ur'[Cc]umpl_í__i') + #1
lema(ur'[Cc]umplir_á_[ns]?_a') + #4
lema(ur'[Cc]ut_á_ne[ao]s?_a') + #23
lema(ur'[Dd]]_ú_os_u') + #0
lema(ur'[Dd]_e_cimocuart[ao]_é') + #35
lema(ur'[Dd]_e_cimoquint[ao]_é') + #38
lema(ur'[Dd]_e_cimosext[ao]_é') + #15
lema(ur'[Dd]_e_cimoséptim[ao]_é') + #3
lema(ur'[Dd]_ecimo_ctav[ao]_écimoo') + #0
lema(ur'[Dd]_á_r[mts]el[aeo]s?_a') + #6
lema(ur'[Dd]_é_biles(?! dignare)_e') + #10
lema(ur'[Dd]_é_bilmente_e') + #3
lema(ur'[Dd]_í_a a d[ií]a_i') + #36
lema(ur'[Dd]_í_gitos?_i') + #79
lema(ur'[Dd]_ó_lar_o', pre=ur'(?:[Ee]l|[Uu]n|[Dd]el|[Aa]l) ') + #45
lema(ur'[Dd]_ó_lares_o', pre=ur'(?:[Ll]os|[Uu]nos|[Ee]n|[Dd]e) ') + #333
lema(ur'[Dd]_ó_nde_o', pre=ur'¿ *') + #1
lema(ur'[Dd]_ú_ctil_u') + #2
lema(ur'[Dd]añar_í_a[ns]?_i') + #0
lema(ur'[Dd]e_ _pronto_') + #5
...
lema(ur'[Dd]e_cisio_nes_(?:cisió|cici[oó]|si[sc]i[oó])') + #10
lema(ur'[Dd]e_s_c(?:enso|iende[ns]?|end(?:er?|ido)|entrali(?:ce[ns]?|zar|zó|zació))_') + #18
lema(ur'[Dd]e_s_cifrar_') + #1
lema(ur'[Dd]ebat(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Dd]ebatir_á_[ns]?_a') + #0
lema(ur'[Dd]eber_á_[ns]?_a') + #34
lema(ur'[Dd]eber_í_a(?:[ns]?|mos)_i') + #38
lema(ur'[Dd]ebilitad_í_sim[ao]s?_i') + #0
lema(ur'[Dd]ec_í_a[ns]?_i', pre=ur'(?:[Qq]u[eé]|[Ss]e|[Ll]es?|[Mm]e|[Nn]os|[Ll]o|[Ss]eg[uú]n|[Dd]onde|[Cc]u[aá]l|[Cc][oó]mo|[Ss][oó]lo|[EeÉ]l|[Qq]ui[eé]n) ') + #15
lema(ur'[Dd]ec_í_amos_i') + #5
lema(ur'[Dd]ec_í_r[mts]el[aeo]s?_i') + #4
lema(ur'[Dd]eca_í_do_i') + #6
lema(ur'[Dd]eci__dió_ci') + #2
lema(ur'[Dd]ecid_í__i') + #7
lema(ur'[Dd]ecidir_á_[ns]?_a') + #1
lema(ur'[Dd]ecimos_é_ptim[ao]s?_e') + #24
lema(ur'[Dd]ecimos_é_ptimo_e') + #3
lema(ur'[Dd]eclarar_í_a[ns]?_i') + #0
lema(ur'[Dd]educir_á__a') + #0
lema(ur'[Dd]ef__endió_i') + #2
lema(ur'[Dd]efender_á_[ns]?_a') + #4
lema(ur'[Dd]efin(?:ir|)_í_a[ns]?_i') + #8
lema(ur'[Dd]efinir_á_[ns]?_a') + #2
lema(ur'[Dd]ejar_í_a[ns]?_i') + #12
lema(ur'[Dd]em_ócra_tas?_[oó]cr') + #2
lema(ur'[Dd]ema_s_iados?_c') + #2
lema(ur'[Dd]emandar_í_a[ns]?_i') + #1
lema(ur'[Dd]emost_r_ar(?:le|on|se|)_') + #2
lema(ur'[Dd]enominar_í_a(?:[ns]?|mos)_i') + #1
lema(ur'[Dd]epend_í_a[ns]?_i') + #6
lema(ur'[Dd]epender_á_[ns]?_a') + #0
lema(ur'[Dd]erivar_í_a[ns]?_i') + #1
lema(ur'[Dd]errotar_í_a[ns]?_i') + #0
lema(ur'[Dd]erru_i_d[ao]s?_í') + #5
lema(ur'[Dd]es_ig_nad[ao]s?_gi') + #54
lema(ur'[Dd]es_é_rtic[ao]s?_e') + #6
lema(ur'[Dd]esaf_i_ar_í') + #4
lema(ur'[Dd]esap_are_r(?:e(?:[ns]?|r(?:a[ns]?|[áé]|ía[ns]?|))|ieron)c_(?:ara|re)') + #0
lema(ur'[Dd]esapare_z_ca[ns]?_s') + #2
lema(ur'[Dd]esaparec_í_a[ns]?_i') + #4
lema(ur'[Dd]esaparecer_á_[ns]?_a') + #2
lema(ur'[Dd]esastro_s_[ao]s?_z') + #30
lema(ur'[Dd]escan_s_(?:os?|ar)_z') + #18
lema(ur'[Dd]escend_í_(?:a[ns]?|)_i') + #6
lema(ur'[Dd]escender_á_[ns]?_a') + #3
lema(ur'[Dd]esconf_í_a[na]?_i') + #3
lema(ur'[Dd]escono_c_id[ao]s?_s') + #1
lema(ur'[Dd]escrib(?:ir|)_í_a[ns]?_i') + #5
lema(ur'[Dd]escrib_í__i') + #0
lema(ur'[Dd]escub__rir_i') + #0
lema(ur'[Dd]escub_r_ieron_') + #3
lema(ur'[Dd]escub_r_ir(?:se|)_') + #9
lema(ur'[Dd]escub_ri_mientos?_ir') + #3
lema(ur'[Dd]escubr(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Dd]escubr_í__i') + #5
lema(ur'[Dd]escubrir_á_[ns]?_a') + #6
lema(ur'[Dd]ese_m_peñarlos_n') + #0
lema(ur'[Dd]ese_m_peño_n') + #1
lema(ur'[Dd]esear_í_a[ns]?_i') + #1
lema(ur'[Dd]eshacer_s_e(?:lo|)_c') + #1
lema(ur'[Dd]esp_i_dió_e') + #2
lema(ur'[Dd]esped_í_a[ns]?_i') + #3
lema(ur'[Dd]esplazar_s_e(?:lo|)_c') + #2
lema(ur'[Dd]espose_í_d[ao]s?_i') + #18
lema(ur'[Dd]esprend_í_a[ns]?_i') + #1
lema(ur'[Dd]esta_ca_d[ao]s?_') + #21
lema(ur'[Dd]estacad_í_sim[ao]s?_i') + #1
lema(ur'[Dd]estinar_í_a[ns]?_i') + #0
lema(ur'[Dd]estitu_i_d[ao]s?_í') + #25
lema(ur'[Dd]estru_i_d[ao]s?_í') + #78
lema(ur'[Dd]estru_i_r(?:l[aeo]s?|se|)_í') + #6
lema(ur'[Dd]estru_í__i') + #1
lema(ur'[Dd]estruir_á_[ns]?_a') + #2
lema(ur'[Dd]esv_á_n_a') + #8
...
lema(ur'[Dd]i_sminui_d[ao]s?_minuí') + #2
lema(ur'[Dd]i_á_metros?_a') + #210
lema(ur'[Dd]i_é_ramos_e') + #1
lema(ur'[Dd]i_ó_xidos?_o') + #6
lema(ur'[Dd]iab_ó_lic(?:as|os)_o') + #2
lema(ur'[Dd]iagn_osticó__(?:óstic[oó]|ostico)', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #6
lema(ur'[Dd]ibujar_í_a[ns]?_i') + #0
lema(ur'[Dd]iecis_é_is_e') + #92
lema(ur'[Dd]iet_é_tic[ao]s?_e') + #3
lema(ur'[Dd]if_í_cil(?:es|mente|)_i') + #143
lema(ur'[Dd]ifer_í_a[ns]?_i') + #0
lema(ur'[Dd]ign_í_sim[ao]s?_i') + #3
lema(ur'[Dd]ij__eron_i') + #10
lema(ur'[Dd]ij_o__ó') + #6
lema(ur'[Dd]ilu_i_d[ao]s?_í') + #9
lema(ur'[Dd]in_á_mic(?:[ao]s|amente)_a') + #9
lema(ur'[Dd]ir_e_ctamente_é') + #2
lema(ur'[Dd]ir_í_amos_i') + #0
lema(ur'[Dd]iri_g_i(?:d[ao]s?|r(?:[tsm]e|á|ía[ns]|l[aeo]s?|))_j') + #26
lema(ur'[Dd]iri_gí_a[ns]?_(?:j[ií]|gi)') + #19
lema(ur'[Dd]irig_id_o por_') + #1
lema(ur'[Dd]irig_í__i') + #2
lema(ur'[Dd]irigir_á_[ns]?_a') + #4
lema(ur'[Dd]is_cí_pul[ao]s?_i') + #2
lema(ur'[Dd]iscurr(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Dd]iscut(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Dd]ise_ñ_a(?:d[ao]s?|dor(?:a|es|)|r)_n') + #3
lema(ur'[Dd]isfra_c_es_z') + #0
lema(ur'[Dd]isminu_i_d[ao]s?_í') + #22
lema(ur'[Dd]isminu_i_r(?:l[aeo]s?|se|)_í') + #0
lema(ur'[Dd]isminuir_á_[ns]?_a') + #0
lema(ur'[Dd]isolver_á__a') + #2
lema(ur'[Dd]isparar_í_a[ns]?_i') + #0
lema(ur'[Dd]ispon_í_a[ns]?_i') + #15
lema(ur'[Dd]ispondr_á_[ns]?_a') + #0
lema(ur'[Dd]isputad_í_sim[ao]s?_i') + #0
lema(ur'[Dd]isputar_í_a[ns]?_i') + #9
lema(ur'[Dd]isten_s_ión_c') + #6
lema(ur'[Dd]istingu(?:ir|)_í_a[ns]?_i') + #7
lema(ur'[Dd]istingu_i_d[ao]s?_í') + #1
lema(ur'[Dd]istinguir_á_[ns]?_a') + #0
lema(ur'[Dd]istribu_i_d[ao]s?_í') + #56
lema(ur'[Dd]istribu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Dd]istribu_í_a[ns]?_i') + #12
lema(ur'[Dd]istribuir_á_[ns]?_a') + #0
lema(ur'[Dd]isuad(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Dd]ivi_sio_n_ci[oó]') + #3
lema(ur'[Dd]ividir_á_[ns]?_a') + #1
lema(ur'[Dd]ivorciar_s_e(?:lo|)_c') + #0
lema(ur'[Dd]iál_o_gos?_') + #1
lema(ur'[Dd]onar_í_an_i') + #0
lema(ur'[Dd]r_á_stic(?:[ao]s|amente)_a') + #7
lema(ur'[Dd]ram_á_tic(?:[ao]s|amente)_a') + #2
lema(ur'[Dd]udar_í_a[ns]?_i') + #1
lema(ur'[Dd]ur_an_te_na') + #5
lema(ur'[Dd]ur_í_sim[ao]s?_i') + #3
lema(ur'[Dd]urar_í_a[ns]?_i') + #3
lema(ur'[Ee]__pisodios?_s') + #9
lema(ur'[Ee]_jem_plo_njen') + #1
lema(ur'[Ee]_m_parejado_n') + #0
lema(ur'[Ee]_m_perador_n') + #5
...
lema(ur'[Ee]_s_pectador(?:es|)_x') + #14
lema(ur'[Ee]_s_trech(?:[ao]s?|amente)_x') + #17
lema(ur'[Ee]_x_celencias?_s?') + #0
lema(ur'[Ee]_x_pectativas?_s') + #12
lema(ur'[Ee]char_í_a[ns]?_i') + #1
lema(ur'[Ee]con_ó_mic(?:[ao]s|amente)_o') + #58
lema(ur'[Ee]g_ó_latras?_o') + #0
lema(ur'[Ee]goc_é_ntric[ao]s?_e') + #2
lema(ur'[Ee]j_é_rcitos_e') + #17
lema(ur'[Ee]jerc_í_a[ns]?_i') + #13
lema(ur'[Ee]jercer_á_[ns]?_a') + #0
lema(ur'[Ee]jerci_cio__o', pre=ur'[Ee]l ') + #1
lema(ur'[Ee]l_e_gir(?:se|)_i') + #8
lema(ur'[Ee]l_e_girá[ns]?_i') + #4
lema(ur'[Ee]l_i_minad[ao]s?_') + #3
lema(ur'[Ee]lectrohidr_á_ulic[ao]s?_a') + #0
lema(ur'[Ee]lectromagn_é_tic[ao]s?_e') + #3
lema(ur'[Ee]legir_á_[ns]?_a') + #5
lema(ur'[Ee]levad_í_sim[ao]s?_i') + #0
lema(ur'[Ee]mblem_á_tic(?:as|os?)_a') + #8
lema(ur'[Ee]mit(?:ir|)_í_a[ns]?_i') + #23
lema(ur'[Ee]mit_í_a[ns]?_i') + #21
lema(ur'[Ee]mitir_á_[ns]?_a') + #3
lema(ur'[Ee]mp_i_eza[ns]?_') + #5
lema(ur'[Ee]mp_r_esari(?:os?|al)_') + #2
lema(ur'[Ee]mpatar_í_a[ns]?_i') + #1
lema(ur'[Ee]mpe_z_ar(?:on|)_s') + #1
lema(ur'[Ee]mpe_zó__(?:s[oó]|zo)') + #69
lema(ur'[Ee]mpezar_í_a[ns]?_i') + #2
lema(ur'[Ee]mpie_c_e[ns]?_z') + #9
lema(ur'[Ee]mpie_z_a[ns]?_s') + #2
lema(ur'[Ee]mprend_í_a[ns]?_i') + #0
lema(ur'[Ee]mprender_á_[ns]?_a') + #0
lema(ur'[Ee]mular_í_a[ns]?_i') + #2
lema(ur'[Ee]n don_d_e_') + #2
lema(ur'[Ee]n_é_rgic(?:[ao]s|amente)_e') + #3
lema(ur'[Ee]n_ó_log[ao]s?_o') + #2
lema(ur'[Ee]namorad_í_sim[ao]s?_i') + #1
lema(ur'[Ee]nc_o_ntraba[ns]?_ue') + #31
lema(ur'[Ee]ncargar_í_a[ns]?_i') + #1
lema(ur'[Ee]nco_g_(?:e[nr]?|imiento|í)_j') + #6
lema(ur'[Ee]ncont_r_ar_') + #48
lema(ur'[Ee]ncontrar_í_a(?:[ns]?|mos)_i') + #4
lema(ur'[Ee]ncubr(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Ee]nfrent_á_r[mts]el[aeo]s?_a') + #0
lema(ur'[Ee]nfrentar_s_e(?:lo|)_c') + #0
lema(ur'[Ee]nfrentar_í_a[ns]?_i') + #7
lema(ur'[Ee]ngre_í_d[ao]s?_i') + #7
lema(ur'[Ee]nlazar_s_e(?:lo|)_c') + #0
lema(ur'[Ee]nojad_í_sim[ao]s?_i') + #0
lema(ur'[Ee]ntalp_í_as?_i') + #8
lema(ur'[Ee]ntend_í_(?:a[ns]?|)_i') + #3
lema(ur'[Ee]ntender_á_[ns]?_a') + #1
lema(ur'[Ee]ntender_í_a(?:[ns]?|mos)_i') + #3
lema(ur'[Ee]nto_n_ces_') + #24
lema(ur'[Ee]ntr_e_ (?:l[ao]s|otros)_é') + #2
lema(ur'[Ee]ntr_e_gad[ao]s?_a') + #8
lema(ur'[Ee]ntr_e_vista(?:s?|d[ao]s?)_') + #7
lema(ur'[Ee]ntrar_í_a[ns]?_i') + #0
lema(ur'[Ee]ntreg_á_r[mts]el[aeo]s?_a') + #6
lema(ur'[Ee]ntregar_í_a[ns]?_i') + #2
lema(ur'[Ee]nv_i_ad[ao]s?_í') + #2
lema(ur'[Ee]nv_í_o_i', pre=ur'(?:[Dd]e|[Ee]l|[Uu]n|[Cc]ada) ') + #9
lema(ur'[Ee]pis_o_dios?_i') + #4
lema(ur'[Ee]pis_ó_dic[ao]s?_o') + #6
lema(ur'[Ee]rr_ó_neamente_o') + #47
lema(ur'[Ee]sc_é_nic[ao]s?_e') + #51
lema(ur'[Ee]scalar_í_a[ns]?_i') + #0
lema(ur'[Ee]scas_í_sim[ao]s?_i') + #0
lema(ur'[Ee]sco_g_(?:e[nr]?|erl[aeo]s?|erá|es|id[aeo]s?|iendo|ieron|imos)_j') + #13
lema(ur'[Ee]sco_j_a[ns]?_g') + #1
lema(ur'[Ee]scoger_á_[ns]?_a') + #1
lema(ur'[Ee]scond_í_a[ns]?_i') + #2
lema(ur'[Ee]scrib(?:ir|)_í_a[ns]?_i') + #14
lema(ur'[Ee]scrib_í_a(?:[ns]?|mos)_i') + #12
lema(ur'[Ee]scribir_á_[ns]?_a') + #0
lema(ur'[Ee]scribir_á_[ns]?_a') + #0
lema(ur'[Ee]sculp(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ee]scult_ó_ric[ao]s?_o') + #6
lema(ur'[Ee]spec_í_fic(?:[ao]s|amente)_i') + #93
lema(ur'[Ee]spec_í_fica_i', pre=ur'(?:[Ee]s|[Mm][aá]s) ') + #11
lema(ur'[Ee]spect_á_culos?_a') + #119
lema(ur'[Ee]spont_á_ne(?:[ao]s|amente)_a') + #13
lema(ur'[Ee]spor_á_dic(?:[ao]s|amente)_a') + #8
lema(ur'[Ee]spor_á_dic[ao]_a') + #0
lema(ur'[Ee]spr_í_nters?_i') + #54
lema(ur'[Ee]squ_í__i') + #66
lema(ur'[Ee]st_á_ndares_a') + #56
lema(ur'[Ee]st_é__e', pre=ur'(?:[Ss]e )') + #37
lema(ur'[Ee]st_é_tic(?:[ao]s|amente)_e') + #7
lema(ur'[Ee]st_é_tica_e', pre=ur'(?:[Ll]a|[Uu]na|[Cc]on|[Dd]e|[Ee]n|[Mm]uy|[Ff]unción[Ff]orma|[Uu]nidad|y) ') + #5
lema(ur'[Ee]st_ó_magos?_o') + #60
lema(ur'[Ee]st_ú_pid(?:[ao]s?|amente)_u') + #7
lema(ur'[Ee]stablec(?:er|)_í_a[ns]?_i') + #32
lema(ur'[Ee]stablec_í_(?:a[ns]?|)_i') + #26
lema(ur'[Ee]stablecer_s_e(?:lo|)_c') + #0
lema(ur'[Ee]stablecer_á_[ns]?_a') + #2
lema(ur'[Ee]stanter_í_as?_i') + #2
lema(ur'[Ee]star_í_a(?:[ns]?|mos)_i') + #30
lema(ur'[Ee]statu_i_d[Ao]s?_í') + #2
lema(ur'[Ee]ster_e_otipos?_i') + #2
lema(ur'[Ee]strat_é_gic(?:[ao]s|amente)_e') + #22
lema(ur'[Ee]strat_é_gic[ao]_e') + #16
lema(ur'[Ee]strenar_í_a[ns]?_i') + #6
lema(ur'[Ee]stu_v_(?:[eo]|ieron|iese[ns]?|iera[ns]?)_b') + #31
lema(ur'[Ee]val_ú_(?:a[ns]?|e[ns]?)_u') + #16
lema(ur'[Ee]x_c_elentes?_') + #3
lema(ur'[Ee]x_c_ept(?:o|uar)_') + #10
lema(ur'[Ee]x_clui_d[ao]s?_luí') + #2
lema(ur'[Ee]x_h_aust[ao]s?_') + #4
lema(ur'[Ee]x_á_menes_a') + #17
lema(ur'[Ee]xced_í_a[ns]?_i') + #2
lema(ur'[Ee]xcelent_í_sim[ao]s?_i') + #13
lema(ur'[Ee]xcept_ú_(?:a[ns]?|e[ns]?)_u') + #0
lema(ur'[Ee]xclu_i_d[ao]s?_í') + #182
lema(ur'[Ee]xclu_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Ee]xi__tos[ao]s?_s') + #51
lema(ur'[Ee]xig_í_a[ns]?_i') + #8
lema(ur'[Ee]xigir_á_[ns]?_a') + #2
lema(ur'[Ee]xist_í_a[ns]?_i') + #54
lema(ur'[Ee]xistir_á_[ns]?_a') + #1
lema(ur'[Ee]xit_o_s(?:[ao]s?|amente)_ó') + #61
lema(ur'[Ee]xitos_í_sim[ao]s?_i') + #0
lema(ur'[Ee]xpand(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Ee]xpel_í_a[ns]?_i') + #1
lema(ur'[Ee]xpl_í_cit(?:[ao]s|amente)_i') + #31
lema(ur'[Ee]xplicar_í_a[ns]?_i') + #1
lema(ur'[Ee]xpondr_á_[ns]?_a') + #1
lema(ur'[Ee]xt__endió_i') + #10
lema(ur'[Ee]xten_sio_nes_ci[oó]') + #8
lema(ur'[Ee]xtend_í_(?:a[ns]?|)_i') + #6
lema(ur'[Ee]xtender_á_[ns]?_a') + #1
lema(ur'[Ee]xtender_í_a[ns]?_i') + #0
lema(ur'[Ee]xtens_í_sim[ao]s?_i') + #0
lema(ur'[Ee]xtin__tos?_c') + #1
lema(ur'[Ee]xtra_í_(?:a[ns]?|d[ao]s?)_i') + #124
lema(ur'[Ee]xtra_í_d[ao]s?_i') + #123
lema(ur'[Ee]xtra_ñ_[ao]_n') + #2
lema(ur'[Ee]xtrater_r_estres?_') + #0
lema(ur'[Ee]xtru_i_d[ao]s?_í') + #3
lema(ur'[Ff]_r_ustrad[ao]s?_') + #6
lema(ur'[Ff]_u_tbolistas?_ú') + #171
lema(ur'[Ff]_á_cil(?:mente|)_a') + #105
lema(ur'[Ff]_í_sicamente(?! esposta)_i') + #15
lema(ur'[Ff]_ó_lic[ao]s?_o') + #3
lema(ur'[Ff]acilitar_í_a[ns]?_i') + #1
lema(ur'[Ff]allar_í_a[ns]?_i') + #1
lema(ur'[Ff]allecer_á_[ns]?_a') + #0
lema(ur'[Ff]als_í_sim[ao]s?_i') + #0
lema(ur'[Ff]amos_í_sim[ao]s?_i') + #2
lema(ur'[Ff]avorecer_á_[ns]?_a') + #0
lema(ur'[Ff]eligres_í_as?_i') + #10
lema(ur'[Ff]en_ó_menos_o') + #8
lema(ur'[Ff]erreter_í_as?_i') + #19
lema(ur'[Ff]ichar_í_a[ns]?_i') + #2
lema(ur'[Ff]idel_í_sim[ao]s?_i') + #3
lema(ur'[Ff]il_á_ntropos?_a') + #8
lema(ur'[Ff]ilmar_í_a[ns]?_i') + #0
lema(ur'[Ff]ilmograf_í_as?_i') + #115
lema(ur'[Ff]ilud_í_sim[ao]s?_i') + #0
lema(ur'[Ff]in_í_sim[ao]s?_i') + #1
lema(ur'[Ff]inal_í_sim[ao]s?_i') + #7
lema(ur'[Ff]inalizar_í_a[ns]?_i') + #5
lema(ur'[Ff]ing_í_a[ns]?_i') + #0
lema(ur'[Ff]irmar_í_a[ns]?_i') + #3
lema(ur'[Ff]lorecer_á_[ns]?_a') + #1
lema(ur'[Ff]lu_i_d[ao]s?_í') + #33
lema(ur'[Ff]luct_ú_(?:a[ns]?|e[ns]?)_u') + #6
lema(ur'[Ff]olcl_ó_ric[ao]s?_o') + #31
lema(ur'[Ff]ora_j_id[ao]s?_g') + #0
lema(ur'[Ff]ormar_í_a[ns]?_i') + #9
lema(ur'[Ff]ort_í_sim[ao]s?_i') + #0
lema(ur'[Ff]ot_ó_graf[ao]s?_') + #0
lema(ur'[Ff]rigor_í_fic[ao]s?_i') + #12
lema(ur'[Ff]ruter_í_as?_i') + #2
lema(ur'[Ff]u_s_i(?:ón|ones|onó|ona[ns]?)_c') + #6
lema(ur'[Ff]ue_r_zas?_') + #41
lema(ur'[Ff]uer_o_n_ó') + #19
lema(ur'[Ff]unda__d[ao]s?_da') + #7
lema(ur'[Ff]undar_í_a[ns]?_i') + #0
lema(ur'[Ff]utbol_í_stic(?:[ao]s|amente)_i') + #12
lema(ur'[Ff]utbol_í_stic[ao]_i') + #49
lema(ur'[Gg]_é_rmenes_e') + #7
lema(ur'[Gg]anader_í_a_i') + #65
lema(ur'[Gg]anar_í_a[ns]?_i') + #5
lema(ur'[Gg]en_é_ric(?:[ao]s|amente)_e') + #5
lema(ur'[Gg]en_é_tic[ao]s_e') + #3
lema(ur'[Gg]en_é_ticamente(?! modificato)_e') + #4
lema(ur'[Gg]eneral_í_sim[ao]s?_i') + #30
lema(ur'[Gg]enial_í_sim[ao]s?_i') + #0
lema(ur'[Gg]eod_é_sic[ao]s?_e') + #0
lema(ur'[Gg]eogr_á_fic(?:[ao]s|amente)_a') + #25
lema(ur'[Gg]erontolog_í_as?_i') + #1
lema(ur'[Gg]inecolog_í_as?(?! (?:Ospedalieri|e (?:Ostetricia|Obstétrícia)))_i') + #11
lema(ur'[Gg]olear_í_a[ns]?_i') + #0
lema(ur'[Gg]rad_ú_(?:a[ns]|e[ns]?)_u') + #19
lema(ur'[Gg]raduar_s_e(?:lo|)_c') + #1
lema(ur'[Gg]ran_ _partido_') + #1
lema(ur'[Gg]rav_í_sim[ao]s?_i') + #3
lema(ur'[Gg]rupo_s__', pre=ur'[Ll]os ') + #101
lema(ur'[Gg]u_i_ad[ao]s?_í') + #3
lema(ur'[Gg]uap_í_sim[ao]s?_i') + #1
lema(ur'[Gg]uarder_í_as?_i') + #7
lema(ur'[Gg]uitar_r_as?_') + #15
lema(ur'[Gg]ustar_í_a[ns]?_i') + #7
lema(ur'[Hh]_á_bil(?:es|mente)_a') + #9
lema(ur'[Hh]_á_bil_a', pre=ur'(?:[Ee]s|[Ee]ra|[Ff]ue) ') + #0
lema(ur'[Hh]_í_gados?_i') + #13
lema(ur'[Hh]_ú_med[ao]s?_u') + #50
lema(ur'[Hh]a_ll_(?:adas|ados?|ando|arse|éis)_y') + #11
lema(ur'[Hh]ab_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_íe') + #0
lema(ur'[Hh]ab_é_r[mts]el[aeo]s?_e') + #5
lema(ur'[Hh]ab_í_a(?:n|mos)_i') + #163
lema(ur'[Hh]aber_s_e(?:lo|)_c') + #1
lema(ur'[Hh]abr_í_as?_i') + #22
lema(ur'[Hh]ac_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_íe') + #2
lema(ur'[Hh]acer_s_e(?:lo|)_c') + #19
lema(ur'[Hh]allar_í_a(?:[ns]?|mos)_i') + #0
lema(ur'[Hh]ect_á_reas?_a') + #69
lema(ur'[Hh]elic_ó_pteros?_o') + #60
lema(ur'[Hh]eredit_a_ri[ao]s?_á') + #16
lema(ur'[Hh]ermos_í_sim[ao]s?_i') + #0
lema(ur'[Hh]eterog_é_ne[ao]s?_e') + #12
lema(ur'[Hh]ialur_ó_nic[ao]s?_o') + #0
lema(ur'[Hh]ic_i_eron_') + #6
lema(ur'[Hh]idr_á_ulic[ao]s?_a') + #17
lema(ur'[Hh]idr_ó_genos?_o') + #28
lema(ur'[Hh]idroel_é_ctric[ao]s?_e') + #19
lema(ur'[Hh]idrogr_á_fic[ao]s?_a') + #23
lema(ur'[Hh]idrograf_í_as?_i') + #79
lema(ur'[Hh]ig_ié_nic[ao]s?_(?:ie|[eé])') + #13
lema(ur'[Hh]iper_ví_nculos?_(?: v[ií]|vi)') + #1
lema(ur'[Hh]ipn_ó_tic[ao]s?_o') + #1
lema(ur'[Hh]ipod_é_rmic[ao]s?_e') + #1
lema(ur'[Hh]ipot_é_tic[ao]s?_e') + #3
lema(ur'[Hh]ispa_noamé_rica_(?:noam|oamé|ñoamé)') + #0
lema(ur'[Hh]istolog_í_as?_i') + #10
lema(ur'[Hh]o_mó_nim[ao]s?_(?:mo|n[oó])') + #90
lema(ur'[Hh]oland_e_s[ae]s_é') + #2
lema(ur'[Hh]ologr_á_fic[ao]s?_a') + #6
lema(ur'[Hh]om_ó_nim[ao]s?_o') + #44
lema(ur'[Hh]onr__os[ao]s?_r') + #3
lema(ur'[Hh]onrar_í_a[ns]?_i') + #3
lema(ur'[Hh]or_ó_scopos?_o') + #3
lema(ur'[Hh]u_i_(?:r(?:l[aeo]s?|se|)|d[ao]s?)_í') + #117
lema(ur'[Hh]u_i_d[ao]s?_í') + #104
lema(ur'[Hh]umor_í_stic(?:[ao]s|amente)_i') + #7
lema(ur'[Hh]umor_í_stic[ao]_i') + #34
lema(ur'[Hh]umor_í_stic[ao]s?_') + #0
lema(ur'[Hh]und(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Hh]urac_a_nes_á') + #3
...
lema(ur'[Ii]_mpresió_n_(?:npre[sc]i[oó]|mpreci[oó]|mpresio)') + #14
lema(ur'[Ii]_n_mortal(?:es|idad)_m') + #4
lema(ur'[Ii]deol_ó_gic(?:[ao]s|amente)_o') + #9
lema(ur'[Ii]diom_á_tic[ao]s?_') + #0
lema(ur'[Ii]leg_í_tim(?:as?|os?|amente)_i') + #43
lema(ur'[Ii]lustr_í_sim[ao]s?_i') + #10
lema(ur'[Ii]m_a_gen_á') + #143
lema(ur'[Ii]m_portan_tes?_(?:ortan|porta)') + #15
...
lema(ur'[Ii]mpl_í_cit(?:[ao]s|amente)_i') + #6
lema(ur'[Ii]mplicar_í_a[ns]?_i') + #0
lema(ur'[Ii]mpondr_á_[ns]?_a') + #0
lema(ur'[Ii]mportant_í_sim[ao]s?_i') + #1
lema(ur'[Ii]mportar_í_a[ns]?_i') + #2
lema(ur'[Ii]mprim(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Ii]n_clui_d[ao]s?_luí') + #1
lema(ur'[Ii]n_i_cia(?:[rlns]|les|tivas?|lmente|ría[ns]?|ron|ndo|d[ao]s?|ción|ciones|)_') + #127
lema(ur'[Ii]n_j_erencias?_g') + #28
lema(ur'[Ii]n_s_pirado_') + #1
lema(ur'[Ii]n_s_talaci(?:ón|ones)_') + #2
lema(ur'[Ii]n_s_tancias?_') + #2
lema(ur'[Ii]n_s_titu(?:ye|y[oó]|ción|ciones|id[ao]s?)_') + #3
lema(ur'[Ii]n_struccio_nes_s?trucció') + #2
lema(ur'[Ii]nal_á_mbric[ao]s?_a') + #22
lema(ur'[Ii]nclu_i_d[ao]s?_í') + #319
lema(ur'[Ii]nclu_i_r(?:l[aeo]s?|se|)_í') + #5
lema(ur'[Ii]nclu_i_r_í') + #3
lema(ur'[Ii]nclu_i_ría[ns]?_í') + #0
lema(ur'[Ii]nclu_í_a[ns]?_i') + #301
lema(ur'[Ii]ncluir_á_[ns]?_a') + #7
lema(ur'[Ii]ncluir_í_a[ns]?_i') + #4
lema(ur'[Ii]ncon_s_ciencias?_') + #3
lema(ur'[Ii]ncon_s_cientes?_') + #20
lema(ur'[Ii]ncon_sc_ientes?_[sc]') + #32
lema(ur'[Ii]ncorporar_s_e(?:lo|)_c') + #0
lema(ur'[Ii]ncre_í_ble(?:s|mente)_i') + #18
lema(ur'[Ii]ncre_í_blemente_i') + #7
lema(ur'[Ii]nde__pendencia_n') + #1
lema(ur'[Ii]ndepend__encias?_i') + #2
lema(ur'[Ii]ndic_ó_ que_o') + #17
lema(ur'[Ii]ndivid_u_os_') + #1
lema(ur'[Ii]nequ_í_voc(?:[ao]s|amente)_i') + #1
lema(ur'[Ii]nflu_i_dos?_í') + #12
lema(ur'[Ii]nfluir_á_[ns]?_a') + #0
lema(ur'[Ii]nform_á_ticos?(?!\.com)_a') + #15
lema(ur'[Ii]nfrac_c_ión_') + #1
lema(ur'[Ii]ngen_i_erías?_') + #7
lema(ur'[Ii]ngresar_í_a[ns]?_i') + #0
lema(ur'[Ii]nic_i_ativas?_') + #3
lema(ur'[Ii]nmiscu_i_d[ao]s?_í') + #1
lema(ur'[Ii]nmo_v_iliz(?:[oó]|a(?:r?|r(?:l[aeo]s?|nos?)|d[ao]s?|ndo|ción|dor))_b') + #9
lema(ur'[Ii]nscrib(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Ii]nsin_ú_(?:a[ns]?|e[ns]?)_u') + #8
lema(ur'[Ii]nsist(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Ii]nspirad_í_sim[ao]s?_i') + #0
lema(ur'[Ii]nspirar_í_a[ns]?_i') + #0
lema(ur'[Ii]nstant_á_ne(?:[ao]s|amente)_a') + #6
lema(ur'[Ii]nstant_á_ne[ao]_a') + #16
lema(ur'[Ii]nstitu_i_d[ao]s?_í') + #21
lema(ur'[Ii]nstru_i_d[ao]s?_í') + #23
lema(ur'[Ii]nt_er_pretad[ao]s?_re') + #15
lema(ur'[Ii]nt_é_rpretes_e', pre=ur'(?:[AaEe]l|[Uu]na?|[Ll][ao]s|[Pp]or|[Vv]ari[ao]s|[Ff]amos[ao]s?|[Aa]rtistas?|[Dd]estacad[ao]s?|[Oo]tr[ao]s?|[Mm]ejor(?:es|)|[Ee]st[ao]s?|[Mm]uch[ao]s?|[Cc]uy[ao]s?|[Aa]lgun[ao]s|[Aa]lgún|[Aa]lguna|[Cc]onocid[ao]s?|[Ss]us?|[0-9]+|[Pp]rimer|[Gg]ran|[Cc]on) ') + #57
lema(ur'[Ii]nte__grad[ao]s?_n') + #0
lema(ur'[Ii]nte_r_pret[oó]_') + #11
lema(ur'[Ii]nte_r_preta[ns]?_') + #4
lema(ur'[Ii]nte_r_pretaba[ns]?_') + #0
lema(ur'[Ii]nte_r_pretaciones_') + #0
lema(ur'[Ii]nte_r_pretación_') + #7
lema(ur'[Ii]nte_r_pretad[ao]s?_') + #30
lema(ur'[Ii]nte_r_pretando_') + #9
lema(ur'[Ii]nte_r_pretar(?:l[ao]s?|se|[aá]|ía[ns]?|ron|)_') + #12
lema(ur'[Ii]nteligent_í_sim[ao]s?_i') + #0
lema(ur'[Ii]nteresar_í_a[ns]?_i') + #1
lema(ur'[Ii]nterp_r_et(?:es?|ad[ao]s?)_') + #6
...
lema(ur'[Ii]nven_c_ibles?_s') + #3
lema(ur'[Ii]nvertir_á_[ns]?_a') + #2
lema(ur'[Ii]nvestigaci_ón|investigaciones]]__[óo]n\]\]es') + #0
lema(ur'[Ii]nvolucrar_í_a[ns]?_i') + #1
lema(ur'[Ii]r_ó_nic(?:[ao]s|amente)_o') + #9
lema(ur'[Jj]_o_ven_ó') + #251
lema(ur'[Jj]_ó_venes_o') + #237
lema(ur'[Jj]ap_oné_s_óne') + #1
lema(ur'[Jj]ard_í_n [Bb]otánico_i') + #12
lema(ur'[Jj]esu_í_tic[ao]s?_i') + #19
lema(ur'[Jj]ovenc_í_sim[ao]s?_i') + #2
lema(ur'[Jj]oyer_í_as?_i') + #17
lema(ur'[Jj]uda_í_smo_i') + #98
lema(ur'[Jj]ueg_u_e[ns]?_') + #10
lema(ur'[Jj]ugar_í_a[ns]?_i') + #26
lema(ur'[Jj]ur_í_dic(?:os|amente)_i') + #6
lema(ur'[Jj]ur_í_dicas(?!\.(?:com|unam\.mx))_i') + #14
...
lema(ur'[Ll]_á_piz_a') + #39
lema(ur'[Ll]_í_deres_i') + #172
lema(ur'[Ll]_í_quenes_i') + #8
lema(ur'[Ll]a n_ó_mina(?! (?:di|al|a la|dubia|en|con))_o') + #12
lema(ur'[Ll]a_ _misma_') + #2
lema(ur'[Ll]a_s_ [aá]reas_') + #8
lema(ur'[Ll]a_s_ acciones_') + #13
lema(ur'[Ll]a_s_ actividades_') + #21
lema(ur'[Ll]a_s_ afueras_') + #13
lema(ur'[Ll]a_s_ autoridades_') + #40
lema(ur'[Ll]a_s_ bandas_') + #18
lema(ur'[Ll]a_s_ bases_') + #21
lema(ur'[Ll]a_s_ calles_') + #43
lema(ur'[Ll]a_s_ canciones_') + #40
lema(ur'[Ll]a_s_ caracter[ií]sticas_') + #17
lema(ur'[Ll]a_s_ cercanías_') + #18
lema(ur'[Ll]a_s_ ciencias_') + #13
lema(ur'[Ll]a_s_ ciudades_') + #72
lema(ur'[Ll]a_s_ compañ[ií]as_') + #13
lema(ur'[Ll]a_s_ comunidades_') + #11
lema(ur'[Ll]a_s_ condiciones_') + #18
lema(ur'[Ll]a_s_ costas_') + #15
lema(ur'[Ll]a_s_ cuales_') + #79
lema(ur'[Ll]a_s_ células_') + #17
lema(ur'[Ll]a_s_ diferencias_') + #16
lema(ur'[Ll]a_s_ diferentes_') + #15
lema(ur'[Ll]a_s_ distintas_') + #6
lema(ur'[Ll]a_s_ divisiones_') + #24
lema(ur'[Ll]a_s_ décadas_') + #8
lema(ur'[Ll]a_s_ elecciones_') + #58
lema(ur'[Ll]a_s_ empresas_') + #29
lema(ur'[Ll]a_s_ especies_') + #17
lema(ur'[Ll]a_s_ estaciones_') + #18
lema(ur'[Ll]a_s_ estructuras_') + #7
lema(ur'[Ll]a_s_ familias_') + #20
lema(ur'[Ll]a_s_ fechas_') + #22
lema(ur'[Ll]a_s_ fiestas_') + #28
lema(ur'[Ll]a_s_ figuras_') + #11
lema(ur'[Ll]a_s_ filas_') + #23
lema(ur'[Ll]a_s_ formas_') + #12
lema(ur'[Ll]a_s_ fuerzas_') + #61
lema(ur'[Ll]a_s_ funciones_') + #15
lema(ur'[Ll]a_s_ grandes_') + #44
lema(ur'[Ll]a_s_ ideas_') + #22
lema(ur'[Ll]a_s_ iglesias_') + #16
lema(ur'[Ll]a_s_ im[aá]genes_') + #14
lema(ur'[Ll]a_s_ industrias_') + #10
lema(ur'[Ll]a_s_ inmediaciones_') + #11
lema(ur'[Ll]a_s_ islas_') + #61
lema(ur'[Ll]a_s_ lenguas_') + #9
lema(ur'[Ll]a_s_ letras_') + #14
lema(ur'[Ll]a_s_ leyes_') + #20
lema(ur'[Ll]a_s_ listas_') + #52
lema(ur'[Ll]a_s_ localidades_') + #15
lema(ur'[Ll]a_s_ líneas_') + #24
lema(ur'[Ll]a_s_ manos_') + #17
lema(ur'[Ll]a_s_ mejores_') + #14
lema(ur'[Ll]a_s_ minas_') + #10
lema(ur'[Ll]a_s_ mismas_') + #25
lema(ur'[Ll]a_s_ montañas_') + #12
lema(ur'[Ll]a_s_ mujeres_') + #42
lema(ur'[Ll]a_s_ nuevas_') + #20
lema(ur'[Ll]a_s_ obras_') + #64
lema(ur'[Ll]a_s_ orillas_') + #8
lema(ur'[Ll]a_s_ otras_') + #24
lema(ur'[Ll]a_s_ palabras_') + #27
lema(ur'[Ll]a_s_ partes_') + #19
lema(ur'[Ll]a_s_ pel[ií]culas_') + #21
lema(ur'[Ll]a_s_ personas_') + #26
lema(ur'[Ll]a_s_ plantas_') + #10
lema(ur'[Ll]a_s_ poblaciones_') + #20
lema(ur'[Ll]a_s_ posibilidades_') + #5
lema(ur'[Ll]a_s_ posiciones_') + #16
lema(ur'[Ll]a_s_ primeras_') + #54
lema(ur'[Ll]a_s_ principales_') + #42
lema(ur'[Ll]a_s_ provincias_') + #38
lema(ur'[Ll]a_s_ redes_') + #14
lema(ur'[Ll]a_s_ regiones_') + #32
lema(ur'[Ll]a_s_ relaciones_') + #31
lema(ur'[Ll]a_s_ revistas_') + #11
lema(ur'[Ll]a_s_ ruinas_') + #11
lema(ur'[Ll]a_s_ rutas_') + #8
lema(ur'[Ll]a_s_ semifinales_') + #39
lema(ur'[Ll]a_s_ series_') + #74
lema(ur'[Ll]a_s_ sierras_') + #5
lema(ur'[Ll]a_s_ siguientes_') + #69
lema(ur'[Ll]a_s_ sociedades_') + #5
lema(ur'[Ll]a_s_ temporadas_') + #18
lema(ur'[Ll]a_s_ teor[ií]as_') + #4
lema(ur'[Ll]a_s_ tierras_') + #9
lema(ur'[Ll]a_s_ tropas_') + #19
lema(ur'[Ll]a_s_ unidades_') + #9
lema(ur'[Ll]a_s_ universidades_') + #10
lema(ur'[Ll]a_s_ ventas_') + #4
lema(ur'[Ll]a_s_ vías_') + #16
lema(ur'[Ll]a_s_ últimas_') + #18
lema(ur'[Ll]anzar_í_a[ns]?_i') + #5
lema(ur'[Ll]argu_í_sim[ao]s?_i') + #1
lema(ur'[Ll]as [uú]ltima_s__') + #69
lema(ur'[Ll]eg_í_tim(?:as|os|amente)_i') + #18
lema(ur'[Ll]encer_í_as?_i') + #17
lema(ur'[Ll]exicolog_í_as?_i') + 
lema(ur'[Ll]iger_í_sim[ao]s?_i') + #0
lema(ur'[Ll]inf_á_tic[ao]s?_a') + #6
lema(ur'[Ll]lam_a_d[ao]s?_') + #38
lema(ur'[Ll]lamar_s_e(?:lo|)_c') + #0
lema(ur'[Ll]lamar_í_a(?:[ns]?|mos)_i') + #6
lema(ur'[Ll]legar_í_a[ns]?_i') + #13
lema(ur'[Ll]len_í_sim[ao]s?_i') + #0
lema(ur'[Ll]lev_á_r[mts]el[aeo]s?_a') + #8
lema(ur'[Ll]leva(rá|) a_ _cabo_') + #13
lema(ur'[Ll]levar_í_a[ns]?_i') + #10
lema(ur'[Ll]ocalizar_s_e(?:lo|)_c') + #0
lema(ur'[Ll]ograr_í_a[ns]?_i') + #8
lema(ur'[Ll]uchar_í_a[ns]?_i') + #0
lema(ur'[Mm]_u_sical_ú') + #219
lema(ur'[Mm]_u_sicales_ú') + #15
lema(ur'[Mm]_utua_mente_(?:útual?|utual)') + #27
lema(ur'[Mm]_á_gic(?:[ao]s|amente)_a') + #28
lema(ur'[Mm]_á_nager_a', pre=ur'(?:[Ee]l|[Dd]el?|[Ll]a|[Uu]n|[Ss]u|nuevo|antiguo|anterior|próximo) ') + #732
lema(ur'[Mm]_á_rgenes_a') + #22
...
lema(ur'[Mm]_á_s (?:actual|afinidad|calor|espectacular|fértil|gol|letal|posibilidad|principal|real|regular|septentrional|usual)(?:es|)\b_a') + #136
lema(ur'[Mm]_á_s (?:adelante|atrás|dos)\b_a') + #152
lema(ur'[Mm]_á_s (?:alt|amarg|amig|citad|competitiv|desconocid|distintiv|envejecid|equilibrad|ergonómic|insegur|lujos|notad|óptim|pequeñ|poblad|prolífic|rocker|select|sosegad|vendid|veteran|vigoros|violent|viv)[ao]s?\b_a') + #503
lema(ur'[Mm]_á_s (?:cambi|campeonat|dat|equip|fot|minut|reconocimient|refuerz|sencill|tir|trabaj|títul)os?\b_a') + #137
lema(ur'[Mm]_á_scaras?_a', pre=ur'(?:[Ll]as?|[Uu]nas?|[Ss]us?) ') + #389
lema(ur'[Mm]_ás allá__(?:as all[aá]|ás alla)') + #146
lema(ur'[Mm]_é_dicos_e', pre=ur'(?:[Ll]os|[Ss]us|[Uu]nos) ') + #6
lema(ur'[Mm]_é_todos_e') + #26
lema(ur'[Mm]_éto_dos?_etó') + #3
lema(ur'[Mm]_í_nimamente_i') + #12
lema(ur'[Mm]_ú_ltiple (?:accidente|álbumes|asesinato|cambio|campeón|con|de |instrumentos|interpretación|mediante|ocasiones|por|productores|que|significa|variantes|vol[uú]menes|y )_u') + #3
lema(ur'[Mm]_ú_ltiples?_u', pre=ur'\b(?:Monitores|en|por|creado|normales|reclutando|[Cc]opias| de|Tiene|esclerosis|[Ee]lectrica) ', xpre=[ur'Pénétrations ']) + #9
lema(ur'[Mm]a_m_posteros_n') + #1
lema(ur'[Mm]a_m_postería_n') + #13
lema(ur'[Mm]a_mposterí_a_nposteri') + #1
lema(ur'[Mm]aci_z_os?_c') + #1
lema(ur'[Mm]acrosc_ó_pic[ao]s?_o') + #4
lema(ur'[Mm]agn_í_fica_i', pre=ur'(?:una (?:banda|vista|forma|defensa natural|escritora)| (?:durante|a) la|de forma|sólida y) ') + #2
lema(ur'[Mm]al_í_sim[ao]s?_i') + #2
lema(ur'[Mm]am_í_fer[ao]s?_i') + #60
lema(ur'[Mm]anten_í_a[ns]?_i') + #14
lema(ur'[Mm]antendr_á_[ns]?_a') + #6
lema(ur'[Mm]antendr_í_a[ns]?_i') + #5
lema(ur'[Mm]archar_í_a[ns]?_i') + #0
lema(ur'[Mm]asoner_í_as?_i') + #29
lema(ur'[Mm]atem_á_tic(?:os|amente)(?!\.unmsm)_a') + #7
lema(ur'[Mm]ayor_í_as?_i') + #216
lema(ur'[Mm]e_n_sajes?_') + #1
lema(ur'[Mm]ec_á_nic(?:[ao]s|amente)_a') + #14
lema(ur'[Mm]ecatr_ó_nicas?_o') + #3
lema(ur'[Mm]edi_a_nte_e') + #5
lema(ur'[Mm]ediod_í_as?_i') + #55
lema(ur'[Mm]edir_á_[ns]?_a') + #2
lema(ur'[Mm]egafon_í_as?_i') + #3
lema(ur'[Mm]elodram_á_tic[ao]s?_a') + #4
lema(ur'[Mm]ensajer_í_as?_i') + #12
lema(ur'[Mm]ercader_í_as?_i') + #9
lema(ur'[Mm]ercanc_í_as?_i') + #71
lema(ur'[Mm]ere_ció__scio') + #0
lema(ur'[Mm]etereol_ó_gic[ao]s?_o') + #1
lema(ur'[Mm]exican_í_sim[ao]s?_i') + #4
lema(ur'[Mm]ie_m_bros?_n') + #5
lema(ur'[Mm]ientra_s__') + #56
lema(ur'[Mm]iner_í_as?_i') + #106
lema(ur'[Mm]inusv_á_lid[ao]s?_a') + #2
lema(ur'[Mm]ism_í_sim[ao]s?_i') + #19
lema(ur'[Mm]o_n_struos?_') + #8
lema(ur'[Mm]o_nstru_o_unstr') + #17
lema(ur'[Mm]oment_á_ne(?:[ao]s|amente)_a') + #6
lema(ur'[Mm]onol_í_tic[ao]s?_i') + #4
lema(ur'[Mm]orir_á_[ns]?_a') + #12
lema(ur'[Mm]orir_í_a[ns]?_i') + #14
lema(ur'[Mm]u__rieron_e') + #5
lema(ur'[Mm]u_n_icipios?__') + #4
lema(ur'[Mm]uch_í_sim[ao]s?_i') + #10
lema(ur'[Mm]ultiprop_ó_sitos?_o') + #4
lema(ur'[Mm]urci_é_lagos?_e') + #40
lema(ur'[Mm]uri_á_tic[ao]s?_a') + #0
lema(ur'[Mm]usic_ó_log[ao]s?_o') + #81
lema(ur'[Mm]usulm_á_n_á') + #6194
lema(ur'[Nn]_á_useas_a') + #182
lema(ur'[Nn]_áu_frag[ao]s?_aú') + #14
lema(ur'[Nn]acional_ de_ Yosemite\]\]_') + #0
lema(ur'[Nn]anotecnolog_í_as?_i') + #6
lema(ur'[Nn]arcotr_á_ficos?_a') + #33
lema(ur'[Nn]ari_c_es_[zs]') + #1
lema(ur'[Nn]ecesitar_í_a(?:[ns]?|mos)_i') + #4
lema(ur'[Nn]ecrol_ó_gic[ao]s?_o') + #16
lema(ur'[Nn]ecrolog_í_as?_i') + #5
lema(ur'[Nn]egoc_i_aci(?:ón|ones)_') + #2
lema(ur'[Nn]eocl_á_sic[ao]s?_a') + #54
lema(ur'[Nn]eum_á_tic[ao]s?_a') + #83
lema(ur'[Nn]eur_á_lgic[ao]s?_a') + #3
lema(ur'[Nn]euroanatom_í_as?_i') + #6
lema(ur'[Nn]europsicolog_í_as?_i') + #5
lema(ur'[Nn]i_ _siquiera_') + #5
lema(ur'[Nn]icarag_ü_enses_u') + #5
lema(ur'[Nn]inf_ó_manas?_o') + #3
lema(ur'[Nn]itr_ó_genos?_o') + #5
lema(ur'[Nn]iv_e_l(?:es|)_é') + #2
lema(ur'[Nn]oqu_eó__io') + #0
lema(ur'[Nn]orirland_é_s_e') + #2
lema(ur'[Nn]orteam_é_rica(?!\]\])_e') + #137
lema(ur'[Nn]otar_í_an_i') + #0
lema(ur'[Nn]ov_í_sim[ao]s?_i') + #9
lema(ur'[Nn]uest_r_o_') + #3
lema(ur'[Nn]um_é_ric(?:[ao]s|amente)_e') + #3
lema(ur'[Oo]_b_t(?:en(?:er|gan?|dr[ií]a[ns]?)|ienen?|uvo)_p') + #5
lema(ur'[Oo]_b_tenido_p') + #0
lema(ur'[Oo]bst_á_culos?_a') + #47
lema(ur'[Oo]bstru_i_d[ao]s?_í') + #2
lema(ur'[Oo]bten(?:dr|)_í_a[ns]?_i') + #14
lema(ur'[Oo]btendr_á_[ns]?_a') + #3
lema(ur'[Oo]btendr_í_a(?:[ns]?|mos)_i') + #5
lema(ur'[Oo]c_éano Í_ndico_(?:eano [iíIÍ]|éano [iIí])') + #29
lema(ur'[Oo]casionar_í_a[ns]?_i') + #0
lema(ur'[Oo]curr(?:ir|)_í_a[ns]?_i') + #6
lema(ur'[Oo]curr_í_a[ns]?_i') + #5
lema(ur'[Oo]currir_á_[ns]?_a') + #5
lema(ur'[Oo]dontol_ó_gic[ao]s?_o') + #5
lema(ur'[Oo]fend_í_a[ns]?_i') + #8
lema(ur'[Oo]frec_í_a[ns]?_i') + #54
lema(ur'[Oo]frecer_á_[ns]?_a') + #4
lema(ur'[Oo]pon_í_a[ns]?_i') + #4
lema(ur'[Oo]ptar_í_a[ns]?_i') + #0
lema(ur'[Oo]r_i_gen_í') + #607
lema(ur'[Oo]r_á_culos?_a') + #15
lema(ur'[Oo]rdenar_í_a[ns]?_i') + #1
lema(ur'[Oo]rg_á_nic(?:[ao]s|amente)_a') + #3
lema(ur'[Oo]rgani_z_ad[ao]s?_s') + #1
lema(ur'[Oo]rganizar_s_e(?:lo|)_c') + #0
lema(ur'[Oo]riginal_í_sim[ao]s?_i') + #1
lema(ur'[Oo]rtop_é_dic[ao]s?_e') + #1
lema(ur'[Oo]torg_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Oo]torrinolaringolog_í_as?_i') + #5
lema(ur'[Pp]_e_rtenece[nrs]?_a') + #2
lema(ur'[Pp]_ro_gramas?_or') + #2
lema(ur'[Pp]_á_gina (?:[Ww]eb|oficial|del?)_a') + #1219
lema(ur'[Pp]_á_ginas?_a', pre=ur'(?:[Ll]as?)') + #2
lema(ur'[Pp]_á_rrafos?_a') + #37
lema(ur'[Pp]_é_rtigas?_e') + #3
lema(ur'[Pp]_é_sim[ao]s?_e') + #10
lema(ur'[Pp]_í_ldoras?_i') + #10
lema(ur'[Pp]_ó_lvoras?_o') + #27
lema(ur'[Pp]a_í_ses(?! Baixos)_i') + #553
lema(ur'[Pp]ac_í_fic(?:as|os|amente)_i') + #14
lema(ur'[Pp]ac_í_fico_i', pre=ur'([Ee]l|[Dd]el) ') + #253
lema(ur'[Pp]acient_í_sim[ao]s?_i') + #0
lema(ur'[Pp]adec_í_a[ns]?_i') + #14
lema(ur'[Pp]agar_í_a[ns]?_i') + #1
lema(ur'[Pp]aisaj_í_stic(?:[ao]s?|amente)_i') + #9
lema(ur'[Pp]aleogeograf_í_a_i') + #1
lema(ur'[Pp]ar_á_lisis_a') + #16
lema(ur'[Pp]araca_í_das?_i') + #4
lema(ur'[Pp]arad_ó_jic(?:[ao]s|amente)_o') + #6
lema(ur'[Pp]aran_o_ic[ao]s?_ó') + #4
lema(ur'[Pp]arecer_s_e(?:lo|)_c') + #0
lema(ur'[Pp]arecer_á_[ns]?_a') + #0
lema(ur'[Pp]arente_s_cos?_z') + #6
lema(ur'[Pp]arlanch_í_n_i') + #2
lema(ur'[Pp]artic_i_par(?:on|)_') + #12
lema(ur'[Pp]articip_ó_ (?:en|junto|como)_o') + #517
lema(ur'[Pp]articipar_í_a[ns]?_i') + #9
lema(ur'[Pp]as_sio_n_i[oó]', pre=ur'of (?:the |)') + #4
lema(ur'[Pp]as_á_r[mts]el[aeo]s?_a') + #1
lema(ur'[Pp]asant_í_as?_i') + #5
lema(ur'[Pp]asar_í_a[ns]?_i') + #22
lema(ur'[Pp]atol_ó_gic[ao]s?_o') + #6
lema(ur'[Pp]atolog_í_as_i') + #3
lema(ur'[Pp]e_r_manece(?:[nr]|ría[ns]?|)_') + #3
lema(ur'[Pp]e_s_ca[rs]?_z') + #4
lema(ur'[Pp]edir_á_[ns]?_a') + #3
lema(ur'[Pp]elear_s_e_z') + #0
lema(ur'[Pp]elear_í_a[ns]?_i') + #0
lema(ur'[Pp]equeñ_í_sim[ao]s?_i') + #1
lema(ur'[Pp]er__iodista_d') + #2
lema(ur'[Pp]er__iodo_d') + #0
lema(ur'[Pp]er_imetró__(?:ímetr[oó]|imetro)', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #0
lema(ur'[Pp]ercib(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Pp]ercl_ó_ric[ao]s?_o') + #1
lema(ur'[Pp]erder_á_[ns]?_a') + #5
lema(ur'[Pp]erdurar_í_a[ns]?_i') + #1
lema(ur'[Pp]eri_ó_dic(?:as|amente)_o', pre=ur'\.edu') + #0
lema(ur'[Pp]eriod_í_stic[ao]s?_i') + #44
lema(ur'[Pp]ermane__ciendo_n') + #15
lema(ur'[Pp]ermanec_í__i') + #0
lema(ur'[Pp]ermanecer_á_[ns]?_a') + #5
lema(ur'[Pp]ermanecer_í_a[ns]?_i') + #6
lema(ur'[Pp]ermit(?:ir|)_í_a[ns]?_i') + #34
lema(ur'[Pp]ermit_í__i') + #4
lema(ur'[Pp]ermitir_á_[ns]?_a') + #9
lema(ur'[Pp]ermitir_í_a[ns]?_i') + #7
lema(ur'[Pp]erseguir_á_[ns]?_a') + #0
lema(ur'[Pp]ersonal_í_sim[ao]s?_i') + #0
lema(ur'[Pp]ersoner_í_as?_i') + #15
lema(ur'[Pp]erten_e_cer(?:á[ns]?|ía[ns]?|)_') + #3
lema(ur'[Pp]ertenecer_á_[ns]?_a') + #0
lema(ur'[Pp]esquer_í_as?_i') + #2
lema(ur'[Pp]ict_ó_ric[ao]s?_o') + #11
lema(ur'[Pp]ing_ü_inos?_u') + #46
lema(ur'[Pp]irater_í_as?_i') + #17
lema(ur'[Pp]luric_é_ntric[ao]s?_e') + #0
lema(ur'[Pp]neumatol_ó_gic[ao]s?_o') + #0
lema(ur'[Pp]nuematolog_í_as?_i') + #0
lema(ur'[Pp]od_í_amos_i') + #2
lema(ur'[Pp]oder_í_o_i') + #27
lema(ur'[Pp]odiatr_í_as?_i') + #0
lema(ur'[Pp]odolog_í_a(?!\.cl)_i') + #1
lema(ur'[Pp]odr_á_[ns]?_a') + #51
lema(ur'[Pp]odr_í_a(?:[ns]?|mos)_i') + #103
lema(ur'[Pp]ol_í_ticas_') + #0
lema(ur'[Pp]ol_í_ticos(?!\.html)_i') + #124
lema(ur'[Pp]olicl_í_nicas?_i') + #19
lema(ur'[Pp]on_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Pp]ondr_á_n_a') + #0
lema(ur'[Pp]ondr_í_a(?:[ns]?|mos)_i') + #9
lema(ur'[Pp]oner_s_e(?:lo|)_c') + #0
lema(ur'[Pp]opular_í_sim[ao]s?_i') + #0
lema(ur'[Pp]opulari_zó__(?:s[oó]|zo)') + #11
lema(ur'[Pp]opurr_í__i') + #79
lema(ur'[Pp]oqu_í_sim[ao]s?_i') + #0
lema(ur'[Pp]or s_í so_l[ao]s?_(?:i s[oó]|í só)') + #370
lema(ur'[Pp]or_ _ciento_') + #43
lema(ur'[Pp]ort_á_til(?:es|)_a') + #134
lema(ur'[Pp]ortug_ué_s_e') + #6
lema(ur'[Pp]ose_í_a[ns]?_i') + #24
lema(ur'[Pp]ose_í_d[ao]s?_i') + #27
lema(ur'[Pp]oseer_á_[ns]?_a') + #0
lema(ur'[Pp]osi_c_ionada_s') + #1
lema(ur'[Pp]osi_c_ionamiento_s') + #1
lema(ur'[Pp]osicionar_s_e(?:lo|)_c') + #0
lema(ur'[Pp]r_a_cticar(?:se|lo|le|on|an|)_á') + #10
lema(ur'[Pp]r_á_ctic(?:os|amente)_a') + #81
lema(ur'[Pp]r_á_cticas de_a') + #20
lema(ur'[Pp]r_á_cticas_a', pre=ur'(?:[Ll]as|[Uu]nas|[Ss]us) ') + #12
lema(ur'[Pp]r_é_stamo_e') + #216
lema(ur'[Pp]r_ó_xim(?:[ao]s|amente)_o') + #115
lema(ur'[Pp]re_s_enci(?:a[ns]?|[oó]|ar(?:[eé]|[aá][ns]?|ron))_s?c') + #13
lema(ur'[Pp]refi__rieron_e') + #2
lema(ur'[Pp]refi__rió_e') + #1
lema(ur'[Pp]rehisp_á_nic[ao]s?_a') + #23
lema(ur'[Pp]reparar_s_e(?:lo|)_c') + #0
lema(ur'[Pp]resent_á_r[mts]el[aeo]s?_a') + #2
lema(ur'[Pp]residir_á_[ns]?_a') + #0
lema(ur'[Pp]residir_í_a[ns]?_i') + #19
lema(ur'[Pp]restar_í_a[ns]?_i') + #0
lema(ur'[Pp]resum(?:ir|)_í_a[ns]?_i') + #2
lema(ur'[Pp]retend_í_a[ns]?_i') + #11
lema(ur'[Pp]revalecer_á_[ns]?_a') + #0
lema(ur'[Pp]reve_í_a[ns]?_i') + #0
lema(ur'[Pp]ri_me_r[ao]s?_em') + #30
lema(ur'[Pp]ri_n_cipal(?:es|mente|)_') + #43
lema(ur'[Pp]rim_e_r[ao]s?_') + #4
lema(ur'[Pp]rim_e_ras?_a', pre=ur'(?:[Ll]as?|[Ss]us|[Uu]nas?|[Ee]n|[Dd]e|[Pp]or) ') + #3
lema(ur'[Pp]rimar_i_a_', pre=ur'(?:[Ee]scuelas?|formas?|[Ee]nseñanzas?|[Ee]ducación|[Ee]lecciones|[Ee]lección|[Aa]tención|Estudió) ') + #2
lema(ur'[Pp]rimer_í_sim[ao]s?_i') + #5
lema(ur'[Pp]rimi_c_ias?_s') + #0
lema(ur'[Pp]ro_b_ad[ao]s?_v') + #27
lema(ur'[Pp]ro_v_oca[ns]?_b') + #0
lema(ur'[Pp]roceder_á_[ns]?_a') + #0
lema(ur'[Pp]rodu_jo__ci[oó]') + #9
lema(ur'[Pp]roduc(?:ir|)_í_a[ns]?_i') + #11
lema(ur'[Pp]roducir_s_e(?:lo|)_c') + #0
lema(ur'[Pp]roducir_á_[ns]?_a') + #3
lema(ur'[Pp]roducir_í_a[ns]?_i') + #4
lema(ur'[Pp]rofe_s_ional(?:es|)_c') + #16
lema(ur'[Pp]rohib_í_a[ns]?_i') + #10
lema(ur'[Pp]rol_í_fic(?:as|os?)_i') + #5
lema(ur'[Pp]romet_í_(?:a[ns]?|)_i') + #5
lema(ur'[Pp]romov_í_a[ns]?_i') + #1
lema(ur'[Pp]romover_á_[ns]?_a') + #2
lema(ur'[Pp]ropi_ó_nic[ao]s?_o') + #2
lema(ur'[Pp]ropon_í_a[ns]?_i') + #4
lema(ur'[Pp]ropondr_á_[ns]?_a') + #0
lema(ur'[Pp]rot_é_sic[ao]s?_e') + #0
lema(ur'[Pp]rotag_ó_nic[ao]s?_o') + #64
lema(ur'[Pp]rote_g_(?:e[nr]?|emos|erl[aeo]s?|erse|erá[ns]?|ería[ns]?|id[aeo]s?|iendo|iera|ieron|iese|ió)_j') + #11
lema(ur'[Pp]rote_í_nas?_i') + #69
lema(ur'[Pp]roteg_í_a[ns]?_i') + #8
lema(ur'[Pp]roteger_á_[ns]?_a') + #1
lema(ur'[Pp]rove_í_a[ns]?_i') + #1
lema(ur'[Pp]rove_í_d[ao]s?_i') + #6
lema(ur'[Pp]roveer_á_[ns]?_a') + #2
lema(ur'[Pp]roven_í_a[ns]?_i') + #54
lema(ur'[Pp]rovi_sio_(?:nal(?:es|)|nes)_ci[oó]') + #31
lema(ur'[Pp]s_í_quic[ao]s?_i') + #46
lema(ur'[Pp]sicoanal_í_tic[ao]s?_i') + #6
lema(ur'[Pp]sicol_ó_gic[ao]s_o') + #8
lema(ur'[Pp]siqui_á_tric[ao]s?_a') + #19
lema(ur'[Pp]u__dieron_e') + #15
lema(ur'[Pp]ublicar_í_a[ns]?_i') + #1
lema(ur'[Qq]u_eri_endo_ier') + #0
lema(ur'[Qq]u_ie_n_ei') + #4
lema(ur'[Qq]u_í_mic(?:[ao]s|amente)_i') + #18
lema(ur'[Qq]ued_ó_ (?:sólo|sin|descubierto)_o') + #17
lema(ur'[Qq]uedar_s_e(?:lo|)_c') + #1
lema(ur'[Qq]uedar_í_a[ns]?_i') + #14
lema(ur'[Qq]uer_í_amos_i') + #5
lema(ur'[Qq]uer_í_amos_i') + #5
lema(ur'[Qq]uincuag_é_sim[ao]s?_e') + #3
lema(ur'[Qq]uir_ú_rgic[ao]s?_u') + #23
lema(ur'[Qq]uis_o__ó') + #6
lema(ur'[Qq]uiz_á_s_a') + #13
lema(ur'[Rr]_á_pid(?:[ao]s|amente)_a') + #118
lema(ur'[Rr]_é_plica_', pre=ur'(?:[Uu]na|1) ') + #0
lema(ur'[Rr]_í_e[ns]?_i', pre=ur'(?:[Ss]e) ') + #12
lema(ur'[Rr]_í_gida_i', pre=ur'(?:hacer|una|Máscara|persona|cola|está) ') + #4
lema(ur'[Rr]adiofon_í_as?_i') + #6
lema(ur'[Rr]apid_í_sim[ao]s?_i') + #0
lema(ur'[Rr]ar_í_sim[ao]s?_i') + #1
lema(ur'[Rr]e__levantes?_e') + #0
lema(ur'[Rr]e_hu_sa[ns]?_(?:hu|[uú])') + #170
lema(ur'[Rr]e_presá_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_gresa') + #0
lema(ur'[Rr]e_s_pectiv[ao]s?_') + #5
lema(ur'[Rr]e_s_ponde[ns]?_') + #2
lema(ur'[Rr]e_s_pondió_') + #0
lema(ur'[Rr]e_í_r_i') + #53
lema(ur'[Rr]e_ú_ne[ns]?_u') + #155
lema(ur'[Rr]e_ú_sa[ns]_u') + #2
lema(ur'[Rr]eabrir_á_[ns]?_a') + #0
lema(ur'[Rr]ealizar_s_e(?:lo|)_c') + #1
lema(ur'[Rr]ealizar_í_a[ns]?_i') + #8
lema(ur'[Rr]eanudar_s_e(?:lo|)_c') + #0
lema(ur'[Rr]eap_are_c(?:e(?:[ns]?|r(?:a[ns]?|[áé]|ía[ns]?|))|ieron)_(?:ara|re)') + #0
lema(ur'[Rr]eaparecer_á_[ns]?_a') + #1
lema(ur'[Rr]earmar_í_a[ns]?_i') + #0
lema(ur'[Rr]eca_í_d[ao]s?_i') + #2
lema(ur'[Rr]ecaudar_í_a[ns]?_i') + #0
lema(ur'[Rr]eci_b_(?:e|ió|[íI]a|ir[eé])_v') + #24
lema(ur'[Rr]eci_b_id[ao]s?_v') + #5
lema(ur'[Rr]eci_bió__(?:vi[oó]|bio)') + #24
lema(ur'[Rr]eci_é_n_e') + #100
lema(ur'[Rr]ecib(?:ir|)_í_a[ns]?_i') + #16
lema(ur'[Rr]ecibir_á_[ns]?_a') + #7
lema(ur'[Rr]ecibir_í_a[ns]?_i') + #2
lema(ur'[Rr]eclu_i_d[ao]s?_í') + #11
lema(ur'[Rr]eco_g_(?:e[nrs]?|erl[aeo]s?|erán|id[ao]s?|iendo|ieron|imiento|ió|í)_j') + #25
lema(ur'[Rr]eco_g_e[ns]?_j') + #17
lema(ur'[Rr]ecog_í_a[ns]?_i') + #10
lema(ur'[Rr]ecoger_á_[ns]?_a') + #1
lema(ur'[Rr]econ_s_truir(?:l[ao]s?|se)_') + #0
lema(ur'[Rr]econciliar_s_e(?:lo|)_c') + #1
lema(ur'[Rr]econoc_í_a[ns]?_i') + #22
lema(ur'[Rr]econocer_á_[ns]?_a') + #0
lema(ur'[Rr]econocid_í_sim[ao]s?_i') + #0
lema(ur'[Rr]econocim_ie_ntos?_ei') + #2
lema(ur'[Rr]econstru_i_d[ao]s?_í') + #13
lema(ur'[Rr]econstru_i_r(?:l[aeo]s?|se|)_í') + #1
lema(ur'[Rr]ecorr_í_a[ns]?_i') + #10
lema(ur'[Rr]ecorrer_á_[ns]?_a') + #0
lema(ur'[Rr]ecuperar_í_a[ns]?_i') + #0
lema(ur'[Rr]ecurr(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Rr]ecurrir_á_[ns]?_a') + #1
lema(ur'[Rr]edistribu_i_d[ao]s?_í') + #1
lema(ur'[Rr]edu_j_eron_ci') + #6
lema(ur'[Rr]educir_s_e(?:lo|)_c') + #0
lema(ur'[Rr]educir_á_[ns]?_a') + #1
lema(ur'[Rr]eeditar_í_a[ns]?_i') + #0
lema(ur'[Rr]eempla_zó__(?:s[oó]|zo)', pre=ur'(?:[Ll]o|[Ss]e(?: me| te| l[aeo]s?|)) ') + #26
lema(ur'[Rr]eemplazar_í_a[ns]?_i') + #3
lema(ur'[Rr]eenv_í_a[ns]?_i') + #8
lema(ur'[Rr]ef_e_rencias?_') + #3
lema(ur'[Rr]eferir_s_e(?:lo|)_c') + #0
lema(ur'[Rr]efiner_í_as?_i') + #9
lema(ur'[Rr]eflejar_í_a[ns]?_i') + #0
lema(ur'[Rr]egad_í_os?_i') + #23
lema(ur'[Rr]egir_á_[ns]?_a') + #3
lema(ur'[Rr]egresar_í_a[ns]?_i') + #7
lema(ur'[Rr]ei_m_preso_n') + #2
...
lema(ur'[Rr]epart(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Rr]epetir_á_[ns]?_a') + #1
lema(ur'[Rr]eposar_í_a[ns]?_i') + #1
lema(ur'[Rr]epresentar_í_a[ns]?_i') + #5
lema(ur'[Rr]equer_í_(?:a[ns]?|)_i') + #7
lema(ur'[Rr]equerir_á_[ns]?_a') + #0
lema(ur'[Rr]esguardar_í_a[ns]?_i') + #0
lema(ur'[Rr]esid(?:ir|)_í_a[ns]?_i') + #12
...
lema(ur'[Rr]espond_í_(?:a[ns]?|)_i') + #8
lema(ur'[Rr]esponder_á_[ns]?_a') + #1
lema(ur'[Rr]est_á_r[mts]el[aeo]s?_a') + #0
lema(ur'[Rr]estitu_i_d[ao]s?_í') + #3
lema(ur'[Rr]estitu_i_r(?:l[aeo]s?|se|)_í') + #0
lema(ur'[Rr]esultar_í_a[ns]?_i') + #2
lema(ur'[Rr]etirar_s_e(?:lo|)_c') + #0
lema(ur'[Rr]etirar_í_a[ns]?_i') + #2
lema(ur'[Rr]etra_í_(?:a[ns]?|d[ao]s?)_i') + #19
lema(ur'[Rr]etra_í_d[ao]s?_i') + #19
lema(ur'[Rr]etractar_í_a[ns]?_i') + #0
lema(ur'[Rr]etribu_i_d[ao]s?_í') + #6
lema(ur'[Rr]eun_í_a[ns]?_i') + #39
lema(ur'[Rr]eunir_á_[ns]?_a') + #4
lema(ur'[Rr]evelar_í_a[ns]?_i') + #1
lema(ur'[Rr]eviv(?:ir|)_í_a[ns]?_i') + #1
lema(ur'[Rr]eñid_í_sim[ao]s?_i') + #0
lema(ur'[Rr]iqu_í_sim[ao]s?_i') + #3
lema(ur'[Rr]omp_í_a[ns]?_i') + #1
lema(ur'[Rr]omper_á_[ns]?_a') + #3
lema(ur'[Rr]ud_í_sim[ao]s?_i') + #0
lema(ur'[Ss]_i_do_í') + #3
lema(ur'[Ss]_i_guie(?:ron|ntes?)_e') + #15
lema(ur'[Ss]_o_la(?:s|mente|)_ó') + #110
lema(ur'[Ss]_á_dic(?:[ao]s?|amente)_a') + #3
lema(ur'[Ss]_í_ntesis_i') + #102
lema(ur'[Ss]_ó_tanos_o') + #5
lema(ur'[Ss]_ú_bit(?:[ao]s|amente)_u') + #3
lema(ur'[Ss]_ú_per (?:Vedette|Humor|Pesad[ao]s?)_u') + #36
lema(ur'[Ss]ab_í_amos_i') + #2
lema(ur'[Ss]acrificar_í_a[ns]?_i') + #0
lema(ur'[Ss]aldar_í_a[ns]?_i') + #1
lema(ur'[Ss]aldr_á_[ns]?_a') + #23
lema(ur'[Ss]aldr_í_a[ns]?_i') + #11
lema(ur'[Ss]ali_en_do_ne') + #0
lema(ur'[Ss]at_í_roc[ao]s?_i') + #1
lema(ur'[Ss]e_ri_es?_ir', pre=ur'(?:[Ll]as?|[Dd]e) ') + #2
lema(ur'[Ss]ecu_e_ncia_a') + #1
lema(ur'[Ss]ecu_e_ncias?_a') + #1
lema(ur'[Ss]ecue_s_trad[ao]s?_') + #1
lema(ur'[Ss]egu(?:ir|)_í_a[ns]?_i') + #30
lema(ur'[Ss]egu_í_amos_i') + #0
lema(ur'[Ss]eguir_í_a(?:[ns]?|mos)_i') + #4
lema(ur'[Ss]eguir_í_amos_i') + #0
lema(ur'[Ss]em_á_foros?_a') + #22
lema(ur'[Ss]emiolog_í_as?_i') + #6
lema(ur'[Ss]enadur_í_as?_i') + #3
lema(ur'[Ss]ent_í_amos_i') + #0
lema(ur'[Ss]eparar_í_a[ns]?_i') + #3
lema(ur'[Ss]er_í_amos_i') + #1
lema(ur'[Ss]eren_í_sim[ao]s?_i') + #9
lema(ur'[Ss]erializar_s_e(?:lo|)_c') + #0
lema(ur'[Ss]ervi_c_ios?_s') + #2
lema(ur'[Ss]ervir_á_[ns]?_a') + #7
lema(ur'[Ss]ervir_í_a[ns]?_i') + #6
lema(ur'[Ss]eud_ó_nimos?_o') + #18
lema(ur'[Ss]i_e_mpre_') + #4
lema(ur'[Ss]i_no má_s bien_ no m[aá]') + #4
lema(ur'[Ss]i_s_temas?_') + #12
lema(ur'[Ss]icol_ó_gic[ao]s?_o') + #0
lema(ur'[Ss]ie_m_pre_n') + #2
lema(ur'[Ss]ignificar_í_a[ns]?_i') + #8
lema(ur'[Ss]igu_i_entes?_') + #45
lema(ur'[Ss]iller_í_as?_i') + #28
lema(ur'[Ss]imb_ó_lic(?:[ao]s|amente)_o') + #4
lema(ur'[Ss]imbi_ó_tic[ao]s?_o') + #13
lema(ur'[Ss]impatiqu_í_sim[ao]s?_i') + #0
lema(ur'[Ss]imult_á_neamente_a') + #53
lema(ur'[Ss]in_ó_nimos?_o') + #22
...
lema(ur'[Ss]ismol_ó_gic[ao]s?_o') + #3
lema(ur'[Ss]istem_á_tic(?:[ao]s?|amente)_a') + #5
lema(ur'[Ss]it_ú_(?:a[ns]?|e[ns]?)_u') + #123
lema(ur'[Ss]o_r_prendió_') + #0
lema(ur'[Ss]obre_vi_vientes?_') + #17
lema(ur'[Ss]obresal(?:dr|)_í_a[ns]?_i') + #0
lema(ur'[Ss]obrese_í_d[ao]s?_i') + #7
lema(ur'[Ss]obrevi_vi_do_') + #8
lema(ur'[Ss]obreviv(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Ss]obrevivir_á_[ns]?_a') + #0
lema(ur'[Ss]of_t_ware_') + #17
lema(ur'[Ss]of_á_s?_a', pre=ur'(?:[Ss]u|[Ee]l|[Dd]el|[Uu]n|[Ll]os|como) ') + #12
lema(ur'[Ss]ol_í_amos_i') + #1
lema(ur'[Ss]omet_é_r[mts]el[aeo]s?_e') + #1
lema(ur'[Ss]omet_í_a[ns]?_i') + #0
lema(ur'[Ss]ometer_á_[ns]?_a') + #1
lema(ur'[Ss]onr_í_e[ns]?_i') + #21
lema(ur'[Ss]onre_í_r_i') + #15
lema(ur'[Ss]orprend_í_a[ns]?_i') + #0
lema(ur'[Ss]u_stitui_d[ao]s?_tituí') + #2
lema(ur'[Ss]ub_í_an_i') + #2
lema(ur'[Ss]ubg_é_neros?_e') + #37
lema(ur'[Ss]uced_í_a[ns]?_i') + #6
lema(ur'[Ss]uceder_á_[ns]?_a') + #2
lema(ur'[Ss]uceder_í_a[ns]?_i') + #2
lema(ur'[Ss]ufr(?:ir|)_í_a[ns]?_i') + #3
lema(ur'[Ss]ufr_í_a[ns]?_i') + #3
lema(ur'[Ss]ufrir_á_[ns]?_a') + #0
lema(ur'[Ss]uger_í_a[ns]?_i') + #0
lema(ur'[Ss]uicid__ó_i') + #7
lema(ur'[Ss]uperh_é_roes?_e', pre=ur'(?:[Uu]n|[Ee]l|[Ll]os| de| y) ') + #11
lema(ur'[Ss]upon_í_a[ns]?_i') + #13
lema(ur'[Ss]upondr_á_[ns]?_a') + #0
lema(ur'[Ss]uponi_en_do_ne') + #0
lema(ur'[Ss]urgir_á_[ns]?_a') + #2
lema(ur'[Ss]urtir_á_[ns]?_a') + #0
lema(ur'[Ss]uspend_í_a[ns]?_i') + #1
lema(ur'[Ss]ust_itui_d[ao]s?_uí') + #1
lema(ur'[Ss]ustitu_i_d[ao]s?_í') + #36
lema(ur'[Ss]ustitu_i_r(?:l[aeo]s?|se|)_í') + #4
lema(ur'[Ss]ustituir_á_[ns]?_a') + #2
lema(ur'[Ss]ustra_í_(?:a[ns]|d[ao]s?)_i') + #2
lema(ur'[Ss]ustra_í_d[ao]s?_i') + #2
lema(ur'[Tt]__igre_r') + #1
lema(ur'[Tt]_e_sis_é') + #124
lema(ur'[Tt]_i_tulad[ao]s?_í') + #111
lema(ur'[Tt]_á_ctil(?:es|)_a') + #23
lema(ur'[Tt]_é_rmic(?:as|os?)_e') + #29
lema(ur'[Tt]_é_rmino_e', pre=ur'[Pp]rimer ') + #10
lema(ur'[Tt]_í_pic(?:[ao]s|amente)_i') + #27
lema(ur'[Tt]_í_teres?_i') + #26
lema(ur'[Tt]_ó_picos?_o') + #12
lema(ur'[Tt]_ó_rax_o') + #17
lema(ur'[Tt]_ó_xic(?:as|os?)_o') + #26
lema(ur'[Tt]ant_í_sim[ao]s?_i') + #0
lema(ur'[Tt]ao_í_s(?:tas?|mo)_i') + #71
lema(ur'[Tt]e_m_prana_n') + #1
lema(ur'[Tt]e_r_minar(?:se|l[ao]s?|ron|ría[ns]?|)_') + #2
lema(ur'[Tt]ec_noló_gic[ao]_(?:nolo|onol[oó])') + #103
lema(ur'[Tt]ect_ó_nic(?:as|os?|amente)_o') + #1
lema(ur'[Tt]el_é_fono_e', pre=ur'(?:[Ee]l|[Ss]u|[Uu]n|como|por) ') + #25
lema(ur'[Tt]el_é_fonos_e') + #25
lema(ur'[Tt]elevi_s_ión_c') + #0
lema(ur'[Tt]elevi_si_ón_') + #2
lema(ur'[Tt]elevis_i_ón_') + #39
lema(ur'[Tt]elevis_i_ón_í') + #0
lema(ur'[Tt]elevisi__ón_s') + #2
lema(ur'[Tt]em_í_a[ns]_i') + #2
lema(ur'[Tt]en_í_amos_i') + #3
lema(ur'[Tt]en_í_an_i') + #79
lema(ur'[Tt]end_í_a[ns]?_i') + #0
lema(ur'[Tt]ende_n_cias?_') + #3
lema(ur'[Tt]endr_á_[ns]_a') + #19
lema(ur'[Tt]endr_í_a[ns]?_i') + #32
lema(ur'[Tt]ent_á_culos?_a') + #13
lema(ur'[Tt]erminar_í_a[ns]?_i') + #15
lema(ur'[Tt]err_e_motos?_o') + #4
lema(ur'[Tt]errest_r_es?_') + #57
lema(ur'[Tt]exte_á_ndo(?:[mst]e|l[aeo]s?|nos)(?:[mt]e|l[aeo]s?|nos|)_a') + #2
lema(ur'[Tt]ie_m_po_n') + #10
lema(ur'[Tt]ioci_á_nic[ao]s?_a') + #0
lema(ur'[Tt]itular_í_sim[ao]s?_i') + #0
lema(ur'[Tt]odoter_r_enos?_') + #0
lema(ur'[Tt]omar_í_a[ns]?_i') + #3
lema(ur'[Tt]opolog_í_as?_i') + #14
lema(ur'[Tt]or_á_xoc[ao]s?_a') + #0
lema(ur'[Tt]ra_ns_curr(?:e[ns]?|ió)_sn') + #1
lema(ur'[Tt]ra_ns_porte[ns]_s?n') + #3
lema(ur'[Tt]ra_í_d[ao]s?_i') + #47
lema(ur'[Tt]ra_í_dos?_i') + #24
lema(ur'[Tt]raducir_á_[ns]?_a') + #0
lema(ur'[Tt]raer_á_[ns]?_a') + #1
lema(ur'[Tt]raicionar_í_a[ns]?_i') + #0
lema(ur'[Tt]rampol_í_n_i') + #13
lema(ur'[Tt]ran_s_formar(?:se|)_') + #4
lema(ur'[Tt]ran_s_paren(?:cias?|tes?)_') + #1
lema(ur'[Tt]ran_s_portados_') + #0
lema(ur'[Tt]ran_s_porte_') + #4
lema(ur'[Tt]ranscurr(?:ir|)_í_a[ns]?_i') + #5
lema(ur'[Tt]ransformar_s_e(?:lo|)_c') + #0
lema(ur'[Tt]ransformar_í_a[ns]?_i') + #0
lema(ur'[Tt]ransmit(?:ir|)_í_a[ns]?_i') + #16
lema(ur'[Tt]ransmitir_á_[ns]?_a') + #4
lema(ur'[Tt]ransportar_í_a[ns]?_i') + #2
lema(ur'[Tt]rasladar_s_e(?:lo|)_c') + #1
lema(ur'[Tt]rasmit(?:ir|)_í_a[ns]?_i') + #0
lema(ur'[Tt]rasmitir_á_[ns]?_a') + #0
lema(ur'[Tt]raspi_é_s?_e') + #3
lema(ur'[Tt]raum_á_tic[ao]s?_') + #0
lema(ur'[Tt]raumatolog_í_as?_i') + #3
lema(ur'[Tt]reintai_ú_n_u') + #1
lema(ur'[Tt]reintaid_ó_s_o') + #1
lema(ur'[Tt]reintais_é_is_e') + #1
lema(ur'[Tt]reintaitr_é_s_e') + #0
lema(ur'[Tt]remend_í_sim[ao]s?_i') + #0
lema(ur'[Tt]rig_é_sim[ao]s?_e') + #13
lema(ur'[Tt]ropical_í_sim[ao]s?_i') + #7
lema(ur'[Tt]uber_í_as?_i') + #22
lema(ur'[Uu]gand_é_s_e') + #5
lema(ur'[Uu]ltras_ó_nic[ao]s?_o') + #7
lema(ur'[Uu]n_ _partido_') + #1
lema(ur'[Uu]n_á_nime(?:mente|)_a') + #25
lema(ur'[Uu]ng_ü_entos?_u') + #1
lema(ur'[Uu]nir_s_e(?:lo|)_c') + #0
lema(ur'[Uu]nir_á_[ns]?_a(?!\])') + #11
lema(ur'[Uu]nir_í_a[ns]?_i') + #9
lema(ur'[Uu]sar_í_a[ns]?_i') + #2
lema(ur'[Uu]t_i_li(?:z(?:[ae]n?|[oó])|cen?)_') + #21
lema(ur'[Uu]t_i_lizad[ao]s?_') + #8
lema(ur'[Uu]t_ilizació_n_(?:lizaci[oó]|ilizacio)') + #13
lema(ur'[Uu]til_í_sim[ao]s?_i') + #3
lema(ur'[Uu]tiler_í_as?_i') + #5
lema(ur'[Uu]tilizar_s_e(?:lo|)_c') + #0
lema(ur'[Uu]tilizar_í_a[ns]?_i') + #3
lema(ur'[Vv][eé][aá]se _t_ambi[eé]n_T') + #460
lema(ur'[Vv]_inculó__(?:íncul[oó]|inculo)', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #2
lema(ur'[Vv]_ié_ndo(?:(?:[mts]e|nos|se)(?:l[aeo]s?|)|l[aeo]s?)_íe') + #1
lema(ur'[Vv]_í_ctimas?_i', pre=ur'(?:[Ee]s|[Ff]u[ée]|[Ff]ueron|[Ll]as?|[Ss]erá|[Ss]on|[Uu]nas?|[Oo]tras?|[Dd]e|[Ss]u) ') + #157
lema(ur'[Vv]al_ú_(?:a[ns]?|en)_u') + #10
lema(ur'[Vv]aldr_á_[ns]?_a') + #0
lema(ur'[Vv]alios_í_sim[ao]s?_i') + #1
lema(ur'[Vv]e_í_amos_i') + #1
lema(ur'[Vv]eh_í_culos?_i') + #156
lema(ur'[Vv]einti_ú_n_u') + #10
lema(ur'[Vv]eintid_ó_s_o') + #36
lema(ur'[Vv]eintis_é_is_e') + #38
lema(ur'[Vv]eintitr_é_s_e') + #54
lema(ur'[Vv]encer_í_a[ns]?_i') + #10
lema(ur'[Vv]ender_á_[ns]?_a') + #3
lema(ur'[Vv]endr_í_a[ns]?_i') + #6
...
lema(ur'[Vv]erg_ü_enzas?_u') + #18
lema(ur'[Vv]estir_á_[ns]?_a') + #6
lema(ur'[Vv]estir_í_a[ns]?_i') + #5
lema(ur'[Vv]ideogr_á_fic[ao]s?_a') + #1
lema(ur'[Vv]illan_í_sim[ao]s?_i') + #0
lema(ur'[Vv]irar_í_a[ns]?_i') + #1
lema(ur'[Vv]iv_í_amos_i') + #0
lema(ur'[Vv]ivir_í_a[ns]?_i') + #1
lema(ur'[Vv]ol_u_men_ú') + #469
lema(ur'[Vv]olv_í_(?:a[ns]?)_i') + #21
lema(ur'[Vv]olver_í_a(?:n|mos|)_i') + #24
lema(ur'[Vv]uelt_a_s?_á') + #0
lema(ur'[Zz]oledr_ó_nic[ao]s?_o') + #1
lema(ur'[p]ertene_nci_as?_c[ií]', pre=ur'(?:[Ll]as?|[Ss]us?|[Dd]e) ') + #117
lema(ur'_Pací_fico_(?:pac[ií]|Paci)', pre=ur'[Oo]c[eé]ano ') + #253
lema(ur'[Ff]i_l_m_', pre=ur'(?:[Dd]el|[Ee]l) ') + #6
lema(ur'[a]_ _sus_') + #4
lema(ur'[c]omprendi_do__[óo]', pre=ur'[Pp]er[ií]odo ') + #3
lema(ur'[d]_í_as_i', pre=ur'(?:[Aa]lgunos|[Bb]uenos|[Ee]scasos|[Ee]stos|[Ll]os|[Nn]uestros|[UÚuú]ltimos|[Uu]nos|[Vv]arios|[Dd]os|[Tt]res|[Cc]uatro|[Cc]inco|[Ss]eis|[Ss]iete|[Oo]cho|[Nn]ueve|[Dd]iez|[0-9]+) ') + #477
lema(ur'[d]e l_ongitud__largària') + #0
lema(ur'[d]eb_í_a(?:s?|mos)_i') + #42
lema(ur'[d]esar_rolló__r?oll?o', pre=ur'[Ss]e(?: me| te| l[aeo]s?|) ') + #83
lema(ur'[d]ivid_id_a_', pre=ur'(?:[Dd]ecisión|[Ss]er|[Ee]star|[Ee]staba|[Ee]st[aá]|estuvo|se encontraba|se encuentra|queda|quedó|quedará|es|fue|llanura|continuó|distancia|Austria|Actualmente|opinión) ') + #22
lema(ur'[e]st_á_(?:[.,;]| (?:el|la|un|una) )_a', pre=ur'donde ') + #1
lema(ur'[f]ranc_é_s[,.]_e') + #23
lema(ur'[f]ranc_é_s_e', pre=ur'[Ii]dioma [Ff]ranc[eé]s\|') + #4
lema(ur'[g]_é_neros?_e', pre=ur'(?:[Ee]l|[Ll]os|[Uu]n|[Uu]nos) ') + #97
lema(ur'[h]ar_á_s_a', pre=ur'(?:[Qq]u[eé]|dinero|te|carrera) ') + #0
lema(ur'[l]e_í_da_i') + #9
lema(ur'[l]e_í_dos_i') + #8
lema(ur'[m]_á_ximas?_a', pre=ur'(?:[Ll]as?|[Uu]nas?) ') + #28
lema(ur'[m]_á_ximos?_a', pre=ur'(?:[Ee]l|[Uu]n|[Ll]os) ') + #22
lema(ur'[m]_í_nimas?_i', pre=ur'(?:[Ll]as?|[Uu]nas?) ') + #8
lema(ur'[m]ir_á_ndol[ae]_a') + #1
lema(ur'[n]_ó_mina_o', pre=ur'(?:[Ss]u|[Ee]n|[Uu]na|misma|primera|en|de) ') + #6
lema(ur'[p]erd_í_a_i') + #7
...
lema(ur'[t]rav_é_s_e', pre=ur'(?:[Aa]|[Dd]e) ') + #179
lema(ur'[v]er_á_n_a') + #2
lema(ur'[v]iv(?:ir|)_í_a[ns]?_i') + #57
lema(ur'[Áá]lbum_e_s_(?:ne|)') + #102
lema(ur'\(_álbum de \g<num>_\)_(?P<num>[0-9]{4}) album') + #10
lema(ur'_(discográfica)__\(record label\)') + #107
lema(ur'_A_quel_Á') + #4
lema(ur'_Club de Futbol Igualada__Club de Fútbol Igualada') + #0
lema(ur'_D_inamarca_d', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or|y) ') + #2
lema(ur'_E_ll[ao]s?_É') + #2
lema(ur'_E_quipos?_É') + #2
lema(ur'_E_spaña_e', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #64
lema(ur'_E_sta vez_É') + #29
lema(ur'_E_ste (?:último|primer)_É') + #32
lema(ur'_E_sto_É') + #85
lema(ur'_Estados U_nidos_(?:estados [Uu]|Estados u)', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #334
lema(ur'_F_rancia_f', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #31
...
lema(ur'_I_talia_i', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #22
lema(ur'_Japó_n_(jap[oó]|Japo)', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #76
lema(ur'_Latinoamé_rica_[Ll](?:ationoame|atínoame|ationoamé|ationame|atioamé|atinooamé|atínoamé)') + #6
lema(ur'_Murphy Pacific Corporation__Murphy Pacific Corporacion') + #0
lema(ur'_P_araguay_p', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #9
lema(ur'_R_usia_r', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #9
lema(ur'_S_uecia_s', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #7
lema(ur'_U_ruguay_u', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #15
lema(ur'_V_enezuela_v', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + #49
lema(ur'__a sus?_h') + #5
lema(ur'__acerca(?:r|rse|)_h') + #0
...
lema(ur'_consultado el__acessado em') + #25
lema(ur'_d_estacados_D', pre=ur'[Jj]ugadores ') + #1558
lema(ur'_e inglé_s_[ey] ingle', pre=ur'(?:quechua|franc[eé]s|español|coreano|japon[eé]s) ') + #10
lema(ur'_e_spañol_E', pre=ur'ejército ') + 
lema(ur'_e_sta (afición|vez)_é') + #162
lema(ur'_e_ste (?:último|primer)_é') + #192
lema(ur'_e_sto_é') + #233
lema(ur'_e_xternos_E', pre=ur'(?:[Ee]nlaces|[Vv]ínculos) ') + #2146
lema(ur'_encontraba__encuentraba') + #21
lema(ur'_escándalo__escandalo') + #39
lema(ur'_esperando__esparando', pre=ur'[Ee]stán? ') + #0
lema(ur'_febrero__[Ff]evereiro', pre=ur'acessado em [0-9]+ de ') + #0
lema(ur'_ha_ dicho (?: a |el |de |en |que|antes|ser )_ah?') + #3
lema(ur'_ha_sta ahora_a') + #1
lema(ur'_hu_esos?_u') + #2
lema(ur'_hu_ndi(?:d[ao]s?|dimiento)_u') + #2
lema(ur'_increíble__íncreible') + #0
lema(ur'_increíbles__íncreibles') + #1
lema(ur'_noviembre__[Nn]ovembro', pre=ur'acessado em [0-9]+ de ') + #0
lema(ur'_obstáculos__obstaculos') + #26
lema(ur'_sali_an?_(?:Sal[ií]|salí)', pre=ur'[Dd]inast[ií]a ') + #1
lema(ur'_sobre la base de__en base a') + #1093
lema(ur'_v_oleibol_b') + #4
lema(ur'_z_ona_s', pre=ur'(?:[Ll]a|[Uu]na|[Dd]e) ') + #3
lema(ur'_Á_gil(?:es|mente)_A') + #0
lema(ur'_Á_ngel Gim[eé]nez_A') + #14
lema(ur'_Á_rbitros?_A') + #132
lema(ur'_Á_ure[ao]s_A') + #0
lema(ur'_É_l (?:anhela|pued[ae]|gana)_E') + #32
lema(ur'_É_nfasis_E') + #2
lema(ur'_É_tnic(?:[ao]s|amente)_E') + #1
lema(ur'_É_xitos?_E') + #138
lema(ur'_Ó_rbitas?_O', pre=ur'(?:[Ll]as?|[Ss]us?|[Uu]nas?|[Ee]n) ') + #6
lema(ur'_Ú_ltimamente_U') + #9
lema(ur'_Ú_ltimas?_U', pre=ur'(?:[Ll]as?|[Uu]nas?) ') + #129
lema(ur'_Ú_nic(?:[ao]s|amente)_U') + #19
lema(ur'_á_gil(?:es|mente|)_a') + #10
lema(ur'_á_guilas?_a') + #97
lema(ur'_á_ngulos?_a', pre=ur'(?:[Ee][nl]|[Uu]n|[Ll]os|[Uu]nos) ') + #27
lema(ur'_á_reas?_a', pre=ur'(?:[AaEe]l|[Ll]as|[Mm][aá]s|[Uu]nas|[Aa]lgunas|[Dd]el?|[Uu]n|[Cc]ada|[Ss]us|[Oo]tras?|[Dd]os|[Ee]stas?|[Ee]sas?|[Ee]n) ') + #179
lema(ur'_álbu_m(?:es|)_albú') + #101
lema(ur'_álbumes__albums', pre=ur'(?:[Ll]os|[Ss]us)') + #0
lema(ur'_é_l (?:ante|cabe|con|desde|entre|según|sin|tras)\b_e', pre=ur'[Cc]on ') + #42
lema(ur'_é_nfasis_e') + #11
lema(ur'_é_tnic(?:[ao]s|amente)_e') + #13
lema(ur'_é_xodos?_e') + #7
lema(ur'_í_ntimamente_i') + #11
lema(ur'_ó_mnibus_o', pre=ur'\b(?:y|[Ee]l|[Uu]n|de|en|trenes|Micro|son|transporte:|llamados|scientiis|formato|tomaran|Empresa|tituló) (?:["\']|\[\[|)') + #47
lema(ur'_ó_pticas_o') + #2
lema(ur'_ó_rdenes_o', pre=ur'(?:[Ll]as|[Uu]nas|[Ss]us|[Dd]ar|[Dd]ando|[Pp]or) ') + #202
lema(ur'_ú_ltima_u', pre=ur'(?:[Aa]|[Cc]omo|[Dd]el|[Ee]st[ao]s?|[Ll]as?|[Pp]or|[Qq]ueda[nsr]?|[Qq]uedó|[Ss]us?|[Uu]na|[Uu]nas|[Yy]) ') + #484
lema(ur'_ú_ltimamente_u') + #25
lema(ur'_ú_ltimas_u', pre=ur'(?:[Ll]as|dos|tres) ') + #83
lema(ur'_ú_nica_u', pre=ur'(?:[Ll]a|[Uu]na|[Ss]u|es|será) ') + #82
lema(ur'_ú_nico_u', pre=ur'(?:[Ee]l|[Uu]n) ') + #111
lema(ur'_ú_nico_u', pre=ur'(?:[Ee]l|[Uu]n)] ') + #0
lema(ur'_ú_nicos_u', pre=ur'(?:[Ss]us|[Ll]os) ') + #17
lema(ur'[Ff]_utbolí_stic(?:[ao]s?|amente)_útbol[ií]') + 
lema(ur'[Dd]_el á_rea_(?:el a|e la [aá])') + 
lema(ur'_el á_rea_(?:el a|la [aá])') + 
lema(ur'[e]n_ _medio_') + 
lema(ur'[Oo]btuv_o__ó') + 
lema(ur'[Ee]stuv_o__ó') + 
lema(ur'[Hh]oland_é_s_e') + 
lema(ur'[Ii]nform_á_tic[ao]s_a') + 
lema(ur'[Vv]ivir_á_[ns]?_a') + #5
lema(ur'_c_heco_C', pre=ur'\b(?:e[ln]|del|idioma|y) ') + 
lema(ur'[Cc]l_ás_ic[ao]s?_[aá]c') + lema(ur'[Cc]l_á_sica_a', xpos=[ur'(?: do|maior)\b', ur'2\.com']) + #293
lema(ur'[Dd]escalific_ó__o') + 
lema(ur'[h]_a_ce_e') + 
lema(ur'[Ll]leg_ó a s_er_(?:o a s|[oó] hac)') + 
lema(ur'[Úú]ltim[ao]_s__', pre=ur'[Ll][ao]s ') + 
lema(ur'[Cc]omisar_í_as?_i', pre=ur'[Ee]n ') + 
lema(ur'_C_olombia_c', pre=ur'(?:[Aa]|[Aa]nte|[Dd]e|[Ee]n|[Pp]ara|[Pp]or) ') + 
lema(ur'[Rr]adiolog_í_as?_i') + 
lema(ur'[Ii]nsect_ó_log[ao]s?_o') + 
lema(ur'[Jj]ug_ó_ (?:un|dos|tres|cuatro|diez|cien|mil|unos|varios)_o') + 
lema(ur'[Pp]rot_e_ic[ao]s?_é') + 
lema(ur'[Tt]ransg_é_ner[ao]s?_e') + 
lema(ur'[Dd]esign_ó__o') + 
lema(ur'[Cc]an_c_i(?:ón|ones)_s', xpos=[ur' barias']) + 
lema(ur'[Gg]r_á_fico_a', xpos=[ur' Editoriale']) + 
lema(ur'[Dd]isput_ó_ en_o') + 
lema(ur'[Nn]eurofenomenolog_í_as?_i') +
lema(ur'[Ss]obre__nombre_ ') +
lema(ur'[m]_á_s_a', pre=ur'(?:[Nn]o (?:cultivan?)|atendió|da|[Ll]ea|[Pp]ara|produciendo|espec[ií]fic(?:[ao]s?|amente)) ') +
...
lema(ur'[Uu]n_a fá_brica_ f[aá]') + #127
lema(ur'[Uu]n_a magní_fica_ magn[ií]') + #127
lema(ur'[Uu]n_a má_quina_ m[aá]') + #127
lema(ur'[Uu]n_a pé_rdida_ p[eé]') + #127
lema(ur'[Uu]n_a ré_plica_ r[eé]') + #127
lema(ur'[Aa]_ _cargo_') + 
lema(ur'[Aa]__ños_ños a') + 
lema(ur'[Cc]__ada_ada c') + 
lema(ur'[Cc]olor___ color', xpos=[ur'\'\'']) + 
lema(ur'[Cc]__omo_omo c') + 
lema(ur'[Cc]__on_on c') + 
lema(ur'[Cc]__uando_uando c') + 
lema(ur'[Dd]__el_el d') + 
lema(ur'[Dd]__esde_esde d') + 
lema(ur'[Dd]__espués_espués d') + 
lema(ur'[Dd]__onde_onde d') + 
lema(ur'[Dd]__urante_urante d') + 
lema(ur'[Dd]e__l_ la e') + 
lema(ur'[Ee]__l_l e') + 
lema(ur'[Ee]n_ _realidad_') + 
lema(ur'[Ee]n_ _serio_') + 
lema(ur'[Ee]n e_l_ año_n') + 
lema(ur'[Ee]__ntre_ntre e') + 
lema(ur'[Ee]__ntre_ntre e') + 
lema(ur'[Ee]__quipo_quipo e') + 
lema(ur'[Ee]__ra_ra e') + 
lema(ur'[Ee]__ste_ste e') + 
lema(ur'[Ff]__ue_ue f') + 
lema(ur'[Ff]__ueron_ueron f') + 
lema(ur'[Hh]__a [a-záéíóúñ]+o_a h') + 
lema(ur'[Ll]__as_as l') + 
lema(ur'[Ll]__o_o l') + 
lema(ur'[Ll]__os_os l') + 
lema(ur'[Ll]o_s_ (?:aires|alrededores|alumnos|antiguos|años|artistas|barrios|bienes|bosques|capítulos|casos|casos|cerros|chicos|ciudadanos|códigos|colores|conceptos|cuales|cuáles|cuartos|datos|derechos|días|dientes|dos|edificios|efectos|ejercicios|elementos|enemigos|equipos|españoles|estándares|estudiantes|eventos|fans|franceses|ganadores|generales|grupos)_') + #600
...
lema(ur'[Oo]__tros_tros o') + 
lema(ur'[Pp]__arte_arte p') + 
lema(ur'[Pp]__ero_ero p') + 
lema(ur'[Pp]__or_or p') + 
lema(ur'[Pp]__rimer_rimer p') + 
lema(ur'[Pp]__uede_uede p') + 
lema(ur'[Qq]__ue_ue q') + 
lema(ur'[Ss]__e_e s') + 
lema(ur'[Ss]__er_er s') + 
lema(ur'[Ss]__i_i s') + 
lema(ur'[Ss]__ido_ido s') + 
lema(ur'[Ss]__obre_obre s') + 
lema(ur'[Ss]__on_on s') + 
lema(ur'[Tt]__ambién_ambién t') + 
lema(ur'[Tt]__iene_iene t') + 
lema(ur'[Áá]__lbum_lbum á') + 
lema(ur'_El__La el') + 
[]][0]

grupo2 = grupoPerfecto + grupoAccion + [# 500-999
lema(ur'[Ii]ndicar_í_a_i', xpre=[ur'Tractatus de astrologia ']) + #4
lema(ur'[Ss]ellar_í_a_i', xpre=[ur'della ']) + #1
lema(ur'(?:[Ss]emi|[Ss]ub|[Hh]iper|[Dd])esarrollar_í_a[ns]?_i') + #1
lema(ur'[Aa]rchivar_í_a[ns]?_i', xpos=[ur', [1-9][0-9]+']) + #1
lema(ur'[Aa]rd_í_as_i', xpre=[ur'de ']) + #1
lema(ur'[Cc]almar_í_a_i', xpre=[ur'\ba ']) + #1
lema(ur'[Cc]aminar_í_a_i', xpre=[ur'Hexatoma ']) + #1
lema(ur'[Dd]egenerar_í_a_i', xpre=[ur'Idaea ']) + #1
lema(ur'[Ee]x_ces_iv[ao]s?_', xpre=[ur'Aucula ']) + #1
lema(ur'[Ll]abrar_í_a_i', xpre=[ur'Abraxas ']) + #1
lema(ur'[Mm]orfol_ó_gic(?:[ao]s|amente)_o', xpos=[ur' e\b']) + #1
lema(ur'[Oo]sar_í_as?_i', xpos=[ur'\'\'']) + #1
lema(ur'[Pp]illar_í_a_i', xpre=[ur'Cycloclypeus ']) + #1
lema(ur'[Vv]ersar_í_a_i', xpre=[ur'Flagrospira ']) + #1
lema(ur'(?:[Ee]nero|[Ff]ebrero|[Mm]arzo|[Aa]bril|[Mm]ayo|[Jj]unio|[Jj]ulio|[Aa]gosto|[Ss]eptiembre|[Oo]ctubre|[Nn]oviembre|[Dd]iciembre)_ de_ (?:\[\[|)[1-9][0-9][0-9][0-9]_(?:,|)', xpre=[ur'Ediciones del 4 de '], xpos=[ur' sullo']) + 
lema(ur'Gim_é_nez_e', xpre=[ur'Antônio ']) + #561
lema(ur'Hait_í__i', pre=ur'(?:\||(?:[Dd]e|[Ee]n) )', xpre=[ur'Démocratie ', ur'Volleyball '], xpos=[ur' (?:Sings|and)']) + #103
lema(ur'Jim_é_nez_e', xpre=[ur'Cláudia ']) + #1714
lema(ur'Medell_í_n_i', xpre=[ur'in ', ur'366272\) ']) + #725
lema(ur'Ocean_í_a_i', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' (?:Cruises|Rugby)']) + #7
lema(ur'[Aa]bogac_í_as?_i', xpos=[ur'\.es']) + #6
lema(ur'[Aa]d_h_esivos?_', xpre=[ur'[Cc]aso ']) + #31
lema(ur'[Aa]narqu_í_as?_i', xpre=[ur'amor i ']) + #55
lema(ur'[Aa]nomal_í_as?_i', xpre=[ur'Pichia ']) + #21
lema(ur'[Aa]scen_s_ión_c', xpos=[ur' (?:Aguilera|[AÁ]lvarez|Alcalá|Andrade|Bonet|De los Santos|Farreras|García|Gómez|Hernández|Lencina|López|Martínez|Negrón|Nicol|Orihuela|Saucedo|Soto|Solórsano|Tepal|Vázquez)']) + #109
lema(ur'[Aa]utom_ó_vil(?:es|)_o', xpos=[ur' Gesellschaft']) + #298
lema(ur'[Bb]iogeogr_á_fic[ao]s?_a', xpre=[ur'\bdi ']) + #15
lema(ur'[Bb]istur_í__i', xpre=[ur'\bO '], xpos=[ur' - La', ur', la']) + #7
lema(ur'[Cc]_ó_ptic[ao]s?_o', xpre=[ur'Ptychotis ']) + #6
lema(ur'[Cc]armes_í__i', xpre=[ur'filla del ']) + #15
lema(ur'[Cc]enar_í_a[ns]?_i', xpre=[ur'(?:[Dd]e|[Ee]n)', ur'[Ii]slote ']) + #9
lema(ur'[Cc]rec_í__i', xpre=[ur'Enrique ']) + #3
lema(ur'[Cc]ronol_ó_gic[ao]_o', xpre=[ur'Storia '], xpos=[ur' (?:dei|della|das)']) + #25
lema(ur'[Dd]_í_a_i', pre=ur'(?:[Hh]oy(?: en|)|[Uu]n (?:buen|cierto|duro|gran|largo|nuevo|s[oó]lo)|[Pp]rimer|[Ss]egundo|[Tt]ercer|[Cc]uarto|[Qq]uinto|[Ss]exto|[Ss][eé]ptimo) ', xpos=[ur' (?:da|e meio)']) + #261
lema(ur'[Dd]ep_ó_sitos?_o', xpre=[ur'(?:[Ii]l|[Ll]a) ', ur'Cardili, ', ur'sepulcro '], xpos=[ur' (?:Giordani|da)']) + #383
lema(ur'[Dd]iscogr_á_fic[ao]s?_a', xpre=[ur'della Critica ']) + #434
lema(ur'[Ee]_x_tendid[ao]s?_s?', xpre=[ur'onde ']) + #20
lema(ur'[Ee]nfermer_í_as?_i', xpos=[ur'\.uady']) + #55
lema(ur'[Ee]sf_é_ric[ao]s?_e', xpre=[ur'Vorticella ', ur'Lepidocyclina ']) + #21
lema(ur'[Ff]icolog_í_as?_i', xpre=[ur'Brasileira de ']) + #2
lema(ur'[Ff]or_á_ne[ao]s?_a', xpre=[ur'battello ', ur'Mythimna ']) + #51
lema(ur'[Ff]re_í_r_i', xpre=[ur'Frey\|']) + #56
lema(ur'[Ff]renes_í__i', xpre=[ur'Coleção '], xpos=[ur' \(Lisboa', ur': história']) + #19
lema(ur'[Gg]e_ó_log[ao]s?_o', xpre=[ur'Professione ']) + #27
lema(ur'[Gg]rad_ú_a_u', xpos=[ur'\'t']) + #19
lema(ur'[Hh]oland_é_s_e', xpre=[ur'permitió que el ']) + #140
lema(ur'[Ii]c_ó_nic[ao]s?_o', xpre=[ur'Glycyrrhiza ', ur'Cousinia ', ur'Conchologica ', ur'Conchologia ']) + #53
lema(ur'[Ii]nfanter_í_as?_i', xpre=[ur'd\''], xpos=[ur' de marinha']) + #222
lema(ur'[Ii]nic_i_os?_', xpos=[ur' d[\'’]Avalos', ur'\'\'\'']) + #37
lema(ur'[Jj]erarqu_í_as?_i', xpos=[ur' a la Responsabilitat']) + #21
lema(ur'[Ll]_á_mparas?_a', xpre=[ur'[A]\. ', ur'Astronesthes ', ur'Wishing ']) + #164
lema(ur'[Ll]_á_tigos?_a', xpre=[ur'for ', ur'George '], xpos=[ur' Means']) + #20
lema(ur'[Ll]_é_sbic[ao]s?_e', xpre=[ur'[AI]\. ', ur'Aphaenogaster ', ur'Isoperla '], xpos=[ur' e gay']) + #33
lema(ur'[Ll]_ó_gic(?:os|amente)_o', xpos=[ur' Aristotelis']) + #5
lema(ur'[Ll]_ó_gic[ao]_o', pre=ur'(?:[Ll]a|[Uu]na) ', xpos=[ur' (?:d[iu]|del)\b']) + #25
lema(ur'[Ll]exicograf_í_as?_i', xpre=[ur'Lexicologia y '], xpos=[ur' (?:e os|catalana|catalanes)\b']) + #14
lema(ur'[Ll]oter_í_as?_i', xpre=[ur'Caixa '], xpos=[ur' (?:Vella|sem)']) + #106
lema(ur'[Mm]agn_í_fica_i', pre=ur'(?:[Ll]a|[Uu]na|[Dd]e|[Ee]sta|[Ss]u|[Tt]an) ', xpos=[ur' (?:Cure|ni)\b']) + #70
lema(ur'[Mm]al_é_vol[ao]s?_e', xpre=[ur'Euphorbia ']) + #7
lema(ur'[Mm]an_í_as?_i', pre=ur'(?:[Ll]as?|[Uu]nas?) ', xpos=[ur'\.com']) + #2
lema(ur'[Mm]ani_á_tic[ao]s?_a', xpre=[ur'[Ii]l ']) + #13
lema(ur'[Mm]ariner_í_as?_i', xpos=[ur' degli']) + #16
lema(ur'[Mm]iscel_á_ne[ao]s?_a', xpos=[ur' (?:Antwerpiensia|Barcinonensia|taxinomica)']) + #88
lema(ur'[Mm]o_v_ilidad_b', xpos=[ur' Bahía']) + #38
lema(ur'[Oo]rfebrer_í_as?_i', xpos=[ur' i\b']) + #17
lema(ur'[Pp]_á_jaros?_a', xpos=[ur' Dunes']) + #135
lema(ur'[Pp]anader_í_as?_i', xpos=[ur'\.blogspot']) + #51
lema(ur'[Pp]arasitolog_í_as?_i', xpre=[ur'\be ']) + #16
lema(ur'[Pp]atri_ó_tic[ao]s?_o', xpre=[ur'Ação '], xpos=[ur' di\b']) + #50
lema(ur'[Pp]edi_á_tric[ao]s?_a', xpos=[ur' Bambino']) + #22
lema(ur'[Pp]ertenec_í_(?:a[ns]?|)_i', xpre=[ur'(?:[Ll]a|[Dd]e|[Ss]u) ', ur'(?:[Ll]as|[Ss]us) ']) + #118
lema(ur'[Pp]olicl_í_nicos?_i', xpre=[ur'estación\)\|\'\'\'', ur'Viale del ', ur'Nápoles\)\|', ur'estación\)\|'], xpos=[ur' \((?:Metro de Nápoles|estación)']) + #19
lema(ur'[Pp]on_í_a[ns]?_i', xpre=[ur'Adiós ']) + #50
lema(ur'[Pp]resb_í_ter[ao]s?_i', xpre=[ur'F\. ']) + #124
lema(ur'[Pp]resid_í_a[ns]?_i', xpre=[ur'fueron ', ur'plural \'\'\'']) + #19
lema(ur'[Pp]ris_o_n_i[oó]', pre=ur'[Ii]n ') + #2
lema(ur'[Rr]adiograf_í_as?_i', xpos=[ur' (?:d´una|di)\b']) + #21
lema(ur'[Ss]_ó_tano_o', xpre=[ur'\'', ur'Zorocrates ', ur'Piaggine ']) + #63
lema(ur'[Ss]_ú_per As_u', xpos=[ur' d’Or']) + #36
lema(ur'[Ss]acrist_í_as?_i', xpos=[ur' Vecchia']) + #34
lema(ur'[Ss]entir_á_[ns]?_a', xpre=[ur'\bet ']) + #2
lema(ur'[Ss]ovi_é_tic[ao]s?_e', xpre=[ur'E\. ', ur'Saussurea ', ur'Euglossa ', ur'Unione ']) + #162
lema(ur'[Ss]ulf_ú_ric[ao]s?_u', xpre=[ur'Dipoena ']) + #5
lema(ur'[Ss]upremac_í_as?_i', xpre=[ur'\be ']) + #35
lema(ur'[Tt]_é_rmica_e', xpre=[ur'Centrale ']) + #29
lema(ur'[Tt]ar_j_etas?_g', xpre=[ur'amb ']) + #5
lema(ur'[Tt]elefon_í_as?_i', xpos=[ur' Nas']) + #52
lema(ur'[Vv]en_z_(?:a[ns]?|o)_s', xpre=[ur'Sant '], xpos=[ur' (?:Klicic|Dolonc)']) + #7
lema(ur'[l]e_í_a_i', xpre=[ur'Wo ', ur'Doriopsilla ']) + #8
lema(ur'[t]ra_í_an_i', xpos=[ur' in\b']) + #4
lema(ur'_Á_rea (?:[Mm]etropolitana|[Cc]hica|Natural|Local|[Cc]onurbada|[Bb]iogeogr[áa]fica|[Rr]ecreativa)\b_A', xpre=[ur'l\'']) + #484
lema(ur'_Á_rea de\b_A', xpre=[ur'Council ']) + #484
lema(ur'_Ú_ric(?:as|os?)_U', xpos=[ur' Schmitdt']) + #4
lema(ur'_é_l (?:anhela|pued[ae]|gana)_e', xpre=[ur'l\'']) + #168
lema(ur'_é_l (?:est(?:ar|)[aá]n?|estaba|estará|estuvo|estar[ií]an?|dijo|dir[aá]|dice|vienen?|fu[ée]|fueron|vendr[aá]n?|tiene|tuvo|ten[ií]a[ns]?|tendrán?|es|era|serán?|fue|hab[ií]a|sabe|sab[ií]a|no le)_e', xpre=[ur'l\'']) + #583
lema(ur'_é_l ha_e', xpre=[ur'(?:ch\'|Af\')']) + #583
lema(ur'_é_l[:]_e', pre=ur'(?:[Aa]|[Dd]e|[Cc]on|[Ee]n|[Pp]or|[Hh]acia) ', xpre=[ur'limita ']) + #1816
lema(ur'_é_l[;]_e', pre=ur'(?:[Aa]|[Dd]e|[Cc]on|[Ee]n|[Pp]or|[Hh]acia) ', xpre=[ur'limita ']) + #1816
lema(ur'_é_pic(?:as|os?)_e', xpre=[ur'Scontro ']) + #12
...
lema(ur'[Aa]rchidi_ó_cesis_o', xpos=[ur' (?:Praetoriensis|Bisuntinis|Limanus)', ]) + #39
...
grupo7 = [# 10-24
lema(ur'[Aa]punt_ó__o', pre=ur'(?:[Ll]e|[Mm]e|[Nn]os) ', xpre=[ur'Yo ']) + #12
lema(ur'[Hh]erb_á_ce(?:as|os?)_a', xpre=[ur'algodoeiros ']) + #17
lema(ur'[Bb]erlin_é_s_e', xpre=[ur'Berlinesas\|', ur'Berlinesa\|', ur'dos ', ur'dos \'']) + #15
lema(ur'[Ee]mbriolog_í_as?_i', xpos=[ur' di\b']) + #13
lema(ur'[Cc]ompa_ñ_er[ao]s?_n', xpre=[ur'The '], xpos=[ur'\'\'']) + #18
lema(ur'[Cc]_á_lculos_a', xpos=[ur' accuratissimos']) + #19
lema(ur'[Cc]_í_tric[ao]s?_i', xpre=[ur'\b[E]\. ', ur'das plantas ', ur'Eotaria ', ur'Cancro ']) + #18
lema(ur'[Aa]_ _veces_', xpre=[ur'Teena ', ]) + #22
lema(ur'[Nn]omb_r_es?_', xpre=[ur'Nakera '], xpos=[ur'\'', ]) + #24
lema(ur'[Aa]cad_é_mico_e', xpre=[ur'[Aa]nno ', ur'Concerto ', ur'Iure ', ur'Mauri ', ur'horto ', ], xpos=[ur' (?:dell|Hauniensi|FC|Do)']) + #24
...
lema(ur'[Mm]atem_á_ticas_a', xpre=[ur' d[ae]s ', ur'es\.ciencia\.', ], xpos=[ur'\.(?:unmsm|uady)']) + #24
lema(ur'[Ss]inton_í_as?_i', xpre=[ur'Cicurina ', ]) + #24
lema(ur'[Aa]nal_í_tica_i', xpre=[ur'della psicologia ', ur'di [Pp]sicologia ', ur'e geometrica ', ur'relazione ', ur'terapia ', ], xpos=[ur' (?:d|do|ed|ragionata|Priora)\b', ur'(?:\.com|: Reflexão)', ]) + #23
lema(ur'[Ee]s__encia(?! Banda Show)_c', xpre=[ur'\]', ]) + #23
lema(ur'[Pp]sic_ó_log[ao]s?_o', xpos=[ur' del carattere']) + #23
lema(ur'[Ee]go_í_stas?_i', xpre=[ur'Lamborghini ', ur'Junai ', ur'Junjou ', ur'lamborgini ', ur'sporco ', ], xpos=[ur' Feat', ]) + #22
lema(ur'[Ee]_n_ (?:el|l[ao]s?|una?|unos?|varios|algun[ao]s?)_m', xpos=[ur' papel de \'\'Brunilda']) + #22
lema(ur'est_á_ muert[ao]_a', xpre=[ur'[Dd]e ', ]) + #22
lema(ur'[Rr]ob_ó_tic[ao]s?_o', xpre=[ur'Toccata ', ], xpos=[ur' (?:\(juego|earthensis)', ur': Cybernation', ]) + #22
lema(ur'[Bb]iol_ó_gic(?:[ao]s|amente)_o', xpre=[ur' e ', ur'Ciências ', ur'Ciências Medicas e ', ur'Sitientibus serie Ciencias ']) + #21
...
lema(ur'[Ss]int_é_tic[ao]s?_e', xpre=[ur'ammoniaca ', ur'grass ', ], xpos=[ur' di', ]) + #19
lema(ur'[Aa]u_n_que_', xpre=[ur'Roger ']) + #18
lema(ur'[Cc]at_á_strofes?_a', xpre=[ur'della ', ur' e ', ], xpos=[ur' da', ]) + #18
lema(ur'[Cc]l_í_nico(?! (?:di))_i', xpre=[ur'lavoro ', ur'Nico ', ]) + #18
lema(ur'_e_ll[ao]s?_é', xpos=[ur' llos ', ]) + #18
lema(ur'[Ll]avander_í_as?_i', xpos=[ur'\'\' regia']) + #18
lema(ur'[Ss]eguir_á_[ns]?_a', xpre=[ur'Luis ', ]) + #18
lema(ur'[Aa]utom_á_tica_a', xpre=[ur'Elaborazione ', ur'Quattroporte ', ur'[Hh]ead ', ur'[Ii]nformazione ', ], xpos=[ur' [0-9]+']) + #17
lema(ur'_á_cida_a', xpre=[ur'Aglaia ', ur'Ambelania ', ur'Asclepia ', ur'Asclepias ', ur'Averrhoa ', ur'Begonia ', ur'Berberis ', ur'Cerasus ', ur'Cicca ', ur'Citrus ', ur'Eulychnia ', ur'Fucsina ', ur'Hymenocardia ', ur'Hypertelis ', ur'Lannea ', ur'Leptomeria ', ur'Meriania ', ur'P\. ', ur'Prunus ', ur'Sonneratia ', ur'Spiloxene ', ur'Spondias ', ur'Tapirira ', ur'Uncaria ', ur'Willughbeia ', ur'subsp\. ', ur'subsp\. \'\'', ur'ssp\. ', ur'var\. ', ], xpos=[ur'\'']) + #17
lema(ur'Am_é_rica_e', pre=ur'[Ll]a ', xpre=[ur'Faremo ', ], xpos=[ur' (?:Cantat|3|Online|do|RJ|East|West|on|Actors|Society)', ur'[\'’´]s', ]) + #17
lema(ur'_a_ ser_(?:ha|ah)', xpre=[ur'\$', ]) + #17
lema(ur'[Cc]_á_lido_a', xpre=[ur'Marquilles y ', ], xpos=[ur' innato', ]) + #17
lema(ur'G_é_nova_e', pre=ur'(?:[Dd]e|[Ee]n|para|desde) ', xpre=[ur'Camogli ', ur'Pallavicino ', ], xpos=[ur', Nicholas', ]) + #17
lema(ur'[Mm]and_í_bula_i', xpre=[ur'Euphitrea ', ur'uma ', ], xpos=[ur'\]\][a-z]+', ur' superiore']) + #17
lema(ur'[Pp]edagog_í_a_i', xpre=[ur'\b[Aei] ', ur'\bin ', ur'della ', ur'Facultat de ', ur'Premi Rosa Sensat de ', ur'Secció de ', ur'\bd[ai] ', ur'dir ', ur'do Curso de ', ], xpos=[ur' (?:sociale|d[aio]|dels|Dell|anb|amb|a Catalunya|sexuala|spagnola|: diálogo e conflito|Revuo|del segle|que ens)', ]) + #17
lema(ur'Erev_á_n_a', xpre=[ur'Pyunik ', ur'Ararat ', ur'Banants ', ur'Spartak ', ur'd\'', ur'und ', ], xpos=[ur' (?:on|Ilesere|Olympic)', ]) + #16
lema(ur'[Ff]_é_nix_e', pre=ur'(?:[Aa]ve|[Aa]tl[eé]tico) ', xpos=[ur' Pictures']) + #16
lema(ur'[Jj]ard_í_n_i', pre=ur'[Uu]n ', xpre=[ur'[Dd]ans ', ur'avait ', ur'd\'', ], xpos=[ur' (?:qui|pour|Royale?|En Méditerranée|en désordre|[Bb]otanique|secret|sauvage|mouillé|à |sans |sur |du |au |de (?:Passacailles|Ville|l\'État)|d[\'’])', ]) + #16
lema(ur'[Rr]eh_é_n_e', xpos=[ur'\]\][a-zñ]+', ]) + #16
lema(ur'[Aa]cabar_í_a[ns]?_i', xpos=[ur' splendens', ur'[\]\']', ]) + #15
lema(ur'[Aa]utom_á_tico_a', xpre=[ur'Moschetto ', ]) + #15
lema(ur'Am_é_rica_e', pre=ur'Sud ', xpre=[ur'für ', ], xpos=[ur' Bank']) + #15
lema(ur'[Bb]enem_é_rit[ao]s?_e', xpos=[ur' Associazione', ]) + #15
lema(ur'[Ee]nv_í_a[ns]_i', xpos=[ur'(?:=|\'m)', ]) + #15
lema(ur'[Ff]ant_á_stic[ao]s_a', xpre=[ur'mighhola mis ', ]) + #15
lema(ur'[Ff]_é_mur_e', xpre=[ur'Rural \(', ur'\bof ', ur'left ', ur'Abogado de ', ur'Bonita ', ur'Freddie ', ur'Neandertal \[\[', ur'\b[Tt]he ', ur'\.\.\. ', ur'super ', ], xpos=[ur' (?:and)', ur'\+head', ]) + #15
lema(ur'[Gg]en_é_rico_e', xpre=[ur' ', ur'E', ur'l', ]) + #15
lema(ur'[Ff]armacolog_í_as?_i', xpre=[ur'Català de ', ], xpos=[ur' e Terapia', ]) + #14
lema(ur'[Gg]en_é_rica_e', xpre=[ur'Floralis ', ], xpos=[ur' (?:e specifica|Hepaticarum)']) + #14
lema(ur'ha_ll_(?:ar|es)_y', xpos=[ur' buddy', ]) + #14
lema(ur'[Hh]uman_í_stic[ao]s?_i', xpre=[ur'Bibliotheca ', ur'Scripta ', ur'Universitas ', ur'et ', ], xpos=[ur' Lovaniensia', ]) + #14
lema(ur'[Vv]endr_á_[ns]?_a', xpre=[ur'Paul ']) + #14
lema(ur'Belmop_á_n_a', xpre=[ur'FC ', ], xpos=[ur' (?:Hospital|Public|United|Blaze|Museum|Bandits)', ]) + #13
lema(ur'[Cc]_é_ntric[ao]s?_e', xpre=[ur'por ', ], xpos=[ur' Energía', ur'[\|\]]', ]) + #13
lema(ur'[Dd]emocr_á_tic(?:[ao]s|amente)_a', xpos=[ur' Avançadas']) + #13
lema(ur'[Mm]ov_í_a_i', xpre=[ur'C\. ', ur'[Pp]ía ', ], xpos=[ur' (?:ingens|BM2)', ur'\]', ]) + #13
lema(ur'[Pp]roced_í_a[ns]?_i', xpre=[ur'ELSEVIER ', ur'Elsevier ', ur'Platform\. '], xpos=[ur' Economics']) + #13
lema(ur'sent_í_a_i', xpre=[ur'Egun ', ]) + #13
lema(ur'[Tt]err_í_colas?_i', xpre=[ur'A\. ', ur'Aysenoides ', ur'Camponotus ', ur'Cylindera ', ur'Cyrtauchenius ', ur'Microtus \(', ur'Moggridgea ', ur'Otira ', ur'Paecilomyces ', ur'Solenopsis ', ur'Spironema ', ur'Tropiphorus ', ur'Trochosa ', ], xpos=[ur' atapuerquensis', ur'[)\]]', ]) + #13
lema(ur'[Tt]r_á_gica_a', xpre=[ur'Ballata ', ur' e ', ur'Alba ', ur'Caccia ', ur'Musa ', ], xpos=[ur' (?:notte|dei|poveste|I-VII)', ]) + #13
lema(ur'[Cc]_á_lida_a', xpre=[ur'Acraea ', ur'Aegilops ', ur'Anthia ', ur'Antiblemma ', ur'Aquae ', ur'Argia ', ur'Drummondita ', ur'Euphrasia ', ur'Globigerinella ', ur'Hyles ', ur'Indervalle - ', ur'Megachile ', ur'Microcyba ', ur'Thalpochares ', ], xpos=[ur' (?:fornax|nit)', ]) + #12
lema(ur'[Hh]ip_ó_tesis_o', xpre=[ur'gap ', ]) + #12
lema(ur'[Pp]er_í_metros?_i', xpre=[ur'\be ', ur'[Ss]e ', ]) + #12
lema(ur'[Pp]ol_í_ticamente_i', xpre=[ur'Partito ', ], xpos=[ur' (?:scorretto|incorreto da)', ]) + #12
lema(ur'[Ss]erv_í_an_i', xpre=[ur'Cristian ', ur'Guillermo ', ur'Nadia ', ur'Yasmine ', ur'de ', ur'hermanos ', ], xpos=[ur' (?:verbi|Giosa|\'\'\')', ur'\]\]', ]) + #12
lema(ur'[Aa]ll_á_ por_a', xpre=[ur'Tethe\'']) + #11
lema(ur'[Cc]orr_í_a_i', xpre=[ur'Fenge ', ur'Odontoptilum ', ur'de ', ur'o Amazonas ', ], xpos=[ur' da', ]) + #11
lema(ur'[Dd]efend_í_(?:a[ns]?|)_i', xpre=[ur'Italo ', ur'Marino ', ur'Rafael ', ur'Rodrigo ', ur'Tonioli ', ], xpos=[ur' Asturies', ur'\]']) + #11
lema(ur'[Ee]vang_é_lic(?:as|os?)_e', xpre=[ur'movimento ', ur'Cantore ', ur'Si ', ]) + #11
lema(ur'[Ee]xc_é_ntric[ao]_e', xpre=[ur'Acacia ', ur'Bulolia ', ur'Compsodrillia ', ur'Dentalina ', ur'Eoophyla ', ur'Hallo ', ur'Kefersteinia ', ur'Pleurothallis ', ur'Stachybotryna ', ]) + #11
lema(ur'Pakist_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' International', ]) + #11
lema(ur'[Pp]sic_ó_patas?_o', xpos=[ur' (?:e Profilaxia|Mora ao)', ]) + #11
lema(ur'[Tt]em_í_a_i', xpre=[ur'C\. ', ur'Crypsirina ', ur'Quesería ', ], xpos=[ur'["\]]', ]) + #11
lema(ur'[Tt]e_ó_ric[ao]_o', xpre=[ur'dal fisico ', ur'Sulla ', ur'modello ', ], xpos=[ur' (?:dell|degli|fino|- pratica|e pratico)', ur', dall', ]) + #11
lema(ur'[Uu]nd_é_cim[ao]s?_e', xpre=[ur'L\'', ur'dell\''], xpos=[ur' (?:novarum|Xou)', ur', nel', ]) + #11
lema(ur'[Cc]osm_é_tic(?:as|os?)_e', xpre=[ur'Benefit ', ur'Natura ', ], xpos=[ur'\.name']) + #10
lema(ur'[Dd]esaf_í_a[ns]?_i', xpos=[ur' o nosso', ]) + #10
lema(ur'[Dd]uod_é_cim[ao]s?_e', xpre=[ur'Paraphlebia ', ur'dell[\' ]', ur'in ', ], xpos=[ur' (?:novarum|reformata|impressao)', ]) + #10
lema(ur'est_á_ detrás_a', xpre=[ur'[Ee]stando ', ]) + #10
lema(ur'fantas_í_as?_i', pre=ur'(?:[Dd]e|[Ll]as|[Ee]n|[Ee]stas?|[Tt]ienen|sus?|y) ', xpre=[ur'Scherzi ', ]) + #10
lema(ur'[Gg]eomorfolog_í_a_i', xpos=[ur' da', ]) + #10
lema(ur'_ha_ (?:bajado|batallado|bebido|beneficiado|borrado|brillado|brindado|buscado)_ah?', xpre=[ur'[0-9]', ]) + #10
lema(ur'[Hh]abr_í_an_i', xpre=[ur'Ain ', ]) + #10
lema(ur'[Mm]alet_í_n_i', xpre=[ur'Alexander ', ur'Alexandr ', ur'Pavel ', ur'Slavko ', ]) + #10
lema(ur'[Tt]at_ú_(?:a[ns]?|e[ns]?)_u', xpre=[ur'Baby ']) + #10
lema(ur'[Tt]_ú_neles_u', xpos=[ur'\.info', ]) + #10
lema(ur'[Nn]acer_á_[ns]?_a', xpre=[ur'Benkhelifa '], xpos=[ur' Boukamoum']) + #13
lema(ur'[Mm]editerr_á_ne[ao]s?_a', xpre=[ur'[CfST]\. ', ur'Tipula ', ur' e ', ur' il ', ur' (?:dil|nel) ', ur'\'', ur'[Cc]ostiero ', ur'e fauna del ', ur'e del ', ur'Dal ', ur'Bacino ', ur'vegetazione marina bentonica fotofila del ', ur'sciafila del ', ur'capitale fenicia del ', ur'storia del ', ur'Lyra del ', ur'Flora ', ur'Eucera ', ur'Echi del ', ur'Paesaggio ', ur'Cystoseira ', ur'vie del ', ur'Accademia ', ur'Aria ', ur'Okenia ', ur'Acetabularia ', ur'Geranium subsección ', ur'Borsa ', ur'Aegiphila ', ur'Actinia ', ur'Alus ', ur'officinalis ', ur'Studi ', ur'Anoplolepis ', ur'Antedon ', ur'Ascidia ', ur'Atropa ', ur'Biserrula ', ur'Brevundimonas ', ur'Myristica ', ur'Brotera ', ur'Bursa ', ur'Calea ', ur'Camerata ', ur'Cappella ', ur'Capsella ', ur'dell[\'’]area ', ur'Spirulina ', ur'Carex ', ur'Astacilla ', ur'Città del ', ur'Cladonia ', ur'Comatula ', ur'Corynactis ', ur'Biscutella ', ur'Cypridina ', ur'Cystoseira ', ur'Cystosera ', ur'Dacia ', ur'Associazione ', ur'Decaisnella ', ur'Vegetazione ', ur'Diospyros ', ur'Associazione ', ur'Editoriale del ', ur'Elytrigia ', ur'Itinera ', ur'Erica ', ur'civiltà ', ur'Pseudorca ', ur'Ersilia ', ur'ungarica ', ur'mare ', ur'identità ', ur'Ferriera ', ur'Festuca ', ur'Musicale ', ur'Flammulina ', ur'Giochi del ', ur'Cooperazione ', ur'Phycologia ', ur'Globorotalia ', ur'Gnathostomula ', ur'Arundo ', ur'Grande ', ur'Gypsocallis ', ur'Hermione ', ur'Stenosoma ', ur'Janusia ', ur'L\'[Aa]ncora del ', ur'Leptomysis ', ur'mari ', ur'Voci del ', ur'di poesia ', ur'Malthonica ', ur'Malva ', ur'Marinomonas ', ur'Musica ', ur'Parachiridotea ', ur'Phytopathologia ', ur'Mycosphaerella ', ur'Orchis ', ur'vegetazione ', ur'Organizzatore Giochi del ', ur'Scabiosa ', ur'Osyris ', ur'Periandra ', ur'Periandra ', ur'argo ', ur'Procrassula ', ur'Pseudomonas ', ur'Vedetta ', ur'Raynaudetia ', ur'Stachys ', ur'Sanguisorba ', ur'impero ', ur'Setaphis ', ur'Società Aerea ', ur'Da Bahia ', ur'Spermophorides ', ur'Multimediale del ', ur'Tipula ', ur'Stipa ', ur'Studia ', ur'Dipoena ', ur'Enoplognatha ', ur'var\. ', ur'internazionale ', ur'Corsari del ', ur'Upogebia ', ur'Uropoda ', ur'Xerula ', ur'Zostera ', ur'[ABP]\. ', ur'[Mm]acchia ', ur'[Nn]obiltà ', ur'[Ss]ocietà ', ur'[Tt]arantola ', ur'centro on-line ', ur'collinetta ', ur'd[\'’][Aa]rt del ', ur'foina ', ur'la canción "', ur'nell\'area ', ur'portuali del ', ur'subsp\. ', ur'sul ', ], xpos=[ur' (?:nella|nei|Editions|viventibus|ricerche|Imperia|Antico|del Limbara|per la Cultura|Sarcuto|\((?:2003|película)|fitosociologico|Studios|centrale|centro-occidentale)', ur'(?:", in|" de Regio|: (?:[Ss]erie|vegetazione|Da))']) + #11
lema(ur'[Mm]en_ú__u', xpre=[ur'\ba ', ur'S\. ', ur'\'s ', ur'CSS3', ur'Jan ', ur'Pierre ', ur'attribute ', ur'Charles ', ur'Ithaa ', ur'Philippe ', ur'Start ', ur'pineau ', ur'Operation ', ur'Sunday ', ur'British ', ur'Bernard ', ur'Beatmac ', ur'Love ', ur'Koi ', ur'Clothilde ', ur'Jean-Christophe ', ur'Bernadette ', ur'main ', ur'Paris: ', ur'CD ', ur'het ', ur'Load ', ur'Alain ', ur'Cheat ', ur'Conde ', ur'Video ', ur'Expanded ', ur'Home ', ur'Rudi ', ur'Teni ', ur'Sunday ', ur'François ', ur'Main ', ur'Me ', ur'Memphis ', ur'Michel ', ur'Millionaire ', ur'Player ', ur'Services ', ur'Short ', ur'Special ', ur'Word ', ur'[Aa]dministration ', ur'[Gg]eneral ', ur'[Tt]he ', ur'[・]', ur'pie ', ur'value ', ], xpos=[ur' (?:à|items|W9|du |wa Tips|Planner|Cookbook|Music|automatically|Screen|programming|Degustació|of|and|for|bétail|[Bb]ar|[Dd]efinition|idéal|Yves|Steam|y (?:Command|Back)|de (?:Ménil|dimanche|repas)|loops|Theme|Engineer|Engineering|Select|Items|navigation|editor|von|Có|\(Melee|& Autopsy)', ur'(?:\.(?:xml|asp|[Aa]pplet|com)|\|, (?:Scheduler|en|\(1984|M\.|Michel)|\'\'\', \(1987|\]\], 1984)', ]) + #11
lema(ur'[Mm]an_í_as? de_i', xpre=[ur'[Ll]a ' ur'(?:[Ll]as|[Uu]na) ', ur'[Uu]nas '], xpos=[ur' (?:Você|de [Vv]ocê|kakushidori|explicação)']) + #10
[]][0]

grupo8 = [# 5-9
lema(ur'[Hh]u_b_o_v', xpos=[ur'\]\]']) + #8
lema(ur'[Bb]ot_á_nicos_a', xpre=[ur'Termos ', ], xpos=[ur' (?:e Estaçao|mais|Regiae|della|intrapreso|in|[Mm]alacitana|do)', ur', in Il', ]) + #9
lema(ur'[Cc]onv_irtió__ertio', xpre=[ur'[Ee]s ', ur'[Ff]ue ', ur'[Ss]er ', ]) + #9
lema(ur'[Cc]riminolog_í_as?_i', xpre=[ur'derecho\.', ], xpos=[ur' (?:femminile|e direito)', ]) + #9
lema(ur'[d]ominar_í_a_i', xpre=[ur'de ', ur' a ', ], xpos=[ur' a qui', ur'\]\]', ]) + #9
lema(ur'[Ff]itogeograf_í_a_i', xpre=[ur' e ', ], xpos=[ur' (?:no|do|e Genetica)', ]) + #9
lema(ur'[Gg]eof_í_sicas?_i', xpre=[ur' di ', ], xpos=[ur'\.cl', ]) + #9
lema(ur'[Ii]n_ú_tiles_u', xpre=[ur'Bouches ', ur'Sourires ', ur'choses ', ur'plantes ', ur'risques ', ur'seraient ', ]) + #9
lema(ur'[Mm]arcar_í_a[ns]?_i', xpre=[ur'Julio ', ur'Protección ', ], xpos=[ur' (?:Julio|sopra)', ur'\]', ]) + #9
lema(ur'part_í_a[ns]?_i', xpre=[ur'bactriana y ', ur'Ispanskaja ', ur'Txakurraren ', ], xpos=[ur'[\|\]]', ]) + #9
lema(ur'[Ss]umir_á_[ns]?_a', xpre=[ur'Mihara '], xpos=[ur', Tequivo']) + #9
lema(ur'[Tt]e_ó_ric(?:[ao]s|amente)_o', xpre=[ur'Sulla ', ]) + #9
lema(ur'[Uu]n_í_a[ns]_i', xpre=[ur'[Dd][’\']'], xpos=[ur'\]\]', ]) + #9
lema(ur'[Aa]rd_í_a_i', xpre=[ur'Sindie ', ], xpos=[ur' (?:Napoli|\(cortometraje)', ur'\]', ]) + #8
lema(ur'[Aa]s_í__i', xpre=[ur'K’', ur'\ben ', ur'Emmanuel ', ur'Ta\'', ur'[Ii]dioma ', ur'al-Fak\'', ], xpos=[ur' (?:(?:sen|TV) |Rahamim|language|dizen|Gonia|Deobriga|Cohen|Gilboa|Domb|Ses|Taulava|Ganga|Pudjiastuti|Golboa|Doğan|Klyachinoy|Al Shuraim|Yarba|Vassihon|Kehra)', ur'(?:\]|\.nic|[0-9ˈ"\']|\.C3)', ]) + #8
lema(ur'[Cc]ent_í_grados?_i', xpre=[ur'Graus ']) + #8
lema(ur'Matur_í_n_i', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' llega', ]) + #8
lema(ur'[Pp]edag_ó_gica_o', xpre=[ur'L\'Opera ', ], xpos=[ur'\.edu', ]) + #8
lema(ur'[Pp]erd_í_a[ns]?_i', xpre=[ur'Roberto ', ur'Alejandro ', ]) + #2
lema(ur'[Ss]imb_ó_lica_o', xpre=[ur'città ', ur'Fiamma ', ur'Natura ', ur'Tarocchi via ', ur'Vita ', ], xpos=[ur' in', ]) + #8
lema(ur'[Ss]imetr_í_as?_i', xpos=[ur' (?:dei|das?)\b', ]) + #8
lema(ur'Sud_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' (?:Airways|Foundation)', ]) + #8
lema(ur'[Tt]aiwan_é_s_e', xpos=[ur'\]\](?:as?|es)']) + #8
lema(ur'Uzbekist_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' (?:Airways|Temir)', ]) + #8
lema(ur'[Aa]erodin_á_mic[ao]s?_a', xpre=[ur'600 Y ', ur'Regia ', ur'Servizio ', ur'di ', ], xpos=[ur' (?:Spider|Torino)', ur' \.difesa', ]) + #7
lema(ur'[Aa]gron_ó_mic[ao]s?_o', xpre=[ur'Acta '], xpos=[ur'(?: +(?:per|coloniale|[Aa]cademiae))', ]) + #7
lema(ur'[Aa]p_ó_stoles_o', xpos=[ur', Michael', ur'\.gov', ]) + #7
lema(ur'[Cc]ompeti_ti_vidad_', xpos=[ur'"']) + #7
lema(ur'[Ee]nerg_í_as_i', xpre=[ur'\be ', ur'L[\'’]', ur'CS ', ur'essa ', ur'Acciona ', ur'Amorim ', ur'da Mesa ', ur'CS ', ur'Kerava ', ur'Tractebel ', ur'Quale ', ur'Amorim ', ur'Manaus ', ur'Tractebel ', ur'Direcção Geral de ', ur'EDP ', ur'Engenharia de ', ur'Galp ', ur'Iberdrola ', ur'Mello ', ur'Som ', ur'as '], xpos=[ur' (?:a um|Fălticeni|della|Târgu|Circular Sport Clube|Lignitul|Ploiești|Productions|Elétrica|y Flacăra|d[ao]|Trustul|de (?:la Generalitat|Portugal)|e (?:Trabalho|Serviços|Servizi))\b']) + #7
lema(ur'[Ee]n_é_rgica_e', xpos=[ur', con', ur' (?:Ego|Motor|decisione)']) + #7
lema(ur'[Ee]_x_clusiv[ao]s?_s', xpre=[ur'Toscana '], xpos=[ur' XII', ]) + #7
lema(ur'[Pp]_á_lid[ao]s?_a', xpos=[ur' Fonk', ]) + #7
lema(ur'[Pp]olit_é_cnicas?_e', xpre=[ur'Escola ', ur'Scuola ', ur'Università ', ], xpos=[ur' (?:de Catalunya|)', ]) + #7
lema(ur'[Rr]om_á_ntic[ao]s_a', xpos=[ur' di ', ]) + #7
lema(ur'Sal_í_an_i', xpos=[ur', Bhat']) + #7
lema(ur'[Ss]_ó_rdida_o', xpre=[ur'Achillea ', ur'Aegiphila ', ur'Agave ', ur'Anemone ', ur'Apatura ', ur'Ardisia ', ur'Argia ', ur'Atriplex ', ur'Ballota ', ur'Bartlettina ', ur'Basselinia ', ur'Bolbophyllaria ', ur'Bodilopsis',  ur'Callicarpa ', ur'Calyptranthes ', ur'Carex ', ur'Centaurea ', ur'Centemopsis ', ur'Cercomela ', ur'Chamaesaracha ', ur'Chitoria ', ur'Chloroclystis ', ur'Coryogalops ', ur'Coryogalops ', ur'Diclidia ', ur'Dyckia ', ur'Edithcolea ', ur'Eria ', ur'Erioptera ', ur'Eulophia ', ur'Eumyias ', ur'Gochnatia ', ur'Hymenandra ', ur'Indigofera ', ur'Iris ', ur'Isoperla ', ur'Jungia ', ur'Larnax ', ur'Monoxia ', ur'Muscicapa ', ur'Nectandra ', ur'Nectandra ', ur'Nemosia ', ur'Neobartlettia ', ur'Odostomia ', ur'Orobanche ', ur'Palmorchis ', ur'Paracaesio ', ur'Physalis ', ur'Pinarochroa ', ur'Pitcairnia ', ur'Pitta ', ur'Pluchea ', ur'Pleurothallis ', ur'Podagricomela ', ur'Pomacea ', ur'Pomacea\) ', ur'Pseudoraphis ', ur'Psychotria ', ur'Pteronia ', ur'Roentgenia ', ur'Salvia ', ur'Sansevieria ', ur'Saussurea ', ur'Schinia ', ur'Scytodes ', ur'Smilisca ', ur'Specklinia ', ur'Stigmatopteris ', ur'Thlypopsis ', ur'Tillandsia ', ur'[ABPEMNDTCls]\. ', ur'lavat ', ur'molinae ', ur'obscura ', ur'sordida ', ur'subsp\. ', ur'var\. ', ], xpos=[ur' struma', ]) + #7
lema(ur'[Tt]r_á_gic(?:[ao]s|amente)_a', xpre=[ur' e ', ]) + #7
lema(ur'[Aa]ctuar_í_a[ns]?_i', xpre=[ur' (?:en|de) ', ur' o ', ur'justicia ', ur'[Cc]iencia ', ur'[Nn]otaria ', ur'mecanógrafa, ', ], xpos=[ur'\'']) + #6
lema(ur'[Aa]strof_í_sicas?_i', xpre=[ur' di ', ], xpos=[ur' (?:Spaziale|d\'oggi)', ]) + #6
lema(ur'[Bb]eb_í_a[ns]?_i', xpre=[ur'Sent ', ], xpos=[ur' Emilia', ]) + #6
lema(ur'[Bb]iom_é_dicas?_e', xpre=[ur'Recerca ', ur'Storia ', ]) + #6
...
lema(ur'_ha_ dicho_ah?', pre=ur'(?:[Ll]es?|[Éé]l|[Ss]e(?: me| te| l[aeo]s?|)) ', xpre=[ur' con ', ]) + #6
lema(ur'le_í_a[ns]?_i', xpre=[ur'2 ', ], xpos=[ur' sawola', ]) + #6
lema(ur'[Mm]orfol_ó_gic[ao]s?_o', xpre=[ur'Diversidade '], xpos=[ur' e formas']) + #6
lema(ur'[Oo]ftalmolog_í_as?_i', xpre=[ur'Brasileiros de ', ur'd[’\']', ]) + #6
lema(ur'[Pp]end_í_a[ns]?_i', xpre=[ur' (?:de|en) ', ], xpos=[ur'(?:[|\]])', ]) + #6
lema(ur'[Ss]ent_í_a[ns]_i', xpos=[ur' impel•lida']) + #6
lema(ur'[Ss]upers_ó_nic[ao]s?_o', xpos=[ur'\.net', ]) + #6
lema(ur'[Tt]ornar_í_a_i', xpre=[ur'Larva ', ur'Mauro ', ], xpos=[ur'\]\]', ]) + #6
lema(ur'[Bb]iogeograf_í_a_i', xpre=[ur'Nuova ', ur'e ', ], xpos=[ur' (?:della|e conservação|d\’un|de parlamentaris|de Magalhães)', ]) + #5
lema(ur'[Cc]asar_í_a_i', xpre=[ur'Pseudopoda ', ]) + #5
lema(ur'[Cc]onc_é_ntric[ao]s?_e', xpre=[ur'[Pp]\. ', ur'var\. ', ur'Lepidocyclina ', ur'Helminthopsis ', ur'Daldinia ', ur'Dosinia ', ur'Halomitra ', ur'Phyllolepis ', ur'Neoregelia ', ur'Quercus ', ], xpos=[ur', Montalbruto', ]) + #5
lema(ur'[Cc]riminal_í_stica_i', xpos=[ur'\.(?:com|net)', ]) + #5
lema(ur'[Dd]ecid(?:ir|)_í_a[ns]?_i', xpre=[ur'Caleta ']) + #5
lema(ur'[Ee]mblem_á_tica_a', xpre=[ur'Ars ', ], xpos=[ur' (?:in|Online)\b']) + #5
lema(ur'[Ee]st_é_tico_e', xpre=[ur'Dizionario ', ur'Cl[íi]nica ', ], xpos=[ur' (?:di|e psicologico)', ]) + #5
lema(ur'[Ff]r_á_gil_a', xpos=[ur' (?:X|things|Heart|Records|[Dd]iscos)', ]) + lema(ur'[Ff]r_á_gil(?:es|mente)_a', xpre=[ur'[&] ', ur'Moisson ', ur'choses ', ur'conquérants ', ]) + #5
lema(ur'[Gg]ob_i_erno_', pre=ur'(?:[Ee]l|[Uu]n|[Dd]el?) ', xpre=[ur'Via ']) + #5
lema(ur'[Ii]mpl_í_cit[ao]_i', xpre=[ur'[Ll]\'', ur'Limnophila ', ur'Phyllophaga ', ur'[LP]\. ', ur'testo ', ], xpos=[ur' nel', ]) + #5
lema(ur'[Ii]r_ó_nic[ao]_o', xpre=[ur'La ', ]) + #5
lema(ur'[Ss]imb_ó_lico(?!e o imaxinario)_o', xpre=[ur'Mondo ', ur'suo uso ', ]) + #5
lema(ur'[Tt]ard_í_(?:[ao]s|amente)_i', xpre=[ur'Direitos ']) + #5
lema(ur'Viv_í_as?_i', xpre=[ur' de ', ]) + #5
lema(ur'[Ss]ubstitu_i_d[ao]s?_í', xpre=[ur'Coroa ', ur'foi ', ur'sendo ', ur'tendo sido ', ], xpos=[ur' por um', ]) + #9
lema(ur'[Bb]ell_í_sim[ao]s?_i', xpre=[ur'Frank ', ]) + #8
lema(ur'[Cc]lar_í_sim[ao]s?_i', xpos=[ur'\'']) + #5
[]][0]

grupo9 = [# 2-4
lema(ur'[Bb]a_il_es?_li', xpos=[ur' (?:Peyton|Mangroe|Swart)', ur'’ Mangroe']) + #3
lema(ur'[Aa]t_ó_nit[ao]s?_o', xpre=[ur'[Ee]l ', ur'cenobitismo ']) + #4
lema(ur'[Dd]escubr_ió__(?:io|ío)', xpre=[ur'quando ', ], xpos=[ur' no anno', ]) + #11
lema(ur'Bak_ú__u', pre=ur'(?:[Dd]e|[Ee]n) ', xpre=[ur'acompañado '], xpos=[ur' Crystal', ]) + #8
lema(ur'[Cc]ono_z_c(?:a[ns]?|amos|o)_s', xpre=[ur'che ', ur'Brincar ', ur'Non ', ur'[TtVvLl]i ', ur'cuide ', ur'non lo ', ]) + #8
lema(ur'[Ee]s__encia(?:l|les|lmente)_c', xpre=[ur'\]', ], xpos=[ur' Indígena', ]) + #7
lema(ur'[Mm]et_í_a[ns]?_i', xpre=[ur'muestra el ', ur';', ur'mágico \(', ur'en que ', ur'\bde ', ur'Lotoala ', ], xpos=[ur' (?:Lotoala|Interactive|Iparis|Industry)', ]) + #6
lema(ur'[Pp]_ó_stum[ao]s_o', xpre=[ur'op\. ', ur'Atilio ', ur'Vibio ', ], xpos=[ur' Dardano', ]) + #6
lema(ur'[Ll]ic_ú_(?:a|as?|e[ns]?)_u', xpre=[ur'grupo ', ur'perlatum ', ], xpos=[ur' Labaudt', ]) + #5
lema(ur'H_á_bil_a', xpre=[ur'Adil ', ur'Dr ', ur'Dr\. ', ], xpos=[ur' (?:Heidelberg|Dr\.|Ahmadov)', ur', (?:eraikan|Halle)', ur'\.', ]) + #4
lema(ur'[Aa]cert_ó_(?! dos)_o', xpre=[ur'Bo ']) + #4
lema(ur'[Ff]isiol_ó_gic[ao]s?_o', xpre=[ur' e ', ]) + #4
lema(ur'[Gg]al_á_ctic[ao]s?_a', xpre=[ur' (?:la|of) ', ur'\ba ', ur'Agua \(', ur'Aria ', ur'marca ', ur'Ephemeroptera ', ur'Battlestar ', ur'Battlestar "', ur'Battlestar\]\] ', ur'Galactica\|', ur'2004\)\|', ur'Hyde ', ur'Imperium ', ur'Invaders ', ur'Pirámide \(', ur'Saddlesore ', ur'Saddlessore ', ur'Sadlessore ', ur'Shadow ', ur'como '], xpos=[ur' (?:e[ns] |Donut|Discovers|Plants|Myosotis|Tornado|Tsunami|Crunch|Magnum|reúne|Year|Inflation|Scales|Superstring|1980|\((?:voz|nave))', ur'(?:\)\||\'\'|: The|, [Aa]stronave)', ]) + #4
lema(ur'[Gg]en_é_tico_e', xpre=[ur'Pomodoro ', ]) + #4
lema(ur'[Ii]niciar_í_a[ns]?_i', xpre=[ur'sus ', ]) + #4
lema(ur'[Mm]ontar_í_a_i', xpos=[ur'\]\]', ]) + #4
lema(ur'Om_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' Air', ]) + #3
lema(ur'[Aa]lquer_í_as_i', xpre=[ur'sive ']) + #3
lema(ur'[Dd]ermatolog_í_as?_i', xpos=[ur' (?:e venereologia|Ospedale)', ]) + #3
lema(ur'[Dd]r_á_stic[ao]_a', xpre=[ur'Millettia ', ur'Anisomeria ', ur'Euphorbia ', ur'Wilbrandia ', ]) + #3
lema(ur'[Ee]_n_ cada_m', xpre=[ur'uma gota de sangue ', ], xpos=[ur' (?:rosto|esquina um)', ]) + #3
lema(ur'[Pp]sicopedagog_í_as?_i', xpos=[ur' em ', ur'\.com', ]) + #3
lema(ur'[Ss]ab_á_tic[ao]s?_a', xpos=[ur'\.com', ]) + #3
lema(ur'[Uu]n_á_nimes_a', xpos=[ur' [Pp]ro [Dd]eo', ]) + #3
lema(ur'Reverter_á__a', xpre=[ur'Nicola ', ], xpos=[ur' della', ]) + #2
lema(ur'[Aa]nal_í_tic(?:as|os?)_i', xpre=[ur'ed ', ]) + #2
lema(ur'[Cc]os_í_a[ns]?_i', xpos=[ur'\]', ]) + #2
lema(ur'[Ii]deol_ó_gic[ao]_o', xpre=[ur'galassia ', ], xpos=[ur' della', ]) + #2
lema(ur'[Ll]aborar_í_a[ns]?_i', xpre=[ur'inurri ', ]) + #2
lema(ur'[Mm]atar_í_a[ns]?_i', xpos=[ur'\]', ]) + #2
lema(ur'[Mm]ineralog_í_as?_i', xpre=[ur'di ', ur'e ', ], xpos=[ur' Cornubiensis', ]) + #2
lema(ur'[Nn]_í_tid(?:as|os?|amente)_i', xpos=[ur' [Nn]ulo', ]) + #2
lema(ur'[Nn]obil_í_sim[ao]s?_i', xpos=[ur' Cæsares', ]) + #2
lema(ur'[Pp]artir_á__a', xpre=[ur'(?:tu|[Oo]n) ', ]) + #2
lema(ur'[Pp]unt_ú_(?:a[ns]?|e[ns]?)_u', xpre=[ur'eta ', ]) + #2
lema(ur'[Ss]i_en_do_ne', xpre=[ur'Andre ', ur'Sinedo\|']) + #2
lema(ur'[Ss]obrar_í_a[ns]?_i', xpre=[ur' de ', ur'Juan ', ]) + #2
lema(ur'_Á_rid(?:as|os?)_A', xpre=[ur' of ', ], xpos=[ur' movie', ]) + #2
 []][0]

grupo10 = [# 1
lema(ur'[Gg]eriatr_í_as?_i', xpos=[ur' e Gerontologia', ]) + #1
lema(ur'secessione\. ', pre=ur'[Dd]i_á_logos_a', xpre=[ur'Lancia ', ur'educaçao: ', ur'el ', ur'secessione. Un ', ], xpos=[ur' (?:del bienaue|between)', ur'\]', ]) + #1
lema(ur'[D]eb_í_as?_i', xpre=[ur'Christian ', ur'Mercedes ', ur'Miranda ', ur'L\. ', ur'Vetsch / ', ]) + #1
lema(ur'[Bb]ot_á_nicas(?! (?:institutiones|no Ceara|in ))_a', xpre=[ur'ad excursiones ', ur'lectiones ', ]) + #1
lema(ur'[Dd]ial_é_ctic[ao]s?_e', xpre=[ur'\'', ur'sive ', ur'Institutiones ', ur'Partitio ', ur'canities ', ur'inventione ', ], xpos=[ur' (?:Eristica|Resolutio|erroribus|libri|[1-9]|\(polilla)', ur'(?:\]|, (?:Logica sive|Rhetorica))', ]) + #1
lema(ur'[Gg]ra_c_ias?_s', xpos=[ur' \(Grupo', ur'\]', ]) + #1
lema(ur'[Hh]abit_ú_(?:a[ns]?|e[ns]?)_u', xpre=[ur'[Uu]n ', ur's\'', ]) + #1
lema(ur'[Ll]ucir_á_[ns]?_a', xpos=[ur' Yariff', ]) + #1
lema(ur'[Mm]e_z_cl(?:a(?:s|r|d[ao]s?)|[éoó])_s', xpos=[ur'["\.,]', ]) + #1
lema(ur'[Pp]_ó_stumamente_o', xpre=[ur' ', ur'H', ur'a', ur'a', ur'e', ur'e', ur'g', ur'i', ur'm', ur'n', ur'o', ]) + #1
lema(ur'[Rr]egular_í_a_i', xpre=[ur' et ', ], xpos=[ur' magistri', ur'\]\]', ]) + #1
lema(ur'[Rr]evert_í_(?:a[ns]?|)_i', xpre=[ur'Posse ', ur'missa ', ]) + #1
lema(ur'[Ss]i_g_ue[ns]?_q', xpre=[ur'[Ee]l ', ], xpos=[ur' Rodríguez', ]) + #1
lema(ur'[s]ubir_á__a', xpos=[ur' et', ]) + #1
lema(ur'barr_í_a[ns]?_i', xpre=[ur'etxe ', ur'orbel ', ur'toño ', ], xpos=[ur'\]', ]) + #1
lema(ur'fantas_í_as?_i', pre=ur'[Uu]nas? ', xpre=[ur'[Qq]uasi ', ]) + #1
lema(ur'[Aa]_dquirió__quirio', xpre=[ur' en ', ]) + #1
lema(ur'[Cc]riminal_í_stic(?:as|os?)_i', xpos=[ur'\.unne', ]) + #1
lema(ur'[Dd]_é_cadas?_e', xpre=[ur'Orbe ', ], xpos=[ur' (?:da|de Orbe Novo)', ur'\'', ]) + #1
lema(ur'[Dd]epon_í_a[ns]?_i', xpre=[ur' de ', ur'vertedero ', ]) + #1
lema(ur'[Ee]l_igió__egio', xpre=[ur'San ', ur'[Ee]s ', ur'[Ff]u[eé] ', ur'[Ss]er ', ], xpos=[ur' (?:funebre|del sueño)', ur'[\]\|]', ]) + #1
lema(ur'[Ee]stampar_í_a[ns]?_i', xpre=[ur'Na ', ]) + #1
lema(ur'[Ll]acrim_ó_gen[ao]s?_o', xpos=[ur'" Bubaseta', ]) + #1
lema(ur'[Ll]eer_á_[ns]?_a', xpos=[ur'\]', ]) + #1
lema(ur'[Pp]aisa_j_es?_g', xpos=[ur' de l´apparence', ur'\'', ]) + #1
lema(ur'[Pp]rol_í_fica_i', xpre=[ur'Derbesia ', ur'Echeveria ', ur'Epicauta ', ur'Fragaria ', ur'Lycosa ', ur'Mimosa ', ur'Ophiocordyceps ', ur'Ottoia ', ur'Pardosa ', ur'Poeciliopsis ', ur'[EOP]\. ', ]) + #1
lema(ur'[Tt]ect_ó_nica_o', xpos=[ur'\.es', ]) + #1
lema(ur'_á_ure(?:as|os?)_a', xpre=[ur'\'', ur'Trifolio ', ur'Miliario ', ur'Ortoedro ', ur'Pisces ', ur'villa ', ur'mille ', ur'trifolio ', ], xpos=[ur' cornu', ]) + #1
lema(ur'[Ff]enomenolog_í_as?_i', xpre=[ur'\bi la ', ur'Estudi sobre la ', ur'Oltre la ', ur'[Uu]ma ', ], xpos=[ur' (?:da|moral de la modernitat|del linguaggio|della|dell|nella|a (?:Sartre|prova)|feministado|spiritului)\b', ]) + #14
lema(ur'Nas_á_u_a', xpre=[ur'Guillermo ', ur'Kuresa ', ur'Mikaele ', ], xpos=[ur' Street', ]) + #2
lema(ur'[Aa]mar_í_a[ns]?_i', xpre=[ur'Mohamad ', ur'denominadas ', ur'incluido ', ]) + #1
lema(ur'[Aa]natom_í_as?_i', xpre=[ur' d[ai] ', ur' e ', ur'[Cc]orporis ', ur'[Hh]umani ', ur'd[’\']', ur'das plantas ', ur'dell\'', ur'pela ', ], xpos=[ur' (?:auri|Hvmani|Mundini|de raízes|Patológica e Medicina|patologica di|Plantarum|Vegetal\. Viçosa|[Cc]omparata|[Uu]mana|comparada (?:das|do)|corporis|foliar|generalis|hummingbird|microscopica corporis|partium|pharmaceutica|półprawd|sistematica|uteri|Vitrioli|d[aio] |dos|del (?:Vitrioli|somni|[Cc]avallo)|comparada da|e (?:fisiologia|[Mm]orfologia|ontogenia|relações|sistematica)|de (?:la relativitat|uma|espécies)|d[’\']un)', ]) + #52
lema(ur'[Cc]omentar_í_a[ns]_i', xpre=[ur'Frases ', ]) + #1
lema(ur'[Dd]iat_ó_nic[ao]s?_o', xpre=[ur'il periodo ', ur'Philaethria ', ]) + #1
lema(ur'[Gg]rand_í_sim[ao]s?_i', xpre=[ur'ymagen de ']) + #2
lema(ur'[Ii]_m_presas_n', xpre=[ur'domínios de ']) + #1
lema(ur'[Ii]nformar_í_a[ns]?_i', xpos=[ur' Digital', ur'\.com', ]) + #1
lema(ur'[Mm]ear_í_a[ns]?_i', xpre=[ur'Lucas, ']) + #1
lema(ur'[Mm]oment_o_s?_ó', xpos=[ur' que todos']) + #1
lema(ur'[Mm]over_á_[ns]?_a', xpre=[ur'\bde ', ur'Peñaflor, ', ur'Vivero y ', ur'\| ', ], xpos=[ur' S\.L', ur'(?:[\'\]\|]|, (?:\+Bytes|Peñaflor|Moyuela))', ]) + #1
lema(ur'[Mm]udar_í_a[ns]?_i', xpos=[ur' Nada Em', ur'\]', ]) + #1
lema(ur'[Pp]rend_é_r[mts]el[aeo]s?_e', xpre=[ur'come ']) + #1
lema(ur'[Rr]eval_ú_(?:a[ns]?|e[ns]?)_u', xpos=[ur' currency']) + #1
lema(ur'[Ss]_ó_lid[ao]_o', xpre=[ur'\b[AC]\. ', ur'Alveolina ', ur'Aceria ', ur'Antimima ', ur'Ardisia ', ur'Barteria ', ur'Blowiella ', ur'Borckhausenia ', ur'Bulla ', ur'Capnites ', ur'Capnoides ', ur'Caryophyllia\) ', ur'Corydalis ', ur'Cymbaloporetta ', ur'Davallia ', ur'Dioryche ', ur'Dos ', ur'Eragrostis ', ur'Euphaedra ', ur'Euphaedrana\) ', ur'Euthyonacta ', ur'Fumaria ', ur'Fargesia ', ur'Fusulina ', ur'Gari ', ur'Hastula ', ur'Leptoseris ', ur'Marginulina ', ur'Marginulinita ', ur'Neocyrena ', ur'Nodosarella ', ur'Nososticta ', ur'Pateoris ', ur'Phallomedusa ', ur'Pistolochia ', ur'Planorbulinella ', ur'Planorbulinoides ', ur'Polymesoda ', ur'Porites ', ur'Pseudotristix ', ur'Quinqueloculina ', ur'Ruschia ', ur'Semele ', ur'Single ', ur'Sphera ', ur'Spiroplectina ', ur'Sybra ', ur'[Hh]a ', ur'[Hh]an ', ur'bat likido ', ur'nisi duos ', ur'septem ', ur'var\. ', ], xpos=[ur' (?:intra solidum|quam)', ur'\'', ]) + #8
lema(ur'[Ss]_ó_rdido_o', xpre=[ur'sentier ', ]) + #1
lema(ur'[Ss]olemn_í_sim[ao]s?_i', xpos=[ur' fiesta del Santissimo', ]) + #1
lema(ur'[Ss]um_á_r[mts]el[aeo]s?_a', xpos=[ur' la conquista de los Creek']) + #1
lema(ur'[Ss]uministrar_í_a[ns]?_i', xpre=[ur'Bolivia les ']) + #1
lema(ur'[Vv]encer_á_[ns]?_a', xpos=[ur' e vinha']) + #1
lema(ur'[Vv]ers_á_til(?:es)_a', xpre=[ur'and ', ]) + #1
lema(ur'_á_lgebras?_a', xpre=[ur'\bs ', ur'\b(?:of|to|[ai]n|as) ', ur'Clifford ', ur'Combinatory ', ur'Commutative ', ur'Die ', ur'Lie ', ur'Moody ', ur'Riemann-Roch ', ur'Undergraduate ', ur'Vertex ', ur'Virasoro ', ur'Witt ', ur'[Aa]ssociative ', ur'[Bb]oolean ', ur'[Cc]omputer ', ur'[DdLl][’\']', ur'[Hh]omological ', ur'[Hh]ypercomplex ', ur'[Ll]inear ', ur'[Mm]atrix ', ur'[Rr]eal ', ur'about ', ur'and ', ur'differential ', ur'group ', ur'maior, ', ur'operator ', ur'particles, ', ur'relational ', ur'the ', ], xpos=[ur' (?:graded|for|from|and|of|em|et)\b', ur'(?:\]|, geometry)', ]) + #35
 []][0]
...
# lema(ur'_d_estinos?_D', pre=ur'[Yy] ', xpre=[ur'Dúos ']) + 
...
congelador = [
lema(ur'_C_hile_c', pre=ur'[Dd]e ', xpre=[ur'deshidratadoras ', ur'capa ', ur'cultivo '], xpos=[ur' (?:rojo|colorado|en polvo|y cenizas|jalapeño|poblano)']) + 
lema(ur'[Ff]und_ó__o', xpre=[ur'Passo ', ur'\b(?:[AaEe]l|[Uu]n) ', ur'del '], xpos=[ur' legal', ur'(?:\]\]|\|)']) + 
...
lema(ur'_m_undial(?:es|)_M', pre=ur'[Cc]ampeonatos? ') + 
lema(ur'_a_cumulad[ao]s?_A', pre=ur'(?:[Gg]eneral(?:es|)) ') + 
lema(ur'_a_lternativos?_A', pre=ur'(?:[Mm]edios?) ') + 
lema(ur'_b_anda_B', pre=ur'(?:[Mm]ejor|[Pp]eor) ') + 
lema(ur'_c_lasificación_C', pre=ur'(?:[Gg]eneral de) ') + 
lema(ur'_c_lasificatori[ao]s?_C', pre=ur'(?:[Rr]onda) ') + 
lema(ur'_c_ocientes?_C', pre=ur'(?:[Gg]eneral de) ') + 
lema(ur'_c_ompetencia_C', pre=ur'(?:[Gg]eneral de) ') + 
lema(ur'_d_isciplinas_D', pre=ur'[Pp]or ') + #281
lema(ur'_d_ram[áa]tic[ao]s?_D', pre=ur'[Ss]erie ') + 
lema(ur'_e_liminatori[ao]s?_E', pre=ur'(?:[Rr]ondas?|[Tt]orneos?|[Pp]artidos?) ') + #1008
lema(ur'_e_pisodios_E', pre=ur'de ') + #1008
lema(ur'_f_auna_F', pre=ur'[Nn]acional de ') + 
lema(ur'_f_emenin[ao]_F', pre=ur'(?:[Nn]acional) ') + 
lema(ur'_f_emeninos_F', pre=ur'(?:[Ii]ndividuales|[Dd]obles) ') + #363
lema(ur'_f_inales_F', pre=ur'[Rr]ondas ') + #1806
lema(ur'_g_eneral_G', pre=ur'(?:[Tt]abla|[Cc]lasificación) ') + 
lema(ur'_i_ndividuales_I', pre=ur'[Dd]istinciones ') + #364
lema(ur'_i_nferior_I', pre=ur'[Cc]uadro ') + #2970
lema(ur'_i_ntern[ao]s?_I', pre=ur'[Cc]omunicación ') + 
...
lema(ur'_p_eriodismo_P', pre=ur'y ') + 
...
lema(ur'_p_rotegidas?_P', pre=ur'[Nn]atural(?:es|) ') + 
lema(ur'_r_eferencias?_R', pre=ur'(?:[Ee]xternos y) ') + 
...
lema(ur'_t_emas_T', pre=ur'(?:[Ll]istas?|[Ll]istados?) de ') + #587
lema(ur'_w_eb_W', pre=ur'(?:[Pp][aá]gina|[Ss]itio|[Pp]ortal) ') + #5102
lema(ur'[Cc]eb_ú__u', xpre=[ur'\b(?:to|of) ', ur'Casino, ', ur'City\]\], ', ur'City\|', ur'Davao y '], xpos=[ur' (?:Pacific|City|International|Flowerpecker)', ur', Filipinas']) + 
...
lema(ur'[Aa]ndalus_í__i', xpre=[ur'poeti ', ur'[Aa]l[- ]\'\'', ur'[Aa]l[- ]\'', ur'[Aa]l[- ]'], xpos=[ur' (?:Arabic|Mix)']) + 
...
# lema(ur'_o_riginal_O', pre=ur'[Ss]onora ', xpos=[ur' do\b']) + 
...
lema(ur'_francé_s_(?:Franc[eé]|france)', pre=ur'\b(?:e[ln]|del?|idioma) ', xpre=[ur'Guerra ', ur'maestra ', ur'Diplomado ']) + 
lema(ur'_japoné_s_(?:Japon[eé]|japone)', pre=ur'\b(?:idioma|e[nl]|del?|y) ', xpre=[ur'Diplomado ']) + 
lema(ur'_i_taliano_I', pre=ur'\b(?:idioma|e[nl]|del?|e) ', xpre=[ur'Club ', ur'Alemán y ']) + 
lema(ur'_inglé_s_(?:Ingl[eé]|ingle)', pre=ur'\b(?:e[ln]|del?|idioma|e) ', xpre=[ur'Diccionario ', ur'Gestión ', ur'en Francés ', ur'Nivel ', ur'Docencia ', ur'[Dd]epartamento ', ur'B\.A\. ', ur'Juan ', ur'Pedagogía ', ur'bilingüe ', ur'[Cc]lase ', ur'[Cc]lases ', ur'[Cc]ursos ', ur'[Cc]arreras ', ur'aparte ', ur'titula ', ur'[Pp]rofesores ', ur'[Pp]rofesor ', ur'Diplomado ', ur'Programa ', ur'[Ee]nseñanza ', ur'graduó ', ur'especializada ', ur'\bla ', ur'Mesa del ', ur'Piedra ', ur'Castellano ', ur'Castillo ', ur'orales ', ur'Maestra ', ur'[Pp]rogramas ', ur'Teacher ', ur'interrelacionados ', ur'Punta ', ur'Playa ', ur'Pico ', ur'Instituto ', ur'Física Nuclear ', ur'grado ', ur'profesor\]\]a ', ur'[Pp]rofesor ', ur'[Pp]rofesora ', ur'Profesorado ', ur'Maestría ', ur'Japón\]\] ', ur'Bogotá\)\|', ur'Playa ', ], xpos=[ur' (?:\(idiomas)', ur'\'\'']) + lema(ur'[Ii]ngl_é_s(?:\]\]|[,.]| \(pueblo)_e', xpre=[ur'Zach ', ur'Chris ', ur'Clube ', ur'cintura e ', ur'David ', ur'Nelson ', ur'J\. ', ur'Joe ', ur'Joe Ingles\|', ur'ojos e ', ur'las ', ur'sus ', ], xpos=[ur'[a-z]+', ur' (?:cuello|axilas|\(Bogotá)']) + #583
 

lema(ur'_c_heco_C', pre=ur'\bde ', xpos=[ur' (?:a|Pérez)\b']) + 
lema(ur'_ú_nic(?:[ao]s|amente)_u', xpre=[ur'pedes dúo ', ]) + 
lema(ur'_ó_rbitas?_o', pre=ur'(?:[Ll]as?|[Ss]us?|[Uu]nas?|[Ee]n) ', xpre=[ur'que ']) + 
lema(ur'_é_tnic[ao]_e', xpre=[ur'Dalmazia ', ], xpos=[ur' e resistenza', ur'\'', ]) + 
lema(ur'_ejé_rcito_Ej[eé]', pre=ur'(?:[Aa]l|[Ee]l|[Dd]el|[Uu]n|[Ss]u) (?:[Pp]rimer|[Ss]egundo|[Tt]ercer|[Cc]uarto|[Qq]uinto|[Ss]exto|[Ss]éptimo|[Oo]ctavo|[Nn]oveno|[Dd]écimo|[0-9]+º) ', xpos=[ur' (?:Panzer|Francés)']) + 
lema(ur'[l]_í_der_i', pre=ur'(?:[Ee]l|[Ll]a|[Uu]na?|[Ee]s|[Ff]u[ée]|[Ss]u) ', xpre=[ur'd´']) + 
lema(ur'[Tt]ermin_ó_ [a-zñ]+[aeáé]ndo(?:(?:[mts]e|nos)(?:l[aeo]s?|)|l[aeo]s?|)_o', xpre=[ur'primer ']) + 
lema(ur'[Rr]_í_gid(?:as|os?|amente)_i', xpos=[ur' e [Cc]erimonale']) + 
lema(ur'[Qq]u_í_mic[ao]_i', xpre=[ur'Uniao ', ur'Estudo '], xpos=[ur'cNova', ur'\.uady']) + 
lema(ur'[Pp]sicol_ó_gic[ao]_o', xpre=[ur'e ', ur'primo ', ], xpos=[ur' ed', ]) + 
lema(ur'[Pp]ol_í_tico_i', xpre=[ur'\be ', ur'\b[Ii]l ', ur'de \'\'', ur'ordinamento ', ur'periódico\)\|', ur'regime ', ur'come paradigma ', ur'categorie del ', ur'pensamento ', ur'regolarità del ciclo ', ur'Aspetti del realismo ', ur'Niente Asilo ', ur'The ', ur'canterò ', ur'il ', ur'significato ', ur'scritto ', ur'Niente Asilo ', ur'The ', ur'il ', ur'scritto ', ur'uomo ', ], xpos=[ur' (?:Centrale|dalla|delle|dei|di|\(periódico)\b', ur'\.(?:com| Diplomazia)']) + 
lema(ur'[Mm]_é_todo_e', xpre=[ur'\be ', ur'\b(?:di|[Ii]l) ', ur'Cirilo y ', ur'struktura ', ur'Introduzione al ', ur'genesi del ', ur'[Ss]ul ', ], xpos=[ur' (?:mui|facile|naturale|ipocondriaco|konparatzailea|[Cc]lassico|exposita|refrigerandi|Telecomunicacoes|storico|anal[ií]tico, filosofico e fisiologico|e tavole|per|di )', ur', Fonti', ]) + #109
lema(ur'[Ll]ogr_ó_ +(?:el|la|los|las|un|una|unos|unas|dos|tres|cuatro|cinco)_o', xpre=[ur'(?:[Uu]n|[Ss]u|[Ll][eo]|[Ss]e) ', ur'mayor ', ur'[Ee]ste ', ur'[Ss]e (?:me|te|l[aeo]) ', ur'[Ss]e l[aeo]s ']) + 
lema(ur'[Ii]nt_é_rprete_e', pre=ur'(?:[Ll]a|[Ee]l|[Uu]na?|como) ', xpre=[ur'no '], xpos=[ur' (?:como|siente|\'\'a capella|el|[ay] )']) + 
lema(ur'[Ff]_á_ciles_a', xpre=[ur'T\. ', ur'Tugulusaurus ', ur'[Pp]ièces ', ], xpos=[ur' (?:à|pour|et)', ]) + 
lema(ur'[Dd]ic_i_embre_', xpre=[ur'Dodici ', ur'\bdi ']) + 
...
lema(ur'[Cc]apit_á_n_a', pre=ur'(?:[Ee]l|[Uu]n|[Dd]el?|[Cc]omo) ', xpre=[ur'OS X ', ur'OS X\]\] "', ur'10.11 \(', ur'OS X\]\] ', ur'\]\] \(', ur'The ', ], xpos=[ur' (?:Theatre|Theater|generale|10\.11)', ]) + 
lema(ur'[Pp]erpet_ú_(?:an|e[ns]?)_u', xpre=[ur'Rote ']) + 
...
lema(ur'[Ll]_é_mur_e', xpre=[ur'Ruffed ', ur'término \'\'', ur'[Gg]énero \'\'', ur'[Gg]énero \'\'\[\[', ur'[Gg]énero\]\] \'\'', ur'The ', ur'latín \'\'', ur'catta\|', ur'Pristimantis '], xpos=[ur' (?:News|Ultra|Center|Conservation|Street|Species|catta|Input)', ur'\] BBC']) + #337
lema(ur'[Vv]_é_rtices?_e', xpre=[ur'\b(?:[Ii]n|Il|of) ', ur'São Paulo: ', ur'Its '], xpos=[ur' (?:del Pci|of|usque)']) + #148
lema(ur'[Aa]rt_í_stic[ao]s_i', xpre=[ur'Produçoes ', ur'storico ']) + lema(ur'[Aa]rt_í_stic[ao]_i', xpre=[ur'\be ', ur'non solo ', ur'Umane, Liceo ', ur'Guida ', ur'letteratura ', ur'creatività ', ur'storico ', ur'storia ', ur'[Ff]onderia ', ur'[Ff]ormazione ', ur'[Aa]ssociazione ', ur'[Ee]sposizione ',ur'[Pp]iù ', ur'[Cc]ircolo ', ur'[Ss]tanilimiento ', ur'sull\''], xpos=[ur' (?:statale|Editrice|e (?:ambientale|demoantropologico)|editrice|a Mantova|architettonica|ticinese|di|futuribile|cremonese)\b']) + 
lema(ur'[Cc]_ó_mplices?_o', xpre=[ur'[LlSs]es ', ur'[Ll]e ', ur'Dii ', ur'Soleil '], xpos=[ur' (?:muta|Ou)', ur'\'']) + 
lema(ur'[mm]_á_quinas?_a', pre=ur'(?:[Ll]as?|[Uu]nas?|[Cc]ada|[Ss]us?|[Ee]stas?|[Aa]) ', xpos=[ur' da ']) + 
lema(ur'Copiap_ó__o', xpre=[ur'Volcano ', ]) + #1
lema(ur'Llovi_ó__o', xpre=[ur'de ', ], xpos=[ur' (?:\(Lloviu|•)', ur'\]', ]) + #13
lema(ur'[Aa]_demá_s_ dem[aá]', xpos=[ur' (?:adolescentes|autoridades|aspectos|bandas|cosas|esclavos|estudiantes|espíritus|gente|generales|jugadores|municipios|organizaciones|partes|plataformas|personas|personalidades|países)']) + 
lema(ur'[Aa]boli_ó__o', xpre=[ur'Rosalía ', ]) + #1
lema(ur'[Aa]cad_é_micos_e', xpre=[ur'Artes ', ur'Congressos ']) + 
...
lema(ur'[Aa]eron_á_utica_a', xpre=[ur'Sociedade ', ur'maggiore ', ur'militare ', ur'Nazionale ', ur'Autoritatea ', ur'Brasileira de ', ur'Gira Globo ', ur'R\. ', ur'dell[’\']', ur'Alenia ', ur'Regia '], xpos=[ur' (?:SMA|[Mm]ilitare|Nazionale|Torino|Umbra|Macchi|Nakajima|Cobelligerante|Regală|Romana|Română|Aichi|Ansaldo|de São Paulo|Sicula|per|Imperialis)', ur'\. Milano']) + 
...
lema(ur'[Aa]ntig_ü_edad(?:es|)_u', xpre=[ur'Ibèrica de la '], xpos=[ur' deste', ur', calidad, i\b']) + 
lema(ur'[Aa]post_ó__o', xpre=[ur'Evarcha ', ], xpos=[ur' Gazella', ]) + #1
lema(ur'[Aa]r_á_cnid[oa]s?_a', xpre=[ur'ooteca ']) + 
lema(ur'[Aa]scendi_ó__o', xpre=[ur'[Ss]iendo ', ]) + #2
lema(ur'[Aa]stron_á_uticas?_a', xpre=[ur'in "', ur'Encyclopedia ']) + 
lema(ur'[Aa]tl_é_tic[ao]_e', xpre=[ur'Clube ', ur'Viva l\'', ur'Associazione '], xpos=[ur'\]\]', ur' (?:Clube|\([Mm]arca|Tucumán|Leggera|Portici|Informáticos|Puteolana|Paranaense)']) + 
lema(ur'[Aa]vent_ó__o', xpos=[ur' Aretino', ]) + #1
lema(ur'[Bb]_ó_ric[ao]s?_o', xpre=[ur'Zamora ', ur'Diego ', ur'Toichoa ', ur'Terencio ']) + 
lema(ur'[Bb]ailar_í_n_i', xpos=[ur'\]\](?:es|a)']) + 
...
lema(ur'[Bb]iogr_á_fic[ao]s?_a', xpre=[ur' e ', ur'Scheda ', ur'[Ss]aggio ', ur'Archivio ', ur'percorso ', ur'studio ', ur'Storico ', ur'Schizzo ', ur'Dizionario[- ]'], xpos=[ur' (?:universale|degli|Treccani|e concettuale|Parmigiani|di|Universale)']) + 
lema(ur'[Bb]iol_ó_gic[ao]_o', xpre=[ur'agricoltura ', ur'Lotta ', ur'testamento ', ur'Senckenbergiana ', ur'Seckenbergiana ', ur'Acta ', ur'Symposia ', ur'Carolinae - ', ur'Carolinae -- ', ur'[Oo]pera '], xpos=[ur', Geographica', ur' (?:Benrodis|[Ff]ennica|[Hh]ungarica|Paranaense|sui|della|nel|e integrata|vegetale|applicata|et )']) + 
lema(ur'[Cc]_á_tedras?_a', xpre=[ur'Publicacions de la ', ur'[Ee]x ']) + 
lema(ur'[Cc]_ú_spides?_u', xpre=[ur' a '], xpos=[ur' (?:tetigisse|Awards)']) + 
lema(ur'[Cc]af_é__e', pre=ur'(?:[Ee]l|[Uu]n|[Cc]olor|[Dd]e) ', xpos=[ur' (?:romantic|dels)']) + 
lema(ur'[Cc]af_é_s_e', xpre=[ur'Two '], xpos=[ur' (?:do|of|and)']) + 
lema(ur'[Cc]l_í_nica_i', xpre=[ur'Schola ', ur'della ', ur'Esempio '], xpos=[ur' (?:di|delle?|e (?:Terapia|di|giuridica)|de l\'Aliança|di |Chimica|Serres|outcome|groazei|Medical|Chirurgica|Est[ée]tico)\b']) + 
lema(ur'[Cc]ompa_ñí_as?_(?:n[ií]|ñi)', xpre=[ur' i ', ur'exercita la '], xpos=[ur' (?:do|Națională|de Iesu)']) + 
lema(ur'[Cc]onoci_ó__o', xpre=[ur'[Ee]s ', ]) + #4
lema(ur'[Cc]onsigui_ó__o', xpos=[ur' dificultar i ', ]) + #4
lema(ur'[Cc]rey_ó__o', xpre=[ur'Ignacio ', ]) + #1
lema(ur'[Cc]ruz_ó__o', xpre=[ur'\*\* ', ur'\b(?:me|[Yy]o) ', ur'Mayas ']) + 
lema(ur'[Dd]iat_ó_nic[ao]s?_o', xpre=[ur'Philaethria '], xpos=[ur' genere']) + 
lema(ur'[Dd]id_á_ctic[ao]s?_a', xpre=[ur'Historica ', ur'Methodus '], xpos=[ur' Omnia']) + 
lema(ur'[Dd]ividi_ó__o', xpre=[ur'[Ee]s ', ur'[Ee]st[aá] ', ur'[Ff]u[eé] ', ]) + #1
lema(ur'[Dd]oli_ó__o', xpre=[ur'Juan ', ur'un ', ], xpos=[ur'\]\]', ]) + #2
lema(ur'[Dd]ond_e__é', xpre=[ur'Villar ', ur'Rafael ', ur'Manuel ', ur'Salvador ', ur'Emilio ', ur'Pedro ', ur'Elda  ', ur'Fundación '], xpos=[ur' Matute', ur'[\]]']) + 
lema(ur'[Dd]orm_í_a[ns]?_i', xpre=[ur'notte, Cassio ']) + 
lema(ur'[Ee]_x_tranjer[ao]s?_s', xpre=[ur'Inglesa y ']) + 
lema(ur'[Ee]jerci_ó__o', xpre=[ur'[Ee]l ', ]) + #1
lema(ur'[Ee]miti_ó__o', xpos=[ur' Mayo', ]) + #6
lema(ur'[Ee]nd_é_mic[ao]s?_e', xpos=[ur' di']) + 
lema(ur'[Ee]nvi_ó__o', xpre=[ur'(?:[Ee]l|[Uu]n|[Dd]e) ', ur'[Cc]ada ', ], xpos=[ur' (?:cada)', ]) + #7
lema(ur'[Ee]rr_ó_ne[ao]s?_o', xpre=[ur'Cordulegaster ']) + 
lema(ur'[Ee]sc_á_ndalos?_a', xpre=[ur'Pubblicista de ']) + 
lema(ur'[Ee]sco_cé_s_(?:s[eé]|ce)', xpos=[ur'\]']) + 
lema(ur'[Ee]scribi_ó__o', xpos=[ur' de sus andanças', ]) + #5
lema(ur'[Ee]strenar_á__a', pre=ur'(?:[Ss]e )', xpre=[ur'que ']) + 
lema(ur'[Ee]ucar_í_stic[ao]s?_i', xpos=[ur' nazionale']) + 
lema(ur'[Ee]ucarist_í_as?_i', xpre=[ur' a ', ur'[Ll][\'’]']) + 
lema(ur'[f]antas_í_as?_i', pre=ur'(?:[Ll]as?|[Uu]nas?|[Dd]e|[Cc]ada|[Ss]u) ', xpre=[ur'regne de la ', ur'Enciclopèdia ', ur'Quando ', ur'[Qq]uasi ', ur'Scherzi '], xpos=[ur' (?:Barrino|inacabable d)\b', ur': (?:enquesta|ballava)']) + 
lema(ur'[Ff]ilm_ó__o', xpos=[ur' (?:[Ii]magen|López)']) + #3
lema(ur'[Ff]loreci_ó__o', xpos=[ur' Varela', ]) + #1
lema(ur'[Ff]onolog_í_as?_i', xpre=[ur'\be ', ur'di ', ur'Hizkuntzen ', ur'Euskal '], xpos=[ur' (?:della|e Gramática|Hitzez|e prosódia)']) + 
lema(ur'[Ff]otogr_á_fic[ao]s?_a', xpre=[ur'Informazione ', ur'percorso ', ur'immagine ', ur'Mostra ', ur'atlante '], xpos=[ur' con testi']) + 
lema(ur'[Gg]eneal_ó_gic[ao]s?_o', xpre=[ur'\be ', ur'\b(?:et|re) '], xpos=[ur' delle']) + 
lema(ur'[Gg]eogr_á_fic[ao]_a', xpre=[ur'Congresso ', ur'[Ss]ociet[áà] ', ur'[Ss]toria ', ur'Frazione ', ur'di una carta ', ur'[Ii]ndicazione ', ur'Istituto '], xpos=[ur', (?:edizione|statistico|nazionale|militare)', ur' (?:dell|Militare|ed|di|das|del mondo|Mondiale|Universale)']) + 
lema(ur'[Gg]eol_ó_gic[ao]s?_o', xpre=[ur' e ', ur' et ', ur'Scripta ', ur'Shakspeareana ', ur'Ufficio ', ur'Studia ', ur'Società ', ur'Carolinae - ', ur'Carolinae: '], xpos=[ur', Palaeontologica et', ur' (?:Sinica|Lilloana|Acta)']) + 
lema(ur'[Gg]obern_ó__o', xpre=[ur'(?:[Ee]l|[Uu]n|[Dd]e) ', ur'V[ií]a del ', ur'[Dd]el ', ur'[Dd]o ', ], xpos=[ur'(?: de Galicia)', ]) + #6
lema(ur'[Hh]er_o_ic[ao]s?_ó', xpre=[ur' e ', ur'Tempos ']) + 
lema(ur'[Hh]erb_á_cea_a', xpre=[ur'Aloe ', ur'Amorpha ', ur'Artemisia ', ur'Ageratina ', ur'[BCEHMSV]\. ', ur'Buddleja ', ur'Begonia ', ur'Capparis ', ur'Cattleya ', ur'Clidemia ', ur'Calycera ', ur'Cicindela ', ur'Calanthe ', ur'Chrysomela ', ur'Chrysolina ', ur'Cornus ', ur'Careya ', ur'var\. ', ur'Eugenia ', ur'Erica ', ur'Epitenodera ', ur'Epipactis ', ur'Erythrina ', ur'Eulophia ', ur'Euphorbia ', ur'Eurydema ', ur'Geophila ', ur'Grewia ', ur'Haworthia ', ur'Histiopteris ', ur'Jatropha ', ur'Memphis ', ur'Nemexia ', ur'Oldenburgia ', ur'Pteromonnina ', ur'Pavetta ', ur'Sybra ', ur'sicula ', ur'salicis-', ur'Sida ', ur'Salvia ', ur'Salicornia ', ur'Sambucus ', ur'Smilax ', ur'Sesbania ', ur'Salix ', ur'Solandra ', ur'Tetradenia ', ur'Tibouchina ', ur'Tetraneuris ', ur'Tetragonia ', ur'Vinca ', ur'Xerothamnella ', ur'Zornia '], xpos=[ur'\'']) + 
lema(ur'[Hh]u_é_rfan[ao]s?_e', xpre=[ur'Christian ', ur'Camilo '], xpos=[ur' \(Colorado']) + 
lema(ur'[Ii]_mbé_cil(?:es|)_(?:nb[eé]|mbe)', xpre=[ur'No ', ur'Vile ', ur'Rotten '], xpos=[ur'\.com']) + 
lema(ur'[Ii]d_é_ntic[ao]s?_e', xpre=[ur'L\'']) + 
lema(ur'[Ii]n_ú_til(?:mente|)_u', xpre=[ur'L\'espera ']) + 
lema(ur'[Ii]nt_é_rpretes_e', pre=ur'(?:[Ll]as|[Ll]os|[Ee]s) ', xpos=[ur' (?:como|siente|\'\'a capella|el|[ay] )']) + 
lema(ur'[Ii]nter_é_s_e', xpos=[ur'\]']) + 
lema(ur'[Ii]sl_á_mic[ao]s?_a', xpre=[ur'Leptanilla ', ur'diritto ', ur'espansione ']) + 
lema(ur'[Jj]am_á_s_a', xpre=[ur'Abel ']) + 
...
lema(ur'[Ll]ogr_ó_ +(?:[a-z]+[aei]r|[0-9]+)(?:se|)\b_o', xpre=[ur'grande ', ur'gran ', ur'[Cc][oó]mo ', ur'mayor ', ur'destacado ', ur'notable ', ur'[Uu]n ']) + 
lema(ur'[Mm]_é_dico_e', pre=ur'(?:[Aa]l|[Ee]l|[Ss]u|[Uu]n|como) ', xpos=[ur' in ']) + 
lema(ur'[Mm]_ó_vil(?:es|)_o', xpre=[ur'and '], xpos=[ur'@ccess', ur' (?:Tours|Air|Acces)']) + 
lema(ur'[Mm]elanc_ó_lic[ao]s?_o', xpos=[ur' – Allegro']) + 
lema(ur'[Mm]eti_ó__o', xpre=[ur' tri ', ], xpos=[ur' (?:Rufo|Marulo|Marullus|Fufecio)', ]) + #2
lema(ur'[Mm]icrobiolog_í_as?_i', xpos=[ur' (?:Ambiental|e Parasitologia|- Manual de Aulas Práticas)']) + 
lema(ur'[Mm]icrosc_ó_pic[ao]s?_o', xpre=[ur'Ascodesmis ', ur'Lemna ', ur'Orthocosta '], xpos=[ur' (?:di|corporis|ron)\b']) + 
lema(ur'[Mm]itolog_í_as?_i', xpre=[ur'sulla ', ur'Herriko ', ur'Relats de '], xpos=[ur' (?:locale|grega|vedica|comparata)']) + 
...
lema(ur'[Nn]_á_ufrag(as|os?)_a', xpre=[ur'[Qq]ue ', ur'Denboraren ']) + 
lema(ur'[Nn]_í_tric[ao]s?_i', xpre=[ur'l’acido ']) + 
...
lema(ur'[Ff]ilolog_í_as?_i', xpre=[ur'\be ', ur'Interuniversitari de ', ur'Portuguesa de ', ur'Departament de ', ur'Seminari de ', ur'Quaderns de ', ur'Grande Antologia ', ur'Anuari de ', ur'alla '], xpos=[ur' (?:da|eta|catalana i|de la Universitat|e (?:storia|cr[ií]tica|modernità|letteratura)|Anglesa)\b']) + #32
...
lema(ur'[Oo]blig_ó__o', xpre=[ur'\by ', ur'\bte ']) + 
lema(ur'[Oo]r_í_genes_i', xpos=[ur' \& Associates']) + 
lema(ur'[Oo]rganiz_ó__o', xpre=[ur'Junulara ', ur'Naturista ']) + #10
lema(ur'[Pp]_á_ramos?_a', xpre=[ur'\bin ', ur'\bo ', ur'Adriana ', ur'[Nn]os ', ur'Santi ', ur'the '], xpos=[ur' (?:dharmáh|dharmaḥ|nunca)']) + 
lema(ur'[Pp]_é_ndulos?_e', xpos=[ur', Doubtful', ur' (?:Studios|lanzó)']) + 
lema(ur'[Pp]_ú_blica_u', pre=ur'(?:Notar[ií]a|[Tt]elevisi[oó]n|[Pp]olítica) ', xpos=[ur' un']) + 
lema(ur'[Pp]_ú_lpitos?_u', xpos=[ur'\'', ur' (?:de chocolate|di |tehuelche|\(Orful)', ur', Nartece']) + 
lema(ur'[Pp]_ú_trid[ao]s?_u', xpre=[ur'Cyclocephala ', ]) + 
lema(ur'[Pp]aleontol_ó_gic[ao]s?_o', xpre=[ur'Societa '], xpos=[ur' e Geol[oó]gico']) + 
lema(ur'[Pp]arti_ó__o', xpre=[ur'[Cc]orazón ', ]) + #3
lema(ur'[Pp]aup_é_rrim[ao]s?_e', xpre=[ur'magistrorum ']) + 
lema(ur'[Pp]ediatr_í_as?_i', xpre=[ur'della ', ur'\bdi ', ur'Symposia – '], xpos=[ur' d’Urgenza']) + 
lema(ur'[Pp]idi_ó__o', xpre=[ur'del ', ur'(?:Lo|El) ']) + #3
lema(ur'[Pp]in_z_as?_s', xpos=[ur'["\']', ur' Attack']) + 
lema(ur'[Pp]ir_á_mides?_i', xpos=[ur' di ']) + 
lema(ur'[Pp]neum_á_tic[ao]s?_a', xpre=[ur'\[\[', ur'seu ', ur'Battello ', ur'Antlia ', ur'Martello ']) + 
lema(ur'[Pp]odr?_í_amos_i', xpre=[ur'nom ']) + 
lema(ur'[Pp]ol_é_mic[ao]s?_e', xpre=[ur'di una '], xpos=[ur' (?:in|tra)\b']) + 
lema(ur'[Pp]r_í_ncipes?_i', pre=ur'(?:[AaEe]l|[Ll]os|[Uu]n|[Uu]nos) ', xpre=[ur' di '], xpos=[ur' metaphysique']) + 
lema(ur'[Pp]ro_y_ectos?_j', xpre=[ur'\bin ', ur'\bcom '], xpos=[ur' (?:971|Francesinha|e edifícios|do|Eficiência|impossível|Vercial)\b']) + #154
lema(ur'[Pp]rogn_ó_stic[ao]s?_o', xpre=[ur'Hippocratis ', ur'\bet ', ur'Lunario Y '], xpos=[ur'\'']) + 
lema(ur'[Pp]ublic_ó_ (?:el|las?|los|una?)_o', xpre=[ur'\bal ']) + 
lema(ur'[Rr]_í_os?_i', pre=ur'(?:[Ll]os|[Uu]nos|[Vv]arios) ', xpos=[ur' Carcedo']) + 
lema(ur'[Rr]_í_tmic[ao]s?_i', xpre=[ur'Allegro ', ur'ben ']) + 
lema(ur'[Rr]_ú_stic[ao]s?_u', xpre=[ur'\bo ', ur'Via ', ur'Nicotiana ', ur'Catonis ', ur'Villa ', ur'Columbella ', ur'alla ', ur'\b(?:[Rr]e|di) ', ur'Emberiza ', ur'Capitalis ', ur'Antonio ', ur'Éditions ', ur'[Hh]irundo '], xpos=[ur'[\]\']', ur' (?:di|degli|Carpio|Xalostoc|nelle|de (?:Filippo|Narbona)|UIR|per|\(revista)\b']) + 
lema(ur'[Rr]e_í_a[ns]?_i', xpre=[ur'programación\)\|', ur'Kiyoku ', ur'wa '], xpos=[ur'[\'\]?]', ur' (?:\(lenguaje|Hiruda|Barbut)']) + 
lema(ur'[Rr]ealiz_ó__o', xpos=[ur' mis']) + #31
lema(ur'[Rr]ev_ó_lver_o', pre='(?:[Ee]l|[Uu]n|[Cc]on) ', xpos=[ur' Golden']) + 
lema(ur'[Rr]id_í_cul[ao]s?_i', xpre=[ur'\bet ', ur'Aristolochia ']) + 
lema(ur'[Rr]omer_í_as?_i', xpos=[ur' \(género', ur'[\]\']']) + 
lema(ur'[Ss]_á_tiras?_a', xpre=[ur'della ']) + 
lema(ur'[Ss]_ó_lid[ao]s_o', xpre=[ur'Rocka ', ur'duos ', ur'septem ', ], xpos=[ur' mulier', ur'\.es']) + #43
lema(ur'[Ss]abr_í_a[ns]?_i', xpos=[ur' Dahane']) + 
lema(ur'[Ss]at_é_lites?_e', xpre=[ur'Sirus '], xpos=[ur' Awards']) + 
lema(ur'[Ss]er_í_an_i', xpre=[ur'Metazygia ']) + 
lema(ur'[Ss]imp_á_tic[ao]s?_a', xpre=[ur'sunnambola / '], xpos=[ur' [Mm]ascalzone']) + 
lema(ur'[Ss]in_ _embargo_', xpos=[ur'\.mx']) + 
...
lema(ur'[Tt]_í_[ao]s?_i', pre=ur'(?:[Ee]l|[Ll]as?|[Ll]os|[Uu]na?|[Uu]n[ao]s|[Ss]us?|y|[Cc]on|[Uu]na?|[Dd]os|[Tt]res|[Cc]uatro) ', xpre=['testament de ', ur'Mia '], xpos=[ur' por']) + 
lema(ur'[Tt]ecnol_ó_gic[ao]s?_o', xpos=[ur'umanesimo ']) + 
lema(ur'[Tt]el_é_grafos?_e', xpre=[ur'Il '], xpos=[ur' and']) + 
lema(ur'[Tt]ent_ó__o', xpre=[ur'Bannou ', ur'Matsui ', ], xpos=[ur' (?:I|\(Febrero)', ur'(?:\)|\'\')', ]) + #1
lema(ur'[Tt]opogr_á_fic[ao]s?_a', xpos=[ur' e geometica']) + 
lema(ur'[Tt]r_á_nsito_a', xpre=[ur'Cappella del '], xpos=[ur' "Frankie']) + 
lema(ur'[Tt]r_á_queas?_a', xpos=[ur'\]']) + 
lema(ur'[Tt]raves_í_as?_i', xpre=[ur'millor ']) + 
lema(ur'[Vv]e_z__s', pre=ur'(?:[Uu]na|[Ee]sta|[Ee]sa|[Cc]ada|[Ss]ola|[Ee]n|[Pp]or) ', xpos=[ur' blanquecino']) + #De
lema(ur'[Vv]ig_é_sim[ao]s?_e', xpre=[ur'alla '], xpos=[ur' libertatis']) + 
lema(ur'[Vv]ivi_ó__o', xpre=[ur'Marco ', ur'Subaru '], xpos=[ur' (?:Pacioco|Sedan)']) + #6
lema(ur'[Zz]apater_í_as?_i', xpos=[ur' hirsuta']) + 
...
lema(ur'_V_oleibol_B', xpos=[ur' Taldea']) + 
lema(ur'_h_asta (?:el|ahora)_', xpre=[ur'Compluto, ']) + 
lema(ur'_hu_yen?_u', xpos=[ur'Aoi no ']) + 
lema(ur'_Á_rbol_A', xpos=[ur' Malacca']) + #191
lema(ur'_Í_dolos?_I', xpos=[ur' (?:infranto|folk|speculi|della)', ]) + 
lema(ur'_Ó_xidos?_O', xpre=[ur'director: ', ]) + 
lema(ur'_á_rbitros?_a', xpre=[ur'L\'']) + 
lema(ur'_í_dolos?_i', xpre=[ur'[Ll]\'', ur'nia kar ', ur'nia grand '], xpos=[ur' ji']) + 
lema(ur'_ó_rganos?_o', xpre=[ur'\bDe ', ur'\bin ', ur'per ', ur'[DdLl][\'’]']) + 
lema(ur'_ó_xidos?_o', xpre=[ur'[Ss]e ']) + 
lema(ur'q_ue__', pre=ur'(?:[Pp]or|[Pp]ara|[Pp]ero) ', xpos=[ur'[<]', ur' є']) + 
lema(ur'[Ll]a primer_a__', xpos=[ur' (?:ministro|miembro)']) + 
lema(ur'[Pp]_ú_rpuras?_u', xpre=[ur'(?:M\.|R,) ', ur'\'\'De ', ur'thrombocytopenic ', ur'Orchis ', ur'Henoch-Schonlein ', ur'erythrostomus, ',], xpos=[ur' (?:scorbutica|[Tt]rombocitopenia|patula|venosa)', ur'\.micolegio', ]) + 
lema(ur'[Rr]_é_plicas_', xpre=[ur'prop ', ur'the ', ur'Master ', ur'\'\''], xpos=[ur' (?:in|look|of|that|917)']) + 
lema(ur'[Cc]r_í_a[ns]?_i', xpos=[ur' a universidade', ur'\.org']) + 
lema(ur'[Mm]agn_é_tic[ao]s?_e', xpos=[ur' vulnerum']) + 
lema(ur'[Tt]ransform_ó__o', xpos=[ur' (?:em)\b']) + 
lema(ur'[Ee]ntre__ver_ ', xpre=[ur'escoger ']) + 
lema(ur'[Rr]adiof_ó_nic[ao]s?_o', xpre=[ur'Unione '], xpos=[ur' che']) + 
lema(ur'[Dd]efensor_í_as?_i', xpre=[ur'patria ', ur'Ep[ií]stola ']) + 
lema(ur'[Dd]ivi_di_d[ao]s_', xpre=[ur'Denise ']) + 
...
lema(ur'[Oo]nom_á_stic[ao]s?_a', xpre=[ur'Egyptian ', ur'Giorno '], xpos=[ur' della']) + 
lema(ur'[Cc]icl_í_stic[ao]s?_i', xpre=[ur'Settimana ', ur'Prova ', ur'[Gg]iro ', ur'[Ss]ettiman ', ur'[Ff]ederazione ', ur'[Ss]ocieta ', ur'[Gg]ara ', ur'[Aa]ssociazione ',]) + 
lema(ur'[Nn]eurol_ó_gic[ao]s?_o', xpos=[ur' (?:Belgica|Scandinavica)']) + 
lema(ur'[Ff]ilogen_é_tic[ao]s?_e', xpre=[ur'approccio '], xpos=[ur'\.org']) + 
...
lema(ur'[Ff]il_ó_sof[ao]s?_o', xpre=[ur'\bdi un ', ur'\bse ', ur'[Pp]rincipessa ', ur'finta ', ur'antro del ', ur'\b[Ii]l '], xpos=[ur' (?:sobre|mondain|dell|della|peripatetico)\b', ur'\.org']) + 
...
lema(ur'[Pp]_á_nicos?_a', xpre=[ur'\bdi ', ur'Sami ', ur'Timor ', ur'Dario ', ur'Giovanni ', ur'Patrizia ', ur'Panico\|', ur'Giuseppe '], xpos=[ur' (?:O|Ia[ck]ovou|Chrysanthou|urvilleani|Pirata|Na)\b', ur'(?:\'s|! La creazione)']) + #113
...
lema(ur'[Tt]_á_ctic[ao]s?_a', xpre=[ur'\[\['], xpos=[ur' Imperialis']) + #100
...
lema(ur'[Dd]istra_í_d(?:[ao]s?|amente)a_i', xpos=[ur'\.org', ]) + 
lema(ur'[Aa]ntr_ó_pic[ao]s?_o', xpre=[ur'influsso ']) + 
lema(ur'Boyac_á__a', xpre=[ur'\bof ']) + 
lema(ur'_É_tic[ao]s?_E', xpre=[ur'Popolare '], xpos=[ur' (?:della|e Vita)', ur'(?:; con una|e analisi)']) + lema(ur'_é_tic[ao]s?_e', xpre=[ur'\bed ']) + 
lema(ur'[Ee]pidemiolog_í_as?_i', xpos=[ur'i Demografía']) + 
...
lema(ur'[Ii]ran_í_(?:es|)_i', xpre=[ur'Honey ', ur'Boman ', ur'Natasha ', ur'Ardeshir '], xpos=[ur' (?:Rael|Sharif)', ur', Shahrukh']) + 
lema(ur'[Ii]raqu_í_(?:es|)_i', xpos=[ur' Oil', ur'\. Jinete']) + 
lema(ur'[Jj]abal_í__i', xpre=[ur'\bAl ', ur'Roberto ', ur'Jabali\|']) + 
lema(ur'[Mm]anat_í_(?:es|)_i', xpos=[ur'\.pr']) + 
lema(ur'[Mm]aniqu_í__i', xpre=[ur'río ', ur'Alto ', ur'Pizza o ']) + 
lema(ur'[Mm]arroqu_í__i', xpre=[ur'María ']) + 
lema(ur'[Rr]earregl_ó__o', xpre=[ur'[Cc]on ', ur'(?:[Uu]n|[Ee]l) ']) + 
lema(ur'[Ss]efard_í__i', xpre=[ur'Bustan '], xpos=[ur' Kultturist']) + 
lema(ur'[Jj]ud_a_ic[ao]s?_á', xpre=[ur'Civilização ']) + 
lema(ur'[Ii]nform_ó__o', xpre=[ur'\b[Yy]o ', ur'\bo "'], xpos=[ur' (?:que (?:no estaré|si usted))']) + 
lema(ur'[Cc]ong_é_nit[ao]s?_e', xpre=[ur'Litoria ']) + 
lema(ur'[Pp]rincip_i_os?_', xpos=[ur' defeso']) + 
lema(ur'[Gg]eobot_á_nic[ao]s?_a', xpre=[ur'Phytotaxonomica ', ur'Folia ', ur'Series A, Taxonomica, ']) + 
lema(ur'[Cc]_ó_smic[ao]s?_o', xpre=[ur'mistero '], xpos=[ur' (?:do|Artists)\b']) + 
#[(ur'¿ *(?:por *qu[eé]|Porqu[eé]|Por que)', ur'¿Por qué')] + 
lema(ur'¿[Pp]or_ qué__(?:qu[eé]| [Qq]ue)', xpos=[ur' decide establecer']) + 
# lema(ur'[Pp]r_á_ctic[ao]_a', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Dd]e) ', xpre=[ur'nadie ', ur'aun ', ur'se ']) + 
lema(ur'[Pp]r_á_ctica_a', pre=ur'(?:[Aa]|[Ee]n|[Dd]e|[Uu]na?|[Pp]ara) la ', xpos=[ur' (?:iudiciaria|della)']) + 
lema(ur'[Rr]_é_cords?_e', pre=ur'(?:[Ll]os|[Uu]nos|[Ee]l|[Uu]n|[Ss]us?|nuevos?|anterior(?:es|)|otros?) ', xpos=[ur' (?:i|o un Recordset|Week|Store|Manager|Plant|Academy|[Rr]eport)\b']) + 
lema(ur'[Rr]_é_cords? (?:del?|que|Guiness|absoluto|[Mm]undial|[Oo]l[ií]mpico)_e', xpre=[ur'(?:[Ee]l|[Uu]n|[Ss]u) ', ur'\b[KM] ', ur'Bros\. ', ur'ABC ', ur'Atlantic ', ur'Wondaland ', ur'URL ', ur'Fear ', ur'Virgin ', ur'Columbia ', ur'Radish ', ur'Selectric ', ur'Doorn ', ur'Invasion ', ur'Flicker ', ur'Capitol ', ur'House ', ur'Repsychled ', ur'Counterfeit ', ur'Tower ', ur'Blind ', ur'RCA ', ur'Earache ', ur'Cleopatra ', ur'Hollywood ', ur'MODE ', ur'Nine ', ur'Elígeme ', ur'Pulse ', ur'London ', ur'Jive ', ur'Ultra ', ur'Reprise ', ur'Napalm ', ur'Stiff ', ur'nuevo ', ur'anterior ', ur'otro ', ur'speed ', ur'Rede ', ur'Cinematic ', ur'World ', ur'Boot ', ], xpos=[ur' (?:l|Saló|Comunicações|València)\b']) + 
lema(ur'[Hh]echi_c_er[ao]s?_z', xpre=[ur'bruxa y '], xpos=[ur' Band']) + 
lema(ur'[Cc]_á_ncer_a', pre=ur'(?:[Ee]l|[Uu]n|al|del?|por|tenía|tiene|tuvo) (?:\[\[|)', xpos=[ur' (?:and|Therapy|pagurus|Council|Bats|Research|Immunology)\b']) + 
lema(ur'[Cc]_á_ncer(?:\]\]|) (?:del?|en)_a', xpre=[ur'(?:[Ee]l|[Uu]n|al|de) \[\[', ur'(?:[Ee]l|[Uu]n|al|de) ', ur'(?:del|por) \[\[', ur'(?:del|por) ', ur'Gastric ', ur'Dinah '], xpos=[ur' (?:la MEN|inglés)']) + 
lema(ur'[Pp]r_ó_statas?_o', xpre=[ur'Eumorphia ', ur'Pernettya ', ur'var\. '],) + 
lema(ur'_s_edes? de_c', xpre=[ur'(?:[EeÉé]l|lo|un) ', ur'\bo ', ur'del ', ur'Villota ', ur'no la ', ur'que ']) + 
lema(ur'[Tt]oponom_á_stic[ao]s?_a', xpos=[ur', Relazioni']) + 
lema(ur'[Bb]_e_mol_é', xpre=[ur'Nocturne en Mi '], xpos=[ur' (?:Mineur|Majeur)']) + 
lema(ur'[Oo]x_í_genos?_i', xpos=[ur'\.bo']) + 
lema(ur'[Nn]_ó_dulos?_o', xpos=[ur'\.org']) + 
lema(ur'[Ll]_i_quen_í', xpre=[ur'Lira de ', ur'Siphula \('], xpos=[ur'\]\]es']) + 
lema(ur'[Cc]entr_í_fug[ao]s?_i', xpre=[ur'[Ss]e ']) + 
lema(ur'[Ll]at_í_n_i', pre=ur'(?:[Ee]n|[Ee]l|[Dd]el) ', xpos=[ur' (?:house|amour|Beat|jazz|lover|New|Award|Horror|American|Cinema|Alternative|Tracks|Grammy|script|Songs|Pop)']) + 
lema(ur'[Nn]av_í_os?_i', xpre=[ur'\bdo ', ur'Francisco ', ur'Malo i ', ur'Malo ', ur'Melara '], xpos=[ur' da\b', ur'[\'\]]']) + 
lema(ur'[Aa]lmac_é_n_e', xpos=[ur'\]\]es']) + 
lema(ur'[Ii]ncluy_ó__o', xpre=[ur'[Yy]o ']) + 
lema(ur'[Aa]not_ó__o', xpre=[ur'\bde \[\[', ur'\bde '], xpos=[ur' (?:\(Col|para que)', ur'\'\'']) + 
lema(ur'[Tt]r_í_os?_i', pre=ur'(?:[Uu]n|[Dd]os|[Tt]res|[Ee]l|[Ll]os|[Aa]l|[Dd]el) (?:\'+|"|\[\[|)', xpos=[ur' (?:Tournament|amb)']) + 
lema(ur'[a]tac_ó__o', xpre=[ur'[Yy]o ', ur'\b[Yy] '], xpos=[ur' (?:tiene origen|sobre el río|o Acajutla|significa|pertenecía|perteneció|solicitaron|espinoso|con besos)']) + 
...
lema(ur'[Ee]ncarg_ó_ una?_o', xpre=[ur'\bsu ']) + 
lema(ur'[Dd]istri__tos?_c', xpre=[ur'\b(?:do|no) ']) + 
lema(ur'[Mm]_u_tu[ao]s?_ú', xpre=[ur'Cable ', ur'Caja ', ur'Agrupació '], xpos=[ur' (?:Escolar|del C|Madrileña|de Granollers|com|General|Universal|Obreros|de Pa)\b']) + 
lema(ur'_í_ndole_i', xpre=[ur'Dell\'']) + 
lema(ur'_Í_ndole_I', xpos=[ur' Metabolism']) + 
lema(ur'[Vv]iol_ó__o', xpre=[ur'Sergio ', ur'[Ss]i no ', ur'[ns]i ']) + 
lema(ur'[Hh]om_ó_log[ao]s?_o', xpre=[ur'coordina y ', ur'[Qq]ue ', ur'\b(?:[Ss]e|[Nn]o|[Ll][ao]) ', ur'[Ll][ao]s '], xpos=[ur' norma']) + 
lema(ur'[Ll]_l_amad[ao]s?_', xpos=[ur' Award']) + 
lema(ur'[Mm]_é_dica_e', xpre=[ur'\b(?:se|et) ', ur'physico ', ur'Questio ', ur'politice ', ur'Citrus ', ur'John ', ur'Excerpta ', ur'Eduardo ', ur'Scuola ', ur'[Aa]rs ', ur'Clio ', ur'Tesis ', ur'Micaria ', ur'Praecepta ', ur'[Mm]ateria ', ur'Mariana Practica ', ur'dottrina ', ur'\be ', ur'Tipula ', ur'\b[Rr]e ', ur'T\. '], xpos=[ur' (?:[Cc]ompleta|Inauguralis|Italo-Argentina|et|nel|facultate|libri|sistens|e dell)\b', ur', Battat']) + 
lema(ur'[Ee]st_á_[ns]?_à', xpre=[ur'Mercè '], xpos=[ur' (?:fent|al exconvento|em|triomfant|amb|gotjant|ben|per|si bull|envoltada|llenot|enamorat|oberta|el nostre|es Canal|blau|pioc|a|perduda|constituït|clar|mort|relacionada formalement|en (?:dit|crisi|consonància|son|xinès)|ensorrant|malalt|assegurada|mai|embelt|“marginat|damunt|que bossa|sol)\b']) + 
lema(ur'[Mm]ar_í_tima_i', xpre=[ur'Sueda ', ur'latín\]\] \'\'', ur'\b[ABL]\. ', ur'subsp\. ', ur'ssp\. ', ur'var\. ', ur'var\. \'\'', ur'Prunus\]\] ', ur'912 ', ur'912\) ', ur'Anurida ', ur'Ruppia ', ur'Muilla ', ur'Matricaria ', ur'Diospyros ', ur'Puccinellia ', ur'Armeria ', ur'Missao de Biologia ', ur'Stachys ', ur'Dipsastraea ', ur'Draba ', ur'Drimia ', ur'Glyce ', ur'Scabiosa ', ur'Alnus ', ur'Cleome ', ur'Cicindela ', ur'Lavatera ', ur'[Ss]partina ', ur'Alnus ', ur'Linaria ', ur'Armenia ', ur'lobularia ', ur'Lasaia ', ur'Salsola ', ur'Chenopodina ', ur'Cryptantha ', ur'Octadenia ', ur'Gnaphosa ', ur'Ipomoea ', ur'Silene ', ur'Urginea ', ur'Artemisia ', ur'Abronia ', ur'Anthemis ', ur'Senckenbergiana ', ur'Armeria', ur'Festuca ', ur'pars ', ur'[Ll]oca ', ur'Glaucoides ', ur'Geositta ', ur'Chromodoris ', ur'ditione ', ur'maritima ', ur'Calendula ', ur'Kakile ', ur'Eurybia ', ur'Mertensia ', ur'Calidris ', ur'Strumpfia ', ur'Carex ', ur'Glaux ', ur'Crucianella ', ur'Mammillaria ', ur'[Ss]uaeda ', ur'Suriana ', ur'Hypselodoris ', ur'Suaeda ', ur'Statice ', ur'\b[Oo]ra ', ur'Batis ', ur'Cakile ', ur'Malcolmia ', ur'Remirea ', ur'Crambe ', ur'Lysimachia ', ur'Urginea ', ur'Vignea ', ur'vulgaris ', ur'Strumpfia ', ur'Jacobaea ', ur'Koniga ', ur'Clypeola ', ur'Prunus ', ur'Lobularia ', ur'Plantago ', ur'Caesarea ', ur'Pinus ', ur'[Rr]uppia ', ur'Thermotoga '], xpos=[ur' (?:in|Centrum|reveal|din|Italorum|omnis|uocauit|crudelissime|\(costera|tiene un \[\[periodo)\b', ur'\'\'']) + 
lema(ur'[Dd]emocr_á_tic[ao]_a', xpre=[ur'dittatore ', ur'Organizzazione ', ur'Editrice ', ur'Convergència ', ur'della teoria ', ur'Esquerra ', ur'istituita la ', ur'Partito Socialista ', ur'Partito ', ur'Sinistra ', ur'Liberalis ', ur'do Movimento '], xpos=[ur' (?:di|in|per|pra|Cinque|Svizzero|Nazionale|Repubblicana|della)\b']) + 
[(ur'(?P<f>\[|\|)(?P<a>Campeonato de Wimbledon|Torneo de Roland Garros) (?P<b>[12][0-9][0-9][0-9]) Individuales Masculinos(?P<e>\}|\]|\|)', ur'\g<f>Anexo:\g<a> \g<b> (individual masculino)\g<e>')] + 
[(ur'(?P<f>\[|\|)(?P<a>Campeonato de Wimbledon|Torneo de Roland Garros) (?P<b>[12][0-9][0-9][0-9]) Individuales Femeninos(?P<e>\}|\]|\|)', ur'\g<f>Anexo:\g<a> \g<b> (individual femenino)\g<e>')] + 
[(ur'(?P<f>\[|\|)(?P<a>Campeonato de Wimbledon|Torneo de Roland Garros) (?P<b>[12][0-9][0-9][0-9]) Dobles Masculinos(?P<e>\}|\]|\|)', ur'\g<f>Anexo:\g<a> \g<b> (dobles masculino)\g<e>')] + 
[(ur'(?P<f>\[|\|)(?P<a>Campeonato de Wimbledon|Torneo de Roland Garros) (?P<b>[12][0-9][0-9][0-9]) Dobles Femeninos(?P<e>\}|\]|\|)', ur'\g<f>Anexo:\g<a> \g<b> (dobles femenino)\g<e>')] + 
lema(ur'_t_v_T', pre=ur'de ', xpos=[ur' Azteca']) + #7506
lema(ur'[Mm]_é_danos?_e', xpos=[ur' Alt']) + 
lema(ur'[Uu]top_í_as?_i', pre=ur'(?:[Ll]as?|[Uu]nas?) ', xpre=[ur'd\'']) + 
[(ur'\((?P<a>[12][0-9][0-9][0-9]) film\)', ur'(película de \g<a>)')] + 
[(ur'\((?P<a>[12][0-9][0-9][0-9]) [Bb]engal[ií] film\)', ur'(película bengalí de \g<a>)')] + 
[(ur'\([Bb]engal[ií] film\)', ur'(película bengalí)')] + 
[(ur'\([Tt][Vv] series\)', ur'(serie de televisión)')] + 
[(ur'\([Bb]oxer\)', ur'(boxeador)')] + 
[(ur'\([Ww]restler\)', ur'(luchador)')] + 
[(ur'\((?:Banda [Ss]onora|banda Sonora)\)', ur'(banda sonora)')] + 
lema(ur'C_anadá__ánada', xpre=[ur'William ', ur'cónsul ']) + 
[(ur'\[\[(?:Parque [Nn]acional [Mm]arítimo-[Tt]errestre del Archipi[eé]lago de Cabrera|Parque nacional del Archipiélago de Cabrera|Parque [Nn]acional del Archipi[eé]lago de Cabrera)(?P<a>\]|\|)', ur'[[Parque nacional marítimo-terrestre del Archipiélago de Cabrera\g<a>')] + 
lema(ur'[Aa]rt_í_fices?_i', xpre=[ur'Dark ', ur'and ', ur'd[’\']'], xpos=[ur' (?:et|and)']) + 
lema(ur'[Dd]i_ó_cesis_o', xpre=[ur'in '], xpos=[ur' Hispaniarum']) + 
lema(ur'[Pp]_í_car[ao]s?_i', xpre=[ur'se '], xpos=[ur' Press']) + 
lema(ur'[Dd]ar_s_e(?:lo|)_c', xpre=[ur'Benito ']) + #1
lema(ur'[Vv]endi_ó__o', xpos=[ur' y shopkick', ]) + 
lema(ur'[Ss]obre_ _todo_', xpre=[ur'(?:[Ee]l|[Ss]u|[Uu]n|de) ', ur'\[']) + 
lema(ur'[H]ispanoam_é_rica_e', xpos=[ur'\]\]n[ao]s?']) + 
lema(ur'[Pp]ol_íti_c[ao]s?_[ií]t', xpos=[ur'\'']) + 
lema(ur'[Aa]compañ_ó__o', xpre=[ur'[Tt]e ']) + 
lema(ur'_ó_ptim[ao]s?_o', xpre=[ur'Ogasawarana '], xpos=[ur' (?:rerum|iure|politia|genere|et)']) + 
lema(ur'[Aa]gronom_í_as?_i', xpre=[ur'\bdi ', ur'Escola Superior de '], xpos=[ur' \(Puerto Bertoni']) + 
lema(ur'[Oo]_í_r_i', xpre=[ur'an '], xpos=[ur'(?:\'\'|")', ur' (?:misa los vaqueiros|é librar|y ayudar á misa|misa y dar cebada|17 años|con)']) + 
...
lema(ur'[Cc]r_í_tica_i', pre=ur'(?:[Ll]a|[Uu]na|[Ss]u|[Oo]tra|[Dd]ura|[Hh]istoria) ', xpre=[ur'\be ', ur'\bin ', ur'Per ', ur'bien '], xpos=[ur' (?:della?|[Oo]perativa)']) + lema(ur'[Cc]r_í_tica (?:por no descubrirse|positiva|negativa|literaria|discogr[aá]fica)\b_i', xpre=[ur'\bno ', ur'donde ', ur'que ', ur'quien ', ur'pero ']) + 
lema(ur'[Cc]r_í_ticas_i', xpre=[ur'[Qq]ue ', ur'[Cc]uando ', ur'chronologicas e '], xpos=[ur' tu propia']) + 
...
lema(ur'Dom_í_nguez_i', xpre=[ur'P ', ur'R\.; ', ur'P\. ', ur'd\'Oscar ', ur'Patrice Dominguez\|', ur'Patrice ', ur'Patrick ', ], xpos=[ur' Hills', ]) + #1105
lema(ur'Hern_á_ndez_a', xpre=[ur'\bby ', ur'over ', ur'Ferreyra ', ur'Feuntes ', ur'Patrick ', ur'Joe ', ur'Cole ', ur'Laurie ', ur'Jason ', ur'Gérard '], xpos=[ur' (?:High|Satyricon|es actualmente)', ur', Kelly']) + 
lema(ur'M_é_ndez_e') + 
lema(ur'P_á_ez_a') + 
lema(ur'Rold_á_n_a') + 
...
lema(ur'Mil_á_n_a', pre=ur'(?:[Dd]e|[Ee]n) ', xpre=[ur'amor ', ur'nombre ', ur'político ', ur'muerte ', ur'marcha ', ur'favor ', ur'africain ', ur'esposa ', ur'Maître ', ur'Africain ', ur'Dame ', ur'politiques ', ur'aldea ', ur'amante ', ur'padre ', ur'favor ', ur'Passage ', ur'Internazionale ', ur'Bâton de Jean ', ur'Pico ', ur'personas residiendo ', ur'Princesse ', ur'Jefa ', ur'Naturale ', ur'Scala ', ur'Valentine ', ur'[Mm]unicipio ', ur'l\'Etat ', ], xpos=[ur' (?:\(fue mucho|Gurovic|oeste|Football|Piqué|Stojadinović|Ivelic|Vidmar|Knížák|Ciganović|Lalkovič|Janković|Studios|Kadlec|Kosovac|Bandić|Gorkić|Bisevac|Turkovic|[Dd]i|Kundera|Melvin|Begović)', ]) + #261
lema(ur'Neuqu_é_n_e', xpre=[ur'7'], xpos=[ur' Trabvun']) + 
lema(ur'Guzm_á_n_a', xpre=[ur'Roderici de '], xpos=[ur' audience']) + 
lema(ur'P_é_rez_e', xpre=[ur'E\. ', ur'Of ', ur'née ', ur'Ellen ', ur'Vivancos ', ur'Rosie ', ur'Abe ', ur'Maurice ', ur'Moshe ', ur'Erickson y ', ur'Vincent ', ur'Lindsey ', ur'Guillo '], xpos=[ur' (?:Hilton|National|Companc Family|Family|Elementary|–se refiere)']) + 
lema(ur'Guti_é_rrez_e', xpre=[ur'Rocky '], xpos=[ur' as\b']) + 
...
lema(ur'Rodr_í_guez_i', xpre=[ur'and ', ur'Claudinei ', ur'Jayson ', ur'Benjamin ', ur'Robert ', ur'Michelle '], xpos=[ur'(?:, G\.|, Carvallaro|\|2012)', ur' (?:Buron|International)']) + 
lema(ur'Taip_é_i_e', pre=ur'(?:[Dd]e|[Ee]n) ', xpos=[ur' City']) + #169
lema(ur'V_á_squez_a', xpre=[ur'Junior ', ur'Jhonen ', ur'and Mario ']) + 
...
lema(ur'[Aa]rmon_í_as?_i', xpre=[ur'Gruppo ', ur'\be ', ur'\bdi ', ur'[LlDd][´’\']', ur'MSC \'\'', ur'Logia ', ur'MSC ', ur'Recondita ', ur'dell[´’\']', ur'dell[´’\'] ', ur'ed ', ur'bon ', ur'principessa ', ], xpos=[ur' (?:Beyondormason|d’Italia|dulcissime|Egara|F\.C\.|Favellare|Justin|per|sacra di|Somers|Valahă|Vivente)', ur'(?:\.info|1019fm)']) + #133
...
lema(ur'[Aa]t_ó_mic[ao]s?_o', xpre=[ur'Fizica ', ur'Desyello ', ur'Zanzara ', ur'formica ', ur'rubammo la bomba ', ur'vis ', ], xpos=[ur' (?:e altri|and|cinese|Patibulo)', ur'\]', ]) + #22
...
lema(ur'[Bb]amb_ú__u', xpre=[ur'Green ', ur'Pristimantis ', ur'balam '], xpos=[ur'\'']) + 
lema(ur'[Bb]ibliograf_í_a_i', xpre=[ur'\b[ei] ', ur'\bdi ', ur'\be la ', ur'Català de ', ur'in \'\'', ur'de la Llengua ', ur'Txillardegiren ', ur'Ensaios de ', ur'Indro Montanelli\. ', ur'locale, ', ur'Pequena ', ur'Seminari de ', ur'assaig de ', ur'della ', ur'di una ', ur'omosessuale\. ', ur'per \'', ur'uma ', ur'universala ', ], xpos=[ur' (?:dell|analitica ragionata|Botânica|militare|de la Llengua|de fra|botanica ossia|botanica della|de Botânica|de botanica 3|catalana cap a|\|Vlahov|critica \(1916-1963|su|i discografía|intellettuale|Medical de Catalunya|interdisciplinària|ragionata|bàsica|sullo|intellettuale|Literatury|italiana degli|cronologica della|Maria da Penha|d[ai]|dell[ae]|degli|e Informazione|verghiana|storico)\b', ]) + #106
...
lema(ur'[Cc]_á_rcel(?:es|)_a', xpre=[ur'Fran ', ur'Guillaume ', ur'[Cc]alle '], xpos=[ur' delle']) + 
...
lema(ur'[Cc]_ó_mic(?:as?|o)_o', xpre=[ur'\b(?:de|at) ', ur'Absurda ', ur'Theatro ', ur'ricreatione ', ur'Discoides ', ur'Scena ', ur'Stelis ', ur'di un ', ur'nasce un ', ur'Il Poeta '], xpos=[ur' (?:Valkyrie|caduto|spettacolo|Comics)\b', ur'(?:[0-9:\]\']|\.jp)']) + 
lema(ur'[Cc]_ó_mics?_o', pre=ur'\b(?:[Uu]n|[Ee]l|[Ll]os|de|en) ', xpos=[ur' (?:Relief|books?|Earth|Bulletin|[Cc]on|Vine|Book|Strip|Buyer|Code)', ur'\.com']) + #384
lema(ur'[Cc]anciller_í_as?_i', xpre=[ur'documents de la '], xpos=[ur'\.go[bv]']) + #16
lema(ur'[Cc]arn_í_vora_i', xpre=[ur'[Oo]rden ', ur'Orden: ', ur'Orden \'\'', ur'Category:', ur'Order ', ur'\[', ur'Anexo:', ur'Union: ', ur'edición de ', ur'Orden '], xpos=[ur' (?:==|Dracunivora)', ur' and', ur'(?:: Canidae|\'\'\'\|y \[\[Miacoidea|, (?:Fissipedia|Ursidae))']) + 
...
lema(ur'[Cc]r_á_ter_a', xpre=[ur'\ba ', ur'The ', ur'Barringer ', ur'Roden ', ur'Turbinaria ', ur'Punchbowl ', ur'Meteor ', ur'Talebheim ', ur'Meteorite ', ur'Molten ', ur'Sedan ', ur'Pico ', ur'Pit ', ur'Gas ', ur'Face ', ur'Corvus y ', ur'Impact ', ur'\bof ', ur'Impact ', ur'constelación\)\|', ur'Sunset ', ur'Nesta '], xpos=[ur' (?:of|in|and|Crawl|Observation|Lakes|structure|Lake|Festival|\(constelación|lake)\b']) + #687
...
lema(ur'[Dd]om_é_stic(?:as|os?)_e', xpre=[ur'Anthony ', ur'Vincenzo ', ur'Enzo ', ur'[Ii]l ', ur'[Ss]e '], xpos=[ur' (?:Kabregu|las plantas)']) + 
lema(ur'[Dd]om_é_stica_e', xpre=[ur'\[\[', ur'\bet ', ur'que ', ur'\b(?:hac|est) ', ur'\b[Ss]e ', ur'[IMNPsT]\. ', ur'\b[Ll]as ', ur'Brueelia ', ur'canaria ', ur'Catappa ', ur'Violenza ', ur'Channel ', ur'Cariniana ', ur'Curcuma ', ur'Cormus ', ur'Eugenia ', ur'Ilex ', ur'Iris ', ur'Jambosa ', ur'Kua ', ur'livia ', ur'Musca ', ur'Malus ', ur'Monodelphis ', ur'moschata ', ur'Nandina ', ur'Prunus ', ur'Pyrus ', ur'striata ', ur'scrofa ', ur'[Ss]orbus ', ur'Sus ', ur'Spermophora ', ur'Tegenaria ', ur'Thermobia '], xpos=[ur' (?:las|algun[ao]s|×|var)\b', ur'(?:\'|, or)']) + 
...
lema(ur'[Ee]m_é_rit[ao]s?_e', xpre=[ur'entre \[\[', ur'con ', ur'Asturica y ', ur'Caesaraugustam ', ur'Augusta ', ], xpos=[ur' (?:[1-9][0-9]*|sp|ya que|Football|Caesarea|Asturicam|Augusta|Caesaraugustam|analoga)\b', ur'(?:\'\'|\]\]\'\'|\]\])', ]) + #2
...
lema(ur'[Ff]_ú_nebres?_u', xpre=[ur'\bdi ', ur'\[\[', ur'banda\)\|', ur'Orasion ', ur'Vincetoxicum ', ur'Letto ', ur'Rex ', ur'Car ', ur'Pompe ', ur'Concerto ', ur'Marcia ', ur'M[ae]rche ', ur'Elegio ', ur'[Ee]logio '], xpos=[ur' (?:in|di|per|sur)\b']) + #81
...
lema(ur'[Hh]ar_í_a[ns]?_i', xpre=[ur'Ipuinen ', ur'montando ', ur'Berita '], xpos=[ur' (?:Penang|Nacional|[Mm]etro|Analisa|Global|Nayla|Waspada)', ur'\]']) + 
...
lema(ur'[M]et_á_lic(?:as|os?)_a', xpos=[ur'(?:\.com|\[\[)']) + 
...
lema(ur'[Mm]_á_rtir(?:es|)_a', xpre=[ur'\b(?:ad|di) ', ur'blissful ', ur'je moray ', ur'1582\) ', ur'dessos gloriosos '], xpos=[ur' (?:da|Cypress)\b', ur'(?:\.gov|\]\]io)']) + 
lema(ur'[Mm]_á_stil_a', xpos=[ur', (?:Chema|Al-Son)']) + #50
lema(ur'[Mm]_é_tric[ao]s?_e', xpre=[ur'\b(?:ad|di) ', ur'Ars ', ur'appendice '], xpos=[ur' (?:spagnola|siculo|Sancti|ad|e (?:poesia|il))']) + 
lema(ur'[Mm]_í_stic[ao]s?_i', xpre=[ur'\be ', ur'alla ', ur'Predicatore - ', ur'\bdi ', ur'e la '], xpos=[ur' (?:omaggio|ultranaţionalismului|di|Maxima|Power)\b']) + 
...
lema(ur'[Mm]agn_í_fic(?:as|os?)_i', xpre=[ur'\b[Dd]on ', ur'\b[Ii]l ', ur'Il falso ', ur'Walter ', ur'Guglielmo '], xpos=[ur' (?:cornuto|Arts|theatro|Studios)', ur'(?:, Salves|\')']) + 
lema(ur'[Mm]aor_í_(?:es|)_i', xpre=[ur'the ', ur'Blacks ', ur'Kaupapa ', ur'Does ', ur'\bof '], xpos=[ur' (?:converts|Tattoo|Myths|Lore|village|Songs|Venture|tattooing|tatu|or Less)', ur'\'']) + #160
...
lema(ur'[Pp]_ó_rticos?_o', xpre=[ur'\ba ', ur'\bin ', ur'(?:[Tt]he|and) ', ur'Stamperia del ', ], xpos=[ur' (?:e San|on|di|della|Quartet|del Pavaglione|Books)']) + #153
...
lema(ur'[Pp]otos_í__i', xpre=[ur'Zorocrates ', ur'Gnaphosa ', ur'Misuri\)\|'], xpos=[ur' \(Misuri', ur'\]\]n[ao]s?']) + 
...
lema(ur'[Rr]etom_ó__o', xpre=[ur'[AaEe]l ']) + 
...
lema(ur'[Ss]ab_í_as? (?:que|lo)_i', xpre=[ur'l\'home ', ur'\bla ', ur'palabra más ', ur'mujeres ', ur'mujer ', ur'disciplina ', ur'\by ', ur'muy '], xpos=[ur' Demais']) + 
lema(ur'[Ss]ab_í_as?_i', pre=ur'(?:[EeÉé]l|[Ee]lla|[Ll]o|[Ss]i|[Nn]o|[Nn]adie|[Qq]u[ée]|[Qq]ui[ée]n|[Yy]a|[Ss]e(?: me| te| l[aeo]s?|)) ', xpos=[ur' (?:não|Javanês|de Cor)']) + 
...
lema(ur'[Tt]_é_cnica (?:de|que)_e', xpos=[ur' Engenharia']) + lema(ur'[Tt]_é_cnicas? de_e', xpos=[ur' de coleta e herborizacao']) + lema(ur'[Tt]_é_cnic(?:[ao]s|amente)_e', xpre=[ur' e ']) + lema(ur'[Tt]_é_cnico_e', xpre=[ur'Istituto ', ur'Boletim ', ur'Stabilimento ', ur'Studio ', ], xpos=[ur' (?:d\'Artiglieria|Industriale|superiore|dell|di )', ur'@', ]) + lema(ur'[Tt]_é_cnica_e', pre=ur'(?:[Ll]a|[Uu]na|[Cc]ada|[Ss]u|[Ee]sta|y) ', xpre=[ur' i de ', ur'Scuola ', ], xpos=[ur' (?:edilizia|dell|di )', ]) + #63
...
lema(ur'[Tt]al_ _vez_', xpre=[ur'Um Dia… ', ur'Amanhã '], xpos=[ur' (?:não|[Ss]eja|Depois)']) + 
lema(ur'[Tt]axon_ó_mic[ao]s?_o', xpre=[ur'Estudo ', ur'Plantilla:Categorias ', ur'Revisão ', ur'Series A, '], xpos=[ur' (?:da|[Dd]ipterorum)\b']) + 
...
lema(ur'[Tt]r_á_ficos?_a', xpre=[ur'No '], xpos=[ur' transatlântico']) + 
...
lema(ur'[Tt]r_á_mites?_a', xpre=[ur'que ', ur'Il ', ur'marchio ', ur'[Ss]e ']) + 
lema(ur'[Tt]ranv_í_a_i', xpos=[ur' Blau', ur'(?:\]|\.(?:org|2011))', ]) + #29
lema(ur'[Uu]tili_c_en?_z', xpre=[ur'Can '], xpos=[ur' (?:the|loss-less)']) + 
...
lema(ur'[Vv]ern_á_cul[ao]s?_a', xpre=[ur'Legio '], xpos=[ur'\]\]r\b']) + 
lema(ur'[Vv]est_í_a[ns]?_i', xpos=[ur' (?:la giubba|lycioides|foetida|gotov)', ur'(?:\]\]|\'\'\'\'\' es)', ]) + #18
lema(ur'[Vv]olc_á_n_a', xpre=[ur'être un ', ur'pequeño de ', ur'planes de ', ur'Viola ', ur'Mangora ', ur'Anyphaenoides ', ur'Lygromma ', ur' (?:du|[Ll]e) '], xpos=[ur' (?:d\'|du|de nous|Mines|Club|Entertainment|Studios)\b', ur'(?:\]\]es)']) + 
lema(ur'[d]e_ _l[ao]s_', xpre=[ur' (?:en|de) ', ur' a ', ur'calandarios '], xpos=[ur'[\]\|\']', ur' (?:\)|Santos|Alas|Eljas|Reyes|[BW]\.)']) + #10
lema(ur'[f]r_í_[ao]_i', xpre=[ur'\bdo ', ur'Theridion ', ur'Acrobasis ', ur'Andrena ', ur'Herpyllus ', ur'Noite ', ur'P\. ', ur'Poecilia ', ur'Priapichthys ', ur'Pseudopoecilia ', ur'aquela ', ur'\b[Dd]u ', ], xpos=[ur'5']) + #191
lema(ur'[m]et_á_lic[ao]s?_a', xpre=[ur'T\. ', ur'Fanzine ', ur'Chamaedorea ', ur'Mnesarete '], xpos=[ur' zine', ur'\.com']) + 
lema(ur'[t]ard_í_[ao]_i', xpre=[ur'Director ', ur'Neil ', ur'\*', ur'do amor ', ], xpos=[ur' de Rio Grande do Sul', ]) + #27
lema(ur'[v]iv_í_a[ns]?_i', xpre=[ur'\b[Dd]i '], xpos=[ur' es el']) + 
lema(ur'_Z_onas_S', xpre=[ur'Jeff ', ]) + #2
lema(ur'_z_onas_s', xpre=[ur'Fuxidos de ', ], xpos=[ur' Veris']) + #5
lema(ur'_Á_guilas?_A', xpre=[ur'Penna ', ur'Dell\' ', ur'[LlSs]\'', ur'School Nido de ', ur'Jeff ']) + 
...
lema(ur'_C_hile_c', pre=ur'(?:[Aa]|[Aa]nte|[Ee]n|[Pp]ara|[Pp]or) ') + 
lema(ur'[Vv]_í_a de_i', xpre=[ur'Uma '], xpos=[ur' les']) + 
lema(ur'[Ee]scond_é_rsel[ao]s?_e') + 
lema(ur'[Ee]nterar_í_a[ns]?_i') + 
lema(ur'[d]ar_í_a[ns]?_i') + 
lema(ur'[Dd]iver_sió_n_(?:ci[oó]|sió)') + 
lema(ur'[Ii]r_í_a[ns]? (?:a|de)\b_i') + 
lema(ur'[Aa]divin_ó__o', xpre=[ur'enano ', ur'(?:ser|del) ', ur'\b([Ee]l|es|un) ']) + 
lema(ur'[Ee]ntreten_í_a[ns]?_i') + 
lema(ur'_S_ur ?[Aa]m[eé]rica_s') + 
lema(ur'_C_entro ?[Aa]m[eé]rica_c') + 
lema(ur'[Pp]rov_e_nientes?_i') + 
lema(ur'[Cc]l_ú_ster_u', pre=ur'(?:[Ee]l|[Uu]n) ') + 
lema(ur'[Cc]onquistar_á_[ns]?_a', xpre=[ur'\bl[ae] ']) + 
lema(ur'[Tt]iran_í_as?_i') + 
lema(ur'_Castejó_n_(?:castej[oó]|Castejo)') + 
lema(ur'[Ee]nc_é_falos?_e') + 
lema(ur'[Oo]per_ó__o', xpre=[ur'\bv ', ur'[Yy]o ', ur'y lo ', ur'delle ', ur'mejor me '], xpos=[ur' omnia']) + 
lema(ur'[Mm]arc_ó_ (?:un|dos|tre|el|la|l[ao]s)_o') + 
lema(ur'[Pp]repar_ó__o', xpre=[ur'\b(?:[Mm]e|[Yy]o|[Ll]o|de) '], xpos=[ur' (?:la adecuada|muy bien|el (?:t[eé]|arroz)|arroz|te para|una (?:fiambrera|super)|muy poco|estas gilipolleces)']) + 
lema(ur'[Vv]isit_ó__o', xpos=[ur' (?:Mi Región|Mi Naturaleza|Mi Historia)']) + 
lema(ur'[Pp]re_c_isamente_s') + 
#lema(ur'___') + #deleitó 
#lema(ur'___') + 
#lema(ur'___') + 
#lema(ur'___') + 
...
lema(ur'_É_xodos?_E', xpre=[ur'\|', ur'Trofeo del '], xpos=[ur' Salmus', ur', Excess']) + 
lema(ur'_Ó_rdenes_O', pre=ur'(?:[Ll]as|[Uu]nas|[Ss]us) ', xpos=[ur' (?:[Mm]ilitares|[Rr]eligiosas|[Cc]iviles|[Dd]inásticas|[yi] [Dd]ecretos)']) + 
lema(ur'_Ó_rganos?_O', xpre=[ur'\b(?:De|il) ', ur'Grand\'', ur'[DdLl][’\']', ur'Lowrey ', ur' in ', ur'per ', ur'Tetl '], xpos=[ur' (?:dei|che|para que puedam)', ur', resumido en doze']) + 
...
lema(ur'[Cc]ancel_ó__o', xpre=[ur'João ', 'Cancelo\|'], xpos=[ur'\]\]']) + 
...
lema(ur'_é_l en\b_e', pre=ur'[Cc]on ', xpos=[ur' ese']) + 
lema(ur'_é_l ante\b_e', pre=ur'[Cc]on ', xpos=[ur' último', ur' penúltimo']) + 
lema(ur'_é_l para\b_e', pre=ur'[Cc]on ', xpos=[ur' entonces', ur'-médico']) + 
lema(ur'_é_l contra\b_e', pre=ur'[Cc]on ', xpos=[ur'-(?:insulto|tenor|almirante)']) + 
lema(ur'[Rr]eprogramaci_ó_n_o', xpos=[ur'\]\]es', ]) + 
lema(ur'[Vv]iaj_ó__o', xpre=[ur'[Yy]o '], xpos=[ur' (?:en tu|con mamá|al país)', ur'\.com']) + 
lema(ur'[Ff]_á_bricas? de_a', xpre=[ur'\b[Ss]e ']) + 
lema(ur'[Aa]firm_ó__o', xpre=[ur'\bdi ', ur'afirmar y ', ur'\[', ur'\b(?:[Nn]o|[SsNn]i|[YyLl]o|me) '], xpos=[ur' (?:oc|hoy|No|que en este punto|lo que|toda la|un contenido|l\'esperança|un judaísmo)', ur', pues']) + 
...
lema(ur'[Uu]n_a_ lanza_', xpos=[ur' (?:agua|granadas|misiles|pelotas|petardos|cohetes|dardos|discos)', ]) + #10
...
lema(ur'[Aa]_l_ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:bla|da|cha|mbre|mpa|rpa))_ (?:el|la)', xpos=[ur' [Mm][aá]ter']) + 
lema(ur'[Dd]e_l_ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:bla|da|cha|mbre|mpa|rpa))_ la', xpos=[ur' [Mm][aá]ter']) + 
lema(ur'_El_ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:bla|da|cha|mbre|mpa|rpa))_La', xpos=[ur' (?:en gesto|[Mm][aá]ter)', ur'\'\'']) + 
lema(ur'_el_ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:bla|da|cha|mbre|mpa|rpa))_la', xpre=[ur'dióle '], xpos=[ur' [Mm][aá]ter', ur'\'\'"']) + 
lema(ur'[Uu]n__ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:da|cha|mbre|mpa|rpa))_a', xpos=[ur' [Mm][aá]ter']) + 
lema(ur'[Ee]st?_a_ (?:[AÁaá](?:rea|guila|lgebra)|ánima|a(?:rma|rca|lma|lza|gua|la|rpa|ve)|ha(?:da|cha|mbre|mpa|rpa))_e', xpre=[ur'del '], xpos=[ur' [Mm][aá]ter']) + 
lema(ur'[Aa]_ _los_', xpre=[ur'Arnaldo ', ur'Arronte ', ur'Peiro ', ur' et '], xpos=[ur' (?:Ahmed|más tarde|Indios|passados)', ur'(?:\]|\.e-monsite)']) + #50
lema(ur'[Aa]__l_ la e', xpre=[ur'[Ll]a '], xpos=[ur' la']) + 
lema(ur'\b[Dd]e_ _[0-9][0-9.,]+_', xpre=[ur'[#]']) + 
lema(ur'[Dd]__e_e d', xpos=[ur' (?:Quervain|Waite|Murise|Beer|Toro|Broglie|Gaulle|Morgan|Arteaga)']) + 
lema(ur'[Ee]n_ _la_', xpos=[ur' (?:eglesia|lengua castellana)']) + 
lema(ur'[Ee]__n_n e', xpos=[ur' año', ur'\.']) + 
lema(ur'[Ee]__s_s e', xpre=[ur'[Ll]o que ', ur'[\]\.]'], xpos=[ur' (?:eterno|el solar)']) + 
lema(ur'[Ll]__a_a l', xpre=[ur'dzim ', ur'tra ', ur'"', ur'[OoUu]h ', ur'Limbo ', ur'[Ll]a ', ur'lae ', ur'Sha '], xpos=[ur'[)\'\]"]', ur' (?:la|aku|jump|m )']) + 
lema(ur'[Pp]__ara_ara p', xpos=[ur'[|\]\']']) + 
lema(ur'[Ss]__u_u s', xpre=[ur'[Ss]u '], xpos=[ur' su']) + 
lema(ur'[Uu]__na_na u', xpre=[ur'cada ']) + 
lema(ur'[y]___ y', xpre=[ur'\]', ur'[Ll]a ', ur'\|\| ', ur'como ', ur'Eosina ', ur'Bay ', ur'Mboi[’\']', ur'= x ', ur'kurupa\'', ur'cromosoma ', ur'núcleo ', ur'R4', ur'w̃, ', ur'W e ', ur'½', ur'X o '], xpos=[ur'[=}\'\]|]', ur' (?:[:BbZzWwXxKk]|iv|ll|el aumento|mitocondrial|luego|el ADN|magia|[0-9])']) + 
lema(ur'_e_ (?!i[ivx]|ius|imn|indios|indica|induce|ist|hiérvelo|hide|hip|high|hippies|hippy|hie|hits)h?i[a-záéíóúñ]+_y', xpre=[ur'>='], xpos=[ur' (?:Meteo|installer|interceptèrent|installa|ii\)|(?:ia|in) )']) + 
lema(ur'_el__la el' , xpre=[ur'cerul ', ur'un ']) + 
[]][0]
