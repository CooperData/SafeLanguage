...
lema(ur'[Mm]itolog_í_as?_i', xpre=[ur'sulla ', ur'Herriko ', ur'Relats de '], xpos=[ur' (?:locale|[Cc]lassica|grega|vedica|comparata)']) + #1
...
lema(ur'[Ss]and_í_as?_i', xpre=[ur'The ', ur'por ', ur'George ', ur'Unida de las ', ur'llamada ', ur'Nacional ', ur'Nacionales ', ur'[Dd]el ', ur'de ', ur'sandios” o “', ur'de Sandia\|', ur'sandía, ', ur'Perú\)\|', ur'Provincia de ', ur'Acacio ', ur'Eduardo ', ur'Familia '], xpos=[ur' (?:\(\(Perú|Llover|View|High|Perú|Pueblo|National|Laboratories|Labs|Casino)', ur'(?:\]\]|\.gov|, Puno)']) + #8
...
lema(ur'[Mm]arc_ó_ (?:en|un|dos|tres|la|l[ao]s)_o', xpre=[ur'por ', ur'como ']) + #1
