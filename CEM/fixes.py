...
####Apellidos
lema(ur'Fern_á_ndez_a', xpre=[ur'and ', ur'd’Anita ', ur'J[eé]r[oô]me ',ur'Jean ', ur'Valentim ', ur'Domenique ', ur'Dominique ', ur'Heine ', ur'Mervyn '], xpos=[ur' Islands']) + #1
...
lema(ur'[Tt]elefon_í_as?_i', xpos=[ur' Nas']) + #9
...
lema(ur'_francé_s_(?:Franc[eé]|france)', pre=ur'\b(?:e[ln]|del?|idioma) ', xpre=[ur'Guerra ', ur'maestra ', ur'Diplomado ']) + #1
...
lema(ur'_é_tnic[ao]_e', xpre=[ur'Dalmazia ', ], xpos=[ur' e resistenza', ur'\'', ]) + #1
...
lema(ur'[Ee]strenar_á__a', pre=ur'(?:[Ss]e )', xpre=[ur'que ']) + #1
...
lema(ur'[Ss]omal_í__i', xpre=[ur'Hamzeh '], xpos=[ur' (?:Piracy|Pigeon|Queen|King|Nationalism|Airlines|Supper)']) + #1
...
lema(ur'[Aa]divin_ó__o', xpre=[ur'enano ', ur'(?:ser|del) ', ur'\b([Ee]l|es|un) ']) + #1
...
lema(ur'[Mm]arc_ó_ (?:un|dos|tre|el|la|l[ao]s)_o') + #1
...
lema(ur'_e_ (?!i[ivx]|ius|imn|indios|indica|induce|ist|hiérvelo|hide|hip|high|hippies|hippy|hie|hits)h?i[a-záéíóúñ]+_y', xpre=[ur'>='], xpos=[ur' (?:Meteo|installer|interceptèrent|installa|ii\)|(?:ia|in) )']) + #1
